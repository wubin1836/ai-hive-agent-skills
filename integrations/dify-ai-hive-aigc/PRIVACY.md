...
The plugin does not sell personal information, run advertising trackers, or send task data to unrelated third parties. Users should not upload content they are not authorized to process. To request deletion or obtain support, contact the AI Hive service operator through the support channel shown on `https://ai-hive.iclip.cn/`.
...
插件不会出售个人信息，不运行广告追踪，也不会把任务数据发送给无关第三方。用户不应上传无权处理的内容。如需删除数据或获得支持，请通过 `https://ai-hive.iclip.cn/` 所示的 AI Hive 服务支持渠道联系运营方。
