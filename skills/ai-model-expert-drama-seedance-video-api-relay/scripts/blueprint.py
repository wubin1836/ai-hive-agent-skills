#!/usr/bin/env python3
"""Create a deterministic production brief for Seedance视频API中转."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='Seedance视频API中转')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['Seedance中转', 'Seedance API', '即梦视频接口', '视频模型中转'],
