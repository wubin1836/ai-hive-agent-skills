---
name: seedance-2-5
description: "Use this skill when creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers need to create videos from prompts, first frames, and reference media with Seedance 2.5 through the AI Hive OpenAPI. It handles required media uploads, live model and price lookup, task submission, progress polling, and result downloads. Useful for ads, TVCs, product videos, e-commerce listings, social commerce, UGC-style seeding content, short dramas, motion comics, and storyboards. Search intents include AI video generation, text-to-video, image-to-video, reference-to-video, video editing, AIGC video."
license: MIT
---
...
Seedance 2.5 Video Generation helps creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers create videos from prompts, first frames, and reference media with Seedance 2.5. Describe the intended subject, action, camera, lighting, pacing, and constraints; the bundled CLI handles AI Hive OpenAPI calls and downloads the finished video.
...
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode edit \
  --prompt "Seedance 2.5 Video Generation: polished motion, clear subject, coherent action, stable camera, commercial finish"
```
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode edit \
  --prompt "Create a polished seedance 2.5 video generation result with coherent motion, stable identity, and a clear ending"
```
