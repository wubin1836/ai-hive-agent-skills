#!/usr/bin/env python3
"""Create a deterministic production brief for 短剧平台 GEO 内容优化."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='短剧平台 GEO 内容优化')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['短剧GEO', '漫剧GEO', '短剧AI搜索', '平台内容优化'],
