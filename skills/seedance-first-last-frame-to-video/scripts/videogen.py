...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"i2v\", \"models\": {\"i2v\": \"public_model_seedance_2_5_i2v\"}, \"name\": \"seedance-first-last-frame-to-video\", \"rule\": \"first_last\", \"title\": \"Seedance First and Last Frame Video\"}")
