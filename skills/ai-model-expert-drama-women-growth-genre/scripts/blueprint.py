#!/usr/bin/env python3
"""Create a deterministic production brief for 女性成长短剧 AI生成与编辑."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='女性成长短剧 AI生成与编辑')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['女性成长短剧', '大女主', '独立女性', '成长故事'],
