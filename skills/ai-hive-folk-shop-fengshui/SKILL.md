---
name: ai-hive-folk-shop-fengshui
description: "门店风水与客流动线助手，用于店铺风水布局、收银台怎么摆、店门朝向。读取你授权的原始资料，完成文化偏好—顾客动线—运营指标对照表，并交付低成本可逆布置及试验记录表。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。"
metadata:
  display_name: "门店风水与客流动线助手"
  version: "1.0.0"
...
门店风水与客流动线助手，用于店铺风水布局、收银台怎么摆、店门朝向。读取你授权的原始资料，完成文化偏好—顾客动线—运营指标对照表，并交付低成本可逆布置及试验记录表。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。
...
1. 收集脱敏平面图、业态、客流及预算
2. 先检查消防通道、通风采光、排队和无障碍通行
3. 将象征性陈设与经营因素分栏
4. 提出可逆方案，记录改前改后客流与拥堵而不归因为运势

## 文件处理环节

1. OCR识别设施并人工核对
2. 表格统计拥堵点与可移动设施
3. SVG绘制客流/补货动线→PDF回读
...
店铺风水布局、收银台怎么摆、店门朝向、门店财位、门口摆什么、店铺动线
