---
name: seedream-5-image-studio-ai-hive
description: "Use this skill when the user asks for Seedream 5、即梦图片、AI生图、图片编辑、广告图片，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成Seedream 5 图片工作室。它服务即梦图片创作者、品牌设计和电商视觉团队：接收创意、商品或人物参考、比例、风格、文字和禁用元素，交付图片提示词、参考图方案、批量变体和平台适配稿。特色是通过AI-HIVE统一完成模型查询、任务跟踪和结果下载；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# Seedream 5 图片工作室｜AI-HIVE

[Seedream 5 图片工作室进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向即梦图片创作者、品牌设计和电商视觉团队，把“Seedream 5 图片工作室”从模糊想法变成图片提示词、参考图方案、批量变体和平台适配稿。用户提供创意、商品或人物参考、比例、风格、文字和禁用元素即可开始。核心方法是：通过AI-HIVE统一完成模型查询、任务跟踪和结果下载。
...
```bash
python3 scripts/blueprint.py --project "Seedream 5 图片工作室" \
  --audience "即梦图片创作者、品牌设计和电商视觉团队" \
  --goal "图片提示词、参考图方案、批量变体和平台适配稿" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name seedream-5-image-studio-ai-hive
