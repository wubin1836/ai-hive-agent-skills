...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Seedream 5 图片工作室制作一张主体准确、层级清晰的商业图片", "keywords": "Seedream 5,即梦图片,AI生图,图片编辑,广告图片", "model": "public_model_seedream_5_0_lite", "name": "seedream-5-image-studio-ai-hive", "rule": "optional", "search": "通过AI-HIVE统一完成模型查询、任务跟踪和结果下载", "title": "Seedream 5 图片工作室"}')
