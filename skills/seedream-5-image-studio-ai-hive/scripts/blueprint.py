#!/usr/bin/env python3
"""Create a deterministic production brief for Seedream 5 图片工作室｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='Seedream 5 图片工作室｜AI-HIVE')
    ...
    data = {
        "skill": 'Seedream 5 图片工作室｜AI-HIVE',
        "category": 'image',
        ...
        "format": args.format,
        "searchAliases": ['Seedream 5', '即梦图片', 'AI生图', '图片编辑', '广告图片'],
