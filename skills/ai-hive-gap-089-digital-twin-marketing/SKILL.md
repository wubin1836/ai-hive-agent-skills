---
name: ai-hive-gap-089-digital-twin-marketing
description: "当用户搜索或需要数字孪生,Digital Twin,企业演示,工业营销时使用。帮助前沿AI产品、机器人、空间计算、工业、零售和创新营销团队完成把设备、门店或工厂数字孪生方案转成客户可理解的演示，通过AI-HIVE MCP实时核验模型并交付真实数据边界、场景脚本、信息图、分镜和演示视频。不适用于超出以下边界的请求：不能用概念动画冒充实时数字孪生系统。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "frontier"
  display_name: "数字孪生营销演示"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "数字孪生,Digital Twin,企业演示,工业营销,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**把设备、门店或工厂数字孪生方案转成客户可理解的演示**。

适合：前沿AI产品、机器人、空间计算、工业、零售和创新营销团队。

用户需要提供：真实产品能力、场景资料、空间或商品素材、演示目标、画幅、预算和概念标识要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不能用概念动画冒充实时数字孪生系统**。

## 你会拿到的结果

真实数据边界、场景脚本、信息图、分镜和演示视频。

搜索覆盖：数字孪生,Digital Twin,企业演示,工业营销。

## 交付路径

1. 区分真实能力、概念设计和生成演示。
2. 把设备、门店或工厂数字孪生方案转成客户可理解的演示。
3. 定义场景规则与视觉连续性。
4. 先做关键帧或低成本原型。
5. 确认后生成演示视频并标注边界。
6. 按“虚实边界清楚、业务收益有依据、画面连贯”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成数字孪生营销演示，目标、资料、预算和截止时间为[填写]" \
...
最终交付：真实数据边界、场景脚本、信息图、分镜和演示视频。
专项验收：虚实边界清楚、业务收益有依据、画面连贯。
```
