---
name: ai-hive-gap-002-persistent-agent-brand
description: "当用户搜索或需要持久化智能体,persistent agent,品牌运营,长期Agent时使用。帮助AI产品经理、运营团队、内容团队、开发者和希望自动化工作的个人完成把品牌事实、风格规则和长期任务状态沉淀为持续运营流程，通过AI-HIVE MCP实时核验模型并交付品牌事实卡、长期记忆边界、周内容计划、素材版本和复盘表。不适用于超出以下边界的请求：不得把未经核实的信息写入长期记忆。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "agent"
  display_name: "持久化智能体品牌运营"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "持久化智能体,persistent agent,品牌运营,长期Agent,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**把品牌事实、风格规则和长期任务状态沉淀为持续运营流程**。

适合：AI产品经理、运营团队、内容团队、开发者和希望自动化工作的个人。

用户需要提供：业务目标、可用工具、授权范围、输入资料、预算、截止时间和人工确认点。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不得把未经核实的信息写入长期记忆**。

## 你会拿到的结果

品牌事实卡、长期记忆边界、周内容计划、素材版本和复盘表。

搜索覆盖：持久化智能体,persistent agent,品牌运营,长期Agent。

## 工作方法

1. 先画出任务状态和权限边界。
2. 把品牌事实、风格规则和长期任务状态沉淀为持续运营流程。
3. 将可并行任务与必须串行确认的动作分开。
4. 用最小样例验证工具连接。
5. 记录检查点和恢复方式。
6. 按“品牌口径一致、记忆可更新、错误信息可撤销”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成持久化智能体品牌运营，目标、资料、预算和截止时间为[填写]" \
...
最终交付：品牌事实卡、长期记忆边界、周内容计划、素材版本和复盘表。
专项验收：品牌口径一致、记忆可更新、错误信息可撤销。
```
