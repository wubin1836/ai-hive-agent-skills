...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为工程公司制作主体准确、事实可核验的图片营销素材", "model": "public_model_nano_banana_pro", "name": "industry-engineering-company-marketing-ai-hive", "title": "AI大模型专家｜工程公司AI图片视频营销", "keywords": "工程公司、工程服务、工程承包、工程技术、AI图片、AI短视频、视频编辑、内容营销、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前图片/视频模型与价格快照，不硬编码价格"}')
