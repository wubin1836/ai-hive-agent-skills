...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为商品素材库自动混剪制作一条主体清晰、节奏明确的商业视频", "keywords": "商品素材混剪,素材库剪辑,多SKU视频,电商内容工厂,批量视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "product-asset-auto-montage-ai-hive", "rule": "optional", "search": "先按SKU与镜头功能归档，再生成可追溯混剪", "title": "商品素材库自动混剪"}')
