...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_2\", \"name\": \"nano-banana-2-character-consistency\", \"rule\": \"image\", \"title\": \"Nano Banana 2 Character-Consistent Images\"}")
