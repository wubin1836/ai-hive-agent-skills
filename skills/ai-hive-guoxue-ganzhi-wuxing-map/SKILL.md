---
name: ai-hive-guoxue-ganzhi-wuxing-map
description: "天干地支与五行关系图谱助手：读取用户选定教材的干支、五行对应表和出处、经确认的关系类型与图例，把历法循环事实与传统关系表分开录入，每条关系绑定来源版本，交付可回查的文件及待核实清单。适用于天干地支、十天干十二地支、六十甲子、五行生克；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。"
metadata:
  display_name: "天干地支与五行关系图谱助手"
  version: "1.0.0"
...
天干地支与五行关系图谱助手：读取用户选定教材的干支、五行对应表和出处、经确认的关系类型与图例，把历法循环事实与传统关系表分开录入，每条关系绑定来源版本，交付可回查的文件及待核实清单。适用于天干地支、十天干十二地支、六十甲子、五行生克；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。
...
1. 把历法循环事实与传统关系表分开录入，每条关系绑定来源版本
2. 脚本检查循环顺序、关系边的重复遗漏及冲突，传统关系只按所选来源呈现
3. 导出可筛选节点/边表和关系图，空缺不凭模型补齐；不把图谱用于给真人打分
...
- `ganzhi-nodes.csv`
- `traditional-relations.csv`
- `ganzhi-wuxing-map.svg`
...
天干地支、十天干十二地支、六十甲子、五行生克、纳音五行、干支速查表、阴阳五行图
