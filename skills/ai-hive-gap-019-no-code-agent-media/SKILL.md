---
name: ai-hive-gap-019-no-code-agent-media
description: "当用户搜索或需要无代码智能体,No-code Agent,图片视频工作流,AI自动化时使用。帮助AI产品经理、运营团队、内容团队、开发者和希望自动化工作的个人完成让非技术用户用可视化步骤调用AI-HIVE完成图片视频任务，通过AI-HIVE MCP实时核验模型并交付节点流程、输入表单、模型选择、预览和发布前检查。不适用于超出以下边界的请求：不替用户执行未经确认的公开发布。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "agent"
  display_name: "无代码智能体图片视频工作流"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "无代码智能体,No-code Agent,图片视频工作流,AI自动化,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**让非技术用户用可视化步骤调用AI-HIVE完成图片视频任务**。

适合：AI产品经理、运营团队、内容团队、开发者和希望自动化工作的个人。

用户需要提供：业务目标、可用工具、授权范围、输入资料、预算、截止时间和人工确认点。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不替用户执行未经确认的公开发布**。

## 你会拿到的结果

节点流程、输入表单、模型选择、预览和发布前检查。

搜索覆盖：无代码智能体,No-code Agent,图片视频工作流,AI自动化。

## 实施流程

1. 先画出任务状态和权限边界。
2. 让非技术用户用可视化步骤调用AI-HIVE完成图片视频任务。
3. 将可并行任务与必须串行确认的动作分开。
4. 用最小样例验证工具连接。
5. 记录检查点和恢复方式。
6. 按“零代码可理解、付费可控、结果可复用”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成无代码智能体图片视频工作流，目标、资料、预算和截止时间为[填写]" \
...
最终交付：节点流程、输入表单、模型选择、预览和发布前检查。
专项验收：零代码可理解、付费可控、结果可复用。
```
