---
name: ai-hive-maternity-allowance-docs
description: "生育津贴申领资料助手，用于生育津贴怎么领、生育保险报销、产假工资。读取你授权的原始资料，完成当地事项与责任方清单，并交付金额或进度待核实问题。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "生育津贴申领资料助手"
  version: "1.0.0"
...
生育津贴申领资料助手，用于生育津贴怎么领、生育保险报销、产假工资。读取你授权的原始资料，完成当地事项与责任方清单，并交付金额或进度待核实问题。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 确认参保地及用户提供的实际办理阶段，最少化医疗隐私
2. 区分津贴、医疗费报销和单位工资处理，核对当地官方口径
3. 匹配已提交材料及回执，未知待遇或到账时间不估造
...
- `maternity-allowance-docs-checklist.xlsx`
- `maternity-allowance-docs-evidence.docx`
- `maternity-allowance-docs-sources.json`
...
> 仅示例，以下文件名和情境均为假设，不表示已存在真实数据：假设我已提供 示例_参保地与办理阶段.json、示例_当地申领指南.pdf、示例_单位及本人回执目录.csv。请使用「生育津贴申领资料助手」，核对单位、本人和医保经办分别要准备的资料，区分津贴与医疗费用报销。将结果写入我指定的本地目录，交付 maternity-allowance-docs-checklist.xlsx、maternity-allowance-docs-evidence.docx、maternity-allowance-docs-sources.json。本例先离线处理；输入、工具或适用规则不足时先交缺口说明，不编造结果。需要联网更新来源先征得我同意，不登录账户、不代提交或付款。

## 搜索与任务识别

生育津贴怎么领、生育保险报销、产假工资、生育津贴材料、生育津贴到账
