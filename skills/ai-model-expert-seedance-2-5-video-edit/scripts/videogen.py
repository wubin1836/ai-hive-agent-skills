...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "保持人物动作与镜头不变，将背景替换为雨夜霓虹城市", "fixed_mode": "edit", "keywords": "Seedance2.5、Seedance 2.5、字节 Seedance、豆包 Seedance、即梦视频、视频编辑、AI剪辑、改视频、视频换背景、视频重绘、video edit", "models": {"edit": "public_model_seedance_2_5_video_edit"}, "name": "seedance-2-5-video-edit", "rule": "edit", "search": "固定调用 Seedance 2.5 视频编辑裸接口", "title": "Seedance 2.5 视频编辑"}')
