...
description: "Use this skill when creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers need to create production-ready AI video from a brief or reference media with AI Hive through the AI Hive OpenAPI. It handles required media uploads, live model and price lookup, task submission, progress polling, and result downloads. Useful for ads, TVCs, product videos, e-commerce listings, social commerce, UGC-style seeding content, short dramas, motion comics, and storyboards. Search intents include AI video generation, AIGC video, generative video, video creator."
license: MIT
---
...
AI Video Generation helps creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers create production-ready AI video from a brief or reference media with AI Hive. Describe the intended subject, action, camera, lighting, pacing, and constraints; the bundled CLI handles AI Hive OpenAPI calls and downloads the finished video.
...
Ads, tvcs, product videos, e-commerce listings, social commerce, ugc-style seeding content, short dramas, motion comics, and storyboards. It is also useful when users search for AI video generation, AIGC video, generative video, video creator.
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name video-generation
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode i2v \
  --prompt "AI Video Generation: polished motion, clear subject, coherent action, stable camera, commercial finish"
```
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "Create a polished ai video generation result with coherent motion, stable identity, and a clear ending"
```
