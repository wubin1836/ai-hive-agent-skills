...
|---|---|---|
| `i2v` | Image to Video | `public_model_minimax_h3_i2v` |
| `r2v` | Reference to Video | `public_model_minimax_h3_r2v` |
| `t2v` | Text to Video | `public_model_minimax_h3_t2v` |
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name minimax-h3-social-commerce-video
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode i2v \
  --prompt "MiniMax H3 Social Commerce Video: polished motion, clear subject, coherent action, stable camera, commercial finish"
```
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "Create a polished minimax h3 social commerce video result with coherent motion, stable identity, and a clear ending"
```
