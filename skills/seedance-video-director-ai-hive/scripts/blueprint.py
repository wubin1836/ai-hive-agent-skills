#!/usr/bin/env python3
"""Create a deterministic production brief for Seedance AI视频导演｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='Seedance AI视频导演｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['Seedance视频导演', 'AI导演', '广告分镜', '运镜提示词', 'AI制片'],
