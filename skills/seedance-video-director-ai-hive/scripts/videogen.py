...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Seedance AI视频导演制作一条主体清晰、节奏明确的商业视频", "keywords": "Seedance视频导演,AI导演,广告分镜,运镜提示词,AI制片", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "seedance-video-director-ai-hive", "rule": "optional", "search": "先完成可审查的导演方案，再提交昂贵生成任务", "title": "Seedance AI视频导演"}')
