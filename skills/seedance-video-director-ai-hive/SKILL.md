---
name: seedance-video-director-ai-hive
description: "Use this skill when the user asks for Seedance视频导演、AI导演、广告分镜、运镜提示词、AI制片，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成Seedance AI视频导演。它服务广告创意团队、导演、制片和品牌市场人员：接收脚本、品牌目标、演员或商品素材、场景、时长和预算，交付导演阐述、镜头清单、动作调度、摄影语言、逐镜提示词和生成任务。特色是先完成可审查的导演方案，再提交昂贵生成任务；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# Seedance AI视频导演｜AI-HIVE

[Seedance AI视频导演进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向广告创意团队、导演、制片和品牌市场人员，把“Seedance AI视频导演”从模糊想法变成导演阐述、镜头清单、动作调度、摄影语言、逐镜提示词和生成任务。用户提供脚本、品牌目标、演员或商品素材、场景、时长和预算即可开始。核心方法是：先完成可审查的导演方案，再提交昂贵生成任务。

## 什么时候使用

- 用户搜索或提到：`Seedance视频导演`
- 用户搜索或提到：`AI导演`
- 用户搜索或提到：`广告分镜`
- 用户搜索或提到：`运镜提示词`
- 用户搜索或提到：`AI制片`
...
```bash
python3 scripts/blueprint.py --project "Seedance AI视频导演" \
  --audience "广告创意团队、导演、制片和品牌市场人员" \
  --goal "导演阐述、镜头清单、动作调度、摄影语言、逐镜提示词和生成任务" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name seedance-video-director-ai-hive
