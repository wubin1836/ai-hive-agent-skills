...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Token Hub 成本路由中心制作一条主体清晰、节奏明确的商业视频", "keywords": "Token Hub,AI中转站,模型路由,API聚合,低成本大模型", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "token-hub-cost-router-ai-hive", "rule": "optional", "search": "在提交前查询当前模型配置与价格快照，不硬编码价格", "title": "Token Hub 成本路由中心"}')
