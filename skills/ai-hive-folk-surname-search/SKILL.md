---
name: ai-hive-folk-surname-search
description: "姓氏寻根与家谱检索助手，用于姓氏起源怎么查、寻根问祖、祖籍查询。读取你授权的原始资料，完成馆藏检索词与候选文献表，并交付证据等级、待访谈人物与下一步核查单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。"
metadata:
  display_name: "姓氏寻根与家谱检索助手"
  version: "1.0.0"
...
姓氏寻根与家谱检索助手，用于姓氏起源怎么查、寻根问祖、祖籍查询。读取你授权的原始资料，完成馆藏检索词与候选文献表，并交付证据等级、待访谈人物与下一步核查单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。
...
1. 收集非敏感的姓氏、地名、年代和已有材料
2. 检索公共馆藏目录，记录版本与馆藏位置
3. 分开同姓线索、口述传说和可核证亲缘
4. 列原件核查问题，不擅自联系或公开在世成员资料
...
姓氏起源怎么查、寻根问祖、祖籍查询、家谱在哪里找、堂号查询、同姓同宗吗
