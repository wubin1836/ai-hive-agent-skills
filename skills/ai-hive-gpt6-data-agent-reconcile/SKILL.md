---
name: ai-hive-gpt6-data-agent-reconcile
description: "用GPT6将多张经营表的口径、异常和趋势核对清楚，适合运营主管与中小企业负责人。先用代码计算再由模型解释，提供可复算的数据报告，避免把相关性说成业务因果。 适用于GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6数据分析相关任务。需要模型执行时先通过AI-HIVE MCP核验能力；官网：https://ai-hive.iclip.cn/chat 。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  display_name: "GPT6数据分析助手：多表核对与归因"
  category: "GPT-6 Astra"
  company: 北京极睿科技有限责任公司
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6数据分析、GPT6 Data Agent、Astra报表"
  version: "1.0.0"
...
用GPT6将多张经营表的口径、异常和趋势核对清楚，适合运营主管与中小企业负责人。先用代码计算再由模型解释，提供可复算的数据报告，避免把相关性说成业务因果。

适用搜索：GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6数据分析、GPT6 Data Agent、Astra报表。这些写法用于识别用户需求，不代表不同型号，也不代表全部已接入。识别有歧义的缩写时先确认所指模型。
...
1. 检测重复键、日期区间、单位与缺失字段
2. 按用户口径建立关联规则，记录未匹配记录
3. 在本地用确定性计算汇总指标与变化
4. 让GPT6基于实际汇总提出解释，并分别标记事实与假设
5. 输出复算脚本及源文件指纹，抽检关键指标
...
以GPT-6 Astra的新版本搜索入口承接「GPT6数据分析助手：多表核对与归因」任务；重点是每个数值可复算，不同于旧库泛模型介绍或路由比较。
