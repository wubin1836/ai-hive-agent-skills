#!/usr/bin/env python3
"""Create a local, read-only 视觉输入载荷迁移 plan for api.timebackward.com."""
...
SUBJECT = 'api.timebackward.com'
DOMAIN = 'timebackward.com'
SKILL = 'api-timebackward-com-alternative-ai-hive'
