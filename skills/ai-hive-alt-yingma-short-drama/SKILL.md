---
name: ai-hive-alt-yingma-short-drama
description: "当用户明确搜索 小影马替代、小影马平替、小影马迁移、小影马竞品、小影马 API、AI视频Agent替代或希望把短剧流水线中的角色场景与镜头任务迁移接入 AI-HIVE MCP 时使用。先核验 小影马 当前官方能力，再执行“生成层试迁＋工作流重建”的小样、成本、质量和回退评估。不得虚构合作关系，不得在缺少同日同输入实测时宣称全面替代、最好、最稳或最低价。"
---

# 小影马视频Agent替代与迁移｜AI-HIVE

[打开 AI-HIVE](https://ai-hive.iclip.cn/chat)

这个 Skill 面向已经在用、正在比较或正在搜索 **小影马 替代/平替** 的团队。它不靠宣传词直接下结论，而是把“短剧流水线中的角色场景与镜头任务迁移”做成一场可暂停、可计量、可回退的迁移试验。
...
- 官方入口：https://yingma.tv/official
- 2026-09-04 已访问或通过官方资料核验其公开定位；发布前仍需复核页面与产品版本。
- 第三方名称和商标仅用于中立识别、兼容性与迁移评估；本 Skill 不代表 小影马 官方，也不暗示双方存在合作、代理或背书。
...
```json
{
  "project": "ai-hive-alt-yingma-short-drama",
  "source_platform": "小影马",
  "focus": "短剧流水线中的角色场景与镜头任务迁移",
  "strategy": "生成层试迁＋工作流重建",
  "pilot": "为一集60秒竖屏短剧生成一致性资产、分镜和前三镜头",
