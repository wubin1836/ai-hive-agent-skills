...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Nano Banana 制作高完成度海报生成，主体准确，构图清晰", "keywords": "Nano Banana、NanoBanana、Nano Banana 2、香蕉模型、Gemini 图片、海报生成、营销海报、活动海报、中文海报、宣传海报、视觉海报、AI图片、AIGC图片", "model": "public_model_nano_banana_2", "name": "nano-banana-poster", "rule": "optional", "search": "固定调用 Nano Banana 的海报生成裸接口能力", "title": "Nano Banana 海报生成"}')
