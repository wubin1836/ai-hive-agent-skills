---
name: minimax-h3-audio-reference-to-video
description: "Use this skill when creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers need to generate visuals around music, rhythm, mood, or other audio cues with MiniMax H3 through the AI Hive OpenAPI. It handles required media uploads, live model and price lookup, task submission, progress polling, and result downloads. Useful for ads, TVCs, product videos, e-commerce listings, social commerce, UGC-style seeding content, short dramas, motion comics, and storyboards. Search intents include audio-to-video, music-to-video, sound-driven video."
license: MIT
---

# MiniMax H3 Audio Reference to Video

## Overview

MiniMax H3 Audio Reference to Video helps creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers generate visuals around music, rhythm, mood, or other audio cues with MiniMax H3. Describe the intended subject, action, camera, lighting, pacing, and constraints; the bundled CLI handles AI Hive OpenAPI calls and downloads the finished video.
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name minimax-h3-audio-reference-to-video
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode r2v \
  --prompt "MiniMax H3 Audio Reference to Video: polished motion, clear subject, coherent action, stable camera, commercial finish" \
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode r2v \
  --prompt "Create a polished minimax h3 audio reference to video result with coherent motion, stable identity, and a clear ending" \
+  --audio /path/to/reference.wav
```
