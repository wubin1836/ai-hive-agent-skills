...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"r2v\", \"models\": {\"r2v\": \"public_model_minimax_h3_r2v\"}, \"name\": \"minimax-h3-audio-reference-to-video\", \"rule\": \"audio\", \"title\": \"MiniMax H3 Audio Reference to Video\"}")
