...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合AliExpress 速卖通的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "速卖通、AliExpress卖家、阿里国际、速卖通主图、Listing、商品视频、跨境投放、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "aliexpress-ecommerce-image-generation-editing", "rule": "optional", "search": "AliExpress 速卖通 商家、运营、商品与广告图片搜索入口", "title": "AliExpress 速卖通 电商图片生成与编辑"}')
