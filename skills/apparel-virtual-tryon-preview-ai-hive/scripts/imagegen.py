...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI服装虚拟试穿效果图制作一张主体准确、层级清晰的商业图片", "keywords": "虚拟试穿,AI试衣,服装上身,穿搭效果图,电商模特", "model": "public_model_gpt_image_2", "name": "apparel-virtual-tryon-preview-ai-hive", "rule": "optional", "search": "用人物与服装双参考生成可分享的视觉预览", "title": "AI服装虚拟试穿效果图"}')
