---
name: ai-hive-gap-034-ai-trainer
description: "当用户搜索或需要AI培训师,企业培训,课程生成,课件制作时使用。帮助普通企业、创业团队、超级个体、销售运营和职能部门完成从企业知识材料制作课程结构、课件视觉和练习，通过AI-HIVE MCP实时核验模型并交付学习目标、课程大纲、讲义、配图、练习和测验。不适用于超出以下边界的请求：专业领域内容需业务专家复核。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "enterprise"
  display_name: "AI培训师课程与课件生成"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "AI培训师,企业培训,课程生成,课件制作,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**从企业知识材料制作课程结构、课件视觉和练习**。

适合：普通企业、创业团队、超级个体、销售运营和职能部门。

用户需要提供：真实业务资料、目标受众、内部口径、交付格式、品牌规范、预算和审批要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**专业领域内容需业务专家复核**。

## 你会拿到的结果

学习目标、课程大纲、讲义、配图、练习和测验。

搜索覆盖：AI培训师,企业培训,课程生成,课件制作。

## 工作方法

1. 将业务问题和生成任务分开。
2. 从企业知识材料制作课程结构、课件视觉和练习。
3. 锁定不可虚构的事实与数字。
4. 先交付文字或结构草案。
5. 确认后制作视觉小样并验收。
6. 按“目标一致、内容准确、难度合适”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成AI培训师课程与课件生成，目标、资料、预算和截止时间为[填写]" \
