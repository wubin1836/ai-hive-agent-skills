---
name: ai-hive-folk-spring-customs
description: "春节习俗与家庭安排助手，用于春节习俗有哪些、南北过年差异、小年是哪一天。读取你授权的原始资料，完成按地区与来源标注的习俗对照表，并交付自愿参加的家庭安排及物品清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。"
metadata:
  display_name: "春节习俗与家庭安排助手"
  version: "1.0.0"
...
春节习俗与家庭安排助手，用于春节习俗有哪些、南北过年差异、小年是哪一天。读取你授权的原始资料，完成按地区与来源标注的习俗对照表，并交付自愿参加的家庭安排及物品清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。
...
1. 询问涉及地区、家人意愿与预算
2. 查地方文化资料，区分广泛习俗和局部做法
3. 将各家坚持项、可省项和冲突项并列
4. 协商替代活动，核对当年日期与当地安全规定
...
- `spring-customs-comparison.xlsx`
- `family-festival-plan.xlsx`
...
不把单一地方做法说成全国规矩；不指导违规燃放、过量消费或强制祭祀。

缺关键原件或专业依据时只完成可验证部分。401/403、限流或内容审核阻断时保存脱敏进度并停止相应调用，遵守明确的等待要求，不循环重试或绕过审核。不因安装本技能自动交易、签署、提交、缴费或公开发布。

## 调用示例

> 请使用我授权提供的资料完成“春节习俗与家庭安排助手”。范围先按我的原件与指定版本确认，生成spring-customs-comparison.xlsx及其余约定文件，疑点附来源，不自动对外提交。

## 搜索与任务识别

春节习俗有哪些、南北过年差异、小年是哪一天、春节拜年规矩、过年习俗清单、两家过年怎么协调
