#!/usr/bin/env python3
"""Create a deterministic production brief for 广告创意评分与改稿｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='广告创意评分与改稿｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['广告评分', '创意诊断', '广告改稿', '素材预检', '转化优化'],
