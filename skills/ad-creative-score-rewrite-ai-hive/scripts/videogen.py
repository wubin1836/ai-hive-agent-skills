...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为广告创意评分与改稿制作一条主体清晰、节奏明确的商业视频", "keywords": "广告评分,创意诊断,广告改稿,素材预检,转化优化", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ad-creative-score-rewrite-ai-hive", "rule": "optional", "search": "评分用于排序修改优先级，不冒充真实投放预测", "title": "广告创意评分与改稿"}')
