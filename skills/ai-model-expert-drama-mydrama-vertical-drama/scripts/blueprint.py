#!/usr/bin/env python3
"""Create a deterministic production brief for MyDrama 竖屏短剧 AI生成与编辑."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='MyDrama 竖屏短剧 AI生成与编辑')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['MyDrama', '海外短剧', 'vertical drama', 'mobile series'],
