...
Social Commerce Video helps creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers produce shoppable, creator-led, and conversion-focused product videos with AI Hive. Describe the intended subject, action, camera, lighting, pacing, and constraints; the bundled CLI handles AI Hive OpenAPI calls and downloads the finished video.
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name social-commerce-video
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode i2v \
  --prompt "Social Commerce Video: polished motion, clear subject, coherent action, stable camera, commercial finish"
```
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "Create a polished social commerce video result with coherent motion, stable identity, and a clear ending"
```
