---
name: ai-hive-proven-110-ppt-visual-director
description: "当用户要做“PPT内容策略与视觉导演”或搜索PPT内容策略与视觉导演、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向企业管理、市场、教育、咨询、研究和内容团队，通过AI-HIVE先规划并查询实时模型与价格，再交付内容结构、事实与来源清单、初稿、图解/配图方案、终稿和质量检查表。先小样后批量；付费生成、发送和公开发布必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "document"
  display_name: "PPT内容策略与视觉导演"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "PPT、内容策略与视觉导演、办公、写作、报告、可视化、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **PPT内容策略与视觉导演**，服务于企业管理、市场、教育、咨询、研究和内容团队。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。
...
python3 scripts/plan.py \
  --brief "我要完成PPT内容策略与视觉导演，目标/受众/平台/预算为[填写]" \
...
PPT、内容策略与视觉导演、办公、写作、报告、可视化、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
