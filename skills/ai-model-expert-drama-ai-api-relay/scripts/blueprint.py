#!/usr/bin/env python3
"""Create a deterministic production brief for AI API中转站."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='AI API中转站')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['AI中转站', 'API中转站', 'API代理', 'API Relay', 'AI接口'],
