...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合Shopee的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "Shopee卖家、虾皮、Shopee跨境电商、Shopee主图、Listing、商品视频、跨境广告、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "shopee-ecommerce-image-generation-editing", "rule": "optional", "search": "Shopee 商家、运营、商品与广告图片搜索入口", "title": "Shopee 电商图片生成与编辑"}')
