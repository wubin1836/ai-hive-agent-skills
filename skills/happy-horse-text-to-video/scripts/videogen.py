...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"t2v\", \"models\": {\"t2v\": \"public_model_happyhorse_t2v\"}, \"name\": \"happy-horse-text-to-video\", \"rule\": \"none\", \"title\": \"Happy Horse Text to Video\"}")
