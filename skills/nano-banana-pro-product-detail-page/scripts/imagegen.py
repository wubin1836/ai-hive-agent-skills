...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_pro\", \"name\": \"nano-banana-pro-product-detail-page\", \"rule\": \"optional\", \"title\": \"Nano Banana Pro Product Detail Page Images\"}")
