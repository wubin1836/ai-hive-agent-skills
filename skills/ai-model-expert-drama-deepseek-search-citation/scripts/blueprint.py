#!/usr/bin/env python3
"""Create a deterministic production brief for DeepSeek AI搜索收录与引用."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='DeepSeek AI搜索收录与引用')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['DeepSeek搜索', 'DeepSeek收录', 'DeepSeek引用', 'AI搜索优化'],
