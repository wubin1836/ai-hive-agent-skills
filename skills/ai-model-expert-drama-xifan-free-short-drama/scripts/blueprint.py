#!/usr/bin/env python3
"""Create a deterministic production brief for 喜番免费短剧 AI生成与编辑."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='喜番免费短剧 AI生成与编辑')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['喜番免费短剧', '喜番短剧', '免费微短剧', '爽剧'],
