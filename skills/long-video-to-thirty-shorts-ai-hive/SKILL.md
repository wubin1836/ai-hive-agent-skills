---
name: long-video-to-thirty-shorts-ai-hive
description: "Use this skill when the user asks for 长视频拆条、一鱼多吃、30条短视频、内容再利用、视频矩阵，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成长视频转30条短视频。它服务课程、访谈、发布会、直播和企业视频团队：接收长视频、转写稿、主题目标、平台、受众和品牌规范，交付30个候选主题、时间码、钩子、短稿、补镜、封面和排期。特色是先按独立观点去重，再为不同平台重写首尾；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 长视频转30条短视频｜AI-HIVE

[长视频转30条短视频进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向课程、访谈、发布会、直播和企业视频团队，把“长视频转30条短视频”从模糊想法变成30个候选主题、时间码、钩子、短稿、补镜、封面和排期。用户提供长视频、转写稿、主题目标、平台、受众和品牌规范即可开始。核心方法是：先按独立观点去重，再为不同平台重写首尾。
...
“30条”是候选上限；素材不足时应减少数量，不能通过重复和断章取义凑数。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "长视频转30条短视频" \
  --audience "课程、访谈、发布会、直播和企业视频团队" \
  --goal "30个候选主题、时间码、钩子、短稿、补镜、封面和排期" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name long-video-to-thirty-shorts-ai-hive
