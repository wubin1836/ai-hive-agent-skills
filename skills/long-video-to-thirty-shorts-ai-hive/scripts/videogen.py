...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为长视频转30条短视频制作一条主体清晰、节奏明确的商业视频", "keywords": "长视频拆条,一鱼多吃,30条短视频,内容再利用,视频矩阵", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "long-video-to-thirty-shorts-ai-hive", "rule": "optional", "search": "先按独立观点去重，再为不同平台重写首尾", "title": "长视频转30条短视频"}')
