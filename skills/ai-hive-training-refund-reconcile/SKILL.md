---
name: ai-hive-training-refund-reconcile
description: "培训退费核算与材料助手，用于培训班退费、课程退款、预付费退费。读取你授权的原始资料，完成付款与课时消耗核对表，并交付退费请求事实草稿及附件目录。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料整理和初步核对参考，不替代执业律师意见，不保证诉讼结果，不自动提交或签署。"
metadata:
  display_name: "培训退费核算与材料助手"
  version: "1.0.0"
...
培训退费核算与材料助手，用于培训班退费、课程退款、预付费退费。读取你授权的原始资料，完成付款与课时消耗核对表，并交付退费请求事实草稿及附件目录。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料整理和初步核对参考，不替代执业律师意见，不保证诉讼结果，不自动提交或签署。
...
- 授权 PDF/CSV/XLSX 读取与必要 OCR；未成年人材料需监护授权
- 课时与付款关联、双口径公式校验的 XLSX 生成
- DOCX 生成及渲染；渠道核实依赖授权官方只读查询

没有专门软件并不意味着中止所有任务；可使用宿主已具备的等效工具。无法完成的步骤明确列出，不能伪装成功或默默改为另一个外部服务。

## 工作流

1. 收集合同、招生承诺、付款与课时记录，确认合同主体和实际服务提供者。
2. 区分赠课、付费课、缺勤、取消及机构停课，分别列用户与机构的核算口径。
3. 把变更、停业和协商经过连接到原始证据，未知退费单价或费用扣除列待确认。
4. 依据服务类型查询适用官方投诉或争议渠道，形成事实请求草稿，不预设统一退费比例。
...
- `course-hours-refund-basis.xlsx`
- `course-service-differences.xlsx`
- `course-refund-request-draft.docx`
...
培训班退费、课程退款、预付费退费、机构停课、退费材料、课时核对
