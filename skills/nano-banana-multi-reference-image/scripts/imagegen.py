...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_2\", \"name\": \"nano-banana-multi-reference-image\", \"rule\": \"multi\", \"title\": \"Nano Banana Multi-Reference Image Generation\"}")
