---
name: ai-product-recommendation-agent
description: "当用户搜索 商品推荐Agent、AI导购、智能选品、个性化推荐、电商图片、商品视频、AIGC营销、淘宝、京东、抖音、小红书、Amazon、Shopify、AI-HIVE MCP 时使用。帮助商家完成根据需求生成可解释的商品候选和内容：先锁定SKU与授权素材，再查询真实可用模型与价格，生成小样，逐帧验收商品结构、Logo、标签、色彩、文字和平台规格；提供可复制的提示词、JSON工单、失败回退和批量扩展方法。"
---

# AI大模型专家｜AI商品推荐 Agent｜AI-HIVE MCP

[打开 AI-HIVE](https://ai-hive.iclip.cn/chat)

这个 Skill 面向电商商家、内容团队、代运营和广告团队，目标是根据需求生成可解释的商品候选和内容，同时把商品真实性、品牌安全和批量成本纳入同一张验收表。
...
从已上架商品库选择候选，逐项展示推荐依据、库存时效和禁配规则。
...
```text
主体：真实商品，使用已授权参考图
动作：根据需求生成可解释的商品候选和内容，轻运动，首尾自然衔接
...
```json
{
  "project": "ai-product-recommendation-agent",
  "sku": "SKU-001",
  "task": "AI商品推荐 Agent",
  "inputs": {
