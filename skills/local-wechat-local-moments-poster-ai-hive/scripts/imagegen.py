...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为微信本地生活朋友圈海报营销制作事实可核验的本地生活营销图片", "model": "public_model_nano_banana_pro", "name": "local-wechat-local-moments-poster-ai-hive", "title": "AI大模型专家｜微信本地生活朋友圈海报营销", "keywords": "微信本地生活、视频号本地推广、微信公众号、微信小程序、朋友圈营销、朋友圈海报营销、本地生活、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前模型与价格，并在平台官方后台核对当前规则"}')
