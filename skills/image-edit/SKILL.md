...
|---|---|---|
| Image Editing | `public_model_gpt_image_2` | At least one reference image |
...
python3 "$SKILL_PATH/scripts/imagegen.py" init --skill-name image-edit
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "Create a polished image editing visual with an accurate subject, clear composition, and commercial finish" \
...
```bash
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "Create a polished image editing result; preserve factual product details and leave useful copy space" \
+  --image /path/to/reference.png
```
