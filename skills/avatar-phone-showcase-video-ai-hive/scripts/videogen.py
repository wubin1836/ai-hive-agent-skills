...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为数字人手机展示视频制作一条主体清晰、节奏明确的商业视频", "keywords": "数字人手机展示,App广告,手机屏幕视频,虚拟人演示,产品展示", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "avatar-phone-showcase-video-ai-hive", "rule": "optional", "search": "让数字人负责吸引注意，真实界面截图负责传达产品事实", "title": "数字人手机展示视频"}')
