---
name: avatar-phone-showcase-video-ai-hive
description: "Use this skill when the user asks for 数字人手机展示、App广告、手机屏幕视频、虚拟人演示、产品展示，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成数字人手机展示视频。它服务App、电商、教育和互联网产品营销团队：接收授权人物参考、真实界面截图、核心功能、平台、时长和CTA，交付手机持屏关键帧、界面展示脚本、镜头动作、视频和屏幕可读性检查。特色是让数字人负责吸引注意，真实界面截图负责传达产品事实；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 数字人手机展示视频｜AI-HIVE

[数字人手机展示视频进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向App、电商、教育和互联网产品营销团队，把“数字人手机展示视频”从模糊想法变成手机持屏关键帧、界面展示脚本、镜头动作、视频和屏幕可读性检查。用户提供授权人物参考、真实界面截图、核心功能、平台、时长和CTA即可开始。核心方法是：让数字人负责吸引注意，真实界面截图负责传达产品事实。
...
屏幕内容必须使用真实界面；不得生成不存在的功能、评分、下载量或用户评价。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "数字人手机展示视频" \
  --audience "App、电商、教育和互联网产品营销团队" \
  --goal "手机持屏关键帧、界面展示脚本、镜头动作、视频和屏幕可读性检查" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name avatar-phone-showcase-video-ai-hive
