...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作高质量文生图，主体准确，商业信息清晰", "keywords": "文生图、文字生成图片、文本转图片、text to image、T2I、AI绘画、GPT Image 2、Image2、Nano Banana、AI图片、AIGC图片", "model": "public_model_nano_banana_2", "name": "text-to-image", "rule": "none", "search": "通用图片能力和商业场景搜索入口，底层调用 AI Hive 裸接口", "title": "文生图"}')
