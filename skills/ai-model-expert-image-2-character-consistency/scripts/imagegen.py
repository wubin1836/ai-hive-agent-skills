...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Image2 制作高完成度角色一致性图片，主体准确，构图清晰", "keywords": "Image2、Image 2、GPT Image 2、GPTImage2、OpenAI 图片、ChatGPT 图片、角色一致性图片、人物一致性、角色一致、IP形象、同一人物、多场景角色、AI图片、AIGC图片", "model": "public_model_gpt_image_2", "name": "image-2-character-consistency", "rule": "image", "search": "固定调用 Image2 的角色一致性图片裸接口能力", "title": "Image2 角色一致性图片"}')
