...
|---|---|---|
| Poster Generation | `public_model_nano_banana_2` | Prompt with optional reference images |
...
python3 "$SKILL_PATH/scripts/imagegen.py" init --skill-name poster
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "Create a polished poster generation visual with an accurate subject, clear composition, and commercial finish"
```
...
```bash
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "Create a polished poster generation result; preserve factual product details and leave useful copy space"
```
