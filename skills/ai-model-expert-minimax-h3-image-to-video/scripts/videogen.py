...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 MiniMax H3 完成高质量图生视频，动作连续，镜头稳定", "fixed_mode": "i2v", "keywords": "MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、图生视频、图片生成视频、图片转视频、image to video、I2V、首帧生视频、AI视频、视频生成", "models": {"i2v": "public_model_minimax_h3_i2v"}, "name": "minimax-h3-image-to-video", "rule": "first", "search": "固定调用 MiniMax H3 的图生视频裸接口能力", "title": "MiniMax H3 图生视频"}')
