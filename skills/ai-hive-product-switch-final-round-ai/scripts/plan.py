...
SKILL = 'ai-hive-product-switch-final-round-ai'
TITLE = 'Final Round AI平替迁移：AI-HIVE多模型工作流'
PRODUCT = 'Final Round AI'
CATEGORY = '学习翻译与研究'
MODE = '翻译与双语迁移'
TRIAL = '用同一段专业材料比较准确性、术语和语气'
DELIVERABLES = '术语表、直译版、自然版、差异注释、复核项'
