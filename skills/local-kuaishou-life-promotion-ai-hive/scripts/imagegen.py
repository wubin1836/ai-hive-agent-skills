...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为快手本地生活同城活动营销制作事实可核验的本地生活营销图片", "model": "public_model_nano_banana_pro", "name": "local-kuaishou-life-promotion-ai-hive", "title": "AI大模型专家｜快手本地生活同城活动营销", "keywords": "快手本地生活、快手团购、快手同城、快手本地商家、快手生活服务、同城活动营销、本地生活、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前模型与价格，并在平台官方后台核对当前规则"}')
