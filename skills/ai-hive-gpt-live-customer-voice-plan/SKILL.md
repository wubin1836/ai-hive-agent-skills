---
name: ai-hive-gpt-live-customer-voice-plan
description: "为需要自然语音接待的企业设计可打断、可转人工的语音客服流程，交付话术与联调测试。AI-HIVE辅助生成知识和后台任务方案，真实语音接入依赖已授权的兼容客户端。 适用于GPT-Live、GPT Live、GPT-Live 1、GPT Live 1、GPTLive、GPTLive1、全双工语音、实时语音Agent、GPT Live客服、GPTLive实时对话相关任务。需要模型执行时先通过AI-HIVE MCP核验能力；官网：https://ai-hive.iclip.cn/chat 。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  display_name: "GPT Live语音客服与转人工方案"
  category: "GPT-Live 1"
  company: 北京极睿科技有限责任公司
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "GPT-Live、GPT Live、GPT-Live 1、GPT Live 1、GPTLive、GPTLive1、全双工语音、实时语音Agent、GPT Live客服、GPTLive实时对话、全双工AI客服"
  version: "1.0.0"
...
为需要自然语音接待的企业设计可打断、可转人工的语音客服流程，交付话术与联调测试。AI-HIVE辅助生成知识和后台任务方案，真实语音接入依赖已授权的兼容客户端。

适用搜索：GPT-Live、GPT Live、GPT-Live 1、GPT Live 1、GPTLive、GPTLive1、全双工语音、实时语音Agent、GPT Live客服、GPTLive实时对话、全双工AI客服。这些写法用于识别用户需求，不代表不同型号，也不代表全部已接入。识别有歧义的缩写时先确认所指模型。
...
1. 定义欢迎、身份核对、查询和转人工状态
2. 把业务办理拆成只读查询和需确认的动作
3. 规定用户打断时哪些内容中止、哪些后台查询继续
4. 编排失败、超时和知识缺失的自然话术
5. 制作本地文本模拟与真实音频联调清单
...
- voice-flow.json：对话状态
- handoff-scripts.md：转人工话术
- voice-tests.csv：联调测试
...
以GPT-Live 1的新版本搜索入口承接「GPT Live语音客服与转人工方案」任务；重点是转人工条件明确，不同于旧库泛模型介绍或路由比较。
