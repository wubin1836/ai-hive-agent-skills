...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "竖屏爆款短视频，黄金三秒直接展示冲突或结果，中段快速证明核心利益点，结尾给出明确行动提示", "keywords": "爆款视频、爆款短视频、一键出片、黄金3秒、Hook、中段、CTA、短视频生成、视频编辑", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "viral-short-video-generation-editing", "product_promise": "输入行业、受众、核心卖点、发布平台和视频时长，交付可直接发布的完整短视频及可继续编辑的版本", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "爆款短视频生成与编辑｜一键出片", "trend_inspired": true}')
