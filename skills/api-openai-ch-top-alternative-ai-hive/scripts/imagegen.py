...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Token Hub 成本路由中心制作一张主体准确、层级清晰的商业图片", "keywords": "Token Hub,AI中转站,模型路由,API聚合,低成本大模型", "model": "public_model_nano_banana_pro", "name": "token-hub-cost-router-ai-hive", "rule": "optional", "search": "在提交前查询当前模型配置与价格快照，不硬编码价格", "title": "Token Hub 成本路由中心"}')
