---
name: ai-hive-gap-023-ai-legal-marketing
description: "当用户搜索或需要AI法务,营销合规,广告风险,内容审核时使用。帮助普通企业、创业团队、超级个体、销售运营和职能部门完成从宣传文案和生成素材中标出可能的合规风险，通过AI-HIVE MCP实时核验模型并交付风险清单、证据位置、修改建议、替代文案和复核项。不适用于超出以下边界的请求：不是法律意见，高风险内容需专业律师复核。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "enterprise"
  display_name: "AI法务营销内容风险预检"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "AI法务,营销合规,广告风险,内容审核,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**从宣传文案和生成素材中标出可能的合规风险**。

适合：普通企业、创业团队、超级个体、销售运营和职能部门。

用户需要提供：真实业务资料、目标受众、内部口径、交付格式、品牌规范、预算和审批要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不是法律意见，高风险内容需专业律师复核**。

## 你会拿到的结果

风险清单、证据位置、修改建议、替代文案和复核项。

搜索覆盖：AI法务,营销合规,广告风险,内容审核。

## 生产步骤

1. 将业务问题和生成任务分开。
2. 从宣传文案和生成素材中标出可能的合规风险。
3. 锁定不可虚构的事实与数字。
4. 先交付文字或结构草案。
5. 确认后制作视觉小样并验收。
6. 按“风险定位具体、修改最小、免责声明明确”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成AI法务营销内容风险预检，目标、资料、预算和截止时间为[填写]" \
...
最终交付：风险清单、证据位置、修改建议、替代文案和复核项。
专项验收：风险定位具体、修改最小、免责声明明确。
```
