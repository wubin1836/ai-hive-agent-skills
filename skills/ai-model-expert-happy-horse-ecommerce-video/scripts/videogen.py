...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一条高完成度电商视频，主体明确，节奏清晰，结尾有记忆点", "keywords": "Happy Horse、HappyHorse、Happyhorse、快乐马、通义万相视频、电商视频、电商广告、商品视频、电商主图视频、详情页视频、SKU视频、AI视频、视频生成", "models": {"i2v": "public_model_happyhorse_i2v", "r2v": "public_model_happyhorse_r2v", "t2v": "public_model_happyhorse_t2v"}, "name": "happy-horse-ecommerce-video", "rule": "optional", "search": "使用 Happy Horse 制作电商视频", "title": "Happy Horse 电商视频"}')
