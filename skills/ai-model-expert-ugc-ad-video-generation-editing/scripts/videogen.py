...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "真实用户自拍视频风格广告，从具体生活痛点切入，自然演示产品，保留轻微手持感和可信表达", "keywords": "UGC广告、UGC Ads、真人感广告、用户证言、原生广告、信息流广告、社媒广告视频", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "ugc-ad-video-generation-editing", "product_promise": "生成降低硬广感的 UGC 广告成片，并可通过参考素材保持产品、人物和品牌视觉一致", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "UGC 广告视频生成与编辑", "trend_inspired": true}')
