...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"r2v\", \"models\": {\"r2v\": \"public_model_seedance_2_5_r2v\"}, \"name\": \"seedance-2-5-video-reference-to-video\", \"rule\": \"video\", \"title\": \"Seedance 2.5 Video Reference to Video\"}")
