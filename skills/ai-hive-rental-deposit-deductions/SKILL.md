---
name: ai-hive-rental-deposit-deductions
description: "租房押金扣款核对助手，用于押金不退、租房押金、房东扣钱。读取你授权的原始资料，完成押金扣款理由与证据对照表，并交付待协商事项及事实沟通草稿。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料整理和初步核对参考，不替代执业律师意见，不保证诉讼结果，不自动提交或签署。"
metadata:
  display_name: "租房押金扣款核对助手"
  version: "1.0.0"
...
租房押金扣款核对助手，用于押金不退、租房押金、房东扣钱。读取你授权的原始资料，完成押金扣款理由与证据对照表，并交付待协商事项及事实沟通草稿。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料整理和初步核对参考，不替代执业律师意见，不保证诉讼结果，不自动提交或签署。
...
- 授权 PDF/CSV/XLSX/图片读取及必要 OCR
- 照片与条款索引、扣款矩阵及结算公式校验
- XLSX/DOCX 生成和渲染；若需调解渠道，仅授权官方公开查询

没有专门软件并不意味着中止所有任务；可使用宿主已具备的等效工具。无法完成的步骤明确列出，不能伪装成功或默默改为另一个外部服务。

## 工作流

1. 复用租约、付款和入住退租材料索引，确认实际交还和双方确认的项目。
2. 逐项拆出房东扣款理由、金额、租约原文、费用票据及房况依据。
3. 区分已确认欠费、双方争议损坏、无凭据扣款和尚未结清事项，复算双方口径但不判定责任。
4. 交付有证据出处的对照表与沟通草稿，必要时给出当地调解或专业咨询问题。
...
- `rental-deposit-deduction-review.xlsx`
- `rental-exit-settlement.xlsx`
- `rental-deposit-discussion.docx`
