---
name: pov-product-ad-ai-hive
description: "Use this skill when the user asks for POV广告、第一视角视频、商品体验、带货视频、UGC广告，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成第一视角POV商品广告。它服务电商商家、生活方式品牌和短视频创作者：接收商品图、使用场景、真实步骤、目标人群、平台和时长，交付第一视角脚本、手部动作、场景转换、视频提示词和成片检查。特色是让观众从使用者视角经历问题、动作和结果；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 第一视角POV商品广告｜AI-HIVE

[第一视角POV商品广告进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向电商商家、生活方式品牌和短视频创作者，把“第一视角POV商品广告”从模糊想法变成第一视角脚本、手部动作、场景转换、视频提示词和成片检查。用户提供商品图、使用场景、真实步骤、目标人群、平台和时长即可开始。核心方法是：让观众从使用者视角经历问题、动作和结果。
...
不得伪造功效、危险操作或把生成画面冒充真实测评。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "第一视角POV商品广告" \
  --audience "电商商家、生活方式品牌和短视频创作者" \
  --goal "第一视角脚本、手部动作、场景转换、视频提示词和成片检查" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name pov-product-ad-ai-hive
