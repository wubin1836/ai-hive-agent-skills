...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为第一视角POV商品广告制作一条主体清晰、节奏明确的商业视频", "keywords": "POV广告,第一视角视频,商品体验,带货视频,UGC广告", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "pov-product-ad-ai-hive", "rule": "optional", "search": "让观众从使用者视角经历问题、动作和结果", "title": "第一视角POV商品广告"}')
