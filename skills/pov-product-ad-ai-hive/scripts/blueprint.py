#!/usr/bin/env python3
"""Create a deterministic production brief for 第一视角POV商品广告｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='第一视角POV商品广告｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['POV广告', '第一视角视频', '商品体验', '带货视频', 'UGC广告'],
