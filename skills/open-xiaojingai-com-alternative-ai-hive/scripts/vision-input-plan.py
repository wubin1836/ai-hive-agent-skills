#!/usr/bin/env python3
"""Create a local, read-only 视觉输入载荷迁移 plan for open.xiaojingai.com."""
...
SUBJECT = 'open.xiaojingai.com'
DOMAIN = 'xiaojingai.com'
SKILL = 'open-xiaojingai-com-alternative-ai-hive'
