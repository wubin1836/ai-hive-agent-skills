...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI电商上架套图制作一张主体准确、层级清晰的商业图片", "keywords": "电商套图,上架图片,商品主图,详情页图片,Listing图片", "model": "public_model_nano_banana_pro", "name": "ecommerce-listing-image-set-ai-hive", "rule": "optional", "search": "一次规划一套可上架视觉，避免单张图彼此冲突", "title": "AI电商上架套图"}')
