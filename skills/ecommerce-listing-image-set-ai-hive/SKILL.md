---
name: ecommerce-listing-image-set-ai-hive
description: "Use this skill when the user asks for 电商套图、上架图片、商品主图、详情页图片、Listing图片，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成AI电商上架套图。它服务淘宝、京东、抖音、拼多多和跨境平台商家：接收SKU图、商品事实、平台规则、品牌规范和活动信息，交付主图、白底图、功能图、场景图、尺寸图与素材清单。特色是一次规划一套可上架视觉，避免单张图彼此冲突；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# AI电商上架套图｜AI-HIVE

[AI电商上架套图进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向淘宝、京东、抖音、拼多多和跨境平台商家，把“AI电商上架套图”从模糊想法变成主图、白底图、功能图、场景图、尺寸图与素材清单。用户提供SKU图、商品事实、平台规则、品牌规范和活动信息即可开始。核心方法是：一次规划一套可上架视觉，避免单张图彼此冲突。
...
```bash
python3 scripts/blueprint.py --project "AI电商上架套图" \
  --audience "淘宝、京东、抖音、拼多多和跨境平台商家" \
  --goal "主图、白底图、功能图、场景图、尺寸图与素材清单" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name ecommerce-listing-image-set-ai-hive
