...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为App界面演示广告制作一条主体清晰、节奏明确的商业视频", "keywords": "App广告,界面演示,软件广告,SaaS视频,应用推广", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "app-ui-demo-ad-ai-hive", "rule": "optional", "search": "用真实UI完成主叙事，AI只负责人物、场景与过渡", "title": "App界面演示广告"}')
