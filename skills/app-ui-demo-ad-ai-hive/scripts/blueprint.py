#!/usr/bin/env python3
"""Create a deterministic production brief for App界面演示广告｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='App界面演示广告｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['App广告', '界面演示', '软件广告', 'SaaS视频', '应用推广'],
