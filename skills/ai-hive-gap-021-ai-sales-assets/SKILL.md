---
name: ai-hive-gap-021-ai-sales-assets
description: "当用户搜索或需要AI销售,销售智能体,售前材料,客户跟进时使用。帮助普通企业、创业团队、超级个体、销售运营和职能部门完成根据真实客户需求形成销售方案、演示图和跟进内容，通过AI-HIVE MCP实时核验模型并交付客户需求卡、价值主张、提案结构、演示视觉和跟进模板。不适用于超出以下边界的请求：不得代替销售承诺价格、合同或交付能力。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "enterprise"
  display_name: "AI销售提案与客户跟进素材"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "AI销售,销售智能体,售前材料,客户跟进,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**根据真实客户需求形成销售方案、演示图和跟进内容**。

适合：普通企业、创业团队、超级个体、销售运营和职能部门。

用户需要提供：真实业务资料、目标受众、内部口径、交付格式、品牌规范、预算和审批要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不得代替销售承诺价格、合同或交付能力**。

## 你会拿到的结果

客户需求卡、价值主张、提案结构、演示视觉和跟进模板。

搜索覆盖：AI销售,销售智能体,售前材料,客户跟进。

## 执行蓝图

1. 将业务问题和生成任务分开。
2. 根据真实客户需求形成销售方案、演示图和跟进内容。
3. 锁定不可虚构的事实与数字。
4. 先交付文字或结构草案。
5. 确认后制作视觉小样并验收。
6. 按“不虚构客户事实、卖点匹配、下一步明确”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成AI销售提案与客户跟进素材，目标、资料、预算和截止时间为[填写]" \
...
最终交付：客户需求卡、价值主张、提案结构、演示视觉和跟进模板。
专项验收：不虚构客户事实、卖点匹配、下一步明确。
```
