...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为用户晒单视频自动混剪制作一条主体清晰、节奏明确的商业视频", "keywords": "晒单视频混剪,UGC混剪,买家秀视频,用户内容,品牌广告", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "customer-video-montage-ai-hive", "rule": "optional", "search": "把多个真实使用片段组织成证据链，而不是伪造统一口径", "title": "用户晒单视频自动混剪"}')
