#!/usr/bin/env python3
"""Create a deterministic production brief for 用户晒单视频自动混剪｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='用户晒单视频自动混剪｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['晒单视频混剪', 'UGC混剪', '买家秀视频', '用户内容', '品牌广告'],
