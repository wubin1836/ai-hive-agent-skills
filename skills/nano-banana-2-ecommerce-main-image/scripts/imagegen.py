...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_2\", \"name\": \"nano-banana-2-ecommerce-main-image\", \"rule\": \"optional\", \"title\": \"Nano Banana 2 E-commerce Main Image\"}")
