...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"r2v\", \"models\": {\"r2v\": \"public_model_seedance_2_5_r2v\"}, \"name\": \"seedance-2-5-audio-reference-to-video\", \"rule\": \"audio\", \"title\": \"Seedance 2.5 Audio Reference to Video\"}")
