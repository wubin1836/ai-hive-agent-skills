...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "小红书生活方式封面，真实场景与明确利益点并存，构图清爽，上方保留中文标题空间", "keywords": "小红书封面、爆款笔记、种草封面、RED封面、XHS封面、笔记首图、好物分享", "model": "public_model_nano_banana_pro", "name": "xiaohongshu-viral-cover-image-generation", "product_promise": "按种草、教程、测评和清单等笔记类型生成封面，强调真实感、收藏价值和系列一致性", "rule": "optional", "search": "面向爆款封面、电商主图、详情页、广告、海报和社媒套图等结果型搜索意图", "title": "小红书爆款笔记封面生成与编辑", "trend_inspired": true}')
