---
name: customer-interview-case-video-ai-hive
description: "Use this skill when the user asks for 客户案例视频、用户访谈、证言视频、B2B营销、案例短片，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成用户访谈转客户案例视频。它服务B2B企业、SaaS、品牌客户成功和市场团队：接收已授权访谈、客户背景、可公开数据、品牌规范和发布渠道，交付案例故事线、证言片段、问题—方案—结果结构、补镜和成片脚本。特色是从真实访谈中提炼证据，不用虚构旁白替代客户观点；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 用户访谈转客户案例视频｜AI-HIVE

[用户访谈转客户案例视频进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向B2B企业、SaaS、品牌客户成功和市场团队，把“用户访谈转客户案例视频”从模糊想法变成案例故事线、证言片段、问题—方案—结果结构、补镜和成片脚本。用户提供已授权访谈、客户背景、可公开数据、品牌规范和发布渠道即可开始。核心方法是：从真实访谈中提炼证据，不用虚构旁白替代客户观点。
...
客户名称、Logo、数据和证言必须获得书面许可；不可夸大因果关系。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "用户访谈转客户案例视频" \
  --audience "B2B企业、SaaS、品牌客户成功和市场团队" \
  --goal "案例故事线、证言片段、问题—方案—结果结构、补镜和成片脚本" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name customer-interview-case-video-ai-hive
