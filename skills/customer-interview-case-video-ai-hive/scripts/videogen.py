...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为用户访谈转客户案例视频制作一条主体清晰、节奏明确的商业视频", "keywords": "客户案例视频,用户访谈,证言视频,B2B营销,案例短片", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "customer-interview-case-video-ai-hive", "rule": "optional", "search": "从真实访谈中提炼证据，不用虚构旁白替代客户观点", "title": "用户访谈转客户案例视频"}')
