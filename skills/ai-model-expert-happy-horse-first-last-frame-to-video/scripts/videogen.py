...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Happy Horse 完成高质量首尾帧生视频，动作连续，镜头稳定", "fixed_mode": "i2v", "keywords": "Happy Horse、HappyHorse、Happyhorse、快乐马、通义万相视频、首尾帧生视频、首尾帧视频、首帧尾帧、两张图生成视频、转场视频、AI视频、视频生成", "models": {"i2v": "public_model_happyhorse_i2v"}, "name": "happy-horse-first-last-frame-to-video", "rule": "first_last", "search": "固定调用 Happy Horse 的首尾帧生视频裸接口能力", "title": "Happy Horse 首尾帧生视频"}')
