...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为装修公司制作主体准确、事实可核验的图片营销素材", "model": "public_model_nano_banana_pro", "name": "industry-renovation-company-marketing-ai-hive", "title": "AI大模型专家｜装修公司AI图片视频营销", "keywords": "装修公司、家装公司、装修设计、装修施工、AI图片、AI短视频、视频编辑、内容营销、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前图片/视频模型与价格快照，不硬编码价格"}')
