...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Seedream 5.0 Lite 制作高完成度营销图片，主体准确，构图清晰", "keywords": "Seedream 5.0 Lite、Seedream 5 Lite、Seedream5、即梦图片 5、字节图片模型、营销图片、营销视觉、活动KV、推广图片、促销图、Campaign视觉、AI图片、AIGC图片", "model": "public_model_seedream_5_0_lite", "name": "seedream-5-lite-marketing-image", "rule": "optional", "search": "固定调用 Seedream 5.0 Lite 的营销图片裸接口能力", "title": "Seedream 5.0 Lite 营销图片"}')
