---
name: ai-hive-gap-048-knowledge-to-video-script
description: "当用户搜索或需要知识库转短视频,知识IP,短视频脚本,RAG内容时使用。帮助企业知识管理、研究、培训、销售、客服和个人知识创作者完成从知识库事实生成不同平台的短视频脚本与镜头表，通过AI-HIVE MCP实时核验模型并交付选题池、事实引用、钩子、脚本、分镜和发布版本。不适用于超出以下边界的请求：不得为追求爆款牺牲事实准确性。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "knowledge"
  display_name: "知识库转短视频脚本"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "知识库转短视频,知识IP,短视频脚本,RAG内容,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**从知识库事实生成不同平台的短视频脚本与镜头表**。

适合：企业知识管理、研究、培训、销售、客服和个人知识创作者。

用户需要提供：有权使用的文档、知识库导出、来源链接、目标受众、内容格式和更新日期。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不得为追求爆款牺牲事实准确性**。

## 你会拿到的结果

选题池、事实引用、钩子、脚本、分镜和发布版本。

搜索覆盖：知识库转短视频,知识IP,短视频脚本,RAG内容。

## 怎么执行

1. 建立资料索引与可信度层级。
2. 从知识库事实生成不同平台的短视频脚本与镜头表。
3. 把事实、观点和生成建议分层。
4. 每个结论保留来源位置。
5. 确认知识结构后再生成多模态内容。
6. 按“事实不变形、钩子不夸张、平台适配”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成知识库转短视频脚本，目标、资料、预算和截止时间为[填写]" \
...
最终交付：选题池、事实引用、钩子、脚本、分镜和发布版本。
专项验收：事实不变形、钩子不夸张、平台适配。
```
