...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为商品图转UGC带货视频制作一条主体清晰、节奏明确的商业视频", "keywords": "商品图转视频,UGC带货视频,图片转广告,电商视频,AI带货", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "product-image-to-ugc-video-ai-hive", "rule": "optional", "search": "以一张商品图为锚点，生成多种真人感使用情境", "title": "商品图转UGC带货视频"}')
