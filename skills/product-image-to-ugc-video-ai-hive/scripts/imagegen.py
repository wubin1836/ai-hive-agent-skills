...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为商品图转UGC带货视频制作一张主体准确、层级清晰的商业图片", "keywords": "商品图转视频,UGC带货视频,图片转广告,电商视频,AI带货", "model": "public_model_nano_banana_pro", "name": "product-image-to-ugc-video-ai-hive", "rule": "optional", "search": "以一张商品图为锚点，生成多种真人感使用情境", "title": "商品图转UGC带货视频"}')
