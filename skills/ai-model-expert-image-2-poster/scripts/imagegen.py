...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Image2 制作高完成度海报生成，主体准确，构图清晰", "keywords": "Image2、Image 2、GPT Image 2、GPTImage2、OpenAI 图片、ChatGPT 图片、海报生成、营销海报、活动海报、中文海报、宣传海报、视觉海报、AI图片、AIGC图片", "model": "public_model_gpt_image_2", "name": "image-2-poster", "rule": "optional", "search": "固定调用 Image2 的海报生成裸接口能力", "title": "Image2 海报生成"}')
