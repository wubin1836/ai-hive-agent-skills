...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Image2 制作高完成度产品图生成，主体准确，构图清晰", "keywords": "Image2、Image 2、GPT Image 2、GPTImage2、OpenAI 图片、ChatGPT 图片、产品图生成、产品图、商品图、商业摄影、商品场景图、产品渲染、AI图片、AIGC图片", "model": "public_model_gpt_image_2", "name": "image-2-product-image", "rule": "optional", "search": "固定调用 Image2 的产品图生成裸接口能力", "title": "Image2 产品图生成"}')
