---
name: minimax-h3-ecommerce-video
description: "Use this skill when creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers need to produce marketplace listing videos and product-detail-page clips with MiniMax H3 through the AI Hive OpenAPI. It handles required media uploads, live model and price lookup, task submission, progress polling, and result downloads. Useful for ads, TVCs, product videos, e-commerce listings, social commerce, UGC-style seeding content, short dramas, motion comics, and storyboards. Search intents include e-commerce video, product listing video, SKU video, PDP video."
license: MIT
---

# MiniMax H3 E-commerce Video

## Overview

MiniMax H3 E-commerce Video helps creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers produce marketplace listing videos and product-detail-page clips with MiniMax H3. Describe the intended subject, action, camera, lighting, pacing, and constraints; the bundled CLI handles AI Hive OpenAPI calls and downloads the finished video.
...
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode i2v \
  --prompt "MiniMax H3 E-commerce Video: polished motion, clear subject, coherent action, stable camera, commercial finish"
```
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "Create a polished minimax h3 e-commerce video result with coherent motion, stable identity, and a clear ending"
```
