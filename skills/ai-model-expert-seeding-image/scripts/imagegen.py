...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作高质量种草图片，主体准确，商业信息清晰", "keywords": "种草图片、小红书种草图、社媒配图、好物推荐图、UGC视觉、笔记封面、GPT Image 2、Image2、Nano Banana、AI图片、AIGC图片", "model": "public_model_nano_banana_2", "name": "seeding-image", "rule": "optional", "search": "通用图片能力和商业场景搜索入口，底层调用 AI Hive 裸接口", "title": "种草图片"}')
