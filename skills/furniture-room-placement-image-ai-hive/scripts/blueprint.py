#!/usr/bin/env python3
"""Create a deterministic production brief for 家居商品空间植入效果图｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='家居商品空间植入效果图｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['家居空间植入', '家具效果图', 'AI室内设计', '场景换装', '家居电商'],
