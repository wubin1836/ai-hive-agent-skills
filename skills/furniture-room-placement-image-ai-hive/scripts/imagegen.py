...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为家居商品空间植入效果图制作一张主体准确、层级清晰的商业图片", "keywords": "家居空间植入,家具效果图,AI室内设计,场景换装,家居电商", "model": "public_model_gpt_image_2", "name": "furniture-room-placement-image-ai-hive", "rule": "optional", "search": "保持家具外观，用空间参考生成营销预览", "title": "家居商品空间植入效果图"}')
