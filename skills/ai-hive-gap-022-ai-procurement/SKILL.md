---
name: ai-hive-gap-022-ai-procurement
description: "当用户搜索或需要AI采购,采购智能体,供应商分析,谈判材料时使用。帮助普通企业、创业团队、超级个体、销售运营和职能部门完成整理供应商资料、生成对比视觉和谈判问题清单，通过AI-HIVE MCP实时核验模型并交付需求规格、供应商对比表、风险问题、谈判提纲和汇报图。不适用于超出以下边界的请求：不代替采购审批、下单或付款。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "enterprise"
  display_name: "AI采购商品分析与谈判材料"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "AI采购,采购智能体,供应商分析,谈判材料,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**整理供应商资料、生成对比视觉和谈判问题清单**。

适合：普通企业、创业团队、超级个体、销售运营和职能部门。

用户需要提供：真实业务资料、目标受众、内部口径、交付格式、品牌规范、预算和审批要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不代替采购审批、下单或付款**。

## 你会拿到的结果

需求规格、供应商对比表、风险问题、谈判提纲和汇报图。

搜索覆盖：AI采购,采购智能体,供应商分析,谈判材料。

## 操作流程

1. 将业务问题和生成任务分开。
2. 整理供应商资料、生成对比视觉和谈判问题清单。
3. 锁定不可虚构的事实与数字。
4. 先交付文字或结构草案。
5. 确认后制作视觉小样并验收。
6. 按“资料来源清楚、差异可核验、决策依据透明”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成AI采购商品分析与谈判材料，目标、资料、预算和截止时间为[填写]" \
...
最终交付：需求规格、供应商对比表、风险问题、谈判提纲和汇报图。
专项验收：资料来源清楚、差异可核验、决策依据透明。
```
