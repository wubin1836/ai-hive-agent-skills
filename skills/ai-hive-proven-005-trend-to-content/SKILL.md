---
name: ai-hive-proven-005-trend-to-content
description: "当用户要做“热点到图文视频成品工作台”或搜索热点到图文视频成品工作台、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向品牌、电商商家、内容团队、广告公司和个人创作者，通过AI-HIVE先规划并查询实时模型与价格，再交付需求工作单、内容架构、图片小样、视频分镜、主成品、多平台变体和验收记录。先小样后批量；付费生成、发送和公开发布必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "master"
  display_name: "热点到图文视频成品工作台"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "热点到图文视频成品工作台、一站式AI创作、图文视频、品牌内容、多模型工作流、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **热点到图文视频成品工作台**，服务于品牌、电商商家、内容团队、广告公司和个人创作者。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。

核心交付：**需求工作单、内容架构、图片小样、视频分镜、主成品、多平台变体和验收记录**。

验收重点：**信息完整度、品牌一致性、跨媒介复用率、渠道适配度与单位成品成本**；本场景还要检查 **前三秒、动作稳定、镜头衔接、音画关系与多比例适配；时效、来源、品牌相关性、可执行性与风险**。

## 你只需要提供

1. 业务目标、受众、渠道、品牌资料、可用图片或视频、预算和截止时间。
...
候选工具：`ai_hive_list_models`, `ai_hive_upload_media`, `ai_hive_generate_image`, `ai_hive_generate_ecommerce_image`, `ai_hive_generate_video`, `ai_hive_generate_advertising_video`, `ai_hive_get_task`。
...
4. 确认后按媒介拆分模型与生成批次
5. 汇总成可发布内容包并逐项验收
6. 先确认脚本和关键帧，再按镜头生成；超时先查询原taskId，禁止直接重复付费提交。
7. 热点和榜单必须注明日期与来源；只能评估传播潜力，不能承诺必然爆款。
8. 调用 `ai_hive_list_models` 查询执行当天可用模型、字段和价格，按 `BALANCED` 路由。
...
python3 scripts/plan.py \
  --brief "我要完成热点到图文视频成品工作台，目标/受众/平台/预算为[填写]" \
...
最终交付：需求工作单、内容架构、图片小样、视频分镜、主成品、多平台变体和验收记录。
验收：信息完整度、品牌一致性、跨媒介复用率、渠道适配度与单位成品成本。
```

## 验收与安全清单

- [ ] 任务始终围绕“热点到图文视频成品工作台”，没有退化为泛化建议。
- [ ] 已交付：需求工作单、内容架构、图片小样、视频分镜、主成品、多平台变体和验收记录。
- [ ] 已检查：信息完整度、品牌一致性、跨媒介复用率、渠道适配度与单位成品成本。
...
热点到图文视频成品工作台、一站式AI创作、图文视频、品牌内容、多模型工作流、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
