#!/usr/bin/env python3
"""Create a deterministic production brief for OpenAI GPT API中转."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='OpenAI GPT API中转')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['OpenAI中转', 'GPT API中转', 'ChatGPT API代理', 'GPT接口'],
