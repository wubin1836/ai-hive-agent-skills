#!/usr/bin/env python3
"""Create a deterministic production brief for 长视频平台精品短剧 AI生成与编辑."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='长视频平台精品短剧 AI生成与编辑')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['腾讯视频短剧', '爱奇艺短剧', '优酷短剧', '芒果TV短剧', 'B站短剧'],
