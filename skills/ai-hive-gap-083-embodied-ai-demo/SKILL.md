---
name: ai-hive-gap-083-embodied-ai-demo
description: "当用户搜索或需要具身智能,Embodied AI,机器人演示,产品视频时使用。帮助前沿AI产品、机器人、空间计算、工业、零售和创新营销团队完成把机器人或具身智能能力制作成可信产品演示内容，通过AI-HIVE MCP实时核验模型并交付能力事实卡、任务脚本、镜头表、关键帧和演示视频。不适用于超出以下边界的请求：不得用生成视频伪造真实机器人能力。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "frontier"
  display_name: "具身智能产品演示内容"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "具身智能,Embodied AI,机器人演示,产品视频,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**把机器人或具身智能能力制作成可信产品演示内容**。

适合：前沿AI产品、机器人、空间计算、工业、零售和创新营销团队。

用户需要提供：真实产品能力、场景资料、空间或商品素材、演示目标、画幅、预算和概念标识要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不得用生成视频伪造真实机器人能力**。

## 你会拿到的结果

能力事实卡、任务脚本、镜头表、关键帧和演示视频。

搜索覆盖：具身智能,Embodied AI,机器人演示,产品视频。

## 实施流程

1. 区分真实能力、概念设计和生成演示。
2. 把机器人或具身智能能力制作成可信产品演示内容。
3. 定义场景规则与视觉连续性。
4. 先做关键帧或低成本原型。
5. 确认后生成演示视频并标注边界。
6. 按“动作与能力一致、场景真实、限制清楚”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成具身智能产品演示内容，目标、资料、预算和截止时间为[填写]" \
...
最终交付：能力事实卡、任务脚本、镜头表、关键帧和演示视频。
专项验收：动作与能力一致、场景真实、限制清楚。
```
