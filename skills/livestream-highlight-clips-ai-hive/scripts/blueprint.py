#!/usr/bin/env python3
"""Create a deterministic production brief for 直播回放爆点切片｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='直播回放爆点切片｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['直播切片', '直播回放', '爆点剪辑', '带货切片', '短视频拆条'],
