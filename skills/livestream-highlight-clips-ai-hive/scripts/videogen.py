...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为直播回放爆点切片制作一条主体清晰、节奏明确的商业视频", "keywords": "直播切片,直播回放,爆点剪辑,带货切片,短视频拆条", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "livestream-highlight-clips-ai-hive", "rule": "optional", "search": "按信息完整度和独立传播价值选段，不只截情绪最高点", "title": "直播回放爆点切片"}')
