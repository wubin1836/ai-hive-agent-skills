---
name: ai-hive-gap-046-knowledge-to-sales-manual
description: "当用户搜索或需要知识库转销售手册,销售知识库,话术生成,企业内容时使用。帮助企业知识管理、研究、培训、销售、客服和个人知识创作者完成把产品知识和真实案例整理成销售可用手册，通过AI-HIVE MCP实时核验模型并交付产品事实卡、场景话术、异议处理、案例卡和视觉版手册。不适用于超出以下边界的请求：不得虚构客户案例、效果或承诺。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "knowledge"
  display_name: "知识库转销售手册"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "知识库转销售手册,销售知识库,话术生成,企业内容,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**把产品知识和真实案例整理成销售可用手册**。

适合：企业知识管理、研究、培训、销售、客服和个人知识创作者。

用户需要提供：有权使用的文档、知识库导出、来源链接、目标受众、内容格式和更新日期。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不得虚构客户案例、效果或承诺**。

## 你会拿到的结果

产品事实卡、场景话术、异议处理、案例卡和视觉版手册。

搜索覆盖：知识库转销售手册,销售知识库,话术生成,企业内容。

## 操作流程

1. 建立资料索引与可信度层级。
2. 把产品知识和真实案例整理成销售可用手册。
3. 把事实、观点和生成建议分层。
4. 每个结论保留来源位置。
5. 确认知识结构后再生成多模态内容。
6. 按“事实一致、话术自然、案例不夸大”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成知识库转销售手册，目标、资料、预算和截止时间为[填写]" \
...
最终交付：产品事实卡、场景话术、异议处理、案例卡和视觉版手册。
专项验收：事实一致、话术自然、案例不夸大。
```
