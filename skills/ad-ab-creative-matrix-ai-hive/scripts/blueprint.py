#!/usr/bin/env python3
"""Create a deterministic production brief for 爆款广告A/B创意矩阵｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='爆款广告A/B创意矩阵｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['A/B广告', '创意矩阵', '素材测试', '广告变体', '投放素材'],
