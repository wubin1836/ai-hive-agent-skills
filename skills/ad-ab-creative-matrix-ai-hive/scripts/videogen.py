...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为爆款广告A/B创意矩阵制作一条主体清晰、节奏明确的商业视频", "keywords": "A/B广告,创意矩阵,素材测试,广告变体,投放素材", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ad-ab-creative-matrix-ai-hive", "rule": "optional", "search": "一次只改变一个主要变量，让测试结果可以解释", "title": "爆款广告A/B创意矩阵"}')
