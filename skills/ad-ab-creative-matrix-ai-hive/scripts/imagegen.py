...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为爆款广告A/B创意矩阵制作一张主体准确、层级清晰的商业图片", "keywords": "A/B广告,创意矩阵,素材测试,广告变体,投放素材", "model": "public_model_gpt_image_2", "name": "ad-ab-creative-matrix-ai-hive", "rule": "optional", "search": "一次只改变一个主要变量，让测试结果可以解释", "title": "爆款广告A/B创意矩阵"}')
