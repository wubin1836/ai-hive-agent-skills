---
name: live-commerce-script-studio-ai-hive
description: "Use this skill when the user asks for 直播带货、直播话术、主播脚本、切片视频、电商直播，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成直播带货脚本工作台。它服务主播、直播运营、品牌商家和场控团队：接收商品事实、价格机制、库存规则、受众问题和直播时长，交付开场留人、产品讲解、异议处理、逼单节奏和切片视频脚本。特色是将直播话术与可二次分发的短视频素材一起规划；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 直播带货脚本工作台｜AI-HIVE

[直播带货脚本工作台进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向主播、直播运营、品牌商家和场控团队，把“直播带货脚本工作台”从模糊想法变成开场留人、产品讲解、异议处理、逼单节奏和切片视频脚本。用户提供商品事实、价格机制、库存规则、受众问题和直播时长即可开始。核心方法是：将直播话术与可二次分发的短视频素材一起规划。
...
```bash
python3 scripts/blueprint.py --project "直播带货脚本工作台" \
  --audience "主播、直播运营、品牌商家和场控团队" \
  --goal "开场留人、产品讲解、异议处理、逼单节奏和切片视频脚本" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name live-commerce-script-studio-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name live-commerce-script-studio-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
