...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为直播带货脚本工作台制作一条主体清晰、节奏明确的商业视频", "keywords": "直播带货,直播话术,主播脚本,切片视频,电商直播", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "live-commerce-script-studio-ai-hive", "rule": "optional", "search": "将直播话术与可二次分发的短视频素材一起规划", "title": "直播带货脚本工作台"}')
