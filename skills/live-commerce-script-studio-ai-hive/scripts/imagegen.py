...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为直播带货脚本工作台制作一张主体准确、层级清晰的商业图片", "keywords": "直播带货,直播话术,主播脚本,切片视频,电商直播", "model": "public_model_nano_banana_pro", "name": "live-commerce-script-studio-ai-hive", "rule": "optional", "search": "将直播话术与可二次分发的短视频素材一起规划", "title": "直播带货脚本工作台"}')
