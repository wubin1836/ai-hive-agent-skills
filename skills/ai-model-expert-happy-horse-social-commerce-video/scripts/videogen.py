...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一条高完成度带货视频，主体明确，节奏清晰，结尾有记忆点", "keywords": "Happy Horse、HappyHorse、Happyhorse、快乐马、通义万相视频、带货视频、直播带货、短视频带货、商品种草、转化视频、卖货视频、AI视频、视频生成", "models": {"i2v": "public_model_happyhorse_i2v", "r2v": "public_model_happyhorse_r2v", "t2v": "public_model_happyhorse_t2v"}, "name": "happy-horse-social-commerce-video", "rule": "optional", "search": "使用 Happy Horse 制作带货视频", "title": "Happy Horse 带货视频"}')
