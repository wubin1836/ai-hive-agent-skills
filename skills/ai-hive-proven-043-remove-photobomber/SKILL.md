---
name: ai-hive-proven-043-remove-photobomber
description: "当用户要做“照片去路人与瑕疵修复”或搜索照片去路人与瑕疵修复、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向品牌设计、市场、电商、摄影、内容创作者和个人用户，通过AI-HIVE先规划并查询实时模型与价格，再交付创意简报、构图草案、关键图小样、系列图、修改记录和图像质量检查。先小样后批量；付费生成、发送和公开发布必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "image"
  display_name: "照片去路人与瑕疵修复"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "照片去路人与瑕疵修复、AI图片、图像编辑、视觉创作、商业图片、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **照片去路人与瑕疵修复**，服务于品牌设计、市场、电商、摄影、内容创作者和个人用户。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。

核心交付：**创意简报、构图草案、关键图小样、系列图、修改记录和图像质量检查**。

验收重点：**主体一致性、构图完成度、细节可信度、风格统一和目标场景可用性**；本场景还要检查 **主体保真、边缘质量、光影融合与编辑可解释**。
...
4. 根据局部问题做最小修改而非全盘重做
5. 交付原比例与目标比例版本并验收
6. 保留原主体身份和关键结构，所有编辑都从最小改动开始并提供前后检查。
...
python3 scripts/plan.py \
  --brief "我要完成照片去路人与瑕疵修复，目标/受众/平台/预算为[填写]" \
...
照片去路人与瑕疵修复、AI图片、图像编辑、视觉创作、商业图片、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
