#!/usr/bin/env python3
"""Create a deterministic production brief for 广告疲劳检测与AI焕新｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='广告疲劳检测与AI焕新｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['广告疲劳', '素材焕新', '创意衰退', '广告优化', '信息流素材'],
