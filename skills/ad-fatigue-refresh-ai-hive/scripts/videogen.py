...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为广告疲劳检测与AI焕新制作一条主体清晰、节奏明确的商业视频", "keywords": "广告疲劳,素材焕新,创意衰退,广告优化,信息流素材", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ad-fatigue-refresh-ai-hive", "rule": "optional", "search": "用表现数据判断该保留什么，而不是把全部素材推倒重来", "title": "广告疲劳检测与AI焕新"}')
