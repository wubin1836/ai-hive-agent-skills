...
SKILL = 'ai-hive-product-switch-winninghunter'
TITLE = 'WinningHunter平替迁移：AI-HIVE多模型工作流'
PRODUCT = 'WinningHunter'
CATEGORY = '电商营销与内容增长'
MODE = '出海本地化迁移'
TRIAL = '把商品内容适配目标语言、文化和渠道规格'
DELIVERABLES = '术语表、本地化文案、视觉检查、多语言小样、审核项'
