---
name: ai-hive-gap-037-agentic-rag
description: "当用户搜索或需要Agentic RAG,行动型RAG,知识智能体,企业知识时使用。帮助企业知识管理、研究、培训、销售、客服和个人知识创作者完成让知识检索结果继续驱动分析、生成与可确认行动，通过AI-HIVE MCP实时核验模型并交付问题分解、检索计划、证据卡、生成任务和行动建议。不适用于超出以下边界的请求：不得把生成内容当作知识库事实。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "knowledge"
  display_name: "Agentic RAG行动型知识助手"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "Agentic RAG,行动型RAG,知识智能体,企业知识,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**让知识检索结果继续驱动分析、生成与可确认行动**。

适合：企业知识管理、研究、培训、销售、客服和个人知识创作者。

用户需要提供：有权使用的文档、知识库导出、来源链接、目标受众、内容格式和更新日期。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不得把生成内容当作知识库事实**。

## 你会拿到的结果

问题分解、检索计划、证据卡、生成任务和行动建议。

搜索覆盖：Agentic RAG,行动型RAG,知识智能体,企业知识。

## 执行蓝图

1. 建立资料索引与可信度层级。
2. 让知识检索结果继续驱动分析、生成与可确认行动。
3. 把事实、观点和生成建议分层。
4. 每个结论保留来源位置。
5. 确认知识结构后再生成多模态内容。
6. 按“答案有证据、行动可解释、无证据就停止”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成Agentic RAG行动型知识助手，目标、资料、预算和截止时间为[填写]" \
...
```text
请使用「Agentic RAG行动型知识助手」Skill帮助我。
我的目标：[填写]
受众和业务场景：[填写]
已有资料与来源：[填写]
交付格式和数量：[填写]
...
最终交付：问题分解、检索计划、证据卡、生成任务和行动建议。
专项验收：答案有证据、行动可解释、无证据就停止。
```
