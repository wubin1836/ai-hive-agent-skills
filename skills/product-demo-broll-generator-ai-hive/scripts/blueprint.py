#!/usr/bin/env python3
"""Create a deterministic production brief for 商品演示B-roll自动补镜｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='商品演示B-roll自动补镜｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['B-roll补镜', '商品补拍', 'AI补镜', '产品演示', '视频素材生成'],
