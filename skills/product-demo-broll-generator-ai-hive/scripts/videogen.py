...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为商品演示B-roll自动补镜制作一条主体清晰、节奏明确的商业视频", "keywords": "B-roll补镜,商品补拍,AI补镜,产品演示,视频素材生成", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "product-demo-broll-generator-ai-hive", "rule": "optional", "search": "只为叙事缺口生成短而明确的功能镜头，减少整片重做", "title": "商品演示B-roll自动补镜"}')
