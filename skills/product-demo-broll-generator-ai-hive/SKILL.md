---
name: product-demo-broll-generator-ai-hive
description: "Use this skill when the user asks for B-roll补镜、商品补拍、AI补镜、产品演示、视频素材生成，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成商品演示B-roll自动补镜。它服务剪辑师、广告后期、商品运营和缺少补拍镜头的团队：接收现有成片或脚本、商品参考图、缺失镜头、画幅、光线和运动方向，交付缺口镜头表、商品动作关键帧、B-roll提示词、视频片段和衔接建议。特色是只为叙事缺口生成短而明确的功能镜头，减少整片重做；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 商品演示B-roll自动补镜｜AI-HIVE

[商品演示B-roll自动补镜进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向剪辑师、广告后期、商品运营和缺少补拍镜头的团队，把“商品演示B-roll自动补镜”从模糊想法变成缺口镜头表、商品动作关键帧、B-roll提示词、视频片段和衔接建议。用户提供现有成片或脚本、商品参考图、缺失镜头、画幅、光线和运动方向即可开始。核心方法是：只为叙事缺口生成短而明确的功能镜头，减少整片重做。
...
B-roll不得表现不存在的结构、功能或危险用法；生成片段需与原片方向、光线和商品外观一致。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "商品演示B-roll自动补镜" \
  --audience "剪辑师、广告后期、商品运营和缺少补拍镜头的团队" \
  --goal "缺口镜头表、商品动作关键帧、B-roll提示词、视频片段和衔接建议" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name product-demo-broll-generator-ai-hive
