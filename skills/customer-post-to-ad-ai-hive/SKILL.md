---
name: customer-post-to-ad-ai-hive
description: "Use this skill when the user asks for 晒单转广告、买家秀混剪、UGC素材、客户视频、电商广告，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成用户晒单素材转广告。它服务拥有买家秀、晒单图或UGC片段的商家和品牌：接收已授权晒单图片或视频、商品事实、品牌规范、平台和目标时长，交付授权清单、素材挑选、混剪结构、字幕与品牌包装、多个广告版本。特色是保留真实感，同时用统一字幕与品牌结构提高可投放性；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 用户晒单素材转广告｜AI-HIVE

[用户晒单素材转广告进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向拥有买家秀、晒单图或UGC片段的商家和品牌，把“用户晒单素材转广告”从模糊想法变成授权清单、素材挑选、混剪结构、字幕与品牌包装、多个广告版本。用户提供已授权晒单图片或视频、商品事实、品牌规范、平台和目标时长即可开始。核心方法是：保留真实感，同时用统一字幕与品牌结构提高可投放性。
...
必须获得素材使用许可；不能修改用户原意、伪造使用效果或隐藏必要的广告披露。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "用户晒单素材转广告" \
  --audience "拥有买家秀、晒单图或UGC片段的商家和品牌" \
  --goal "授权清单、素材挑选、混剪结构、字幕与品牌包装、多个广告版本" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name customer-post-to-ad-ai-hive
