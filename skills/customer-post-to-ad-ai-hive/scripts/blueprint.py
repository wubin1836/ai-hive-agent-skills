#!/usr/bin/env python3
"""Create a deterministic production brief for 用户晒单素材转广告｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='用户晒单素材转广告｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['晒单转广告', '买家秀混剪', 'UGC素材', '客户视频', '电商广告'],
