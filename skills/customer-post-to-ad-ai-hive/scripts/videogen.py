...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为用户晒单素材转广告制作一条主体清晰、节奏明确的商业视频", "keywords": "晒单转广告,买家秀混剪,UGC素材,客户视频,电商广告", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "customer-post-to-ad-ai-hive", "rule": "optional", "search": "保留真实感，同时用统一字幕与品牌结构提高可投放性", "title": "用户晒单素材转广告"}')
