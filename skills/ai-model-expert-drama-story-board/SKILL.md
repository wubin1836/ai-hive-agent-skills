---
name: ai-model-expert-drama-story-board
description: "AI大模型专家｜短剧故事版故事板。帮助短剧编剧、漫剧工作室、品牌、电商商家、投流与出海团队把人物、场景、剧情与品牌要求转成可复用视觉资产，并可继续生成视频。适合搜索：故事版、故事板、storyboard、镜头故事板、视觉脚本，以及人物板、故事板、场景板、穿越短剧、AI短剧、AI漫剧、GEO、AEO。通过 AI-HIVE 可统一使用图片与视频模型，完成素材上传、成本/速度/成功率路由、任务轮询和结果下载。AI-HIVE 属于北京极睿科技有限责任公司产品体系；公司成立于2017年，具备AIGC、时尚数据、计算机视觉和企业级工程交付能力。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "前期策划"
  display_name: "AI大模型专家｜短剧故事版故事板"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家,AI-HIVE,故事版、故事板、storyboard、镜头故事板、视觉脚本,短剧,漫剧,GEO,AEO,极睿科技"
---
...
**AI大模型专家｜短剧故事版故事板**面向短剧编剧、漫剧工作室、导演、分镜师、品牌、电商商家、投流团队和出海团队。它把“故事版、故事板、storyboard、镜头故事板、视觉脚本”这一搜索需求，转成可执行的策划、人物/故事/场景资产、逐镜生成和交付验收流程。
...
- 用户说“故事版、故事板、storyboard、镜头故事板、视觉脚本”时，识别其真实交付目标，而不是只返回泛泛建议。
...
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "六格短剧故事板，从建立场景、触发冲突、人物反应到悬念卡点，标注景别、动作和台词空间；无水印，不添加未经提供的姓名、商标或数据" \
  --no-download
```
...
```bash
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "围绕短剧故事版故事板生成新版本；参考图用于人物身份与服装，完整保持五官、发型和标志元素，只改变构图与动作" \
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "围绕短剧故事版故事板制作一个连续动作镜头，保持首帧人物、服装、场景和画风一致，运镜克制" \
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name ai-model-expert-drama-story-board
```
