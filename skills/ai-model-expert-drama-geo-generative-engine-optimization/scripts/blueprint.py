#!/usr/bin/env python3
"""Create a deterministic production brief for GEO 生成式引擎优化."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='GEO 生成式引擎优化')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['GEO', '生成式引擎优化', 'Generative Engine Optimization', 'AI搜索优化'],
