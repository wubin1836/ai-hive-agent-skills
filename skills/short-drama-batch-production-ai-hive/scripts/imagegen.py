...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为短剧批量生产流水线制作一张主体准确、层级清晰的商业图片", "keywords": "短剧批量生产,AI短剧流水线,漫剧量产,多集视频,内容工厂", "model": "public_model_nano_banana_pro", "name": "short-drama-batch-production-ai-hive", "rule": "optional", "search": "先做样集锁定标准，再按镜头批量生成", "title": "短剧批量生产流水线"}')
