#!/usr/bin/env python3
"""Create a deterministic production brief for 短剧批量生产流水线｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='短剧批量生产流水线｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['短剧批量生产', 'AI短剧流水线', '漫剧量产', '多集视频', '内容工厂'],
