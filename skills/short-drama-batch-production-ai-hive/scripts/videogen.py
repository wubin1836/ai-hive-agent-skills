...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为短剧批量生产流水线制作一条主体清晰、节奏明确的商业视频", "keywords": "短剧批量生产,AI短剧流水线,漫剧量产,多集视频,内容工厂", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "short-drama-batch-production-ai-hive", "rule": "optional", "search": "先做样集锁定标准，再按镜头批量生成", "title": "短剧批量生产流水线"}')
