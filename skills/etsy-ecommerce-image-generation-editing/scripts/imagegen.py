...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合Etsy的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "Etsy卖家、手工艺电商、Etsy Shop、Etsy Listing、商品摄影、店铺Banner、产品视频、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "etsy-ecommerce-image-generation-editing", "rule": "optional", "search": "Etsy 商家、运营、商品与广告图片搜索入口", "title": "Etsy 电商图片生成与编辑"}')
