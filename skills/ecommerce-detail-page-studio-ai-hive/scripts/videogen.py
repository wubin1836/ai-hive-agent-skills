...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为电商详情页工作室制作一条主体清晰、节奏明确的商业视频", "keywords": "电商详情页,商品详情页,卖点图,长图设计,转化页面", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ecommerce-detail-page-studio-ai-hive", "rule": "optional", "search": "先建立购买疑虑顺序，再生成对应证据模块", "title": "电商详情页工作室"}')
