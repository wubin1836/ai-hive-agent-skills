...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为电商详情页工作室制作一张主体准确、层级清晰的商业图片", "keywords": "电商详情页,商品详情页,卖点图,长图设计,转化页面", "model": "public_model_nano_banana_pro", "name": "ecommerce-detail-page-studio-ai-hive", "rule": "optional", "search": "先建立购买疑虑顺序，再生成对应证据模块", "title": "电商详情页工作室"}')
