...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"edit\", \"models\": {\"edit\": \"public_model_happyhorse_video_edit\"}, \"name\": \"happy-horse-video-edit\", \"rule\": \"edit\", \"title\": \"Happy Horse Video Editing\"}")
