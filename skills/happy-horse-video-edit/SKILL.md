...
description: "Use this skill when creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers need to edit an existing video with natural-language instructions with Happy Horse through the AI Hive OpenAPI. It handles required media uploads, live model and price lookup, task submission, progress polling, and result downloads. Useful for ads, TVCs, product videos, e-commerce listings, social commerce, UGC-style seeding content, short dramas, motion comics, and storyboards. Search intents include AI video editing, video restyling, background replacement, video-to-video editing."
license: MIT
---

# Happy Horse Video Editing

## Overview

Happy Horse Video Editing helps creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers edit an existing video with natural-language instructions with Happy Horse. Describe the intended subject, action, camera, lighting, pacing, and constraints; the bundled CLI handles AI Hive OpenAPI calls and downloads the finished video.
...
Ads, tvcs, product videos, e-commerce listings, social commerce, ugc-style seeding content, short dramas, motion comics, and storyboards. It is also useful when users search for AI video editing, video restyling, background replacement, video-to-video editing.
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name happy-horse-video-edit
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode edit \
  --prompt "Happy Horse Video Editing: polished motion, clear subject, coherent action, stable camera, commercial finish" \
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode edit \
  --prompt "Create a polished happy horse video editing result with coherent motion, stable identity, and a clear ending" \
+  --video /path/to/source.mp4
```
