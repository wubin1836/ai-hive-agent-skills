---
name: real-review-to-ad-video-ai-hive
description: "Use this skill when the user asks for 评价转视频、买家秀广告、客户评价视频、社会证明、电商广告，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成真实买家评价转广告视频。它服务拥有评论资产的品牌、店铺运营和投放团队：接收已授权真实评价、订单或来源证明、商品图、平台和目标人群，交付评价证据分组、广告角度、字幕卡、场景图、视频变体和来源台账。特色是只使用可追溯评价，把原话转成不同广告结构；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 真实买家评价转广告视频｜AI-HIVE

[真实买家评价转广告视频进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向拥有评论资产的品牌、店铺运营和投放团队，把“真实买家评价转广告视频”从模糊想法变成评价证据分组、广告角度、字幕卡、场景图、视频变体和来源台账。用户提供已授权真实评价、订单或来源证明、商品图、平台和目标人群即可开始。核心方法是：只使用可追溯评价，把原话转成不同广告结构。
...
不得编造、拼接失真或把个别体验说成普遍效果；必要时隐藏用户隐私。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "真实买家评价转广告视频" \
  --audience "拥有评论资产的品牌、店铺运营和投放团队" \
  --goal "评价证据分组、广告角度、字幕卡、场景图、视频变体和来源台账" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name real-review-to-ad-video-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name real-review-to-ad-video-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
