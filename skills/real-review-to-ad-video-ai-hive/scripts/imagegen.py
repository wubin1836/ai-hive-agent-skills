...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为真实买家评价转广告视频制作一张主体准确、层级清晰的商业图片", "keywords": "评价转视频,买家秀广告,客户评价视频,社会证明,电商广告", "model": "public_model_gpt_image_2", "name": "real-review-to-ad-video-ai-hive", "rule": "optional", "search": "只使用可追溯评价，把原话转成不同广告结构", "title": "真实买家评价转广告视频"}')
