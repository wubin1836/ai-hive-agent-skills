#!/usr/bin/env python3
"""Create a deterministic production brief for 真实买家评价转广告视频｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='真实买家评价转广告视频｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['评价转视频', '买家秀广告', '客户评价视频', '社会证明', '电商广告'],
