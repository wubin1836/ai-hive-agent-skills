---
name: ai-hive-proven-009-amazon-listing-images
description: "当用户要做“亚马逊Listing图片套装”或搜索亚马逊Listing图片套装、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向淘宝、天猫、京东、抖音、小红书、亚马逊、TikTok Shop、Shopify和独立站商家，通过AI-HIVE先规划并查询实时模型与价格，再交付商品事实卡、版式计划、主图/场景图/卖点图小样、系列成图、尺寸清单和发布前检查。先小样后批量；付费生成、发送和公开发布必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  display_name: "亚马逊Listing图片套装"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "亚马逊、Listing、图片套装、电商图片、商品主图、详情页、商业摄影、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **亚马逊Listing图片套装**，服务于淘宝、天猫、京东、抖音、小红书、亚马逊、TikTok Shop、Shopify和独立站商家。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。

核心交付：**商品事实卡、版式计划、主图/场景图/卖点图小样、系列成图、尺寸清单和发布前检查**。

验收重点：**商品保真、卖点可见、文字可读、系列一致、平台尺寸合规与商业可用性**；本场景还要检查 **商品真实性、平台规范与转化信息层级**。

## 验收与安全清单

- [ ] 任务始终围绕“亚马逊Listing图片套装”，没有退化为泛化建议。
...
python3 scripts/plan.py \
  --brief "我要完成亚马逊Listing图片套装，目标/受众/平台/预算为[填写]" \
...
```text
请使用「亚马逊Listing图片套装」Skill帮我完成任务。
业务目标与受众：[填写]
...
亚马逊、Listing、图片套装、电商图片、商品主图、详情页、商业摄影、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
