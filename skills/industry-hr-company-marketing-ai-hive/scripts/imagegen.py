...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为人力资源公司制作主体准确、事实可核验的图片营销素材", "model": "public_model_nano_banana_pro", "name": "industry-hr-company-marketing-ai-hive", "title": "AI大模型专家｜人力资源公司AI图片视频营销", "keywords": "人力资源公司、人力服务、劳务服务、HR服务、AI图片、AI短视频、视频编辑、内容营销、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前图片/视频模型与价格快照，不硬编码价格"}')
