...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 GPT Image 2 制作高完成度种草图片，主体准确，构图清晰", "keywords": "GPT Image 2、GPT-Image-2、GPTImage2、OpenAI Image 2、ChatGPT Images、Image2、种草图片、小红书种草图、社媒配图、好物推荐图、UGC视觉、笔记封面、AI图片、AIGC图片", "model": "public_model_gpt_image_2", "name": "gpt-image-2-seeding-image", "rule": "optional", "search": "固定调用 GPT Image 2 的种草图片裸接口能力", "title": "GPT Image 2 种草图片"}')
