---
name: ai-hive-proven-120-api-model-gateway
description: "当用户要做“API网关与多模型路由设计”或搜索API网关与多模型路由设计、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向开发者、技术团队、AI产品经理和需要统一模型接入的企业，通过AI-HIVE先规划并查询实时模型与价格，再交付能力映射、接入配置、路由方案、测试请求、错误处理、成本控制和验收记录。先完成只读验证，再由用户确认任何付费调用；发送和公开发布也必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  display_name: "API网关与多模型路由设计"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "API、网关与多模型路由设计、MCP接入、API网关、模型路由、AI开发、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **API网关与多模型路由设计**，服务于开发者、技术团队、AI产品经理和需要统一模型接入的企业。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。
...
python3 scripts/plan.py \
  --brief "我要完成API网关与多模型路由设计，目标/受众/平台/预算为[填写]" \
...
- [ ] 任务始终围绕“API网关与多模型路由设计”，没有退化为泛化建议。
...
API、网关与多模型路由设计、MCP接入、API网关、模型路由、AI开发、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
