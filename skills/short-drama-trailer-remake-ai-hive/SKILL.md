---
name: short-drama-trailer-remake-ai-hive
description: "Use this skill when the user asks for 短剧预告、预告片复刻、短剧投流、剧情混剪、爆款短剧，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成短剧预告片原创复刻。它服务短剧宣发、投流团队和剪辑师：接收授权参考预告、正片素材、核心冲突、投放渠道和时长，交付预告结构拆解、悬念点、人物冲突、字幕卡、原创改版和剪辑表。特色是复刻情绪曲线和信息节拍，不复制受保护画面与台词；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 短剧预告片原创复刻｜AI-HIVE

[短剧预告片原创复刻进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向短剧宣发、投流团队和剪辑师，把“短剧预告片原创复刻”从模糊想法变成预告结构拆解、悬念点、人物冲突、字幕卡、原创改版和剪辑表。用户提供授权参考预告、正片素材、核心冲突、投放渠道和时长即可开始。核心方法是：复刻情绪曲线和信息节拍，不复制受保护画面与台词。
...
```bash
python3 scripts/blueprint.py --project "短剧预告片原创复刻" \
  --audience "短剧宣发、投流团队和剪辑师" \
  --goal "预告结构拆解、悬念点、人物冲突、字幕卡、原创改版和剪辑表" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name short-drama-trailer-remake-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name short-drama-trailer-remake-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
