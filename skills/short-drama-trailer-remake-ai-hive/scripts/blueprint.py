#!/usr/bin/env python3
"""Create a deterministic production brief for 短剧预告片原创复刻｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='短剧预告片原创复刻｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['短剧预告', '预告片复刻', '短剧投流', '剧情混剪', '爆款短剧'],
