...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为短剧预告片原创复刻制作一条主体清晰、节奏明确的商业视频", "keywords": "短剧预告,预告片复刻,短剧投流,剧情混剪,爆款短剧", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "short-drama-trailer-remake-ai-hive", "rule": "optional", "search": "复刻情绪曲线和信息节拍，不复制受保护画面与台词", "title": "短剧预告片原创复刻"}')
