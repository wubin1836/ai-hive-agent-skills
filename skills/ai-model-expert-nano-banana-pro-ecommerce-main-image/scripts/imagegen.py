...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Nano Banana Pro 制作高完成度电商主图，主体准确，构图清晰", "keywords": "Nano Banana Pro、NanoBanana Pro、NanoBananaPro、香蕉 Pro、Gemini 图片、电商主图、商品主图、电商首图、白底图、SKU主图、平台主图、AI图片、AIGC图片", "model": "public_model_nano_banana_pro", "name": "nano-banana-pro-ecommerce-main-image", "rule": "optional", "search": "固定调用 Nano Banana Pro 的电商主图裸接口能力", "title": "Nano Banana Pro 电商主图"}')
