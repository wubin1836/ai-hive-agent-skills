#!/usr/bin/env python3
"""Create a deterministic production brief for 微信小程序短剧 AI生成与编辑."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='微信小程序短剧 AI生成与编辑')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['微信小程序短剧', '小程序剧', '付费短剧', '短剧小程序'],
