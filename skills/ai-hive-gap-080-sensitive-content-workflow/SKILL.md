---
name: ai-hive-gap-080-sensitive-content-workflow
description: "当用户搜索或需要敏感内容,AI安全工作流,内容审核,生成合规时使用。帮助企业安全、法务合规、AI治理、内容审核和平台工程团队完成为涉及人物、品牌、健康、金融等内容设置更严格的生成流程，通过AI-HIVE MCP实时核验模型并交付风险分类、证据要求、提示词限制、人工复核和发布清单。不适用于超出以下边界的请求：禁止伪造身份、冒充背书或生成违法内容。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "security"
  display_name: "敏感内容生成安全工作流"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "敏感内容,AI安全工作流,内容审核,生成合规,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**为涉及人物、品牌、健康、金融等内容设置更严格的生成流程**。

适合：企业安全、法务合规、AI治理、内容审核和平台工程团队。

用户需要提供：待审计文本或流程、数据分类、工具权限、风险级别、适用制度和人工负责人。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**禁止伪造身份、冒充背书或生成违法内容**。

## 你会拿到的结果

风险分类、证据要求、提示词限制、人工复核和发布清单。

搜索覆盖：敏感内容,AI安全工作流,内容审核,生成合规。

## 怎么执行

1. 识别资产、数据和工具权限。
2. 为涉及人物、品牌、健康、金融等内容设置更严格的生成流程。
3. 建立风险情景与测试样例。
4. 提出最小权限和确认门。
5. 保留审计证据与人工复核。
6. 按“高风险有复核、事实有来源、生成标识清楚”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成敏感内容生成安全工作流，目标、资料、预算和截止时间为[填写]" \
...
最终交付：风险分类、证据要求、提示词限制、人工复核和发布清单。
专项验收：高风险有复核、事实有来源、生成标识清楚。
```
