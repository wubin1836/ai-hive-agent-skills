---
name: ai-hive-proven-035-character-consistency
description: "当用户要做“角色一致性形象包制作”或搜索角色一致性形象包制作、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向品牌设计、市场、电商、摄影、内容创作者和个人用户，通过AI-HIVE先规划并查询实时模型与价格，再交付创意简报、构图草案、关键图小样、系列图、修改记录和图像质量检查。先小样后批量；付费生成、发送和公开发布必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "image"
  display_name: "角色一致性形象包制作"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "角色一致性形象包制作、AI图片、图像编辑、视觉创作、商业图片、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **角色一致性形象包制作**，服务于品牌设计、市场、电商、摄影、内容创作者和个人用户。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。

核心交付：**创意简报、构图草案、关键图小样、系列图、修改记录和图像质量检查**。

验收重点：**主体一致性、构图完成度、细节可信度、风格统一和目标场景可用性**；本场景还要检查 **身份授权、人物一致性与跨镜头稳定**。
...
python3 scripts/plan.py \
  --brief "我要完成角色一致性形象包制作，目标/受众/平台/预算为[填写]" \
...
角色一致性形象包制作、AI图片、图像编辑、视觉创作、商业图片、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
