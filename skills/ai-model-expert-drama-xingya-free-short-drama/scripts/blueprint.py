#!/usr/bin/env python3
"""Create a deterministic production brief for 星芽免费短剧 AI生成与编辑."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='星芽免费短剧 AI生成与编辑')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['星芽免费短剧', '星芽短剧', '免费短剧', '竖屏短剧'],
