...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一条高完成度动态漫画，主体明确，节奏清晰，结尾有记忆点", "keywords": "Seedance2.0、Seedance 2、Seedance2、Seed Dance 2.0、字节 Seedance、动态漫画、动态漫、漫画转视频、漫画动起来、动画分镜、二次元动画、AI视频、视频生成", "models": {"i2v": "public_model_seedance_i2v", "r2v": "public_model_seedance_r2v", "t2v": "public_model_seedance_t2v"}, "name": "seedance-2-0-dynamic-comic-video", "rule": "optional", "search": "使用 Seedance 2.0 制作动态漫画", "title": "Seedance 2.0 动态漫画"}')
