#!/usr/bin/env python3
"""Create a deterministic production brief for 商品360环绕展示视频｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='商品360环绕展示视频｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['商品360视频', '环绕展示', '产品旋转', '商品视频', '3D视觉'],
