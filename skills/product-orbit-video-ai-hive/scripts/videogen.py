...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为商品360环绕展示视频制作一条主体清晰、节奏明确的商业视频", "keywords": "商品360视频,环绕展示,产品旋转,商品视频,3D视觉", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "product-orbit-video-ai-hive", "rule": "optional", "search": "用多角度参考减少结构漂移，生成短环绕展示镜头", "title": "商品360环绕展示视频"}')
