...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Image2 制作高完成度图生图，主体准确，构图清晰", "keywords": "Image2、Image 2、GPT Image 2、GPTImage2、OpenAI 图片、ChatGPT 图片、图生图、图片生成图片、以图生图、image to image、I2I、参考图重绘、AI图片、AIGC图片", "model": "public_model_gpt_image_2", "name": "image-2-image-to-image", "rule": "image", "search": "固定调用 Image2 的图生图裸接口能力", "title": "Image2 图生图"}')
