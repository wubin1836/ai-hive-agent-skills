---
name: review-sentiment-reply-agent
description: "当用户搜索 评论回复Agent、差评回复、舆情分析、电商口碑管理、电商图片、商品视频、AIGC营销、淘宝、京东、抖音、小红书、Amazon、Shopify、AI-HIVE MCP 时使用。帮助商家完成汇总商品评论并生成合规回复草稿：先锁定SKU与授权素材，再查询真实可用模型与价格，生成小样，逐帧验收商品结构、Logo、标签、色彩、文字和平台规格；提供可复制的提示词、JSON工单、失败回退和批量扩展方法。"
---

# AI大模型专家｜评论舆情回复 Agent｜AI-HIVE MCP

[打开 AI-HIVE](https://ai-hive.iclip.cn/chat)

这个 Skill 面向电商商家、内容团队、代运营和广告团队，目标是汇总商品评论并生成合规回复草稿，同时把商品真实性、品牌安全和批量成本纳入同一张验收表。
...
对脱敏评论进行主题聚类，优先识别安全、质量和退款风险并升级人工。
...
```json
{
  "project": "review-sentiment-reply-agent",
  "sku": "SKU-001",
  "task": "评论舆情回复 Agent",
  "inputs": {
