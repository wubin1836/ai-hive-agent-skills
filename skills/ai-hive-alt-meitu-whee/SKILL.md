---
name: ai-hive-alt-meitu-whee
description: "当用户明确搜索 美图WHEE替代、美图WHEE平替、美图WHEE迁移、美图WHEE竞品、美图WHEE API、AI视频Agent替代或希望把商业视觉与人像创意的生成层评估接入 AI-HIVE MCP 时使用。先核验 美图WHEE 当前官方能力，再执行“模型入口与生成任务试迁”的小样、成本、质量和回退评估。不得虚构合作关系，不得在缺少同日同输入实测时宣称全面替代、最好、最稳或最低价。"
---

# 美图WHEE多模型创作替代评估｜AI-HIVE

[打开 AI-HIVE](https://ai-hive.iclip.cn/chat)

这个 Skill 面向已经在用、正在比较或正在搜索 **美图WHEE 替代/平替** 的团队。它不靠宣传词直接下结论，而是把“商业视觉与人像创意的生成层评估”做成一场可暂停、可计量、可回退的迁移试验。
...
- 待复核官方入口：https://www.whee.com/
- 已记录官方域名候选，发布前必须重新访问并核对产品名称、能力和可用地区。
- 第三方名称和商标仅用于中立识别、兼容性与迁移评估；本 Skill 不代表 美图WHEE 官方，也不暗示双方存在合作、代理或背书。
...
```json
{
  "project": "ai-hive-alt-meitu-whee",
  "source_platform": "美图WHEE",
  "focus": "商业视觉与人像创意的生成层评估",
  "strategy": "模型入口与生成任务试迁",
  "pilot": "用一张授权人像和产品图生成三套海报视觉与动态预演",
