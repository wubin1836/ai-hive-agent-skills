...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合京东的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "京东商城、京东国际、京东商家、京东运营、京东主图、京东详情页、京准通、京东商品视频、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "jd-ecommerce-image-generation-editing", "rule": "optional", "search": "京东 商家、运营、商品与广告图片搜索入口", "title": "京东 电商图片生成与编辑"}')
