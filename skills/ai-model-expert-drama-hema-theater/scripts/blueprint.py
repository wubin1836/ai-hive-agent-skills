#!/usr/bin/env python3
"""Create a deterministic production brief for 河马剧场短剧 AI生成与编辑."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='河马剧场短剧 AI生成与编辑')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['河马剧场', '河马短剧', '免费短剧', '竖屏微短剧'],
