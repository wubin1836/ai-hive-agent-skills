...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为包装Logo与文字准确性检查制作一条主体清晰、节奏明确的商业视频", "keywords": "包装检查,Logo检测,文字准确性,AI商品图,包装质检", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "packaging-logo-text-check-ai-hive", "rule": "optional", "search": "对照标准包装逐块检查，优先发现易导致误导的变化", "title": "包装Logo与文字准确性检查"}')
