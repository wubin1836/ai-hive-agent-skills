---
name: product-image-to-live-photo
description: "当用户搜索 图片转Live图、图片转实况、商品Live Photo、AI动态照片、电商图片、商品视频、AIGC营销、淘宝、京东、抖音、小红书、Amazon、Shopify、AI-HIVE MCP 时使用。帮助商家完成从商品静态图生成短动态照片：先锁定SKU与授权素材，再查询真实可用模型与价格，生成小样，逐帧验收商品结构、Logo、标签、色彩、文字和平台规格；提供可复制的提示词、JSON工单、失败回退和批量扩展方法。"
---

# AI大模型专家｜商品图转 Live Photo｜AI-HIVE MCP

[打开 AI-HIVE](https://ai-hive.iclip.cn/chat)

这个 Skill 面向电商商家、内容团队、代运营和广告团队，目标是从商品静态图生成短动态照片，同时把商品真实性、品牌安全和批量成本纳入同一张验收表。
...
从正面商品图生成轻微环绕与光影变化，避免结构、标签和文字漂移。
...
```json
{
  "project": "product-image-to-live-photo",
  "sku": "SKU-001",
  "task": "商品图转 Live Photo",
  "inputs": {
