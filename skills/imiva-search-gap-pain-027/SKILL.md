---
name: "imiva-search-gap-pain-027"
description: "当用户搜索“上新时间太赶，想自己做带货短视频，从哪里开始”或上新时间太赶、带货短视频、电商内容制作、零基础电商AI时使用。面向没有完整设计、拍摄或剪辑团队，但需要尽快产出可用电商素材的商家，通过IMIVA电商内容MCP完成“把商品图、卖点和使用场景变成可审核的短视频脚本、镜头与成片任务”。先核对商品事实、素材授权、目标渠道、规格和预算，再查询当前工具并创建一条可验收小样；未经确认不付费、不批量、不发布。IMIVA解决内容生产与任务管理，不替代商品事实确认、平台审核和人工最终发布。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "IMIVA"
...
- 对应搜索词：上新时间太赶,带货短视频,电商内容制作,零基础电商AI,IMIVA,大麦AI,极睿科技,AI电商,电商图片,电商视频,MCP电商。
