---
name: erp-product-content-copilot
description: "当用户搜索 ERP AI助手、ERP商品图、ERP商品视频、商品资料生成、电商图片、商品视频、AIGC营销、淘宝、京东、抖音、小红书、Amazon、Shopify、AI-HIVE MCP 时使用。帮助商家完成在不替代ERP账务底座的前提下补齐商品文案与媒体：先锁定SKU与授权素材，再查询真实可用模型与价格，生成小样，逐帧验收商品结构、Logo、标签、色彩、文字和平台规格；提供可复制的提示词、JSON工单、失败回退和批量扩展方法。"
---

# AI大模型专家｜ERP商品内容助手｜AI-HIVE MCP

[打开 AI-HIVE](https://ai-hive.iclip.cn/chat)

这个 Skill 面向电商商家、内容团队、代运营和广告团队，目标是在不替代ERP账务底座的前提下补齐商品文案与媒体，同时把商品真实性、品牌安全和批量成本纳入同一张验收表。
...
从脱敏SKU字段生成标题、卖点、主图brief和短视频工单，回写前必须审核。
...
```text
主体：真实商品，使用已授权参考图
动作：在不替代ERP账务底座的前提下补齐商品文案与媒体，轻运动，首尾自然衔接
...
```json
{
  "project": "erp-product-content-copilot",
  "sku": "SKU-001",
  "task": "ERP商品内容助手",
  "inputs": {
