...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_pro\", \"name\": \"nano-banana-pro-multi-reference-image\", \"rule\": \"multi\", \"title\": \"Nano Banana Pro Multi-Reference Image Generation\"}")
