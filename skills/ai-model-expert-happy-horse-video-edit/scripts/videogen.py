...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "保持人物动作与镜头不变，将背景替换为雨夜霓虹城市", "fixed_mode": "edit", "keywords": "Happy Horse、HappyHorse、Happyhorse、快乐马、通义万相视频、视频编辑、AI剪辑、改视频、视频换背景、视频重绘、video edit", "models": {"edit": "public_model_happyhorse_video_edit"}, "name": "happy-horse-video-edit", "rule": "edit", "search": "固定调用 Happy Horse 视频编辑裸接口", "title": "Happy Horse 视频编辑"}')
