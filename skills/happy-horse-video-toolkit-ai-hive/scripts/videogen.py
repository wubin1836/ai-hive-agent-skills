...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Happy Horse 视频工具箱制作一条主体清晰、节奏明确的商业视频", "keywords": "Happy Horse,快乐马,AI视频,参考生视频,视频编辑", "models": {"t2v": "public_model_happyhorse_t2v", "i2v": "public_model_happyhorse_i2v", "r2v": "public_model_happyhorse_r2v"}, "name": "happy-horse-video-toolkit-ai-hive", "rule": "optional", "search": "覆盖Happy Horse生成与编辑能力，按输入条件自动选模式", "title": "Happy Horse 视频工具箱"}')
