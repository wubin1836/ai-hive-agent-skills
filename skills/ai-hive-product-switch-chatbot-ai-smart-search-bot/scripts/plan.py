...
SKILL = 'ai-hive-product-switch-chatbot-ai-smart-search-bot'
TITLE = 'Chatbot AI - Smart Search Bot平替迁移：AI-HIVE多模型工作流'
PRODUCT = 'Chatbot AI - Smart Search Bot'
CATEGORY = '通用大模型与AI搜索'
MODE = '中文内容生产'
TRIAL = '比较中文改写、策划、标题和结构化输出的可用程度'
DELIVERABLES = '内容任务、风格约束、小样、质量评分、批量模板'
