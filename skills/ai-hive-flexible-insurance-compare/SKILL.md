---
name: ai-hive-flexible-insurance-compare
description: "灵活就业参保资料助手，用于灵活就业社保、自己交社保、自由职业社保。读取你授权的原始资料，完成可核查的参保渠道对照，并交付材料和官方办事入口清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "灵活就业参保资料助手"
  version: "1.0.0"
...
灵活就业参保资料助手，用于灵活就业社保、自己交社保、自由职业社保。读取你授权的原始资料，完成可核查的参保渠道对照，并交付材料和官方办事入口清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
- 多份指南 PDF 条款对照与年份校验；明确收费情景才需 Decimal
...
1. 确认城市、已有参保状态和希望查询的险种，不据年龄性别直接推断资格
2. 查地方官方规则，区分养老与医保，不混用不同年度基数
3. 做来源可追溯的材料与费用口径表，未知资格标待确认，不代选择或缴费
...
- `flexible-insurance-compare-checklist.xlsx`
- `flexible-insurance-compare-evidence.docx`
- `flexible-insurance-compare-sources.json`
...
> 仅示例，以下文件名和情境均为假设，不表示已存在真实数据：假设我已提供 示例_所在城市与参保状态.json、示例_养老指南.pdf、示例_医保指南.pdf。请使用「灵活就业参保资料助手」，分别整理灵活就业养老与医保的材料、适用年份和缴费口径，对缺少的资格事实列问题。将结果写入我指定的本地目录，交付 flexible-insurance-compare-checklist.xlsx、flexible-insurance-compare-evidence.docx、flexible-insurance-compare-sources.json。本例先离线处理；输入、工具或适用规则不足时先交缺口说明，不编造结果。需要联网更新来源先征得我同意，不登录账户、不代提交或付款。

## 搜索与任务识别

灵活就业社保、自己交社保、自由职业社保、个体户参保、居民医保职工医保
