...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为抖音生活服务30天团购运营制作主体稳定、事实可核验的本地生活视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "local-douyin-life-operation-ai-hive", "title": "AI大模型专家｜抖音生活服务30天团购运营", "keywords": "抖音生活服务、抖音来客、抖音团购、抖音本地生活、同城团购、30天团购运营、本地生活、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前模型与价格，并在平台官方后台核对当前规则"}')
