...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为连载角色一致性守护制作一条主体清晰、节奏明确的商业视频", "keywords": "角色一致性,连载短剧,人物连续性,AI漫剧质检,虚拟IP", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "serialized-character-consistency-ai-hive", "rule": "optional", "search": "把稳定锚点与剧情允许变化分开检查", "title": "连载角色一致性守护"}')
