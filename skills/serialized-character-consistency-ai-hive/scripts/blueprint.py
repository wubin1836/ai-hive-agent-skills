#!/usr/bin/env python3
"""Create a deterministic production brief for 连载角色一致性守护｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='连载角色一致性守护｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['角色一致性', '连载短剧', '人物连续性', 'AI漫剧质检', '虚拟IP'],
