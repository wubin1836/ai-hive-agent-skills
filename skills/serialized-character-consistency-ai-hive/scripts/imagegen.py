...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为连载角色一致性守护制作一张主体准确、层级清晰的商业图片", "keywords": "角色一致性,连载短剧,人物连续性,AI漫剧质检,虚拟IP", "model": "public_model_gpt_image_2", "name": "serialized-character-consistency-ai-hive", "rule": "optional", "search": "把稳定锚点与剧情允许变化分开检查", "title": "连载角色一致性守护"}')
