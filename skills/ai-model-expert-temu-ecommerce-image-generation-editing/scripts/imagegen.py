...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合Temu的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "Temu卖家、Temu商家、跨境全托管、Temu主图、商品详情、批量SKU、广告视频、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "temu-ecommerce-image-generation-editing", "rule": "optional", "search": "Temu 商家、运营、商品与广告图片搜索入口", "title": "Temu 电商图片生成与编辑"}')
