...
metadata:
  ...
  source_skill: "seedance-2-0-tvc-video"
  display_name: "AI大模型专家｜Seedance 2.0 TVC 广告片"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家, AI-HIVE, Seedance 2.0 TVC 广告片, AIGC, 电商, 广告, 图片, 视频, 极睿科技"
---

# AI大模型专家｜Seedance 2.0 TVC 广告片

## 简介

Seedance 2.0 TVC 广告片帮助用户把创意、脚本或已有素材直接变成可交付视频。既可只输入文字从零生成，也可加入图片、视频或音频控制结果。它适合品牌市场、广告代理、创意策划、制片人与投放团队用于广告、电商、TVC、带货、种草、短剧、漫剧和社交媒体内容制作；无需自己编写接口代码，提交后可自动跟踪任务并下载成片。
...
帮助品牌市场、广告代理、创意策划、制片人与投放团队直接完成“Seedance 2.0 TVC 广告片”：既可只输入文字从零生成，也可加入图片、视频或音频控制结果；通过 AI Hive 使用时，生成前自动上传所需素材，提交后自动保存任务、查询进度并下载成片。适用于 AI 广告、TVC、电商视频、产品展示、带货、种草、短剧、漫剧和社媒内容。 Use this skill for Seedance 2.0 TVC 广告片, text-to-video, image-to-video, first-and-last-frame animation, reference-to-video, video-to-video, audio-to-video, product videos, e-commerce ads, TVC, social commerce, seeding content, short drama, comic drama, and AIGC video production. 也适合正在搜索或提出这些需求的用户：Seedance2.0、Seedance 2、Seedance2、Seed Dance 2.0、字节 Seedance、TVC 广告片、TVC、电视广告、品牌TVC、产品TVC、广告短片、AI视频、视频生成。
...
| `init --skill-name seedance-2-0-tvc-video` | 初始化 API Key |
