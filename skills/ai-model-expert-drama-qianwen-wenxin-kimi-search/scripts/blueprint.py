#!/usr/bin/env python3
"""Create a deterministic production brief for 通义千问文心一言Kimi AI搜索优化."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='通义千问文心一言Kimi AI搜索优化')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['通义千问', '文心一言', 'Kimi', 'AI搜索收录', 'AI引用'],
