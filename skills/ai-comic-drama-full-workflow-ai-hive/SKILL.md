---
name: ai-comic-drama-full-workflow-ai-hive
description: "Use this skill when the user asks for AI漫剧、漫改视频、漫画短剧、分镜生成、AI动画，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成AI漫剧全流程制作。它服务漫剧工作室、短剧团队、小说IP方和独立创作者：接收故事、画风、人物、集数、单集时长、平台和预算，交付剧本拆分、人物板、场景板、分镜图、动态镜头、配音字幕与成片清单。特色是用角色与场景资产库贯穿全流程，减少每镜重猜；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# AI漫剧全流程制作｜AI-HIVE

[AI漫剧全流程制作进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向漫剧工作室、短剧团队、小说IP方和独立创作者，把“AI漫剧全流程制作”从模糊想法变成剧本拆分、人物板、场景板、分镜图、动态镜头、配音字幕与成片清单。用户提供故事、画风、人物、集数、单集时长、平台和预算即可开始。核心方法是：用角色与场景资产库贯穿全流程，减少每镜重猜。
...
```bash
python3 scripts/blueprint.py --project "AI漫剧全流程制作" \
  --audience "漫剧工作室、短剧团队、小说IP方和独立创作者" \
  --goal "剧本拆分、人物板、场景板、分镜图、动态镜头、配音字幕与成片清单" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name ai-comic-drama-full-workflow-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name ai-comic-drama-full-workflow-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
