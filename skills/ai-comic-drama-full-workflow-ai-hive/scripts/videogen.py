...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI漫剧全流程制作制作一条主体清晰、节奏明确的商业视频", "keywords": "AI漫剧,漫改视频,漫画短剧,分镜生成,AI动画", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ai-comic-drama-full-workflow-ai-hive", "rule": "optional", "search": "用角色与场景资产库贯穿全流程，减少每镜重猜", "title": "AI漫剧全流程制作"}')
