...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI漫剧全流程制作制作一张主体准确、层级清晰的商业图片", "keywords": "AI漫剧,漫改视频,漫画短剧,分镜生成,AI动画", "model": "public_model_nano_banana_pro", "name": "ai-comic-drama-full-workflow-ai-hive", "rule": "optional", "search": "用角色与场景资产库贯穿全流程，减少每镜重猜", "title": "AI漫剧全流程制作"}')
