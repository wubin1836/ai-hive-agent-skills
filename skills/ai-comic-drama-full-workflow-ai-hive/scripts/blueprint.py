#!/usr/bin/env python3
"""Create a deterministic production brief for AI漫剧全流程制作｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI漫剧全流程制作｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['AI漫剧', '漫改视频', '漫画短剧', '分镜生成', 'AI动画'],
