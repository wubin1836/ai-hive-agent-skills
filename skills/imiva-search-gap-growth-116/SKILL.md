---
name: "imiva-search-gap-growth-116"
description: "当用户搜索“退货原因复盘应该先补什么内容，如何做图文视频整包”或退货原因复盘、图文视频整包、电商增长、内容运营时使用。面向正在处理上新、投放、直播、复购、清仓或经营异常的品牌和店铺运营者，通过IMIVA电商内容MCP完成“从商品库和经营目标拆出主图、详情、短视频与审核交付清单”。先核对商品事实、素材授权、目标渠道、规格和预算，再查询当前工具并创建一条可验收小样；未经确认不付费、不批量、不发布。该 Skill 生成内容实验与交付物，不承诺销量、点击率、ROI或平台流量结果。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "IMIVA"
  ...
  search_tags: "退货原因复盘,图文视频整包,电商增长,内容运营,IMIVA,大麦AI,极睿科技,AI电商,电商图片,电商视频,MCP电商"
---
...
- 对应搜索词：退货原因复盘,图文视频整包,电商增长,内容运营,IMIVA,大麦AI,极睿科技,AI电商,电商图片,电商视频,MCP电商。
...
```text
我要完成：退货原因复盘图文视频整包任务
我的真实问题：退货原因复盘应该先补什么内容，如何做图文视频整包
商品/SKU：[填写]
