...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "高级商业摄影风格的产品主视觉，主体清晰，材质真实，留出标题空间", "keywords": "Seedream 5.0 Lite、Seedream 5 Lite、Seedream5、即梦图片 5、字节图片模型、文生图、图生图、图片编辑、电商图、广告图、详情页、带货、种草", "model": "public_model_seedream_5_0_lite", "name": "seedream-5-lite", "rule": "optional", "search": "覆盖 Seedream 5.0 Lite、Seedream 5 Lite、Seedream5、即梦图片 5、字节图片模型 的裸接口图片能力", "title": "Seedream 5.0 Lite 图片生成与编辑"}')
