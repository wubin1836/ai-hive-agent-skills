...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为参考动作迁移短视频制作一条主体清晰、节奏明确的商业视频", "keywords": "动作迁移,参考动作,视频动作复刻,R2V,AI舞蹈", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "reference-motion-transfer-ai-hive", "rule": "optional", "search": "迁移动作节奏与轨迹，重建人物、场景和视觉表达", "title": "参考动作迁移短视频"}')
