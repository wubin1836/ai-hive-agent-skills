#!/usr/bin/env python3
"""Create a deterministic production brief for 参考动作迁移短视频｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='参考动作迁移短视频｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['动作迁移', '参考动作', '视频动作复刻', 'R2V', 'AI舞蹈'],
