...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Seedance 参考视频原创复刻制作一条主体清晰、节奏明确的商业视频", "keywords": "Seedance参考生视频,R2V,视频复刻,运镜复刻,动作参考", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "seedance-reference-video-remake-ai-hive", "rule": "optional", "search": "只迁移可复用结构变量，主动建立原创差异", "title": "Seedance 参考视频原创复刻"}')
