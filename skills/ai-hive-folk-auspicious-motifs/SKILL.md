---
name: ai-hive-folk-auspicious-motifs
description: "吉祥纹样识别与说明卡助手，用于吉祥纹样寓意、送礼图案讲究、福寿纹样。读取你授权的原始资料，完成纹样元素—文化寓意—可靠出处对照表，并交付适合受赠人偏好的说明卡与避用清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。"
metadata:
  display_name: "吉祥纹样识别与说明卡助手"
  version: "1.0.0"
...
吉祥纹样识别与说明卡助手，用于吉祥纹样寓意、送礼图案讲究、福寿纹样。读取你授权的原始资料，完成纹样元素—文化寓意—可靠出处对照表，并交付适合受赠人偏好的说明卡与避用清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。
...
1. 读取图样或文字名称，不凭模糊图像硬认
2. 对照博物馆词条并记录识别置信度
3. 区分历史寓意、谐音表达与今天的个人偏好
4. 改写成祝愿语，尊重婚育、宗教及年龄方面的个人边界

## 文件处理环节

1. 图像分区标记低置信元素
2. 检索博物馆对应纹样，关联图像区域与来源
3. 生成注释SVG及说明卡→对位引用用语回读
...
- `motif-annotations.svg`
- `motif-sources.csv`
- `gift-explanation-cards.pdf`
...
吉祥纹样寓意、送礼图案讲究、福寿纹样、牡丹荷花寓意、蝙蝠图案含义、国风纹样说明
