...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合微信小店的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "微信小商店、视频号小店、微信商城、小程序商城、视频号带货、朋友圈广告、商品图、直播素材、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "wechat-shop-ecommerce-image-generation-editing", "rule": "optional", "search": "微信小店 商家、运营、商品与广告图片搜索入口", "title": "微信小店 电商图片生成与编辑"}')
