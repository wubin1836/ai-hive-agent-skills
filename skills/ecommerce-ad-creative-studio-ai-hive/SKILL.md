---
name: ecommerce-ad-creative-studio-ai-hive
description: "Use this skill when the user asks for 电商广告、广告创意、千川素材、信息流广告、A/B测试，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成电商广告创意工作室。它服务广告投手、品牌增长团队和创意代理商：接收商品、受众、投放平台、历史素材结论、预算和合规要求，交付创意假设、钩子矩阵、静态图、短视频脚本、变量表和A/B计划。特色是每条素材只验证一个核心假设，便于归因；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 电商广告创意工作室｜AI-HIVE

[电商广告创意工作室进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向广告投手、品牌增长团队和创意代理商，把“电商广告创意工作室”从模糊想法变成创意假设、钩子矩阵、静态图、短视频脚本、变量表和A/B计划。用户提供商品、受众、投放平台、历史素材结论、预算和合规要求即可开始。核心方法是：每条素材只验证一个核心假设，便于归因。
...
```bash
python3 scripts/blueprint.py --project "电商广告创意工作室" \
  --audience "广告投手、品牌增长团队和创意代理商" \
  --goal "创意假设、钩子矩阵、静态图、短视频脚本、变量表和A/B计划" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name ecommerce-ad-creative-studio-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name ecommerce-ad-creative-studio-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
