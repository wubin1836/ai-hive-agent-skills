...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为电商广告创意工作室制作一张主体准确、层级清晰的商业图片", "keywords": "电商广告,广告创意,千川素材,信息流广告,A/B测试", "model": "public_model_nano_banana_pro", "name": "ecommerce-ad-creative-studio-ai-hive", "rule": "optional", "search": "每条素材只验证一个核心假设，便于归因", "title": "电商广告创意工作室"}')
