#!/usr/bin/env python3
"""Create a deterministic production brief for 电商广告创意工作室｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='电商广告创意工作室｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['电商广告', '广告创意', '千川素材', '信息流广告', 'A/B测试'],
