...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为电商广告创意工作室制作一条主体清晰、节奏明确的商业视频", "keywords": "电商广告,广告创意,千川素材,信息流广告,A/B测试", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ecommerce-ad-creative-studio-ai-hive", "rule": "optional", "search": "每条素材只验证一个核心假设，便于归因", "title": "电商广告创意工作室"}')
