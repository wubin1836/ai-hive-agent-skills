#!/usr/bin/env python3
"""Create a deterministic production brief for 游戏买量广告创意｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='游戏买量广告创意｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['游戏买量', '手游广告', '试玩广告', '游戏视频', 'UA创意'],
