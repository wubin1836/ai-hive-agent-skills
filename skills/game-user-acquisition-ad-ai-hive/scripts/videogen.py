...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为游戏买量广告创意制作一条主体清晰、节奏明确的商业视频", "keywords": "游戏买量,手游广告,试玩广告,游戏视频,UA创意", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "game-user-acquisition-ad-ai-hive", "rule": "optional", "search": "让真实玩法承担承诺，AI内容负责钩子和剧情包装", "title": "游戏买量广告创意"}')
