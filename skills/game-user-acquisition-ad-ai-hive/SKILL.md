---
name: game-user-acquisition-ad-ai-hive
description: "Use this skill when the user asks for 游戏买量、手游广告、试玩广告、游戏视频、UA创意，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成游戏买量广告创意。它服务手游、小游戏、发行和买量创意团队：接收真实游戏录屏、玩法说明、角色授权、平台、地区、时长和KPI，交付广告概念、真实玩法锚点、钩子、剧情包装、视频变体和披露检查。特色是让真实玩法承担承诺，AI内容负责钩子和剧情包装；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 游戏买量广告创意｜AI-HIVE

[游戏买量广告创意进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向手游、小游戏、发行和买量创意团队，把“游戏买量广告创意”从模糊想法变成广告概念、真实玩法锚点、钩子、剧情包装、视频变体和披露检查。用户提供真实游戏录屏、玩法说明、角色授权、平台、地区、时长和KPI即可开始。核心方法是：让真实玩法承担承诺，AI内容负责钩子和剧情包装。
...
不得用与真实玩法无关的假游戏画面误导下载；角色、IP和商店评分必须真实授权。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "游戏买量广告创意" \
  --audience "手游、小游戏、发行和买量创意团队" \
  --goal "广告概念、真实玩法锚点、钩子、剧情包装、视频变体和披露检查" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name game-user-acquisition-ad-ai-hive
