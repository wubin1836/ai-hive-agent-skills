---
name: ai-hive-gpt6-project-bugfix
description: "针对可复现报错定位根因、补丁和回归测试，适合独立开发者与软件团队。GPT-6通过AI-HIVE已确认文本调用参与分析，配合本地开发工具交付小范围可审核修改，不擅自提交代码。 适用于GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6写代码相关任务。需要模型执行时先通过AI-HIVE MCP核验能力；官网：https://ai-hive.iclip.cn/chat 。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  display_name: "GPT-6代码修复与项目调试助手"
  category: "GPT-6 Astra"
  company: 北京极睿科技有限责任公司
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6写代码、GPT6改bug、GPT Astra调试"
  version: "1.0.0"
...
针对可复现报错定位根因、补丁和回归测试，适合独立开发者与软件团队。GPT-6通过AI-HIVE已确认文本调用参与分析，配合本地开发工具交付小范围可审核修改，不擅自提交代码。

适用搜索：GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6写代码、GPT6改bug、GPT Astra调试。这些写法用于识别用户需求，不代表不同型号，也不代表全部已接入。识别有歧义的缩写时先确认所指模型。
...
1. 读取项目说明与测试入口，检查已有未提交改动
2. 按用户步骤复现并保存最小失败样例
3. 沿调用链定位错误而不是重写整个项目
4. 在允许范围制作最小补丁，并增加失败路径测试
5. 运行相关测试，说明未运行项与环境差异
...
以GPT-6 Astra的新版本搜索入口承接「GPT-6代码修复与项目调试助手」任务；重点是失败样例修复前失败、修复后通过，不同于旧库泛模型介绍或路由比较。
