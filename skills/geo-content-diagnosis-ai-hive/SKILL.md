---
name: geo-content-diagnosis-ai-hive
description: "Use this skill when the user asks for GEO诊断、AEO优化、AI搜索可见度、内容审计、结构化问答，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成GEO 内容诊断与优化。它服务网站运营、品牌内容团队和AI搜索增长顾问：接收现有页面或文本、目标问题、公开证据、受众和转化目标，交付可引用性评分、事实缺口、结构问题、改写建议和验证计划。特色是明确区分可观察问题、推断和待验证项；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# GEO 内容诊断与优化｜AI-HIVE

[GEO 内容诊断与优化进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向网站运营、品牌内容团队和AI搜索增长顾问，把“GEO 内容诊断与优化”从模糊想法变成可引用性评分、事实缺口、结构问题、改写建议和验证计划。用户提供现有页面或文本、目标问题、公开证据、受众和转化目标即可开始。核心方法是：明确区分可观察问题、推断和待验证项。
...
```bash
python3 scripts/blueprint.py --project "GEO 内容诊断与优化" \
  --audience "网站运营、品牌内容团队和AI搜索增长顾问" \
  --goal "可引用性评分、事实缺口、结构问题、改写建议和验证计划" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name geo-content-diagnosis-ai-hive
