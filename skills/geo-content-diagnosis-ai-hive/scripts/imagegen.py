...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为GEO 内容诊断与优化制作一张主体准确、层级清晰的商业图片", "keywords": "GEO诊断,AEO优化,AI搜索可见度,内容审计,结构化问答", "model": "public_model_gpt_image_2", "name": "geo-content-diagnosis-ai-hive", "rule": "optional", "search": "明确区分可观察问题、推断和待验证项", "title": "GEO 内容诊断与优化"}')
