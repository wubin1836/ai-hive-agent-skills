...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI视频穿帮检测制作一条主体清晰、节奏明确的商业视频", "keywords": "视频穿帮,AI视频质检,连续性检查,角色一致性,商品视频审核", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ai-video-continuity-check-ai-hive", "rule": "optional", "search": "按时间轴找可观察穿帮，并给出重剪或重生成方案", "title": "AI视频穿帮检测"}')
