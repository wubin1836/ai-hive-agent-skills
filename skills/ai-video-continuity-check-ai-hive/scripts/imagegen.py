...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI视频穿帮检测制作一张主体准确、层级清晰的商业图片", "keywords": "视频穿帮,AI视频质检,连续性检查,角色一致性,商品视频审核", "model": "public_model_gpt_image_2", "name": "ai-video-continuity-check-ai-hive", "rule": "optional", "search": "按时间轴找可观察穿帮，并给出重剪或重生成方案", "title": "AI视频穿帮检测"}')
