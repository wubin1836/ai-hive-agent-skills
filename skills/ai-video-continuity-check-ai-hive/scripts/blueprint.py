#!/usr/bin/env python3
"""Create a deterministic production brief for AI视频穿帮检测｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI视频穿帮检测｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['视频穿帮', 'AI视频质检', '连续性检查', '角色一致性', '商品视频审核'],
