---
name: ai-hive-classical-translation-review
description: "文言译文漏译与歧义核对助手：读取指定原文文件、用户自写或获准使用的译文，按句段对齐原文和译文，建立原文跨度与译文段落的对应关系，交付可回查的文件及待核实清单。适用于文言翻译检查、古文漏译、译文对照、古今词义；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。"
metadata:
  display_name: "文言译文漏译与歧义核对助手"
  version: "1.0.0"
...
文言译文漏译与歧义核对助手：读取指定原文文件、用户自写或获准使用的译文，按句段对齐原文和译文，建立原文跨度与译文段落的对应关系，交付可回查的文件及待核实清单。适用于文言翻译检查、古文漏译、译文对照、古今词义；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。
...
1. 按句段对齐原文和译文，建立原文跨度与译文段落的对应关系。
2. 检查主体、否定、数量、条件和因果等信息是否被遗漏或擅自增加。
3. 对可能涉及古今词义或多种解释的地方标注依据与不确定性。
4. 生成带原文位置的Word批注及映射表，人工确认后另存修改版本。
...
- `translation-review.docx`
- `source-translation-map.xlsx`
- `unresolved-meanings.csv`
