#!/usr/bin/env python3
"""Create a deterministic production brief for LLMO 大模型内容优化与可见度监测."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='LLMO 大模型内容优化与可见度监测')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['LLMO', '大模型优化', 'AI可见度监测', 'AI品牌提及'],
