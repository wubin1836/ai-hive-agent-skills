...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"r2v\", \"models\": {\"r2v\": \"public_model_happyhorse_r2v\"}, \"name\": \"happy-horse-audio-reference-to-video\", \"rule\": \"audio\", \"title\": \"Happy Horse Audio Reference to Video\"}")
