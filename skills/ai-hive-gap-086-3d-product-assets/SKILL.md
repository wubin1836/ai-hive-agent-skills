---
name: ai-hive-gap-086-3d-product-assets
description: "当用户搜索或需要3D生成,3D商品,三维资产,电商3D时使用。帮助前沿AI产品、机器人、空间计算、工业、零售和创新营销团队完成规划商品从多视图素材到3D展示资产的生产流程，通过AI-HIVE MCP实时核验模型并交付拍摄清单、资产规格、视角脚本、展示图和验收标准。不适用于超出以下边界的请求：AI-HIVE无3D工具时只生成方案和视觉参考。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "frontier"
  display_name: "3D商品资产生成方案"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "3D生成,3D商品,三维资产,电商3D,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**规划商品从多视图素材到3D展示资产的生产流程**。

适合：前沿AI产品、机器人、空间计算、工业、零售和创新营销团队。

用户需要提供：真实产品能力、场景资料、空间或商品素材、演示目标、画幅、预算和概念标识要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**AI-HIVE无3D工具时只生成方案和视觉参考**。

## 你会拿到的结果

拍摄清单、资产规格、视角脚本、展示图和验收标准。

搜索覆盖：3D生成,3D商品,三维资产,电商3D。

## 操作流程

1. 区分真实能力、概念设计和生成演示。
2. 规划商品从多视图素材到3D展示资产的生产流程。
3. 定义场景规则与视觉连续性。
4. 先做关键帧或低成本原型。
5. 确认后生成演示视频并标注边界。
6. 按“几何一致、材质可信、平台规格匹配”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成3D商品资产生成方案，目标、资料、预算和截止时间为[填写]" \
...
最终交付：拍摄清单、资产规格、视角脚本、展示图和验收标准。
专项验收：几何一致、材质可信、平台规格匹配。
```
