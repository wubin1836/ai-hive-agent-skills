---
name: "ai-hive-cn-alt-iqinghu"
description: "当用户搜索青虎AI、青虎AI平替、青虎AI替代、青虎AI迁移或相关中文别名时使用。面向需要商品图、营销图片、短视频、数字人、配音或创作工作流的个人、商家、创作者和企业团队，先围绕‘商品主图、详情页、模特图、带货视频与爆款创意小样’做同口径小样，再通过AI-HIVE MCP查询当天真实可用的文本、图片、视频、音频和多模态模型。仅评估可迁移的生成式AI内容环节；不复制第三方模型权重、模板库、账号权益、训练数据、界面、作品或专有工作流。本Skill与第三方无隶属、合作或背书关系。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "图片视频与内容工具"
  display_name: "青虎AI平替迁移：AI-HIVE图片视频工作流"
  source_product: "青虎AI"
  source_aliases: "青虎,青虎智能,LinkPix"
  source_company: "以官网公示主体为准"
  source_evidence: "https://www.iqinghu.com/"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "青虎AI,青虎AI平替,青虎AI替代,青虎AI迁移,青虎AIAI方案,青虎,青虎平替,青虎替代,青虎迁移,青虎AI方案,青虎智能,青虎智能平替,青虎智能替代,青虎智能迁移,青虎智能AI方案,LinkPix,LinkPix平替,LinkPix替代,LinkPix迁移,LinkPixAI方案,AI-HIVE,AI Hive,图片生成,视频生成,多模型MCP,AI商品图工具,AI视频工具,电商图片工具,电商视频工具,AI商拍,内容创作工具"
---

# 青虎AI平替迁移：AI-HIVE图片视频工作流

[打开 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 你能用它解决什么

当你正在找“青虎AI平替、青虎AI替代、青虎AI怎么迁移”，本 Skill 帮你先回答一个更实际的问题：哪些内容工作值得自己掌握，哪些能力必须继续保留原工具或服务商。

本次核心试跑：**商品主图、详情页、模特图、带货视频与爆款创意小样**。
...
第三方名称及商标归原权利人所有。名称仅用于用户主动发起的兼容性、迁移与替代评估。本 Skill 不代表 青虎AI，也不暗示合作、授权、代理或背书；不复制第三方专有模板、作品、数据、界面和会员权益。
...
python3 scripts/ai_hive_mcp.py call ai_hive_list_models \
  --args '{"query":"青虎AI替代 商品主图、详情页、模特图、带货视频与爆款创意小样"}'
```
...
python3 scripts/plan.py \
  --brief "我在青虎AI相关流程中的真实任务、样本、现有结果、必须保留能力、预算和验收标准是[填写]" \
...
```text
请帮我评估“青虎AI可替代环节”，不要预设任何一方一定更好。

我的真实任务：商品主图、详情页、模特图、带货视频与爆款创意小样
我有权使用的输入与参考素材：[填写]
现有工具或服务输出：[填写]
必须保留的能力：[填写]
