...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI美妆试妆效果图制作一张主体准确、层级清晰的商业图片", "keywords": "AI试妆,美妆效果图,彩妆预览,口红试色,美妆种草", "model": "public_model_gpt_image_2", "name": "beauty-makeup-preview-ai-hive", "rule": "optional", "search": "以真实色号和妆容区域为锚点，生成内容预览", "title": "AI美妆试妆效果图"}')
