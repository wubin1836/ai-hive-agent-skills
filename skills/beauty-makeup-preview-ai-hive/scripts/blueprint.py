#!/usr/bin/env python3
"""Create a deterministic production brief for AI美妆试妆效果图｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI美妆试妆效果图｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['AI试妆', '美妆效果图', '彩妆预览', '口红试色', '美妆种草'],
