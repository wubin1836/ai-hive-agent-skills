---
name: beauty-makeup-preview-ai-hive
description: "Use this skill when the user asks for AI试妆、美妆效果图、彩妆预览、口红试色、美妆种草，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成AI美妆试妆效果图。它服务美妆品牌、彩妆商家、达人和内容营销团队：接收授权人像、产品色号与真实效果资料、场景、光线和平台，交付妆容风格预览、色彩方案、步骤配图与多个肤色版本。特色是以真实色号和妆容区域为锚点，生成内容预览；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# AI美妆试妆效果图｜AI-HIVE

[AI美妆试妆效果图进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向美妆品牌、彩妆商家、达人和内容营销团队，把“AI美妆试妆效果图”从模糊想法变成妆容风格预览、色彩方案、步骤配图与多个肤色版本。用户提供授权人像、产品色号与真实效果资料、场景、光线和平台即可开始。核心方法是：以真实色号和妆容区域为锚点，生成内容预览。
...
不得把生成效果当作真实功效、肤质改善或精确色差证明；需要标注AI视觉预览。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "AI美妆试妆效果图" \
  --audience "美妆品牌、彩妆商家、达人和内容营销团队" \
  --goal "妆容风格预览、色彩方案、步骤配图与多个肤色版本" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name beauty-makeup-preview-ai-hive
