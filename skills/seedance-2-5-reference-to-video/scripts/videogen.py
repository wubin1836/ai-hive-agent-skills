...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"r2v\", \"models\": {\"r2v\": \"public_model_seedance_2_5_r2v\"}, \"name\": \"seedance-2-5-reference-to-video\", \"rule\": \"reference\", \"title\": \"Seedance 2.5 Reference to Video\"}")
