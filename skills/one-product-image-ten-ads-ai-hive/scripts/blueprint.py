#!/usr/bin/env python3
"""Create a deterministic production brief for 一张商品图生成10条广告｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='一张商品图生成10条广告｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['一图生成视频', '10条广告', '批量广告', '商品图转视频', 'A/B测试'],
