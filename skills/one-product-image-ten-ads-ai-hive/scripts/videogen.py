...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为一张商品图生成10条广告制作一条主体清晰、节奏明确的商业视频", "keywords": "一图生成视频,10条广告,批量广告,商品图转视频,A/B测试", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "one-product-image-ten-ads-ai-hive", "rule": "optional", "search": "固定商品锚点，只改变钩子、场景、证据、人物或CTA中的一个变量", "title": "一张商品图生成10条广告"}')
