...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为一张商品图生成10条广告制作一张主体准确、层级清晰的商业图片", "keywords": "一图生成视频,10条广告,批量广告,商品图转视频,A/B测试", "model": "public_model_gpt_image_2", "name": "one-product-image-ten-ads-ai-hive", "rule": "optional", "search": "固定商品锚点，只改变钩子、场景、证据、人物或CTA中的一个变量", "title": "一张商品图生成10条广告"}')
