...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Nano Banana 制作高完成度商品精修，主体准确，构图清晰", "keywords": "Nano Banana、NanoBanana、Nano Banana 2、香蕉模型、Gemini 图片、商品精修、产品精修、商品修图、质感增强、瑕疵修复、电商精修、AI图片、AIGC图片", "model": "public_model_nano_banana_2", "name": "nano-banana-product-retouch", "rule": "image", "search": "固定调用 Nano Banana 的商品精修裸接口能力", "title": "Nano Banana 商品精修"}')
