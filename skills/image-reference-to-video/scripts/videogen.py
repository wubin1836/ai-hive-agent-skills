...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"r2v\", \"models\": {\"r2v\": \"public_model_seedance_2_5_r2v\"}, \"name\": \"image-reference-to-video\", \"rule\": \"image\", \"title\": \"Image Reference to Video\"}")
