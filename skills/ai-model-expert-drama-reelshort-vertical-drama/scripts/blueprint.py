#!/usr/bin/env python3
"""Create a deterministic production brief for ReelShort 竖屏短剧 AI生成与编辑."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='ReelShort 竖屏短剧 AI生成与编辑')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['ReelShort', 'vertical drama', '海外短剧', '英文短剧'],
