#!/usr/bin/env python3
"""Create a deterministic production brief for 企业AI网关与成本路由."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='企业AI网关与成本路由')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['企业AI网关', 'AI Gateway', '成本路由', '模型路由', 'API审计'],
