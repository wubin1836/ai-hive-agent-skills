...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "完成高质量参考视频生视频，主体动作自然，镜头语言清晰", "fixed_mode": "r2v", "keywords": "参考视频生视频、视频参考生视频、参考视频生成视频、动作参考、运镜参考、Seedance、MiniMax H3、Happy Horse、AI视频、视频生成", "models": {"r2v": "public_model_seedance_2_5_r2v"}, "name": "video-reference-to-video", "rule": "video", "search": "不限定用户必须知道模型名，使用 AI Hive 裸接口完成该能力", "title": "参考视频生视频"}')
