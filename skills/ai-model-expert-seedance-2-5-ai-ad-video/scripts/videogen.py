...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一条高完成度AI 广告视频，主体明确，节奏清晰，结尾有记忆点", "keywords": "Seedance2.5、Seedance 2.5、字节 Seedance、豆包 Seedance、即梦视频、AI 广告视频、AI广告、广告片、品牌广告、商业广告、信息流广告、AI视频、视频生成", "models": {"i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "seedance-2-5-ai-ad-video", "rule": "optional", "search": "使用 Seedance 2.5 制作AI 广告视频", "title": "Seedance 2.5 AI 广告视频"}')
