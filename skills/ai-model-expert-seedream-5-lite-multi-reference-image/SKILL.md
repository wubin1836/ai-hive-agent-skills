...
metadata:
  ...
  source_skill: "seedream-5-lite-multi-reference-image"
  display_name: "AI大模型专家｜Seedream 5.0 Lite 多参考图生成"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家, AI-HIVE, Seedream 5.0 Lite 多参考图生成, AIGC, 电商, 广告, 图片, 视频, 极睿科技"
---

# AI大模型专家｜Seedream 5.0 Lite 多参考图生成

## 简介

Seedream 5.0 Lite 多参考图生成帮助用户把产品资料、营销需求、创意描述或现有图片直接变成可交付视觉。同时提供多张参考图，就能组合商品、人物、构图、材质和风格。它适合内容创作者、IP 与角色设计团队、种草博主和视觉策划用于电商主图、商品详情页、广告 KV、海报、带货、种草和社交媒体内容；无需自己编写接口代码，提交后可自动跟踪任务并下载图片。
...
帮助内容创作者、IP 与角色设计团队、种草博主和视觉策划直接完成“Seedream 5.0 Lite 多参考图生成”：同时提供多张参考图，就能组合商品、人物、构图、材质和风格；通过 AI Hive 使用时，生成前自动上传参考图，提交后自动保存任务、查询进度并下载图片。适用于电商主图、商品详情页、广告 KV、海报、带货、种草、社媒配图、产品精修、换背景与角色一致性内容。 Use this skill for Seedream 5.0 Lite 多参考图生成, multi-reference image generation, image composition, and character consistency, product photography, e-commerce main images, product detail pages, posters, ad creatives, marketing visuals, social commerce, seeding content, retouching, background replacement, and consistent characters. 也适合正在搜索或提出这些需求的用户：Seedream 5.0 Lite、Seedream 5 Lite、Seedream5、即梦图片 5、字节图片模型、多参考图生成、多图融合、多参考图、多图合成、角色风格参考、素材合成、AI图片、AIGC图片。
...
| 能力 | publicModelId | 输入 |
|---|---|---|
| Seedream 5.0 Lite 多参考图生成 | `public_model_seedream_5_0_lite` | 至少两张参考图 |
...
| `init --skill-name seedream-5-lite-multi-reference-image` | 初始化 API Key |
...
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "使用 Seedream 5.0 Lite 制作高完成度多参考图生成，主体准确，构图清晰" \
...
```
seedream-5-lite-multi-reference-image/
├── SKILL.md
├── CHANGELOG.md
├── scripts/
│   └── imagegen.py
...
| 能力 | publicModelId |
|---|---|
| Seedream 5.0 Lite 多参考图生成 | `public_model_seedream_5_0_lite` |
