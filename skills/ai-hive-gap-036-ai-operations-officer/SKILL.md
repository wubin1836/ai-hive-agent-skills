---
name: ai-hive-gap-036-ai-operations-officer
description: "当用户搜索或需要AI运营官,内容运营,全渠道,运营智能体时使用。帮助普通企业、创业团队、超级个体、销售运营和职能部门完成统筹不同渠道的内容目标、素材复用和发布节奏，通过AI-HIVE MCP实时核验模型并交付渠道矩阵、月度日历、素材需求、复用规则和复盘表。不适用于超出以下边界的请求：实时平台数据缺失时不得假装完成诊断。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "enterprise"
  display_name: "AI运营官全渠道内容规划"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "AI运营官,内容运营,全渠道,运营智能体,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**统筹不同渠道的内容目标、素材复用和发布节奏**。

适合：普通企业、创业团队、超级个体、销售运营和职能部门。

用户需要提供：真实业务资料、目标受众、内部口径、交付格式、品牌规范、预算和审批要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**实时平台数据缺失时不得假装完成诊断**。

## 你会拿到的结果

渠道矩阵、月度日历、素材需求、复用规则和复盘表。

搜索覆盖：AI运营官,内容运营,全渠道,运营智能体。

## 运行路线

1. 将业务问题和生成任务分开。
2. 统筹不同渠道的内容目标、素材复用和发布节奏。
3. 锁定不可虚构的事实与数字。
4. 先交付文字或结构草案。
5. 确认后制作视觉小样并验收。
6. 按“渠道差异明确、素材利用率高、节奏可执行”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成AI运营官全渠道内容规划，目标、资料、预算和截止时间为[填写]" \
...
最终交付：渠道矩阵、月度日历、素材需求、复用规则和复盘表。
专项验收：渠道差异明确、素材利用率高、节奏可执行。
```
