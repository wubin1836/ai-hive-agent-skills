...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI UGC广告生成器制作一张主体准确、层级清晰的商业图片", "keywords": "AI UGC广告,UGC视频,真人感广告,带货视频,电商广告", "model": "public_model_nano_banana_pro", "name": "ai-ugc-ad-generator-ai-hive", "rule": "optional", "search": "让广告像真实体验分享，但所有证言和效果必须有依据", "title": "AI UGC广告生成器"}')
