...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI UGC广告生成器制作一条主体清晰、节奏明确的商业视频", "keywords": "AI UGC广告,UGC视频,真人感广告,带货视频,电商广告", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ai-ugc-ad-generator-ai-hive", "rule": "optional", "search": "让广告像真实体验分享，但所有证言和效果必须有依据", "title": "AI UGC广告生成器"}')
