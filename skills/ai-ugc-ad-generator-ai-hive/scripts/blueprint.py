#!/usr/bin/env python3
"""Create a deterministic production brief for AI UGC广告生成器｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI UGC广告生成器｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['AI UGC广告', 'UGC视频', '真人感广告', '带货视频', '电商广告'],
