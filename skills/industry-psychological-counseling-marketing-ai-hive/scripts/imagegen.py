...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为心理咨询制作主体准确、事实可核验的图片营销素材", "model": "public_model_nano_banana_pro", "name": "industry-psychological-counseling-marketing-ai-hive", "title": "AI大模型专家｜心理咨询AI图片视频营销", "keywords": "心理咨询、心理机构、心理服务、心理工作室、AI图片、AI短视频、视频编辑、内容营销、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前图片/视频模型与价格快照，不硬编码价格"}')
