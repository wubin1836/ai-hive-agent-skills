...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为小红书本地生活门店团购营销制作事实可核验的本地生活营销图片", "model": "public_model_nano_banana_pro", "name": "local-xiaohongshu-life-groupbuy-ai-hive", "title": "AI大模型专家｜小红书本地生活门店团购营销", "keywords": "小红书本地生活、小红书探店、小红书同城、小红书门店、小红书团购、门店团购营销、本地生活、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前模型与价格，并在平台官方后台核对当前规则"}')
