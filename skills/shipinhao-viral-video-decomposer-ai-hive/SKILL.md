---
name: shipinhao-viral-video-decomposer-ai-hive
description: "Use this skill when the user asks for 视频号爆款、爆款拆解、带货视频、短视频复刻、微信视频号，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成视频号爆款短视频拆解。它服务视频号运营者、品牌内容团队和带货商家：接收一条已获授权的参考视频、商品信息、目标人群和账号定位，交付爆点摘要、黄金3秒、逐镜结构、原创改写脚本和复刻分镜。特色是把参考视频拆成可迁移的结构变量，而不是照搬台词和画面；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 视频号爆款短视频拆解｜AI-HIVE

[视频号爆款短视频拆解进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向视频号运营者、品牌内容团队和带货商家，把“视频号爆款短视频拆解”从模糊想法变成爆点摘要、黄金3秒、逐镜结构、原创改写脚本和复刻分镜。用户提供一条已获授权的参考视频、商品信息、目标人群和账号定位即可开始。核心方法是：把参考视频拆成可迁移的结构变量，而不是照搬台词和画面。
...
```bash
python3 scripts/blueprint.py --project "视频号爆款短视频拆解" \
  --audience "视频号运营者、品牌内容团队和带货商家" \
  --goal "爆点摘要、黄金3秒、逐镜结构、原创改写脚本和复刻分镜" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name shipinhao-viral-video-decomposer-ai-hive
