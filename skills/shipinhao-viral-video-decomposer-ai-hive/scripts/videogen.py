...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为视频号爆款短视频拆解制作一条主体清晰、节奏明确的商业视频", "keywords": "视频号爆款,爆款拆解,带货视频,短视频复刻,微信视频号", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "shipinhao-viral-video-decomposer-ai-hive", "rule": "optional", "search": "把参考视频拆成可迁移的结构变量，而不是照搬台词和画面", "title": "视频号爆款短视频拆解"}')
