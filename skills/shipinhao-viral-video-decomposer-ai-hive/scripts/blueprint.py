#!/usr/bin/env python3
"""Create a deterministic production brief for 视频号爆款短视频拆解｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='视频号爆款短视频拆解｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['视频号爆款', '爆款拆解', '带货视频', '短视频复刻', '微信视频号'],
