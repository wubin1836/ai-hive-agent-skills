...
metadata:
  ...
  source_skill: "seedance-short-drama-video"
  display_name: "AI大模型专家｜Seedance 短剧视频"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家, AI-HIVE, Seedance 短剧视频, AIGC, 电商, 广告, 图片, 视频, 极睿科技"
---

# AI大模型专家｜Seedance 短剧视频

## 简介

Seedance 短剧视频帮助用户把创意、脚本或已有素材直接变成可交付视频。既可只输入文字从零生成，也可加入图片、视频或音频控制结果。它适合短视频创作者、种草博主、短剧与漫剧团队、分镜师用于广告、电商、TVC、带货、种草、短剧、漫剧和社交媒体内容制作；无需自己编写接口代码，提交后可自动跟踪任务并下载成片。
...
| `init --skill-name seedance-short-drama-video` | 初始化 API Key |
