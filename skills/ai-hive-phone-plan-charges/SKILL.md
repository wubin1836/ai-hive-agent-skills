---
name: ai-hive-phone-plan-charges
description: "手机宽带套餐扣费核对助手，用于话费怎么这么多、宽带套餐扣费、增值业务扣费。读取你授权的原始资料，完成套餐合同与账单逐项对照，并交付客服沟通要点。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "手机宽带套餐扣费核对助手"
  version: "1.0.0"
...
手机宽带套餐扣费核对助手，用于话费怎么这么多、宽带套餐扣费、增值业务扣费。读取你授权的原始资料，完成套餐合同与账单逐项对照，并交付客服沟通要点。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 用脱敏套餐说明和账单区分基础费、超量、设备与增值项目
2. 逐期复算优惠到期及实际用量，保留无法解释项目，不编造开通同意记录
3. 给出查证和沟通清单，不自动退订、改套餐或承诺退费
...
- `phone-plan-charges-checklist.xlsx`
- `phone-plan-charges-evidence.docx`
- `phone-plan-charges-sources.json`
...
话费怎么这么多、宽带套餐扣费、增值业务扣费、合约期怎么看、手机套餐账单
