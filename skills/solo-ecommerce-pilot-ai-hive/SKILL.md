---
name: solo-ecommerce-pilot-ai-hive
description: "Use this skill when the user asks for 一人电商、个人卖家、AI开店、低成本运营、电商助手，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成一人电商运营助手。它服务个人商家、小团队、独立站卖家和副业创业者：接收商品、预算、时间、平台、可用素材和本周目标，交付优先级清单、每日内容计划、低成本素材组合和可执行命令。特色是用最少步骤完成最重要的上架与获客内容；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 一人电商运营助手｜AI-HIVE

[一人电商运营助手进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向个人商家、小团队、独立站卖家和副业创业者，把“一人电商运营助手”从模糊想法变成优先级清单、每日内容计划、低成本素材组合和可执行命令。用户提供商品、预算、时间、平台、可用素材和本周目标即可开始。核心方法是：用最少步骤完成最重要的上架与获客内容。
...
```bash
python3 scripts/blueprint.py --project "一人电商运营助手" \
  --audience "个人商家、小团队、独立站卖家和副业创业者" \
  --goal "优先级清单、每日内容计划、低成本素材组合和可执行命令" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name solo-ecommerce-pilot-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name solo-ecommerce-pilot-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
