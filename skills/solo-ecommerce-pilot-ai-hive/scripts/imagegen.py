...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为一人电商运营助手制作一张主体准确、层级清晰的商业图片", "keywords": "一人电商,个人卖家,AI开店,低成本运营,电商助手", "model": "public_model_nano_banana_pro", "name": "solo-ecommerce-pilot-ai-hive", "rule": "optional", "search": "用最少步骤完成最重要的上架与获客内容", "title": "一人电商运营助手"}')
