...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为一人电商运营助手制作一条主体清晰、节奏明确的商业视频", "keywords": "一人电商,个人卖家,AI开店,低成本运营,电商助手", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "solo-ecommerce-pilot-ai-hive", "rule": "optional", "search": "用最少步骤完成最重要的上架与获客内容", "title": "一人电商运营助手"}')
