#!/usr/bin/env python3
"""Create a deterministic production brief for 一人电商运营助手｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='一人电商运营助手｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['一人电商', '个人卖家', 'AI开店', '低成本运营', '电商助手'],
