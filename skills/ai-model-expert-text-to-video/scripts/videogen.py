...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "完成高质量文生视频，主体动作自然，镜头语言清晰", "fixed_mode": "t2v", "keywords": "文生视频、文字生成视频、文本转视频、text to video、T2V、Seedance、MiniMax H3、Happy Horse、AI视频、视频生成", "models": {"t2v": "public_model_seedance_2_5_t2v"}, "name": "text-to-video", "rule": "none", "search": "不限定用户必须知道模型名，使用 AI Hive 裸接口完成该能力", "title": "文生视频"}')
