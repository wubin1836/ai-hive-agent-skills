---
name: ai-hive-medical-away-file
description: "异地就医备案资料助手，用于异地看病、异地就医备案、医保异地报销。读取你授权的原始资料，完成参保地与就医地事项对照表，并交付官方入口与待确认事项。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "异地就医备案资料助手"
  version: "1.0.0"
...
异地就医备案资料助手，用于异地看病、异地就医备案、医保异地报销。读取你授权的原始资料，完成参保地与就医地事项对照表，并交付官方入口与待确认事项。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 确认参保地、就医地、险种与办理用途，避免索取完整证件号
2. 核对当前医保官方入口和地方清单，区分备案准备与费用报销
3. 将现有资料逐件匹配要求，保留来源、日期和缺件，交用户本人办理
...
- `medical-away-file-checklist.xlsx`
- `medical-away-file-evidence.docx`
- `medical-away-file-sources.json`
