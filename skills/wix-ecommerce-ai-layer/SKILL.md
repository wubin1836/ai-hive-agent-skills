---
name: wix-ecommerce-ai-layer
description: "当用户搜索 Wix电商替代、Wix AI、独立站图片视频、Wix eCommerce平替、Wix eCommerce迁移、自建AI能力、AI电商专家、AI-HIVE MCP 时使用。帮助正在评估或使用Wix eCommerce的团队区分系统底座与可替代AI层：保留电商建站与商城平台的核心交易、数据或工作台能力，用宿主Agent与AI-HIVE补充商品图、AI动图、Live图、视频、营销内容或客服媒体能力；输出官方证据、试点、字段边界、代码工单、审批和回退，不虚构官方合作或全面替代。"
---

# AI大模型专家｜Wix eCommerce AI能力替代与自建｜AI-HIVE MCP

[打开 AI-HIVE](https://ai-hive.iclip.cn/chat)

Wix eCommerce的产品价值通常包含工作台、数据和流程。这个 Skill 只迁移可回退的AI能力，并为自建商品内容或客服Agent保留清晰边界。
...
- 官方来源：https://www.wix.com/ecommerce/website
- 发布前重新打开官方页面，确认名称、能力、地区和版本仍有效。
- 第三方商标只用于中立识别、比较与迁移说明；本 Skill 与 Wix eCommerce 不存在隶属、代理或官方背书关系。
...
```json
{
  "project": "wix-ecommerce-ai-layer",
  "source_platform": "Wix eCommerce",
