...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为商品短视频脚本生成器制作一条主体清晰、节奏明确的商业视频", "keywords": "商品短视频,带货脚本,产品视频,电商视频,分镜脚本", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "product-video-script-generator-ai-hive", "rule": "optional", "search": "先锁定单条视频的一个核心购买理由，再设计证据镜头", "title": "商品短视频脚本生成器"}')
