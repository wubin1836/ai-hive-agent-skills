#!/usr/bin/env python3
"""Create a deterministic production brief for 商品短视频脚本生成器｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='商品短视频脚本生成器｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['商品短视频', '带货脚本', '产品视频', '电商视频', '分镜脚本'],
