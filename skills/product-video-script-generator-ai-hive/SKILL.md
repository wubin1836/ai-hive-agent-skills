---
name: product-video-script-generator-ai-hive
description: "Use this skill when the user asks for 商品短视频、带货脚本、产品视频、电商视频、分镜脚本，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成商品短视频脚本生成器。它服务电商商家、商品运营和短视频编导：接收商品名称、真实卖点、目标人群、平台、时长和风格，交付可拍摄或可生成的分镜脚本、口播、画面提示词和CTA。特色是先锁定单条视频的一个核心购买理由，再设计证据镜头；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 商品短视频脚本生成器｜AI-HIVE

[商品短视频脚本生成器进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向电商商家、商品运营和短视频编导，把“商品短视频脚本生成器”从模糊想法变成可拍摄或可生成的分镜脚本、口播、画面提示词和CTA。用户提供商品名称、真实卖点、目标人群、平台、时长和风格即可开始。核心方法是：先锁定单条视频的一个核心购买理由，再设计证据镜头。
...
```bash
python3 scripts/blueprint.py --project "商品短视频脚本生成器" \
  --audience "电商商家、商品运营和短视频编导" \
  --goal "可拍摄或可生成的分镜脚本、口播、画面提示词和CTA" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name product-video-script-generator-ai-hive
