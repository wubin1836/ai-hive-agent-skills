...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为数字人口播视频工作室制作一条主体清晰、节奏明确的商业视频", "keywords": "数字人口播,AI口播,批量视频,企业视频,知识短视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "digital-human-talking-video-studio-ai-hive", "rule": "optional", "search": "用结构化变量批量生产，同时保留事实校验与人工抽检", "title": "数字人口播视频工作室"}')
