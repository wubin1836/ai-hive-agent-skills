#!/usr/bin/env python3
"""Create a deterministic production brief for 数字人口播视频工作室｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='数字人口播视频工作室｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['数字人口播', 'AI口播', '批量视频', '企业视频', '知识短视频'],
