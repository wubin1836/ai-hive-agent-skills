---
name: digital-human-talking-video-studio-ai-hive
description: "Use this skill when the user asks for 数字人口播、AI口播、批量视频、企业视频、知识短视频，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成数字人口播视频工作室。它服务需要稳定日更的商家、知识账号和企业内容团队：接收主题、事实资料、数字人素材授权、语气、时长和平台，交付口播稿、镜头背景方案、字幕重点、批量变量表和视频任务。特色是用结构化变量批量生产，同时保留事实校验与人工抽检；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 数字人口播视频工作室｜AI-HIVE

[数字人口播视频工作室进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向需要稳定日更的商家、知识账号和企业内容团队，把“数字人口播视频工作室”从模糊想法变成口播稿、镜头背景方案、字幕重点、批量变量表和视频任务。用户提供主题、事实资料、数字人素材授权、语气、时长和平台即可开始。核心方法是：用结构化变量批量生产，同时保留事实校验与人工抽检。
...
```bash
python3 scripts/blueprint.py --project "数字人口播视频工作室" \
  --audience "需要稳定日更的商家、知识账号和企业内容团队" \
  --goal "口播稿、镜头背景方案、字幕重点、批量变量表和视频任务" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name digital-human-talking-video-studio-ai-hive
