...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "完成高质量图生视频，主体动作自然，镜头语言清晰", "fixed_mode": "i2v", "keywords": "图生视频、图片生成视频、图片转视频、image to video、I2V、首帧生视频、Seedance、MiniMax H3、Happy Horse、AI视频、视频生成", "models": {"i2v": "public_model_seedance_2_5_i2v"}, "name": "image-to-video", "rule": "first", "search": "不限定用户必须知道模型名，使用 AI Hive 裸接口完成该能力", "title": "图生视频"}')
