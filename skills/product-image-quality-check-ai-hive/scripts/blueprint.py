#!/usr/bin/env python3
"""Create a deterministic production brief for AI商品图自动质检｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI商品图自动质检｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['商品图质检', 'AI图片质检', '电商图片审核', '商品准确性', '图片检查'],
