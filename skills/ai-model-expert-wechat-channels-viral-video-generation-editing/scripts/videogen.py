...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "视频号爆款结构，开头建立熟人信任，中段给出具体利益和真实使用情境，结尾引导关注、私信或商品链接", "keywords": "视频号爆款、微信视频号、视频号短视频、私域引流、视频号带货、视频号成片", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "wechat-channels-viral-video-generation-editing", "product_promise": "围绕视频号受众、私域信任和转化目标生成可发布成片，并支持参考视频二创和后续编辑", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "视频号爆款短视频生成与编辑", "trend_inspired": true}')
