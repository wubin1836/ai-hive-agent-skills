#!/usr/bin/env python3
"""Create a deterministic production brief for 抖音商品卡图片工作室｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='抖音商品卡图片工作室｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['抖音商品卡', '抖店主图', '千川图片', '电商素材', '商品广告图'],
