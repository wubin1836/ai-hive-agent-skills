...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为抖音商品卡图片工作室制作一张主体准确、层级清晰的商业图片", "keywords": "抖音商品卡,抖店主图,千川图片,电商素材,商品广告图", "model": "public_model_nano_banana_pro", "name": "douyin-product-card-image-studio-ai-hive", "rule": "optional", "search": "围绕三秒理解与商品识别优化，而不是只追求视觉复杂", "title": "抖音商品卡图片工作室"}')
