---
name: douyin-product-card-image-studio-ai-hive
description: "Use this skill when the user asks for 抖音商品卡、抖店主图、千川图片、电商素材、商品广告图，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成抖音商品卡图片工作室。它服务抖音小店、商品卡运营和千川投放团队：接收商品图、价格机制、活动规则、卖点、受众和尺寸，交付商品卡首图、卖点图、活动图、素材变体和移动端可读性检查。特色是围绕三秒理解与商品识别优化，而不是只追求视觉复杂；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 抖音商品卡图片工作室｜AI-HIVE

[抖音商品卡图片工作室进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向抖音小店、商品卡运营和千川投放团队，把“抖音商品卡图片工作室”从模糊想法变成商品卡首图、卖点图、活动图、素材变体和移动端可读性检查。用户提供商品图、价格机制、活动规则、卖点、受众和尺寸即可开始。核心方法是：围绕三秒理解与商品识别优化，而不是只追求视觉复杂。
...
```bash
python3 scripts/blueprint.py --project "抖音商品卡图片工作室" \
  --audience "抖音小店、商品卡运营和千川投放团队" \
  --goal "商品卡首图、卖点图、活动图、素材变体和移动端可读性检查" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name douyin-product-card-image-studio-ai-hive
