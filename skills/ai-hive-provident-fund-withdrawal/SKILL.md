---
name: ai-hive-provident-fund-withdrawal
description: "公积金提取材料助手，用于公积金怎么取、租房提取公积金、离职提取公积金。读取你授权的原始资料，完成提取原因与官方条件对照，并交付填写前核对单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "公积金提取材料助手"
  version: "1.0.0"
...
公积金提取材料助手，用于公积金怎么取、租房提取公积金、离职提取公积金。读取你授权的原始资料，完成提取原因与官方条件对照，并交付填写前核对单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 确认缴存城市、提取用途和账户事实，不默认余额都能取出
2. 从当地公积金中心核对当前用途分支、资料及限制
3. 逐件核对记录和声明依据，保留未知项，不代登录、签署或提交
...
- `provident-fund-withdrawal-checklist.xlsx`
- `provident-fund-withdrawal-evidence.docx`
- `provident-fund-withdrawal-sources.json`
...
> 仅示例，以下文件名和情境均为假设，不表示已存在真实数据：假设我已提供 示例_缴存城市与提取用途.json、示例_当地提取指南.pdf、示例_用途证明目录.csv。请使用「公积金提取材料助手」，只按我选定的提取用途分支检查材料，列出欠缺证明及不确定限制，不推断全部余额都能提取。将结果写入我指定的本地目录，交付 provident-fund-withdrawal-checklist.xlsx、provident-fund-withdrawal-evidence.docx、provident-fund-withdrawal-sources.json。本例先离线处理；输入、工具或适用规则不足时先交缺口说明，不编造结果。需要联网更新来源先征得我同意，不登录账户、不代提交或付款。

## 搜索与任务识别

公积金怎么取、租房提取公积金、离职提取公积金、公积金提取材料、公积金提取
