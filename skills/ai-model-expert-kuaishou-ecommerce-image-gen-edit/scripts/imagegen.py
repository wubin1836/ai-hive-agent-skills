...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合快手电商的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "快手小店、快手商家、磁力金牛、磁力引擎、带货视频、直播素材、商品图、信息流广告、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "kuaishou-ecommerce-ecommerce-image-generation-editing", "rule": "optional", "search": "快手电商 商家、运营、商品与广告图片搜索入口", "title": "快手电商 电商图片生成与编辑"}')
