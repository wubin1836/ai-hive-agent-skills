#!/usr/bin/env python3
"""Create a deterministic production brief for 视频号短剧 AI生成与编辑."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='视频号短剧 AI生成与编辑')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['微信视频号短剧', '视频号剧情', '私域短剧', '社交短剧'],
