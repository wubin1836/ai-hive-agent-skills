---
name: seamless-loop-video-ai-hive
description: "Use this skill when the user asks for 无缝循环、Loop Video、循环短视频、首尾帧、视觉动效，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成无缝循环短视频生成器。它服务社媒创作者、品牌视觉、音乐内容和广告团队：接收主体、动作、首尾状态、场景、画幅、时长和平台，交付首尾帧设计、循环动作、提示词、视频和循环衔接检查。特色是在生成前定义相同的起止状态，减少后期硬切；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 无缝循环短视频生成器｜AI-HIVE

[无缝循环短视频生成器进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向社媒创作者、品牌视觉、音乐内容和广告团队，把“无缝循环短视频生成器”从模糊想法变成首尾帧设计、循环动作、提示词、视频和循环衔接检查。用户提供主体、动作、首尾状态、场景、画幅、时长和平台即可开始。核心方法是：在生成前定义相同的起止状态，减少后期硬切。
...
不得通过隐藏剪辑伪造商品持续时间、耐用性或实验结果。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "无缝循环短视频生成器" \
  --audience "社媒创作者、品牌视觉、音乐内容和广告团队" \
  --goal "首尾帧设计、循环动作、提示词、视频和循环衔接检查" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name seamless-loop-video-ai-hive
