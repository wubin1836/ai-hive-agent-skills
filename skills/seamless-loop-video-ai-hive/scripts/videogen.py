...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为无缝循环短视频生成器制作一条主体清晰、节奏明确的商业视频", "keywords": "无缝循环,Loop Video,循环短视频,首尾帧,视觉动效", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "seamless-loop-video-ai-hive", "rule": "optional", "search": "在生成前定义相同的起止状态，减少后期硬切", "title": "无缝循环短视频生成器"}')
