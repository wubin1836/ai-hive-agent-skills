#!/usr/bin/env python3
"""Create a deterministic production brief for 无缝循环短视频生成器｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='无缝循环短视频生成器｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['无缝循环', 'Loop Video', '循环短视频', '首尾帧', '视觉动效'],
