...
Seedance 2.5 Video Editing helps creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers edit an existing video with natural-language instructions with Seedance 2.5. Describe the intended subject, action, camera, lighting, pacing, and constraints; the bundled CLI handles AI Hive OpenAPI calls and downloads the finished video.
...
|---|---|---|
| `edit` | Video Editing | `public_model_seedance_2_5_video_edit` |
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name seedance-2-5-video-edit
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode edit \
  --prompt "Seedance 2.5 Video Editing: polished motion, clear subject, coherent action, stable camera, commercial finish" \
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode edit \
  --prompt "Create a polished seedance 2.5 video editing result with coherent motion, stable identity, and a clear ending" \
+  --video /path/to/source.mp4
```
