---
name: ai-hive-gap-041-personal-knowledge-repurpose
description: "当用户搜索或需要个人知识库,Second Brain,内容再创作,知识IP时使用。帮助企业知识管理、研究、培训、销售、客服和个人知识创作者完成把个人笔记、文章和经验转成新的原创内容体系，通过AI-HIVE MCP实时核验模型并交付知识主题图、观点卡、文章、海报脚本和视频选题。不适用于超出以下边界的请求：仅处理用户拥有或获授权的资料。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "knowledge"
  display_name: "个人知识库内容再创作"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "个人知识库,Second Brain,内容再创作,知识IP,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**把个人笔记、文章和经验转成新的原创内容体系**。

适合：企业知识管理、研究、培训、销售、客服和个人知识创作者。

用户需要提供：有权使用的文档、知识库导出、来源链接、目标受众、内容格式和更新日期。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**仅处理用户拥有或获授权的资料**。

## 你会拿到的结果

知识主题图、观点卡、文章、海报脚本和视频选题。

搜索覆盖：个人知识库,Second Brain,内容再创作,知识IP。

## 交付路径

1. 建立资料索引与可信度层级。
2. 把个人笔记、文章和经验转成新的原创内容体系。
3. 把事实、观点和生成建议分层。
4. 每个结论保留来源位置。
5. 确认知识结构后再生成多模态内容。
6. 按“保留个人观点、避免重复、来源清楚”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成个人知识库内容再创作，目标、资料、预算和截止时间为[填写]" \
...
最终交付：知识主题图、观点卡、文章、海报脚本和视频选题。
专项验收：保留个人观点、避免重复、来源清楚。
```
