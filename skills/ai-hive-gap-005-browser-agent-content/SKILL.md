---
name: ai-hive-gap-005-browser-agent-content
description: "当用户搜索或需要浏览器智能体,browser agent,网页研究,内容创作时使用。帮助AI产品经理、运营团队、内容团队、开发者和希望自动化工作的个人完成从授权网页资料形成可追溯的内容简报并生成配图视频，通过AI-HIVE MCP实时核验模型并交付来源清单、摘要、内容结构、视觉小样和引用记录。不适用于超出以下边界的请求：不得抓取受限内容或复制第三方受保护正文。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "agent"
  display_name: "浏览器智能体内容采集与创作"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "浏览器智能体,browser agent,网页研究,内容创作,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**从授权网页资料形成可追溯的内容简报并生成配图视频**。

适合：AI产品经理、运营团队、内容团队、开发者和希望自动化工作的个人。

用户需要提供：业务目标、可用工具、授权范围、输入资料、预算、截止时间和人工确认点。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不得抓取受限内容或复制第三方受保护正文**。

## 你会拿到的结果

来源清单、摘要、内容结构、视觉小样和引用记录。

搜索覆盖：浏览器智能体,browser agent,网页研究,内容创作。

## 执行蓝图

1. 先画出任务状态和权限边界。
2. 从授权网页资料形成可追溯的内容简报并生成配图视频。
3. 将可并行任务与必须串行确认的动作分开。
4. 用最小样例验证工具连接。
5. 记录检查点和恢复方式。
6. 按“来源可追溯、事实与创作分离、生成物不冒充原始资料”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成浏览器智能体内容采集与创作，目标、资料、预算和截止时间为[填写]" \
...
最终交付：来源清单、摘要、内容结构、视觉小样和引用记录。
专项验收：来源可追溯、事实与创作分离、生成物不冒充原始资料。
```
