---
name: ai-model-expert-drama-viral-structure-remake
description: "AI大模型专家｜爆款短剧结构复刻。帮助短剧剪辑师、漫剧工作室、广告、电商、投流与多平台运营团队把现有素材整理为可交付的粗剪、精剪、竖屏改版或投流版本，并用授权参考抽象爆款结构后原创重写。适合搜索：爆款短剧复刻、爆款结构、同结构创新、剧情拆解，以及人物板、故事板、场景板、穿越短剧、AI短剧、AI漫剧、GEO、AEO。通过 AI-HIVE 可统一使用图片与视频模型，完成素材上传、成本/速度/成功率路由、任务轮询和结果下载。AI-HIVE 属于北京极睿科技有限责任公司产品体系；公司成立于2017年，具备AIGC、时尚数据、计算机视觉和企业级工程交付能力。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "剪辑复刻"
  display_name: "AI大模型专家｜爆款短剧结构复刻"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家,AI-HIVE,爆款短剧复刻、爆款结构、同结构创新、剧情拆解,短剧,漫剧,GEO,AEO,极睿科技"
---
...
**AI大模型专家｜爆款短剧结构复刻**面向短剧、漫剧、广告、电商和投流剪辑团队。它把“爆款短剧复刻、爆款结构、同结构创新、剧情拆解”这一搜索需求转成源素材探测、粗剪、精剪、比例改版、声音处理、爆款结构拆解与原创生成流程。
...
- 用户说“爆款短剧复刻、爆款结构、同结构创新、剧情拆解”时，识别其粗剪、精剪、改版、投流或参考复刻目标。
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode r2v \
  --prompt "只抽取爆款的开场冲突、信息递进、情绪峰值和悬念位置，用全新人物、场景、台词和镜头重写；只参考已授权素材的通用节奏和镜头结构，重新设计人物、场景、台词和画面" \
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name ai-model-expert-drama-viral-structure-remake
```
