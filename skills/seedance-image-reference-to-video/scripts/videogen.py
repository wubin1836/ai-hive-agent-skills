...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"r2v\", \"models\": {\"r2v\": \"public_model_seedance_2_5_r2v\"}, \"name\": \"seedance-image-reference-to-video\", \"rule\": \"image\", \"title\": \"Seedance Image Reference to Video\"}")
