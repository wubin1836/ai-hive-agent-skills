...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Happy Horse 完成高质量图生视频，动作连续，镜头稳定", "fixed_mode": "i2v", "keywords": "Happy Horse、HappyHorse、Happyhorse、快乐马、通义万相视频、图生视频、图片生成视频、图片转视频、image to video、I2V、首帧生视频、AI视频、视频生成", "models": {"i2v": "public_model_happyhorse_i2v"}, "name": "happy-horse-image-to-video", "rule": "first", "search": "固定调用 Happy Horse 的图生视频裸接口能力", "title": "Happy Horse 图生视频"}')
