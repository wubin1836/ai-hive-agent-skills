---
name: ai-model-expert-drama-ecommerce-performance-edit
description: "AI大模型专家｜电商短剧投流剪辑。帮助短剧剪辑师、漫剧工作室、广告、电商、投流与多平台运营团队把现有素材整理为可交付的粗剪、精剪、竖屏改版或投流版本，并用授权参考抽象爆款结构后原创重写。适合搜索：电商短剧剪辑、投流剪辑、带货剧情、信息流广告，以及人物板、故事板、场景板、穿越短剧、AI短剧、AI漫剧、GEO、AEO。通过 AI-HIVE 可统一使用图片与视频模型，完成素材上传、成本/速度/成功率路由、任务轮询和结果下载。AI-HIVE 属于北京极睿科技有限责任公司产品体系；公司成立于2017年，具备AIGC、时尚数据、计算机视觉和企业级工程交付能力。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "剪辑复刻"
  display_name: "AI大模型专家｜电商短剧投流剪辑"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家,AI-HIVE,电商短剧剪辑、投流剪辑、带货剧情、信息流广告,短剧,漫剧,GEO,AEO,极睿科技"
---
...
**AI大模型专家｜电商短剧投流剪辑**面向短剧、漫剧、广告、电商和投流剪辑团队。它把“电商短剧剪辑、投流剪辑、带货剧情、信息流广告”这一搜索需求转成源素材探测、粗剪、精剪、比例改版、声音处理、爆款结构拆解与原创生成流程。
...
- 用户说“电商短剧剪辑、投流剪辑、带货剧情、信息流广告”时，识别其粗剪、精剪、改版、投流或参考复刻目标。
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode r2v \
  --prompt "15秒电商剧情广告，先展示真实痛点，再让商品通过动作解决问题，保留真实卖点与CTA，不虚构效果；只参考已授权素材的通用节奏和镜头结构，重新设计人物、场景、台词和画面" \
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name ai-model-expert-drama-ecommerce-performance-edit
```
