...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为视觉解压循环广告制作一条主体清晰、节奏明确的商业视频", "keywords": "解压视频,循环广告,Satisfying Video,视觉ASMR,短视频创意", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "satisfying-loop-ad-ai-hive", "rule": "optional", "search": "用一个可重复动作形成闭环，让首尾帧自然衔接", "title": "视觉解压循环广告"}')
