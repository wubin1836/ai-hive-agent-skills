#!/usr/bin/env python3
"""Create a deterministic production brief for 视觉解压循环广告｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='视觉解压循环广告｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['解压视频', '循环广告', 'Satisfying Video', '视觉ASMR', '短视频创意'],
