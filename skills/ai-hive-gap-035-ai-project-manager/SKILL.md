---
name: ai-hive-gap-035-ai-project-manager
description: "当用户搜索或需要AI项目经理,项目计划,项目汇报,AI PM时使用。帮助普通企业、创业团队、超级个体、销售运营和职能部门完成把复杂AI项目拆成里程碑、责任人、风险和汇报材料，通过AI-HIVE MCP实时核验模型并交付WBS、里程碑、风险台账、周报和决策记录。不适用于超出以下边界的请求：不自动修改外部项目系统或通知成员。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "enterprise"
  display_name: "AI项目经理计划与汇报"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "AI项目经理,项目计划,项目汇报,AI PM,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**把复杂AI项目拆成里程碑、责任人、风险和汇报材料**。

适合：普通企业、创业团队、超级个体、销售运营和职能部门。

用户需要提供：真实业务资料、目标受众、内部口径、交付格式、品牌规范、预算和审批要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不自动修改外部项目系统或通知成员**。

## 你会拿到的结果

WBS、里程碑、风险台账、周报和决策记录。

搜索覆盖：AI项目经理,项目计划,项目汇报,AI PM。

## 实施流程

1. 将业务问题和生成任务分开。
2. 把复杂AI项目拆成里程碑、责任人、风险和汇报材料。
3. 锁定不可虚构的事实与数字。
4. 先交付文字或结构草案。
5. 确认后制作视觉小样并验收。
6. 按“依赖清楚、状态真实、风险可行动”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成AI项目经理计划与汇报，目标、资料、预算和截止时间为[填写]" \
...
最终交付：WBS、里程碑、风险台账、周报和决策记录。
专项验收：依赖清楚、状态真实、风险可行动。
```
