...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为淘宝天猫主图工作室制作一张主体准确、层级清晰的商业图片", "keywords": "淘宝主图,天猫主图,直通车图,电商设计,商品点击率", "model": "public_model_nano_banana_pro", "name": "taobao-main-image-studio-ai-hive", "rule": "optional", "search": "用信息层级而非堆字提升首屏理解效率", "title": "淘宝天猫主图工作室"}')
