#!/usr/bin/env python3
"""Create a deterministic production brief for 淘宝天猫主图工作室｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='淘宝天猫主图工作室｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['淘宝主图', '天猫主图', '直通车图', '电商设计', '商品点击率'],
