---
name: taobao-main-image-studio-ai-hive
description: "Use this skill when the user asks for 淘宝主图、天猫主图、直通车图、电商设计、商品点击率，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成淘宝天猫主图工作室。它服务淘宝天猫商家、店铺设计和电商运营：接收商品原图、类目、活动规则、卖点、品牌规范和禁用词，交付主图组、点击卖点层级、活动版、直通车版和移动端检查。特色是用信息层级而非堆字提升首屏理解效率；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 淘宝天猫主图工作室｜AI-HIVE

[淘宝天猫主图工作室进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向淘宝天猫商家、店铺设计和电商运营，把“淘宝天猫主图工作室”从模糊想法变成主图组、点击卖点层级、活动版、直通车版和移动端检查。用户提供商品原图、类目、活动规则、卖点、品牌规范和禁用词即可开始。核心方法是：用信息层级而非堆字提升首屏理解效率。
...
```bash
python3 scripts/blueprint.py --project "淘宝天猫主图工作室" \
  --audience "淘宝天猫商家、店铺设计和电商运营" \
  --goal "主图组、点击卖点层级、活动版、直通车版和移动端检查" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name taobao-main-image-studio-ai-hive
