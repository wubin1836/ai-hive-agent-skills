...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为小红书本地生活探店种草笔记制作主体稳定、事实可核验的本地生活视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "local-xiaohongshu-life-visit-note-ai-hive", "title": "AI大模型专家｜小红书本地生活探店种草笔记", "keywords": "小红书本地生活、小红书探店、小红书同城、小红书门店、小红书团购、探店种草笔记、本地生活、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前模型与价格，并在平台官方后台核对当前规则"}')
