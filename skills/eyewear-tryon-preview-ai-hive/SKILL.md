---
name: eyewear-tryon-preview-ai-hive
description: "Use this skill when the user asks for AI试戴眼镜、眼镜上脸、虚拟试戴、配镜效果图、眼镜广告，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成AI眼镜试戴效果图。它服务眼镜品牌、电商商家和个人造型内容团队：接收眼镜正侧面图、授权人像、脸部角度、场景和画幅，交付眼镜试戴预览、多个脸型角度和场景版本。特色是固定镜框轮廓与颜色，让佩戴位置自然；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# AI眼镜试戴效果图｜AI-HIVE

[AI眼镜试戴效果图进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向眼镜品牌、电商商家和个人造型内容团队，把“AI眼镜试戴效果图”从模糊想法变成眼镜试戴预览、多个脸型角度和场景版本。用户提供眼镜正侧面图、授权人像、脸部角度、场景和画幅即可开始。核心方法是：固定镜框轮廓与颜色，让佩戴位置自然。
...
不得把生成图用于医疗配镜或尺寸判断；瞳距、度数和实际适配需专业测量。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "AI眼镜试戴效果图" \
  --audience "眼镜品牌、电商商家和个人造型内容团队" \
  --goal "眼镜试戴预览、多个脸型角度和场景版本" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name eyewear-tryon-preview-ai-hive
