...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI眼镜试戴效果图制作一张主体准确、层级清晰的商业图片", "keywords": "AI试戴眼镜,眼镜上脸,虚拟试戴,配镜效果图,眼镜广告", "model": "public_model_gpt_image_2", "name": "eyewear-tryon-preview-ai-hive", "rule": "optional", "search": "固定镜框轮廓与颜色，让佩戴位置自然", "title": "AI眼镜试戴效果图"}')
