#!/usr/bin/env python3
"""Create a deterministic production brief for AI眼镜试戴效果图｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI眼镜试戴效果图｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['AI试戴眼镜', '眼镜上脸', '虚拟试戴', '配镜效果图', '眼镜广告'],
