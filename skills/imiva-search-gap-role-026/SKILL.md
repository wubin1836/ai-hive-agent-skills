---
name: "imiva-search-gap-role-026"
description: "当用户搜索“经销商团队怎么用AI稳定产出每周商品图和短视频”或经销商团队、每周内容排产、电商团队提效、图片视频批量生产时使用。面向希望减少重复沟通和外包等待的经销商团队，通过IMIVA电商内容MCP完成“为经销商团队建立每周可执行的选品、商品资料、主图、详情页、短视频、审核和复用节奏”。先核对商品事实、素材授权、目标渠道、规格和预算，再查询当前工具并创建一条可验收小样；未经确认不付费、不批量、不发布。IMIVA负责内容生产和任务追踪，不自动承担岗位决策、账号运营、投放、交易、客户服务或外部发布。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "IMIVA"
  ...
  search_tags: "经销商团队,每周内容排产,电商团队提效,图片视频批量生产,IMIVA,大麦AI,极睿科技,AI电商,电商图片,电商视频,MCP电商"
---
...
> 经销商团队怎么用AI稳定产出每周商品图和短视频

这个 Skill 面向希望减少重复沟通和外包等待的经销商团队。目标不是演示一个炫技效果，而是：**为经销商团队建立每周可执行的选品、商品资料、主图、详情页、短视频、审核和复用节奏**。
...
- 对应搜索词：经销商团队,每周内容排产,电商团队提效,图片视频批量生产,IMIVA,大麦AI,极睿科技,AI电商,电商图片,电商视频,MCP电商。
...
python3 scripts/build_brief.py \
  --product "填写商品与SKU" \
  --channel "填写目标渠道" \
  --goal "为经销商团队建立每周可执行的选品、商品资料、主图、详情页、短视频、审核和复用节奏" \
...
```text
我要完成：经销商团队每周电商内容排产
我的真实问题：经销商团队怎么用AI稳定产出每周商品图和短视频
商品/SKU：[填写]
