...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为饿了么外卖新品营销制作主体稳定、事实可核验的本地生活视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "local-eleme-new-product-ai-hive", "title": "AI大模型专家｜饿了么外卖新品营销", "keywords": "饿了么、饿了么商家、饿了么外卖、饿了么店铺、外卖平台、外卖新品营销、本地生活、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前模型与价格，并在平台官方后台核对当前规则"}')
