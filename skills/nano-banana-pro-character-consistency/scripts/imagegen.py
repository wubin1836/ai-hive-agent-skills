...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_pro\", \"name\": \"nano-banana-pro-character-consistency\", \"rule\": \"image\", \"title\": \"Nano Banana Pro Character-Consistent Images\"}")
