...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为批量素材重复度检测制作一条主体清晰、节奏明确的商业视频", "keywords": "素材去重,批量图片检查,视频重复度,创意重复,内容工厂质检", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "batch-creative-duplicate-check-ai-hive", "rule": "optional", "search": "区分技术重复、视觉近似和创意同质化", "title": "批量素材重复度检测"}')
