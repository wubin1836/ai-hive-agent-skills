---
name: ecommerce-ad-compliance-precheck-ai-hive
description: "Use this skill when the user asks for 广告合规、违禁词检查、电商广告审核、素材预检、平台规则，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成电商广告合规预检。它服务电商商家、广告投放、法务初审和内容运营：接收广告文案、图片视频、商品事实、目标平台、地区和最新适用规则，交付高风险表达、证据缺口、平台素材风险、建议替换和人工审核清单。特色是在发布前发现明显风险，并标记必须查阅的最新规则；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 电商广告合规预检｜AI-HIVE

[电商广告合规预检进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向电商商家、广告投放、法务初审和内容运营，把“电商广告合规预检”从模糊想法变成高风险表达、证据缺口、平台素材风险、建议替换和人工审核清单。用户提供广告文案、图片视频、商品事实、目标平台、地区和最新适用规则即可开始。核心方法是：在发布前发现明显风险，并标记必须查阅的最新规则。
...
只提供风险提示，不是法律意见，也不承诺平台审核通过；规则必须按发布日期更新。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "电商广告合规预检" \
  --audience "电商商家、广告投放、法务初审和内容运营" \
  --goal "高风险表达、证据缺口、平台素材风险、建议替换和人工审核清单" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name ecommerce-ad-compliance-precheck-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name ecommerce-ad-compliance-precheck-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
