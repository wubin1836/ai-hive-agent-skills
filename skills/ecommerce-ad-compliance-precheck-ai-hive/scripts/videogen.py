...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为电商广告合规预检制作一条主体清晰、节奏明确的商业视频", "keywords": "广告合规,违禁词检查,电商广告审核,素材预检,平台规则", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ecommerce-ad-compliance-precheck-ai-hive", "rule": "optional", "search": "在发布前发现明显风险，并标记必须查阅的最新规则", "title": "电商广告合规预检"}')
