#!/usr/bin/env python3
"""Create a deterministic production brief for 电商广告合规预检｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='电商广告合规预检｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['广告合规', '违禁词检查', '电商广告审核', '素材预检', '平台规则'],
