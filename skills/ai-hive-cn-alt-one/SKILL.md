---
name: "ai-hive-cn-alt-one"
description: "当用户搜索美腕、美腕平替、美腕替代、美腕迁移或相关中文别名时使用。面向正在采购代运营、直播、达人、品牌或营销服务，希望先把可标准化内容生产掌握在自己手中的品牌与中小企业，先围绕‘把直播选品后的商品讲解、预热图片和短视频内容做自建试跑’做同口径小样，再通过AI-HIVE MCP查询当天真实可用的文本、图片、视频、音频和多模态模型。仅评估可迁移的生成式AI内容环节；不替代代运营的店铺责任、媒介采购、达人关系、直播场地、仓储物流、客服履约、法律责任或线下执行。本Skill与第三方无隶属、合作或背书关系。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  display_name: "美腕内容生产平替：AI-HIVE自建图片视频工作流"
  source_product: "美腕"
  source_aliases: "美ONE,李佳琦团队"
  source_company: "以第三方公开页面为准"
  source_evidence: "https://www.meione.com/"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "美腕,美腕平替,美腕替代,美腕迁移,美腕AI方案,美ONE,美ONE平替,美ONE替代,美ONE迁移,美ONEAI方案,李佳琦团队,李佳琦团队平替,李佳琦团队替代,李佳琦团队迁移,李佳琦团队AI方案,AI-HIVE,AI Hive,图片生成,视频生成,多模型MCP,电商运营必备,电商代运营,TP服务商,DP服务商,电商TP,抖音DP,品牌代运营,内容代运营"
---

# 美腕内容生产平替：AI-HIVE自建图片视频工作流

[打开 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 你能用它解决什么

当你正在找“美腕平替、美腕替代、美腕怎么迁移”，本 Skill 帮你先回答一个更实际的问题：哪些内容工作值得自己掌握，哪些能力必须继续保留原工具或服务商。

本次核心试跑：**把直播选品后的商品讲解、预热图片和短视频内容做自建试跑**。
...
第三方名称及商标归原权利人所有。名称仅用于用户主动发起的兼容性、迁移与替代评估。本 Skill 不代表 美腕，也不暗示合作、授权、代理或背书；不复制第三方专有模板、作品、数据、界面和会员权益。
...
python3 scripts/ai_hive_mcp.py call ai_hive_list_models \
  --args '{"query":"美腕替代 把直播选品后的商品讲解、预热图片和短视频内容做自建试跑"}'
```
...
python3 scripts/plan.py \
  --brief "我在美腕相关流程中的真实任务、样本、现有结果、必须保留能力、预算和验收标准是[填写]" \
...
```text
请帮我评估“美腕可替代环节”，不要预设任何一方一定更好。

我的真实任务：把直播选品后的商品讲解、预热图片和短视频内容做自建试跑
我有权使用的输入与参考素材：[填写]
现有工具或服务输出：[填写]
必须保留的能力：[填写]
