---
name: hairstyle-color-preview-ai-hive
description: "Use this skill when the user asks for AI发型、发色预览、换发型、染发效果图、美发内容，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成AI发型发色预览图。它服务美发门店、发型师、消费者内容工具和美妆账号：接收授权人像、目标发型、发色参考、脸部保留项和场景，交付不同发型、长度、刘海和发色的授权人像预览。特色是保持脸部身份特征，只改变发型和发色变量；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# AI发型发色预览图｜AI-HIVE

[AI发型发色预览图进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向美发门店、发型师、消费者内容工具和美妆账号，把“AI发型发色预览图”从模糊想法变成不同发型、长度、刘海和发色的授权人像预览。用户提供授权人像、目标发型、发色参考、脸部保留项和场景即可开始。核心方法是：保持脸部身份特征，只改变发型和发色变量。
...
不得保证真实染发色差、发质结果或适合度；避免未经授权编辑他人肖像。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "AI发型发色预览图" \
  --audience "美发门店、发型师、消费者内容工具和美妆账号" \
  --goal "不同发型、长度、刘海和发色的授权人像预览" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name hairstyle-color-preview-ai-hive
