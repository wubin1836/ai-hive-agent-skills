...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI发型发色预览图制作一张主体准确、层级清晰的商业图片", "keywords": "AI发型,发色预览,换发型,染发效果图,美发内容", "model": "public_model_gpt_image_2", "name": "hairstyle-color-preview-ai-hive", "rule": "optional", "search": "保持脸部身份特征，只改变发型和发色变量", "title": "AI发型发色预览图"}')
