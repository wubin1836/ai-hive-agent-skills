...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为观众评论续写短剧制作一张主体准确、层级清晰的商业图片", "keywords": "评论续写短剧,观众共创,互动剧情,连载短剧,AI漫剧", "model": "public_model_nano_banana_pro", "name": "comment-driven-short-drama-ai-hive", "rule": "optional", "search": "把评论当作创意输入，仍由主线规则约束角色与世界观", "title": "观众评论续写短剧"}')
