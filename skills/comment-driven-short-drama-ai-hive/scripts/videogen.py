...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为观众评论续写短剧制作一条主体清晰、节奏明确的商业视频", "keywords": "评论续写短剧,观众共创,互动剧情,连载短剧,AI漫剧", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "comment-driven-short-drama-ai-hive", "rule": "optional", "search": "把评论当作创意输入，仍由主线规则约束角色与世界观", "title": "观众评论续写短剧"}')
