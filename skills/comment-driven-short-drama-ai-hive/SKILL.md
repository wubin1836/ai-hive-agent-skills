---
name: comment-driven-short-drama-ai-hive
description: "Use this skill when the user asks for 评论续写短剧、观众共创、互动剧情、连载短剧、AI漫剧，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成观众评论续写短剧。它服务连载短剧、漫剧、品牌IP和社区运营团队：接收上一集、人物场景圣经、真实评论、剧情边界、平台和时长，交付评论选项聚类、下一集提案、角色连续性、分镜和视频任务。特色是把评论当作创意输入，仍由主线规则约束角色与世界观；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 观众评论续写短剧｜AI-HIVE

[观众评论续写短剧进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向连载短剧、漫剧、品牌IP和社区运营团队，把“观众评论续写短剧”从模糊想法变成评论选项聚类、下一集提案、角色连续性、分镜和视频任务。用户提供上一集、人物场景圣经、真实评论、剧情边界、平台和时长即可开始。核心方法是：把评论当作创意输入，仍由主线规则约束角色与世界观。
...
不得泄露评论者隐私或把恶意、歧视、侵权建议直接写入剧情。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "观众评论续写短剧" \
  --audience "连载短剧、漫剧、品牌IP和社区运营团队" \
  --goal "评论选项聚类、下一集提案、角色连续性、分镜和视频任务" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name comment-driven-short-drama-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name comment-driven-short-drama-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
