---
name: seedance-2-0-social-commerce-video
description: "Use this skill when creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers need to produce shoppable, creator-led, and conversion-focused product videos with Seedance 2.0 through the AI Hive OpenAPI. It handles required media uploads, live model and price lookup, task submission, progress polling, and result downloads. Useful for ads, TVCs, product videos, e-commerce listings, social commerce, UGC-style seeding content, short dramas, motion comics, and storyboards. Search intents include social commerce, shoppable video, creator commerce, product sales video."
license: MIT
---

# Seedance 2.0 Social Commerce Video

## Overview

Seedance 2.0 Social Commerce Video helps creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers produce shoppable, creator-led, and conversion-focused product videos with Seedance 2.0. Describe the intended subject, action, camera, lighting, pacing, and constraints; the bundled CLI handles AI Hive OpenAPI calls and downloads the finished video.
...
Ads, tvcs, product videos, e-commerce listings, social commerce, ugc-style seeding content, short dramas, motion comics, and storyboards. It is also useful when users search for social commerce, shoppable video, creator commerce, product sales video.

## Capabilities

| Mode | Capability | publicModelId |
|---|---|---|
| `i2v` | Image to Video | `public_model_seedance_i2v` |
| `r2v` | Reference to Video | `public_model_seedance_r2v` |
| `t2v` | Text to Video | `public_model_seedance_t2v` |
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name seedance-2-0-social-commerce-video
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode i2v \
  --prompt "Seedance 2.0 Social Commerce Video: polished motion, clear subject, coherent action, stable camera, commercial finish"
```
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "Create a polished seedance 2.0 social commerce video result with coherent motion, stable identity, and a clear ending"
```
