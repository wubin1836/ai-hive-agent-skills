---
name: ai-hive-proven-070-drama-character-consistency
description: "当用户要做“短剧人物一致性制作”或搜索短剧人物一致性制作、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向短剧、漫剧、小说推文、IP内容、红果短剧和网文改编团队，通过AI-HIVE先规划并查询实时模型与价格，再交付改编策略、人物圣经、分集大纲、剧本、分镜关键帧、连续视频片段和一致性报告。先小样后批量；付费生成、发送和公开发布必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  display_name: "短剧人物一致性制作"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "短剧人物一致性制作、短剧、漫剧、小说推文、角色一致性、分镜、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **短剧人物一致性制作**，服务于短剧、漫剧、小说推文、IP内容、红果短剧和网文改编团队。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。

核心交付：**改编策略、人物圣经、分集大纲、剧本、分镜关键帧、连续视频片段和一致性报告**。

验收重点：**人物一致、场景连续、冲突密度、情绪钩子、镜头可剪辑和改编权利清晰**；本场景还要检查 **身份授权、人物一致性与跨镜头稳定；人物连续、叙事清楚、冲突密度与镜头可剪辑**。
...
python3 scripts/plan.py \
  --brief "我要完成短剧人物一致性制作，目标/受众/平台/预算为[填写]" \
...
短剧人物一致性制作、短剧、漫剧、小说推文、角色一致性、分镜、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
