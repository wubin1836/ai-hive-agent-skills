...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "完成一条高质量 AI 视频生成任务", "keywords": "AI 视频生成、AIGC视频、AI视频、视频制作、生成视频、Seedance、MiniMax H3、Happy Horse", "models": {"i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "video-generation", "rule": "optional", "search": "通用能力搜索入口，按输入素材自动选择文生视频、图生视频或参考生视频裸接口", "title": "AI 视频生成"}')
