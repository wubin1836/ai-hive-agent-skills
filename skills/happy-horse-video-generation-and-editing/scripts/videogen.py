...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频与原生视频编辑", "example": "生成一条电影感品牌短片；也可加入现有素材进行参考重制、风格调整或画面编辑", "keywords": "Happy Horse视频生成与编辑、HappyHorse、Happy Horse、Happyhorse、快乐马、通义万相视频、文生视频、图生视频、参考生视频、视频编辑、视频重绘、视频续写、AI视频、AIGC、电商视频、广告视频、TVC、产品视频、带货、种草、短剧、漫剧", "models": {"edit": "public_model_happyhorse_video_edit", "i2v": "public_model_happyhorse_i2v", "r2v": "public_model_happyhorse_r2v", "t2v": "public_model_happyhorse_t2v"}, "name": "happy-horse-video-generation-and-editing", "rule": "optional", "search": "视频生成与编辑聚合搜索入口，按文字、图片、视频或音频输入选择同一模型家族的可用能力", "title": "HappyHorse 视频生成与编辑"}')
