...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"i2v\", \"models\": {\"i2v\": \"public_model_happyhorse_i2v\"}, \"name\": \"happy-horse-first-last-frame-to-video\", \"rule\": \"first_last\", \"title\": \"Happy Horse First and Last Frame Video\"}")
