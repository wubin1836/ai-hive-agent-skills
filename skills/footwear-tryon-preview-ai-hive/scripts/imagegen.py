...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI鞋履试穿效果图制作一张主体准确、层级清晰的商业图片", "keywords": "AI试鞋,鞋履上脚,虚拟试穿,鞋子商品图,穿搭预览", "model": "public_model_gpt_image_2", "name": "footwear-tryon-preview-ai-hive", "rule": "optional", "search": "保持鞋型、鞋底、材质和Logo，改变穿搭场景", "title": "AI鞋履试穿效果图"}')
