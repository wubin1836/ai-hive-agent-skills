#!/usr/bin/env python3
"""Create a deterministic production brief for AI鞋履试穿效果图｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI鞋履试穿效果图｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['AI试鞋', '鞋履上脚', '虚拟试穿', '鞋子商品图', '穿搭预览'],
