---
name: footwear-tryon-preview-ai-hive
description: "Use this skill when the user asks for AI试鞋、鞋履上脚、虚拟试穿、鞋子商品图、穿搭预览，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成AI鞋履试穿效果图。它服务鞋履品牌、跨境卖家、买手和种草内容团队：接收鞋履多角度图、授权人物或腿脚参考、场景、姿势和平台，交付鞋履上脚预览、不同裤装与场景版本、细节检查。特色是保持鞋型、鞋底、材质和Logo，改变穿搭场景；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# AI鞋履试穿效果图｜AI-HIVE

[AI鞋履试穿效果图进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向鞋履品牌、跨境卖家、买手和种草内容团队，把“AI鞋履试穿效果图”从模糊想法变成鞋履上脚预览、不同裤装与场景版本、细节检查。用户提供鞋履多角度图、授权人物或腿脚参考、场景、姿势和平台即可开始。核心方法是：保持鞋型、鞋底、材质和Logo，改变穿搭场景。
...
输出是视觉预览，不保证尺码、足弓支撑、舒适性或真实穿着效果。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "AI鞋履试穿效果图" \
  --audience "鞋履品牌、跨境卖家、买手和种草内容团队" \
  --goal "鞋履上脚预览、不同裤装与场景版本、细节检查" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name footwear-tryon-preview-ai-hive
