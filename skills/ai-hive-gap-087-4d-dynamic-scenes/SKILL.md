---
name: ai-hive-gap-087-4d-dynamic-scenes
description: "当用户搜索或需要4D生成,动态场景,时空生成,AI视频时使用。帮助前沿AI产品、机器人、空间计算、工业、零售和创新营销团队完成设计随时间变化的动态空间场景与演示内容，通过AI-HIVE MCP实时核验模型并交付时间轴、空间状态、动作规则、镜头和原型视频。不适用于超出以下边界的请求：不把二维视频原型描述成真实4D资产。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "frontier"
  display_name: "4D动态场景内容规划"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "4D生成,动态场景,时空生成,AI视频,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**设计随时间变化的动态空间场景与演示内容**。

适合：前沿AI产品、机器人、空间计算、工业、零售和创新营销团队。

用户需要提供：真实产品能力、场景资料、空间或商品素材、演示目标、画幅、预算和概念标识要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不把二维视频原型描述成真实4D资产**。

## 你会拿到的结果

时间轴、空间状态、动作规则、镜头和原型视频。

搜索覆盖：4D生成,动态场景,时空生成,AI视频。

## 生产步骤

1. 区分真实能力、概念设计和生成演示。
2. 设计随时间变化的动态空间场景与演示内容。
3. 定义场景规则与视觉连续性。
4. 先做关键帧或低成本原型。
5. 确认后生成演示视频并标注边界。
6. 按“时空关系清楚、动作连续、演示可理解”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成4D动态场景内容规划，目标、资料、预算和截止时间为[填写]" \
...
最终交付：时间轴、空间状态、动作规则、镜头和原型视频。
专项验收：时空关系清楚、动作连续、演示可理解。
```
