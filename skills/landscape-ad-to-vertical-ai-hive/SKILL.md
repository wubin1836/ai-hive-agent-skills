---
name: landscape-ad-to-vertical-ai-hive
description: "Use this skill when the user asks for 横版转竖版、广告改竖屏、TVC改短视频、视频重构、9比16视频，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成横版旧广告智能重构为竖版。它服务拥有16:9广告、TVC和发布会素材的品牌与商家：接收横版原片、品牌规范、目标平台、时长、必须保留信息和素材授权，交付竖版镜头重构、主体重定位、字幕安全区、缺口补镜和9:16成片。特色是按叙事重新构图，不做机械裁中间；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 横版旧广告智能重构为竖版｜AI-HIVE

[横版旧广告智能重构为竖版进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向拥有16:9广告、TVC和发布会素材的品牌与商家，把“横版旧广告智能重构为竖版”从模糊想法变成竖版镜头重构、主体重定位、字幕安全区、缺口补镜和9:16成片。用户提供横版原片、品牌规范、目标平台、时长、必须保留信息和素材授权即可开始。核心方法是：按叙事重新构图，不做机械裁中间。
...
不能裁掉必要声明、商标或关键商品；如需生成扩图或补镜，应检查与原片的一致性。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "横版旧广告智能重构为竖版" \
  --audience "拥有16:9广告、TVC和发布会素材的品牌与商家" \
  --goal "竖版镜头重构、主体重定位、字幕安全区、缺口补镜和9:16成片" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name landscape-ad-to-vertical-ai-hive
