...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为横版旧广告智能重构为竖版制作一条主体清晰、节奏明确的商业视频", "keywords": "横版转竖版,广告改竖屏,TVC改短视频,视频重构,9比16视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "landscape-ad-to-vertical-ai-hive", "rule": "optional", "search": "按叙事重新构图，不做机械裁中间", "title": "横版旧广告智能重构为竖版"}')
