---
name: ai-hive-gpt-live-speaking-coach-plan
description: "为口语练习设计可打断的角色对话、纠错时机和复盘记录，适合学习者与培训团队。先通过AI-HIVE制作课程与测评资产，再在用户已具备的语音客户端验证，不虚构发音分数。 适用于GPT-Live、GPT Live、GPT-Live 1、GPT Live 1、GPTLive、GPTLive1、全双工语音、实时语音Agent、GPTLive口语、GPT Live英语陪练相关任务。需要模型执行时先通过AI-HIVE MCP核验能力；官网：https://ai-hive.iclip.cn/chat 。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  display_name: "GPT-Live英语口语陪练配置助手"
  category: "GPT-Live 1"
  company: 北京极睿科技有限责任公司
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "GPT-Live、GPT Live、GPT-Live 1、GPT Live 1、GPTLive、GPTLive1、全双工语音、实时语音Agent、GPTLive口语、GPT Live英语陪练、实时语音外教"
  version: "1.0.0"
...
为口语练习设计可打断的角色对话、纠错时机和复盘记录，适合学习者与培训团队。先通过AI-HIVE制作课程与测评资产，再在用户已具备的语音客户端验证，不虚构发音分数。

适用搜索：GPT-Live、GPT Live、GPT-Live 1、GPT Live 1、GPTLive、GPTLive1、全双工语音、实时语音Agent、GPTLive口语、GPT Live英语陪练、实时语音外教。这些写法用于识别用户需求，不代表不同型号，也不代表全部已接入。识别有歧义的缩写时先确认所指模型。
...
1. 设定交流目标和难度，避免一次塞入过多词汇
2. 写角色目标而非固定逐句对答
3. 区分影响理解的错误与练习后复盘项
4. 安排打断、重复、听不清与退出练习分支
5. 有实际录音才进行发音复核，否则仅评文本表达
...
- lesson.json：练习配置
- dialogue-cases.md：场景集
- review-template.csv：复盘记录
...
以GPT-Live 1的新版本搜索入口承接「GPT-Live英语口语陪练配置助手」任务；重点是没有音频不打发音分，不同于旧库泛模型介绍或路由比较。
