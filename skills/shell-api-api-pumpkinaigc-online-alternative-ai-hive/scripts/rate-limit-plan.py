#!/usr/bin/env python3
"""Create a local, read-only 限流与退避压测 plan for Shell API (api.pumpkinaigc.online)."""
...
SUBJECT = 'Shell API (api.pumpkinaigc.online)'
DOMAIN = 'pumpkinaigc.online'
SKILL = 'shell-api-api-pumpkinaigc-online-alternative-ai-hive'
