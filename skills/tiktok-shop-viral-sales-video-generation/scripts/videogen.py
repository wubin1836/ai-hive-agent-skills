...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "TikTok Shop竖屏带货视频，快速问题演示，真实UGC使用过程，多角度产品特写，结尾明确购物行动", "keywords": "TikTok Shop爆款、TikTok带货、Spark Ads、GMV Max、UGC Ads、海外带货视频", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "tiktok-shop-viral-sales-video-generation", "product_promise": "面向 TikTok Shop 和海外社交电商生成 UGC 风格带货成片，可继续制作 Spark Ads 和多语言版本", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "TikTok Shop 爆款带货视频生成", "trend_inspired": true}')
