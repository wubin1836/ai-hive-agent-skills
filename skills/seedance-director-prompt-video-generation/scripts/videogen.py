...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "按主体、动作顺序、镜头运动、光线、声音和限制条件组织导演提示词，再生成电影感视频", "keywords": "Seedance提示词、导演提示词、运镜提示词、视频Prompt、镜头语言、物理规律、Seedance成片", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "seedance-director-prompt-video-generation", "product_promise": "把模糊创意转成可执行的导演提示词，并直接调用 Seedance 生成视频，兼顾镜头语言和模型边界", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "Seedance 导演提示词与视频生成", "trend_inspired": true}')
