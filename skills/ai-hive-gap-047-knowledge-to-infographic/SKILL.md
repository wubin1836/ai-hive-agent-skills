---
name: ai-hive-gap-047-knowledge-to-infographic
description: "当用户搜索或需要知识库转图解,知识海报,信息图,AI设计时使用。帮助企业知识管理、研究、培训、销售、客服和个人知识创作者完成把复杂知识转成层级清晰的图解和海报方案，通过AI-HIVE MCP实时核验模型并交付核心结论、信息层级、图解草案、视觉小样和尺寸版。不适用于超出以下边界的请求：生成底图与最终文字排版分开验收。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "knowledge"
  display_name: "知识库转图解海报"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "知识库转图解,知识海报,信息图,AI设计,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**把复杂知识转成层级清晰的图解和海报方案**。

适合：企业知识管理、研究、培训、销售、客服和个人知识创作者。

用户需要提供：有权使用的文档、知识库导出、来源链接、目标受众、内容格式和更新日期。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**生成底图与最终文字排版分开验收**。

## 你会拿到的结果

核心结论、信息层级、图解草案、视觉小样和尺寸版。

搜索覆盖：知识库转图解,知识海报,信息图,AI设计。

## 生产步骤

1. 建立资料索引与可信度层级。
2. 把复杂知识转成层级清晰的图解和海报方案。
3. 把事实、观点和生成建议分层。
4. 每个结论保留来源位置。
5. 确认知识结构后再生成多模态内容。
6. 按“信息准确、三秒可读、图文一致”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成知识库转图解海报，目标、资料、预算和截止时间为[填写]" \
