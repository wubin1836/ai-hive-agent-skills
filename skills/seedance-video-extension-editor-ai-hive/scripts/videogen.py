...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Seedance 视频编辑与延长制作一条主体清晰、节奏明确的商业视频", "keywords": "Seedance视频编辑,视频延长,AI补帧,视频修改,Extend Video", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "seedance-video-extension-editor-ai-hive", "rule": "optional", "search": "区分确定性剪辑与生成式编辑，减少无谓重生成", "title": "Seedance 视频编辑与延长"}')
