---
name: short-drama-character-bible-ai-hive
description: "Use this skill when the user asks for 短剧人物、角色一致性、人物设定、角色圣经、AI短剧，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成短剧人物圣经与角色一致性。它服务短剧、美术、漫剧和AI视频制作团队：接收剧本、人物关系、时代、画风、演员或角色参考和集数，交付角色卡、外观锚点、服装变化、表情动作库、禁改项和参考图任务。特色是把稳定特征与剧情变化分开记录；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 短剧人物圣经与角色一致性｜AI-HIVE

[短剧人物圣经与角色一致性进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向短剧、美术、漫剧和AI视频制作团队，把“短剧人物圣经与角色一致性”从模糊想法变成角色卡、外观锚点、服装变化、表情动作库、禁改项和参考图任务。用户提供剧本、人物关系、时代、画风、演员或角色参考和集数即可开始。核心方法是：把稳定特征与剧情变化分开记录。
...
```bash
python3 scripts/blueprint.py --project "短剧人物圣经与角色一致性" \
  --audience "短剧、美术、漫剧和AI视频制作团队" \
  --goal "角色卡、外观锚点、服装变化、表情动作库、禁改项和参考图任务" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name short-drama-character-bible-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name short-drama-character-bible-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
