#!/usr/bin/env python3
"""Create a deterministic production brief for 短剧人物圣经与角色一致性｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='短剧人物圣经与角色一致性｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['短剧人物', '角色一致性', '人物设定', '角色圣经', 'AI短剧'],
