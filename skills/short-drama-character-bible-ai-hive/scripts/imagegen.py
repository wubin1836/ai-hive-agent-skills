...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为短剧人物圣经与角色一致性制作一张主体准确、层级清晰的商业图片", "keywords": "短剧人物,角色一致性,人物设定,角色圣经,AI短剧", "model": "public_model_gpt_image_2", "name": "short-drama-character-bible-ai-hive", "rule": "optional", "search": "把稳定特征与剧情变化分开记录", "title": "短剧人物圣经与角色一致性"}')
