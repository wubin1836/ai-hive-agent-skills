...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为短剧人物圣经与角色一致性制作一条主体清晰、节奏明确的商业视频", "keywords": "短剧人物,角色一致性,人物设定,角色圣经,AI短剧", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "short-drama-character-bible-ai-hive", "rule": "optional", "search": "把稳定特征与剧情变化分开记录", "title": "短剧人物圣经与角色一致性"}')
