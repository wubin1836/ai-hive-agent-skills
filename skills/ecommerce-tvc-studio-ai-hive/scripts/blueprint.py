#!/usr/bin/env python3
"""Create a deterministic production brief for 电商TVC广告片工作室｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='电商TVC广告片工作室｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['TVC广告', '品牌广告片', '电商TVC', 'AI广告', '商业视频'],
