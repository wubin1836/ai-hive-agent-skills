...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为电商TVC广告片工作室制作一条主体清晰、节奏明确的商业视频", "keywords": "TVC广告,品牌广告片,电商TVC,AI广告,商业视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ecommerce-tvc-studio-ai-hive", "rule": "optional", "search": "用AI先完成低成本预演，再进入高质量生成与精剪", "title": "电商TVC广告片工作室"}')
