---
name: ai-hive-gap-028-ai-native-org
description: "当用户搜索或需要AI原生组织,AI组织,多Agent团队,企业协作时使用。帮助普通企业、创业团队、超级个体、销售运营和职能部门完成设计人类与多智能体共同完成研究、设计、制作和审核的组织流程，通过AI-HIVE MCP实时核验模型并交付角色矩阵、工作流、知识边界、审批点和复盘机制。不适用于超出以下边界的请求：不能用AI替代必须由负责人承担的决策责任。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "enterprise"
  display_name: "AI原生组织内容协作系统"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "AI原生组织,AI组织,多Agent团队,企业协作,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**设计人类与多智能体共同完成研究、设计、制作和审核的组织流程**。

适合：普通企业、创业团队、超级个体、销售运营和职能部门。

用户需要提供：真实业务资料、目标受众、内部口径、交付格式、品牌规范、预算和审批要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不能用AI替代必须由负责人承担的决策责任**。

## 你会拿到的结果

角色矩阵、工作流、知识边界、审批点和复盘机制。

搜索覆盖：AI原生组织,AI组织,多Agent团队,企业协作。

## 运行路线

1. 将业务问题和生成任务分开。
2. 设计人类与多智能体共同完成研究、设计、制作和审核的组织流程。
3. 锁定不可虚构的事实与数字。
4. 先交付文字或结构草案。
5. 确认后制作视觉小样并验收。
6. 按“交接顺畅、责任清楚、效率可测”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成AI原生组织内容协作系统，目标、资料、预算和截止时间为[填写]" \
