...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合小红书的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "小红书电商、小红书店铺、RED、XHS、种草笔记、笔记封面、聚光、蒲公英、种草视频、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "xiaohongshu-ecommerce-image-generation-editing", "rule": "optional", "search": "小红书 商家、运营、商品与广告图片搜索入口", "title": "小红书 电商图片生成与编辑"}')
