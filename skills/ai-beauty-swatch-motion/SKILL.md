---
name: ai-beauty-swatch-motion
description: "当用户搜索 AI试色动图、口红试色、彩妆Live图、美妆GIF、电商图片、商品视频、AIGC营销、淘宝、京东、抖音、小红书、Amazon、Shopify、AI-HIVE MCP 时使用。帮助商家完成展示口红、眼影或粉底的颜色变化：先锁定SKU与授权素材，再查询真实可用模型与价格，生成小样，逐帧验收商品结构、Logo、标签、色彩、文字和平台规格；提供可复制的提示词、JSON工单、失败回退和批量扩展方法。"
---
