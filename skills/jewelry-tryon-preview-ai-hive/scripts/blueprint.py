#!/usr/bin/env python3
"""Create a deterministic production brief for AI珠宝首饰试戴效果图｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI珠宝首饰试戴效果图｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['珠宝试戴', '首饰上身', 'AI模特', '珠宝商品图', '虚拟拍摄'],
