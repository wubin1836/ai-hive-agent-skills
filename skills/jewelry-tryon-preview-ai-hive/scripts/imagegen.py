...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI珠宝首饰试戴效果图制作一张主体准确、层级清晰的商业图片", "keywords": "珠宝试戴,首饰上身,AI模特,珠宝商品图,虚拟拍摄", "model": "public_model_gpt_image_2", "name": "jewelry-tryon-preview-ai-hive", "rule": "optional", "search": "优先保持结构、宝石切割、比例和金属颜色", "title": "AI珠宝首饰试戴效果图"}')
