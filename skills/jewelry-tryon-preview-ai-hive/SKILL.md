---
name: jewelry-tryon-preview-ai-hive
description: "Use this skill when the user asks for 珠宝试戴、首饰上身、AI模特、珠宝商品图、虚拟拍摄，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成AI珠宝首饰试戴效果图。它服务珠宝品牌、首饰商家、摄影团队和种草账号：接收首饰多角度图、授权人物局部图、佩戴位置、比例和光线，交付戒指、项链、耳饰或手表的试戴预览与微距版本。特色是优先保持结构、宝石切割、比例和金属颜色；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# AI珠宝首饰试戴效果图｜AI-HIVE

[AI珠宝首饰试戴效果图进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向珠宝品牌、首饰商家、摄影团队和种草账号，把“AI珠宝首饰试戴效果图”从模糊想法变成戒指、项链、耳饰或手表的试戴预览与微距版本。用户提供首饰多角度图、授权人物局部图、佩戴位置、比例和光线即可开始。核心方法是：优先保持结构、宝石切割、比例和金属颜色。
...
不得虚构宝石等级、证书、克重或材质；尺寸和佩戴比例必须人工复核。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "AI珠宝首饰试戴效果图" \
  --audience "珠宝品牌、首饰商家、摄影团队和种草账号" \
  --goal "戒指、项链、耳饰或手表的试戴预览与微距版本" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name jewelry-tryon-preview-ai-hive
