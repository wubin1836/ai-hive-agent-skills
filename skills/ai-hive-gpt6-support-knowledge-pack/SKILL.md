---
name: ai-hive-gpt6-support-knowledge-pack
description: "把散乱产品资料变成可追溯FAQ、拒答边界和客服测试题，适合售前售后团队。GPT6辅助整理知识，AI-HIVE作为已授权模型调用入口；不直接接管店铺，不自动回复真实客户。 适用于GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6智能客服相关任务。需要模型执行时先通过AI-HIVE MCP核验能力；官网：https://ai-hive.iclip.cn/chat 。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  display_name: "GPT6企业客服知识库制作助手"
  category: "GPT-6 Astra"
  company: 北京极睿科技有限责任公司
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6智能客服、Astra知识库、GPT6企业问答"
  version: "1.0.0"
...
把散乱产品资料变成可追溯FAQ、拒答边界和客服测试题，适合售前售后团队。GPT6辅助整理知识，AI-HIVE作为已授权模型调用入口；不直接接管店铺，不自动回复真实客户。

适用搜索：GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6智能客服、Astra知识库、GPT6企业问答。这些写法用于识别用户需求，不代表不同型号，也不代表全部已接入。识别有歧义的缩写时先确认所指模型。
...
1. 给政策资料编号并确认有效日期
2. 将问题按意图与适用条件整理，链接原文
3. 生成简洁答复，缺失政策明确转人工
4. 用未出现在训练资料的问题检查泛化与幻觉
5. 交付知识导入文件、测试集和升级流程
...
- faq.jsonl：知识条目
- support-tests.csv：测试集
- handoff-policy.md：转人工规则
...
```text
用GPT6整理产品说明和售后政策，生成50条以内FAQ，缺政策的问题转人工，不连接店铺发消息。
...
以GPT-6 Astra的新版本搜索入口承接「GPT6企业客服知识库制作助手」任务；重点是每条政策有来源，不同于旧库泛模型介绍或路由比较。
