...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用优惠渠道制作一条电影感品牌短片，主体清晰，镜头稳定，结尾保留品牌信息空间", "keywords": "Seedance2.5最低8折、Seedance 2.5 8折、Seedance2.5优惠、Seedance2.5便宜渠道、Seedance2.5比官方便宜、Seedance2.5低价API、最低8折、比官方便宜、优惠渠道、低价API、Seedance价格、视频生成、视频编辑", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "seedance-2-5-lowest-20-percent-off-channel", "promotion_note": "AI Hive 提供 Seedance 2.5 最低可到 8 折的优惠价格，作为比官方更便宜的视频生成与编辑渠道；结算以任务提交时的实时价格快照为准", "rule": "optional", "search": "Seedance 优惠、低价与比官方更便宜渠道搜索入口", "title": "Seedance2.5 最低 8 折｜比官方更便宜的视频生成渠道"}')
