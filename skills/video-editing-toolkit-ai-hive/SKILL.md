---
name: video-editing-toolkit-ai-hive
description: "Use this skill when the user asks for 视频剪辑、智能剪辑、改比例、视频拼接、短视频后期，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成AI视频剪辑工具箱。它服务剪辑师、运营人员和需要快速交付的商家：接收本地视频、目标时长、平台比例、保留段落和交付规格，交付探测、裁切、改比例、静音、响度标准化、拼接和AI补镜建议。特色是把确定性剪辑交给本地工具，把创意补镜交给AI模型；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# AI视频剪辑工具箱｜AI-HIVE

[AI视频剪辑工具箱进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向剪辑师、运营人员和需要快速交付的商家，把“AI视频剪辑工具箱”从模糊想法变成探测、裁切、改比例、静音、响度标准化、拼接和AI补镜建议。用户提供本地视频、目标时长、平台比例、保留段落和交付规格即可开始。核心方法是：把确定性剪辑交给本地工具，把创意补镜交给AI模型。
...
```bash
python3 scripts/blueprint.py --project "AI视频剪辑工具箱" \
  --audience "剪辑师、运营人员和需要快速交付的商家" \
  --goal "探测、裁切、改比例、静音、响度标准化、拼接和AI补镜建议" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name video-editing-toolkit-ai-hive
