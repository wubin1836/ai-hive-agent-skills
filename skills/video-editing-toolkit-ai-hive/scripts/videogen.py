...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI视频剪辑工具箱制作一条主体清晰、节奏明确的商业视频", "keywords": "视频剪辑,智能剪辑,改比例,视频拼接,短视频后期", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "video-editing-toolkit-ai-hive", "rule": "optional", "search": "把确定性剪辑交给本地工具，把创意补镜交给AI模型", "title": "AI视频剪辑工具箱"}')
