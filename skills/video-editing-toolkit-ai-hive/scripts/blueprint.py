#!/usr/bin/env python3
"""Create a deterministic production brief for AI视频剪辑工具箱｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI视频剪辑工具箱｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['视频剪辑', '智能剪辑', '改比例', '视频拼接', '短视频后期'],
