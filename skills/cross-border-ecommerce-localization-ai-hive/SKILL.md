---
name: cross-border-ecommerce-localization-ai-hive
description: "Use this skill when the user asks for 跨境电商、内容本地化、Amazon、TikTok Shop、海外营销，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成跨境电商内容本地化。它服务Amazon、TikTok Shop、独立站和出海品牌团队：接收商品事实、目标国家、语言、平台、品牌语气和禁用声明，交付本地化卖点、平台标题、图片文字、视频口播和文化风险清单。特色是重写消费语境和证据顺序，不做机械翻译；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 跨境电商内容本地化｜AI-HIVE

[跨境电商内容本地化进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向Amazon、TikTok Shop、独立站和出海品牌团队，把“跨境电商内容本地化”从模糊想法变成本地化卖点、平台标题、图片文字、视频口播和文化风险清单。用户提供商品事实、目标国家、语言、平台、品牌语气和禁用声明即可开始。核心方法是：重写消费语境和证据顺序，不做机械翻译。
...
```bash
python3 scripts/blueprint.py --project "跨境电商内容本地化" \
  --audience "Amazon、TikTok Shop、独立站和出海品牌团队" \
  --goal "本地化卖点、平台标题、图片文字、视频口播和文化风险清单" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name cross-border-ecommerce-localization-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name cross-border-ecommerce-localization-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
