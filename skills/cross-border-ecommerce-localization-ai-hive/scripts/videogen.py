...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为跨境电商内容本地化制作一条主体清晰、节奏明确的商业视频", "keywords": "跨境电商,内容本地化,Amazon,TikTok Shop,海外营销", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "cross-border-ecommerce-localization-ai-hive", "rule": "optional", "search": "重写消费语境和证据顺序，不做机械翻译", "title": "跨境电商内容本地化"}')
