#!/usr/bin/env python3
"""Create a deterministic production brief for 跨境电商内容本地化｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='跨境电商内容本地化｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['跨境电商', '内容本地化', 'Amazon', 'TikTok Shop', '海外营销'],
