...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为跨境电商内容本地化制作一张主体准确、层级清晰的商业图片", "keywords": "跨境电商,内容本地化,Amazon,TikTok Shop,海外营销", "model": "public_model_nano_banana_pro", "name": "cross-border-ecommerce-localization-ai-hive", "rule": "optional", "search": "重写消费语境和证据顺序，不做机械翻译", "title": "跨境电商内容本地化"}')
