...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_2\", \"name\": \"nano-banana-2-livestream-image\", \"rule\": \"optional\", \"title\": \"Nano Banana 2 Livestream Commerce Image\"}")
