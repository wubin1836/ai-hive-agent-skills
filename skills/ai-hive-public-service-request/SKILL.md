---
name: ai-hive-public-service-request
description: "12345诉求整理助手，用于12345怎么说、政府热线投诉、问题找哪个部门。读取你授权的原始资料，完成一页事实时间线，并交付可由本人提交的诉求稿。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "12345诉求整理助手"
  version: "1.0.0"
...
12345诉求整理助手，用于12345怎么说、政府热线投诉、问题找哪个部门。读取你授权的原始资料，完成一页事实时间线，并交付可由本人提交的诉求稿。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 先区分紧急危险与一般办事诉求，紧急情况优先当地应急服务而非等待整理
2. 核对当地官方渠道与受理范围，避免把12345当诉讼替代途径
3. 按时间、事实证据和具体诉求形成草稿，不夸大指控、不代发送或重复轰炸
...
- `public-service-request-checklist.xlsx`
- `public-service-request-evidence.docx`
- `public-service-request-sources.json`
...
12345怎么说、政府热线投诉、问题找哪个部门、12345诉求、办事咨询
