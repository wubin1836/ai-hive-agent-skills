---
name: virtual-host-product-video-ai-hive
description: "Use this skill when the user asks for 虚拟主播、数字人带货、商品播报、AI口播视频、店播视频，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成虚拟主播商品播报视频。它服务店播商家、私域运营、跨境卖家和企业产品团队：接收授权虚拟主播或人物参考、商品事实、平台、语言、时长和CTA，交付主播人设、商品播报稿、持物或屏幕画面、视频和多语言脚本。特色是用稳定虚拟主播批量播报真实商品信息；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 虚拟主播商品播报视频｜AI-HIVE

[虚拟主播商品播报视频进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向店播商家、私域运营、跨境卖家和企业产品团队，把“虚拟主播商品播报视频”从模糊想法变成主播人设、商品播报稿、持物或屏幕画面、视频和多语言脚本。用户提供授权虚拟主播或人物参考、商品事实、平台、语言、时长和CTA即可开始。核心方法是：用稳定虚拟主播批量播报真实商品信息。
...
不得冒充真人主播或伪造直播互动；价格、库存和活动需使用当前数据。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "虚拟主播商品播报视频" \
  --audience "店播商家、私域运营、跨境卖家和企业产品团队" \
  --goal "主播人设、商品播报稿、持物或屏幕画面、视频和多语言脚本" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name virtual-host-product-video-ai-hive
