#!/usr/bin/env python3
"""Create a deterministic production brief for 虚拟主播商品播报视频｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='虚拟主播商品播报视频｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['虚拟主播', '数字人带货', '商品播报', 'AI口播视频', '店播视频'],
