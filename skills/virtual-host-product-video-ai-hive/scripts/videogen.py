...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为虚拟主播商品播报视频制作一条主体清晰、节奏明确的商业视频", "keywords": "虚拟主播,数字人带货,商品播报,AI口播视频,店播视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "virtual-host-product-video-ai-hive", "rule": "optional", "search": "用稳定虚拟主播批量播报真实商品信息", "title": "虚拟主播商品播报视频"}')
