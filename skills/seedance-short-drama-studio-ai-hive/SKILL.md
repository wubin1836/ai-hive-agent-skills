---
name: seedance-short-drama-studio-ai-hive
description: "Use this skill when the user asks for Seedance短剧、AI短剧、漫剧、剧情视频、短剧分镜，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成Seedance 短剧生成工作室。它服务短剧团队、漫剧工作室、品牌内容部门和独立创作者：接收剧本、人物设定、场景参考、集数、单集时长和画风，交付人物板、故事板、场景板、逐镜提示词、生成任务和连续性验收。特色是把连续性资产前置，减少角色和场景漂移；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# Seedance 短剧生成工作室｜AI-HIVE

[Seedance 短剧生成工作室进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向短剧团队、漫剧工作室、品牌内容部门和独立创作者，把“Seedance 短剧生成工作室”从模糊想法变成人物板、故事板、场景板、逐镜提示词、生成任务和连续性验收。用户提供剧本、人物设定、场景参考、集数、单集时长和画风即可开始。核心方法是：把连续性资产前置，减少角色和场景漂移。
...
```bash
python3 scripts/blueprint.py --project "Seedance 短剧生成工作室" \
  --audience "短剧团队、漫剧工作室、品牌内容部门和独立创作者" \
  --goal "人物板、故事板、场景板、逐镜提示词、生成任务和连续性验收" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name seedance-short-drama-studio-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name seedance-short-drama-studio-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
