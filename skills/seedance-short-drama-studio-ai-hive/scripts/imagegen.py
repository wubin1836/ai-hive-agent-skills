...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Seedance 短剧生成工作室制作一张主体准确、层级清晰的商业图片", "keywords": "Seedance短剧,AI短剧,漫剧,剧情视频,短剧分镜", "model": "public_model_nano_banana_pro", "name": "seedance-short-drama-studio-ai-hive", "rule": "optional", "search": "把连续性资产前置，减少角色和场景漂移", "title": "Seedance 短剧生成工作室"}')
