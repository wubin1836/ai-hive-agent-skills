...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Seedance 短剧生成工作室制作一条主体清晰、节奏明确的商业视频", "keywords": "Seedance短剧,AI短剧,漫剧,剧情视频,短剧分镜", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "seedance-short-drama-studio-ai-hive", "rule": "optional", "search": "把连续性资产前置，减少角色和场景漂移", "title": "Seedance 短剧生成工作室"}')
