...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为品牌视觉一致性审核制作一条主体清晰、节奏明确的商业视频", "keywords": "品牌一致性,品牌审核,视觉规范,Brand Check,AI内容质检", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "brand-visual-consistency-audit-ai-hive", "rule": "optional", "search": "以用户提供的品牌规范为唯一标准进行对照", "title": "品牌视觉一致性审核"}')
