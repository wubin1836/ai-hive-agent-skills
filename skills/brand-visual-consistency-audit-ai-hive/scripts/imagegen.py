...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为品牌视觉一致性审核制作一张主体准确、层级清晰的商业图片", "keywords": "品牌一致性,品牌审核,视觉规范,Brand Check,AI内容质检", "model": "public_model_gpt_image_2", "name": "brand-visual-consistency-audit-ai-hive", "rule": "optional", "search": "以用户提供的品牌规范为唯一标准进行对照", "title": "品牌视觉一致性审核"}')
