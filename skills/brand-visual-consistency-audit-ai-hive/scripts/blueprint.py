#!/usr/bin/env python3
"""Create a deterministic production brief for 品牌视觉一致性审核｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='品牌视觉一致性审核｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['品牌一致性', '品牌审核', '视觉规范', 'Brand Check', 'AI内容质检'],
