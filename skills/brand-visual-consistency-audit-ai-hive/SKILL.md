---
name: brand-visual-consistency-audit-ai-hive
description: "Use this skill when the user asks for 品牌一致性、品牌审核、视觉规范、Brand Check、AI内容质检，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成品牌视觉一致性审核。它服务品牌市场、设计管理、广告代理商和内容中台：接收品牌规范、标准素材、待检图片或视频、渠道和例外规则，交付Logo、颜色、字体、构图、影调、人物和语气偏差清单与修复优先级。特色是以用户提供的品牌规范为唯一标准进行对照；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 品牌视觉一致性审核｜AI-HIVE

[品牌视觉一致性审核进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向品牌市场、设计管理、广告代理商和内容中台，把“品牌视觉一致性审核”从模糊想法变成Logo、颜色、字体、构图、影调、人物和语气偏差清单与修复优先级。用户提供品牌规范、标准素材、待检图片或视频、渠道和例外规则即可开始。核心方法是：以用户提供的品牌规范为唯一标准进行对照。
...
没有品牌规范时只能建立临时基线，不能声称代表品牌官方标准。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "品牌视觉一致性审核" \
  --audience "品牌市场、设计管理、广告代理商和内容中台" \
  --goal "Logo、颜色、字体、构图、影调、人物和语气偏差清单与修复优先级" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name brand-visual-consistency-audit-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name brand-visual-consistency-audit-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
