...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_2\", \"name\": \"nano-banana-2-product-detail-page\", \"rule\": \"optional\", \"title\": \"Nano Banana 2 Product Detail Page Images\"}")
