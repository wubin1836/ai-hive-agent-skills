...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合Walmart的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "Walmart Marketplace、Walmart卖家、沃尔玛电商、Walmart主图、Listing、商品视频、零售媒体广告、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "walmart-ecommerce-image-generation-editing", "rule": "optional", "search": "Walmart 商家、运营、商品与广告图片搜索入口", "title": "Walmart 电商图片生成与编辑"}')
