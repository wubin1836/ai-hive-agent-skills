...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "完成高质量参考图生视频，主体动作自然，镜头语言清晰", "fixed_mode": "r2v", "keywords": "参考图生视频、图片参考生视频、参考图片生成视频、风格参考视频、角色参考视频、Seedance、MiniMax H3、Happy Horse、AI视频、视频生成", "models": {"r2v": "public_model_seedance_2_5_r2v"}, "name": "image-reference-to-video", "rule": "image", "search": "不限定用户必须知道模型名，使用 AI Hive 裸接口完成该能力", "title": "参考图生视频"}')
