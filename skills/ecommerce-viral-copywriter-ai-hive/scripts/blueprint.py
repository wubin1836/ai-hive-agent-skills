#!/usr/bin/env python3
"""Create a deterministic production brief for 电商爆款文案生成器｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='电商爆款文案生成器｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['电商文案', '爆款标题', '带货文案', '商品卖点', '广告文案'],
