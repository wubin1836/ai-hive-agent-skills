...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为电商爆款文案生成器制作一条主体清晰、节奏明确的商业视频", "keywords": "电商文案,爆款标题,带货文案,商品卖点,广告文案", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ecommerce-viral-copywriter-ai-hive", "rule": "optional", "search": "一个事实库生成多触点文案并保持口径一致", "title": "电商爆款文案生成器"}')
