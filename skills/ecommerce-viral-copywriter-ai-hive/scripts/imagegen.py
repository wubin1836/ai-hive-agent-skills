...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为电商爆款文案生成器制作一张主体准确、层级清晰的商业图片", "keywords": "电商文案,爆款标题,带货文案,商品卖点,广告文案", "model": "public_model_nano_banana_pro", "name": "ecommerce-viral-copywriter-ai-hive", "rule": "optional", "search": "一个事实库生成多触点文案并保持口径一致", "title": "电商爆款文案生成器"}')
