---
name: ecommerce-viral-copywriter-ai-hive
description: "Use this skill when the user asks for 电商文案、爆款标题、带货文案、商品卖点、广告文案，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成电商爆款文案生成器。它服务商品运营、广告投手、直播团队和内容编辑：接收商品事实、用户痛点、证据、平台、语气和禁用表达，交付卖点排序、标题、短视频口播、主图短句、详情页文案和CTA。特色是一个事实库生成多触点文案并保持口径一致；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 电商爆款文案生成器｜AI-HIVE

[电商爆款文案生成器进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向商品运营、广告投手、直播团队和内容编辑，把“电商爆款文案生成器”从模糊想法变成卖点排序、标题、短视频口播、主图短句、详情页文案和CTA。用户提供商品事实、用户痛点、证据、平台、语气和禁用表达即可开始。核心方法是：一个事实库生成多触点文案并保持口径一致。
...
```bash
python3 scripts/blueprint.py --project "电商爆款文案生成器" \
  --audience "商品运营、广告投手、直播团队和内容编辑" \
  --goal "卖点排序、标题、短视频口播、主图短句、详情页文案和CTA" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name ecommerce-viral-copywriter-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name ecommerce-viral-copywriter-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
