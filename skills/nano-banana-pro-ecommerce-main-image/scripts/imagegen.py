...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_pro\", \"name\": \"nano-banana-pro-ecommerce-main-image\", \"rule\": \"optional\", \"title\": \"Nano Banana Pro E-commerce Main Image\"}")
