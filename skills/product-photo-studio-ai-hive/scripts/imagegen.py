...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI商品图工作室制作一张主体准确、层级清晰的商业图片", "keywords": "AI商品图,产品摄影,白底图,场景图,商品精修", "model": "public_model_nano_banana_pro", "name": "product-photo-studio-ai-hive", "rule": "optional", "search": "以商品外观真实性为底线组织整套商品视觉", "title": "AI商品图工作室"}')
