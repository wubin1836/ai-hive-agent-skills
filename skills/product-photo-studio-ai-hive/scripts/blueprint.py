#!/usr/bin/env python3
"""Create a deterministic production brief for AI商品图工作室｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI商品图工作室｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['AI商品图', '产品摄影', '白底图', '场景图', '商品精修'],
