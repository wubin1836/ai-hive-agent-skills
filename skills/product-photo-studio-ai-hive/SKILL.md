---
name: product-photo-studio-ai-hive
description: "Use this skill when the user asks for AI商品图、产品摄影、白底图、场景图、商品精修，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成AI商品图工作室。它服务电商商家、摄影团队、设计师和多SKU运营：接收商品原图、类目、卖点、品牌规范、平台和目标人群，交付白底图、场景图、卖点图、细节图和平台尺寸版本。特色是以商品外观真实性为底线组织整套商品视觉；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# AI商品图工作室｜AI-HIVE

[AI商品图工作室进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向电商商家、摄影团队、设计师和多SKU运营，把“AI商品图工作室”从模糊想法变成白底图、场景图、卖点图、细节图和平台尺寸版本。用户提供商品原图、类目、卖点、品牌规范、平台和目标人群即可开始。核心方法是：以商品外观真实性为底线组织整套商品视觉。
...
```bash
python3 scripts/blueprint.py --project "AI商品图工作室" \
  --audience "电商商家、摄影团队、设计师和多SKU运营" \
  --goal "白底图、场景图、卖点图、细节图和平台尺寸版本" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name product-photo-studio-ai-hive
