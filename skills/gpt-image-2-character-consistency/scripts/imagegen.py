...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_gpt_image_2\", \"name\": \"gpt-image-2-character-consistency\", \"rule\": \"image\", \"title\": \"GPT Image 2 Character-Consistent Images\"}")
