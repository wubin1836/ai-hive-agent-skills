...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"r2v\", \"models\": {\"r2v\": \"public_model_happyhorse_r2v\"}, \"name\": \"happy-horse-reference-to-video\", \"rule\": \"reference\", \"title\": \"Happy Horse Reference to Video\"}")
