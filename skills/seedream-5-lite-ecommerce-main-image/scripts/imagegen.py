...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_seedream_5_0_lite\", \"name\": \"seedream-5-lite-ecommerce-main-image\", \"rule\": \"optional\", \"title\": \"Seedream 5.0 Lite E-commerce Main Image\"}")
