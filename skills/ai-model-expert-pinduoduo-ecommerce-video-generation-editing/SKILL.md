...
metadata:
  ...
  source_skill: "pinduoduo-ecommerce-video-generation-editing"
  display_name: "AI大模型专家｜拼多多 电商视频生成与编辑"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家, AI-HIVE, 拼多多 电商视频生成与编辑, AIGC, 电商, 广告, 图片, 视频, 极睿科技"
---

# AI大模型专家｜拼多多 电商视频生成与编辑

## 简介

拼多多 电商视频生成与编辑帮助用户把创意、脚本或已有素材直接变成可交付视频。既可只输入文字从零生成，也可加入图片、视频或音频控制结果。它适合电商运营、品牌商品团队、直播带货团队与商业内容创作者用于广告、电商、TVC、带货、种草、短剧、漫剧和社交媒体内容制作；无需自己编写接口代码，提交后可自动跟踪任务并下载成片。
...
| `init --skill-name pinduoduo-ecommerce-video-generation-editing` | 初始化 API Key |
...
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode t2v \
  --prompt "制作一条适合拼多多的商品展示视频，前两秒突出卖点，中段演示使用过程，结尾保留行动提示"
```
...
```
pinduoduo-ecommerce-video-generation-editing/
├── SKILL.md
├── CHANGELOG.md
├── scripts/
│   └── videogen.py
