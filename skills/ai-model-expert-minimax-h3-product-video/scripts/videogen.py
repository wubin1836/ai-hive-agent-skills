...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一条高完成度产品宣传视频，主体明确，节奏清晰，结尾有记忆点", "keywords": "MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、产品宣传视频、产品视频、产品宣传片、商品展示、产品镜头、品牌宣传片、AI视频、视频生成", "models": {"i2v": "public_model_minimax_h3_i2v", "r2v": "public_model_minimax_h3_r2v", "t2v": "public_model_minimax_h3_t2v"}, "name": "minimax-h3-product-video", "rule": "optional", "search": "使用 MiniMax H3 制作产品宣传视频", "title": "MiniMax H3 产品宣传视频"}')
