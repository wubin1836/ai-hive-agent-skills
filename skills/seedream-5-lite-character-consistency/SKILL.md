...
|---|---|---|
| Seedream 5.0 Lite Character-Consistent Images | `public_model_seedream_5_0_lite` | At least one reference image |
...
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "Create a polished seedream 5.0 lite character-consistent images visual with an accurate subject, clear composition, and commercial finish" \
...
```bash
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "Create a polished seedream 5.0 lite character-consistent images result; preserve factual product details and leave useful copy space" \
+  --image /path/to/reference.png
```
