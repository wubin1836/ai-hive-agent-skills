---
name: ai-hive-residence-permit-renewal
description: "居住证办理与续签助手，用于居住证怎么办、居住证续签、居住登记。读取你授权的原始资料，完成当前城市事项分支表，并交付办事步骤与缺件清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "居住证办理与续签助手"
  version: "1.0.0"
...
居住证办理与续签助手，用于居住证怎么办、居住证续签、居住登记。读取你授权的原始资料，完成当前城市事项分支表，并交付办事步骤与缺件清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 区分首次登记、申领、变更、签注等实际事项，不把各地名称强行统一
2. 查当地公安或政务官方指南并记录版本
3. 检查所需材料与证件时间，仅给准备清单，不代填写虚假住所
...
- `residence-permit-renewal-checklist.xlsx`
- `residence-permit-renewal-evidence.docx`
- `residence-permit-renewal-sources.json`
