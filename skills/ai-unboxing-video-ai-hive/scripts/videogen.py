...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI开箱视频生成器制作一条主体清晰、节奏明确的商业视频", "keywords": "AI开箱,开箱视频,新品发布,商品展示,电商视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ai-unboxing-video-ai-hive", "rule": "optional", "search": "按真实包装层级和配件顺序设计开箱体验", "title": "AI开箱视频生成器"}')
