#!/usr/bin/env python3
"""Create a deterministic production brief for AI开箱视频生成器｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI开箱视频生成器｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['AI开箱', '开箱视频', '新品发布', '商品展示', '电商视频'],
