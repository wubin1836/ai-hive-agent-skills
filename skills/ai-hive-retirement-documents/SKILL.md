---
name: ai-hive-retirement-documents
description: "退休办理材料助手，用于办理退休、退休手续、退休申请材料。读取你授权的原始资料，完成退休办理材料目录，并交付当地办理步骤与联系人清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "退休办理材料助手"
  version: "1.0.0"
...
退休办理材料助手，用于办理退休、退休手续、退休申请材料。读取你授权的原始资料，完成退休办理材料目录，并交付当地办理步骤与联系人清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 确认办理地、参保类型及官方通知，不默认适用同一退休规则
2. 核对用户提供的记录与当地当期清单，身份原件只留必要引用
3. 列材料版本、缺失页和需要经办机构核定的事项，正式申请由本人确认
...
- `retirement-documents-checklist.xlsx`
- `retirement-documents-evidence.docx`
- `retirement-documents-sources.json`
...
> 仅示例，以下文件名和情境均为假设，不表示已存在真实数据：假设我已提供 示例_退休办理通知.pdf、示例_脱敏缴费履历.xlsx、示例_档案材料目录.csv。请使用「退休办理材料助手」，按办理地清单整理父母退休申请的已有材料、缺页及需要核定的历史记录。将结果写入我指定的本地目录，交付 retirement-documents-checklist.xlsx、retirement-documents-evidence.docx、retirement-documents-sources.json。本例先离线处理；输入、工具或适用规则不足时先交缺口说明，不编造结果。需要联网更新来源先征得我同意，不登录账户、不代提交或付款。

## 搜索与任务识别

办理退休、退休手续、退休申请材料、退休一件事、退休档案
