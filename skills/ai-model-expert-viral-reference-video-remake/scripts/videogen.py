...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "参考现有视频的节奏、动作和运镜，但替换为用户提供的商品、人物与品牌视觉，形成原创版本", "keywords": "参考视频仿拍、爆款视频二创、视频复刻、动作参考、运镜参考、同款视频、R2V", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "viral-reference-video-remake", "product_promise": "使用参考视频控制结构和节奏，重建为新的品牌内容；不复制第三方商标、人物身份或受保护素材", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "爆款参考视频仿拍与二创", "trend_inspired": true}')
