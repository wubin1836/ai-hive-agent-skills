#!/usr/bin/env python3
"""Create a deterministic production brief for 家庭伦理短剧 AI生成与编辑."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='家庭伦理短剧 AI生成与编辑')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['家庭伦理短剧', '家庭情感', '婆媳剧情', '亲情故事'],
