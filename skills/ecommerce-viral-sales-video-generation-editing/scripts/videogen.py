...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "电商爆款带货视频，围绕单一商品卖点，通过痛点、演示、证据和行动提示完成转化叙事", "keywords": "电商爆款视频、爆单视频、带货视频、商品视频、主图视频、详情页视频、转化视频", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "ecommerce-viral-sales-video-generation-editing", "product_promise": "输入商品事实、受众、平台和转化目标，交付可用于主图、详情页、直播切片和广告投放的商品视频", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "电商爆款带货视频生成与编辑", "trend_inspired": true}')
