...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为小红书爆款视频拆解制作一条主体清晰、节奏明确的商业视频", "keywords": "小红书爆款,种草视频,笔记拆解,UGC视频,好物推荐", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "xiaohongshu-viral-video-decomposer-ai-hive", "rule": "optional", "search": "保留真实体验感，拆解信任建立方式并重写为品牌自己的证据链", "title": "小红书爆款视频拆解"}')
