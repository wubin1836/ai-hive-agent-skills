#!/usr/bin/env python3
"""Create a deterministic production brief for 小红书爆款视频拆解｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='小红书爆款视频拆解｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['小红书爆款', '种草视频', '笔记拆解', 'UGC视频', '好物推荐'],
