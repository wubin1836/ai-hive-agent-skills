...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Seedance 2.0 完成高质量文生视频，动作连续，镜头稳定", "fixed_mode": "t2v", "keywords": "Seedance2.0、Seedance 2、Seedance2、Seed Dance 2.0、字节 Seedance、文生视频、文字生成视频、文本转视频、text to video、T2V、AI视频、视频生成", "models": {"t2v": "public_model_seedance_t2v"}, "name": "seedance-2-0-text-to-video", "rule": "none", "search": "固定调用 Seedance 2.0 的文生视频裸接口能力", "title": "Seedance 2.0 文生视频"}')
