...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为高德地图门店活动营销制作事实可核验的本地生活营销图片", "model": "public_model_nano_banana_pro", "name": "local-amap-promotion-ai-hive", "title": "AI大模型专家｜高德地图门店活动营销", "keywords": "高德地图、高德商家、高德地图门店、高德POI、高德地图营销、门店活动营销、本地生活、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前模型与价格，并在平台官方后台核对当前规则"}')
