---
name: viral-video-shot-rhythm-analyzer-ai-hive
description: "Use this skill when the user asks for 镜头拆解、剪辑节奏、转场手法、B-roll、视频重剪，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成爆款视频镜头节奏拆解。它服务视频剪辑师、后期团队和短视频编导：接收授权视频、目标时长、平台比例、音乐节拍和必须保留镜头，交付镜头时长表、节奏峰谷、转场逻辑、B-roll清单和重剪方案。特色是用时间轴和镜头功能解释节奏，不把快切等同于有效；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 爆款视频镜头节奏拆解｜AI-HIVE

[爆款视频镜头节奏拆解进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向视频剪辑师、后期团队和短视频编导，把“爆款视频镜头节奏拆解”从模糊想法变成镜头时长表、节奏峰谷、转场逻辑、B-roll清单和重剪方案。用户提供授权视频、目标时长、平台比例、音乐节拍和必须保留镜头即可开始。核心方法是：用时间轴和镜头功能解释节奏，不把快切等同于有效。
...
```bash
python3 scripts/blueprint.py --project "爆款视频镜头节奏拆解" \
  --audience "视频剪辑师、后期团队和短视频编导" \
  --goal "镜头时长表、节奏峰谷、转场逻辑、B-roll清单和重剪方案" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name viral-video-shot-rhythm-analyzer-ai-hive
