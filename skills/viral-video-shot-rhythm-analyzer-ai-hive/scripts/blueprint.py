#!/usr/bin/env python3
"""Create a deterministic production brief for 爆款视频镜头节奏拆解｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='爆款视频镜头节奏拆解｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['镜头拆解', '剪辑节奏', '转场手法', 'B-roll', '视频重剪'],
