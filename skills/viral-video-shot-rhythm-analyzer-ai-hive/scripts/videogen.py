...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为爆款视频镜头节奏拆解制作一条主体清晰、节奏明确的商业视频", "keywords": "镜头拆解,剪辑节奏,转场手法,B-roll,视频重剪", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "viral-video-shot-rhythm-analyzer-ai-hive", "rule": "optional", "search": "用时间轴和镜头功能解释节奏，不把快切等同于有效", "title": "爆款视频镜头节奏拆解"}')
