...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"r2v\", \"models\": {\"r2v\": \"public_model_seedance_r2v\"}, \"name\": \"seedance-2-0-image-reference-to-video\", \"rule\": \"image\", \"title\": \"Seedance 2.0 Image Reference to Video\"}")
