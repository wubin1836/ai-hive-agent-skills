---
name: seedance-2-0-image-reference-to-video
description: "Use this skill when creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers need to use reference images to control subjects, products, composition, or style with Seedance 2.0 through the AI Hive OpenAPI. It handles required media uploads, live model and price lookup, task submission, progress polling, and result downloads. Useful for ads, TVCs, product videos, e-commerce listings, social commerce, UGC-style seeding content, short dramas, motion comics, and storyboards. Search intents include reference image video, style reference video, character reference video."
license: MIT
---
...
Seedance 2.0 Image Reference to Video helps creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers use reference images to control subjects, products, composition, or style with Seedance 2.0. Describe the intended subject, action, camera, lighting, pacing, and constraints; the bundled CLI handles AI Hive OpenAPI calls and downloads the finished video.
...
Ads, tvcs, product videos, e-commerce listings, social commerce, ugc-style seeding content, short dramas, motion comics, and storyboards. It is also useful when users search for reference image video, style reference video, character reference video.
...
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode r2v \
  --prompt "Seedance 2.0 Image Reference to Video: polished motion, clear subject, coherent action, stable camera, commercial finish" \
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode r2v \
  --prompt "Create a polished seedance 2.0 image reference to video result with coherent motion, stable identity, and a clear ending" \
+  --image /path/to/reference.png
```
