#!/usr/bin/env python3
"""Create a deterministic production brief for 繁花剧场短剧 AI生成与编辑."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='繁花剧场短剧 AI生成与编辑')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['繁花剧场', '繁花短剧', '免费短剧', '剧情短片'],
