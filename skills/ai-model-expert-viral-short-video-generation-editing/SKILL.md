...
metadata:
  ...
  source_skill: "viral-short-video-generation-editing"
  display_name: "AI大模型专家｜爆款短视频生成与编辑｜一键出片"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家, AI-HIVE, 爆款短视频生成与编辑｜一键出片, AIGC, 电商, 广告, 图片, 视频, 极睿科技"
---

# AI大模型专家｜爆款短视频生成与编辑｜一键出片

## 简介

爆款短视频生成与编辑｜一键出片帮助用户把创意、脚本或已有素材直接变成可交付视频。既可只输入文字从零生成，也可加入图片、视频或音频控制结果。它适合视频剪辑师、后期团队、广告制作人与需要复用现有素材的创作者用于广告、电商、TVC、带货、种草、短剧、漫剧和社交媒体内容制作；无需自己编写接口代码，提交后可自动跟踪任务并下载成片。
...
| `init --skill-name viral-short-video-generation-editing` | 初始化 API Key |
...
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode t2v \
  --prompt "竖屏爆款短视频，黄金三秒直接展示冲突或结果，中段快速证明核心利益点，结尾给出明确行动提示"
```
...
```bash
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name viral-short-video-generation-editing
```
...
```
viral-short-video-generation-editing/
├── SKILL.md
├── CHANGELOG.md
├── scripts/
│   └── videogen.py
