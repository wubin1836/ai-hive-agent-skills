...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"extend\", \"models\": {\"extend\": \"public_model_seedance_2_5_video_extend\"}, \"name\": \"seedance-video-extend\", \"rule\": \"extend\", \"title\": \"Seedance Video Extension\"}")
