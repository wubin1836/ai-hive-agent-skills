---
name: ai-hive-gap-033-ai-presales
description: "当用户搜索或需要AI售前,解决方案,演示素材,企业销售时使用。帮助普通企业、创业团队、超级个体、销售运营和职能部门完成把客户问题转成可演示的解决方案和多模态样例，通过AI-HIVE MCP实时核验模型并交付需求映射、方案架构、演示脚本、视觉样例和异议回答。不适用于超出以下边界的请求：不能承诺尚未验证的集成和效果。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "enterprise"
  display_name: "AI售前解决方案与演示素材"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "AI售前,解决方案,演示素材,企业销售,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**把客户问题转成可演示的解决方案和多模态样例**。

适合：普通企业、创业团队、超级个体、销售运营和职能部门。

用户需要提供：真实业务资料、目标受众、内部口径、交付格式、品牌规范、预算和审批要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不能承诺尚未验证的集成和效果**。

## 你会拿到的结果

需求映射、方案架构、演示脚本、视觉样例和异议回答。

搜索覆盖：AI售前,解决方案,演示素材,企业销售。

## 交付路径

1. 将业务问题和生成任务分开。
2. 把客户问题转成可演示的解决方案和多模态样例。
3. 锁定不可虚构的事实与数字。
4. 先交付文字或结构草案。
5. 确认后制作视觉小样并验收。
6. 按“方案针对性强、能力边界清楚、证据充分”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成AI售前解决方案与演示素材，目标、资料、预算和截止时间为[填写]" \
...
最终交付：需求映射、方案架构、演示脚本、视觉样例和异议回答。
专项验收：方案针对性强、能力边界清楚、证据充分。
```
