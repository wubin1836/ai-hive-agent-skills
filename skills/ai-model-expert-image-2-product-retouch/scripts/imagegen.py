...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Image2 制作高完成度商品精修，主体准确，构图清晰", "keywords": "Image2、Image 2、GPT Image 2、GPTImage2、OpenAI 图片、ChatGPT 图片、商品精修、产品精修、商品修图、质感增强、瑕疵修复、电商精修、AI图片、AIGC图片", "model": "public_model_gpt_image_2", "name": "image-2-product-retouch", "rule": "image", "search": "固定调用 Image2 的商品精修裸接口能力", "title": "Image2 商品精修"}')
