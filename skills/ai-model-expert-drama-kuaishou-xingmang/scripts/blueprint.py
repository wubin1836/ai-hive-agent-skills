#!/usr/bin/env python3
"""Create a deterministic production brief for 快手星芒短剧 AI生成与编辑."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='快手星芒短剧 AI生成与编辑')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['快手星芒', '快手短剧', '星芒短剧', '老铁短剧'],
