---
name: ai-hive-gpt6-screenshot-ui-spec
description: "从获授权的界面截图整理布局、组件和交互待确认项，适合设计交接与旧系统升级。GPT Astra辅助视觉理解，不把图片中的未知交互当事实，可进一步通过宿主前端工具制作原型。 适用于GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6识图相关任务。需要模型执行时先通过AI-HIVE MCP核验能力；官网：https://ai-hive.iclip.cn/chat 。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  display_name: "GPT Astra截图转界面规范助手"
  category: "GPT-6 Astra"
  company: 北京极睿科技有限责任公司
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6识图、GPT Astra截图分析、GPT6设计交接"
  version: "1.0.0"
...
从获授权的界面截图整理布局、组件和交互待确认项，适合设计交接与旧系统升级。GPT Astra辅助视觉理解，不把图片中的未知交互当事实，可进一步通过宿主前端工具制作原型。

适用搜索：GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6识图、GPT Astra截图分析、GPT6设计交接。这些写法用于识别用户需求，不代表不同型号，也不代表全部已接入。识别有歧义的缩写时先确认所指模型。
...
以GPT-6 Astra的新版本搜索入口承接「GPT Astra截图转界面规范助手」任务；重点是不臆造截图之外功能，不同于旧库泛模型介绍或路由比较。
