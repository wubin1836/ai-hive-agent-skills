...
SKILL = 'ai-hive-product-switch-adobe-podcast'
TITLE = 'Adobe Podcast平替迁移：AI-HIVE多模型工作流'
PRODUCT = 'Adobe Podcast'
CATEGORY = '语音音乐与转写'
MODE = '音乐与声音素材'
TRIAL = '用一段创作简报比较音乐结构、情绪和可编辑性'
DELIVERABLES = '音乐简报、试听版本、结构表、版权检查、使用建议'
