---
name: ai-hive-gap-050-deep-research-content
description: "当用户搜索或需要Deep Research,深度研究,研究智能体,内容生产时使用。帮助企业知识管理、研究、培训、销售、客服和个人知识创作者完成把深度研究证据转成报告、演示和多平台内容，通过AI-HIVE MCP实时核验模型并交付研究问题、来源矩阵、结论、反方证据、报告和内容包。不适用于超出以下边界的请求：没有实时研究工具时必须基于用户提供资料。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "knowledge"
  display_name: "Deep Research研究到内容"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "Deep Research,深度研究,研究智能体,内容生产,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**把深度研究证据转成报告、演示和多平台内容**。

适合：企业知识管理、研究、培训、销售、客服和个人知识创作者。

用户需要提供：有权使用的文档、知识库导出、来源链接、目标受众、内容格式和更新日期。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**没有实时研究工具时必须基于用户提供资料**。

## 你会拿到的结果

研究问题、来源矩阵、结论、反方证据、报告和内容包。

搜索覆盖：Deep Research,深度研究,研究智能体,内容生产。

## 工作方法

1. 建立资料索引与可信度层级。
2. 把深度研究证据转成报告、演示和多平台内容。
3. 把事实、观点和生成建议分层。
4. 每个结论保留来源位置。
5. 确认知识结构后再生成多模态内容。
6. 按“来源多样、结论克制、引用可追溯”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成Deep Research研究到内容，目标、资料、预算和截止时间为[填写]" \
...
```text
请使用「Deep Research研究到内容」Skill帮助我。
我的目标：[填写]
受众和业务场景：[填写]
已有资料与来源：[填写]
交付格式和数量：[填写]
...
最终交付：研究问题、来源矩阵、结论、反方证据、报告和内容包。
专项验收：来源多样、结论克制、引用可追溯。
```
