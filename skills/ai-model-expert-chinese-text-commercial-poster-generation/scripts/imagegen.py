...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "商业图片包含指定中文标题，严格保持字词、大小写、换行和位置，主体与排版层级清晰", "keywords": "精准中文、图片文字、中文海报、广告文字、商品卖点图、标题排版、文字编辑", "model": "public_model_nano_banana_pro", "name": "chinese-text-commercial-poster-generation", "product_promise": "面向中文海报、详情页和广告图生成带文字视觉，并要求交付前逐字复核", "rule": "optional", "search": "面向爆款封面、电商主图、详情页、广告、海报和社媒套图等结果型搜索意图", "title": "精准中文文字商业图片生成与编辑", "trend_inspired": true}')
