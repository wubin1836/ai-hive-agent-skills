---
name: seedance-comic-drama-video
description: "Use this skill when creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers need to turn comic-style scenes into dramatic animated episodes with Seedance through the AI Hive OpenAPI. It handles required media uploads, live model and price lookup, task submission, progress polling, and result downloads. Useful for ads, TVCs, product videos, e-commerce listings, social commerce, UGC-style seeding content, short dramas, motion comics, and storyboards. Search intents include comic drama, manga drama, webtoon video, animated comic story."
license: MIT
---

# Seedance Comic Drama Video

## Overview

Seedance Comic Drama Video helps creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers turn comic-style scenes into dramatic animated episodes with Seedance. Describe the intended subject, action, camera, lighting, pacing, and constraints; the bundled CLI handles AI Hive OpenAPI calls and downloads the finished video.
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name seedance-comic-drama-video
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode i2v \
  --prompt "Seedance Comic Drama Video: polished motion, clear subject, coherent action, stable camera, commercial finish"
```
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "Create a polished seedance comic drama video result with coherent motion, stable identity, and a clear ending"
```
