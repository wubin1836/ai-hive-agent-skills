...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为抖音爆款短视频拆解制作一条主体清晰、节奏明确的商业视频", "keywords": "抖音爆款,短视频拆解,抖音带货,千川素材,爆款复刻", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "douyin-viral-video-decomposer-ai-hive", "rule": "optional", "search": "围绕停留、完播、点击与转化四个阶段重新设计", "title": "抖音爆款短视频拆解"}')
