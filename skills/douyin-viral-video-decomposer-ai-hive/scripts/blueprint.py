#!/usr/bin/env python3
"""Create a deterministic production brief for 抖音爆款短视频拆解｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='抖音爆款短视频拆解｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['抖音爆款', '短视频拆解', '抖音带货', '千川素材', '爆款复刻'],
