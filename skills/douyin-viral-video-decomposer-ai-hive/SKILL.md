---
name: douyin-viral-video-decomposer-ai-hive
description: "Use this skill when the user asks for 抖音爆款、短视频拆解、抖音带货、千川素材、爆款复刻，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成抖音爆款短视频拆解。它服务抖音商家、投手、编导和短视频运营：接收参考视频、商品卖点、客单价、投放目标和禁用表达，交付停留钩子、情绪曲线、卖点节拍、口播脚本和9:16镜头表。特色是围绕停留、完播、点击与转化四个阶段重新设计；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 抖音爆款短视频拆解｜AI-HIVE

[抖音爆款短视频拆解进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向抖音商家、投手、编导和短视频运营，把“抖音爆款短视频拆解”从模糊想法变成停留钩子、情绪曲线、卖点节拍、口播脚本和9:16镜头表。用户提供参考视频、商品卖点、客单价、投放目标和禁用表达即可开始。核心方法是：围绕停留、完播、点击与转化四个阶段重新设计。
...
```bash
python3 scripts/blueprint.py --project "抖音爆款短视频拆解" \
  --audience "抖音商家、投手、编导和短视频运营" \
  --goal "停留钩子、情绪曲线、卖点节拍、口播脚本和9:16镜头表" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name douyin-viral-video-decomposer-ai-hive
