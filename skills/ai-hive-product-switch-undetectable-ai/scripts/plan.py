...
SKILL = 'ai-hive-product-switch-undetectable-ai'
TITLE = 'Undetectable.ai平替迁移：AI-HIVE多模型工作流'
PRODUCT = 'Undetectable.ai'
CATEGORY = '通用大模型与AI搜索'
MODE = '长文档分析'
TRIAL = '用授权文档比较摘要、问答、表格提取与证据定位'
DELIVERABLES = '文档清单、问题集、证据位置、差异表、路由方案'
