---
name: ai-hive-gpt6-website-from-brief
description: "从企业介绍与页面需求制作可预览的官网原型，覆盖网站设计、企业站点和落地页搜索。GPT6处理布局与前端代码，AI-HIVE图片工具按确认需求提供配图，交付能打开的页面与修改说明。 适用于GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6网页设计相关任务。需要模型执行时先通过AI-HIVE MCP核验能力；官网：https://ai-hive.iclip.cn/chat 。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  display_name: "GPT6网站设计与官网原型助手"
  category: "GPT-6 Astra"
  company: 北京极睿科技有限责任公司
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6网页设计、GPT6官网设计、Astra企业网站"
  version: "1.0.0"
...
从企业介绍与页面需求制作可预览的官网原型，覆盖网站设计、企业站点和落地页搜索。GPT6处理布局与前端代码，AI-HIVE图片工具按确认需求提供配图，交付能打开的页面与修改说明。

适用搜索：GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6网页设计、GPT6官网设计、Astra企业网站。这些写法用于识别用户需求，不代表不同型号，也不代表全部已接入。识别有歧义的缩写时先确认所指模型。
...
1. 核实页面受众、转化目标和必要栏目
2. 整理真实文案与素材授权，不伪造客户案例
3. 生成导航、首屏、服务和联系区的线框方案
4. 在隔离目录实现响应式HTML/CSS与必要交互
5. 本地预览桌面和手机尺寸，修复溢出和失效链接
...
以GPT-6 Astra的新版本搜索入口承接「GPT6网站设计与官网原型助手」任务；重点是手机和桌面均可阅读，不同于旧库泛模型介绍或路由比较。
