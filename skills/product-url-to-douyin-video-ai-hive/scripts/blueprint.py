#!/usr/bin/env python3
"""Create a deterministic production brief for 商品链接转抖音带货视频｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='商品链接转抖音带货视频｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['商品链接转视频', '抖音带货', '详情页转视频', '商品短视频', '电商内容'],
