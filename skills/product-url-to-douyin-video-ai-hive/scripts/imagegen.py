...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为商品链接转抖音带货视频制作一张主体准确、层级清晰的商业图片", "keywords": "商品链接转视频,抖音带货,详情页转视频,商品短视频,电商内容", "model": "public_model_nano_banana_pro", "name": "product-url-to-douyin-video-ai-hive", "rule": "optional", "search": "从详情页提取一个核心购买理由，生成可投放竖屏视频", "title": "商品链接转抖音带货视频"}')
