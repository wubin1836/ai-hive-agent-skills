...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为商品链接转抖音带货视频制作一条主体清晰、节奏明确的商业视频", "keywords": "商品链接转视频,抖音带货,详情页转视频,商品短视频,电商内容", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "product-url-to-douyin-video-ai-hive", "rule": "optional", "search": "从详情页提取一个核心购买理由，生成可投放竖屏视频", "title": "商品链接转抖音带货视频"}')
