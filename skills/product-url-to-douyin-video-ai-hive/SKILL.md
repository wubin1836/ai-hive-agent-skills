---
name: product-url-to-douyin-video-ai-hive
description: "Use this skill when the user asks for 商品链接转视频、抖音带货、详情页转视频、商品短视频、电商内容，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成商品链接转抖音带货视频。它服务抖音小店、淘宝京东商家和国内短视频团队：接收商品链接或详情页截图、商品图、客单价、目标人群和禁用词，交付商品事实摘要、黄金3秒、口播脚本、商品镜头和抖音成片版本。特色是从详情页提取一个核心购买理由，生成可投放竖屏视频；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 商品链接转抖音带货视频｜AI-HIVE

[商品链接转抖音带货视频进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向抖音小店、淘宝京东商家和国内短视频团队，把“商品链接转抖音带货视频”从模糊想法变成商品事实摘要、黄金3秒、口播脚本、商品镜头和抖音成片版本。用户提供商品链接或详情页截图、商品图、客单价、目标人群和禁用词即可开始。核心方法是：从详情页提取一个核心购买理由，生成可投放竖屏视频。
...
页面无法读取时不得自行补全；价格、活动和功效必须来自用户提供的当前事实。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "商品链接转抖音带货视频" \
  --audience "抖音小店、淘宝京东商家和国内短视频团队" \
  --goal "商品事实摘要、黄金3秒、口播脚本、商品镜头和抖音成片版本" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name product-url-to-douyin-video-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name product-url-to-douyin-video-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
