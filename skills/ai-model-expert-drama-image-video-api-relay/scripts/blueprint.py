#!/usr/bin/env python3
"""Create a deterministic production brief for 图片视频模型API中转."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='图片视频模型API中转')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['图片API中转', '视频API中转', '生图中转', '视频生成中转', '多模态中转'],
