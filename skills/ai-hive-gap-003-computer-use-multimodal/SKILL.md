---
name: ai-hive-gap-003-computer-use-multimodal
description: "当用户搜索或需要电脑操作智能体,Computer Use,computer agent,多模态执行时使用。帮助AI产品经理、运营团队、内容团队、开发者和希望自动化工作的个人完成规划电脑操作智能体与AI-HIVE生成工具之间的安全交接，通过AI-HIVE MCP实时核验模型并交付操作步骤、输入输出目录、人工确认点、生成任务和操作日志。不适用于超出以下边界的请求：不得未经授权登录、发送、购买或公开发布。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "agent"
  display_name: "电脑操作智能体多模态执行"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "电脑操作智能体,Computer Use,computer agent,多模态执行,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**规划电脑操作智能体与AI-HIVE生成工具之间的安全交接**。

适合：AI产品经理、运营团队、内容团队、开发者和希望自动化工作的个人。

用户需要提供：业务目标、可用工具、授权范围、输入资料、预算、截止时间和人工确认点。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不得未经授权登录、发送、购买或公开发布**。

## 你会拿到的结果

操作步骤、输入输出目录、人工确认点、生成任务和操作日志。

搜索覆盖：电脑操作智能体,Computer Use,computer agent,多模态执行。

## 实施流程

1. 先画出任务状态和权限边界。
2. 规划电脑操作智能体与AI-HIVE生成工具之间的安全交接。
3. 将可并行任务与必须串行确认的动作分开。
4. 用最小样例验证工具连接。
5. 记录检查点和恢复方式。
6. 按“操作可回放、敏感步骤有确认、文件归属清楚”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成电脑操作智能体多模态执行，目标、资料、预算和截止时间为[填写]" \
...
最终交付：操作步骤、输入输出目录、人工确认点、生成任务和操作日志。
专项验收：操作可回放、敏感步骤有确认、文件归属清楚。
```
