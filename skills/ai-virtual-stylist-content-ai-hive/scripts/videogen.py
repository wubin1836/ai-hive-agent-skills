...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI虚拟买手穿搭内容制作一条主体清晰、节奏明确的商业视频", "keywords": "AI穿搭,虚拟买手,穿搭推荐,服装种草,Lookbook", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ai-virtual-stylist-content-ai-hive", "rule": "optional", "search": "只从用户提供的真实SKU中组合，形成可购买的穿搭内容", "title": "AI虚拟买手穿搭内容"}')
