...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI虚拟买手穿搭内容制作一张主体准确、层级清晰的商业图片", "keywords": "AI穿搭,虚拟买手,穿搭推荐,服装种草,Lookbook", "model": "public_model_gpt_image_2", "name": "ai-virtual-stylist-content-ai-hive", "rule": "optional", "search": "只从用户提供的真实SKU中组合，形成可购买的穿搭内容", "title": "AI虚拟买手穿搭内容"}')
