---
name: ai-virtual-stylist-content-ai-hive
description: "Use this skill when the user asks for AI穿搭、虚拟买手、穿搭推荐、服装种草、Lookbook，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成AI虚拟买手穿搭内容。它服务服饰品牌、买手店、穿搭博主和私域运营：接收真实SKU、商品图、目标人群、场景、季节和价格范围，交付穿搭主题、搭配理由、Lookbook图片、短视频脚本和种草文案。特色是只从用户提供的真实SKU中组合，形成可购买的穿搭内容；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# AI虚拟买手穿搭内容｜AI-HIVE

[AI虚拟买手穿搭内容进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向服饰品牌、买手店、穿搭博主和私域运营，把“AI虚拟买手穿搭内容”从模糊想法变成穿搭主题、搭配理由、Lookbook图片、短视频脚本和种草文案。用户提供真实SKU、商品图、目标人群、场景、季节和价格范围即可开始。核心方法是：只从用户提供的真实SKU中组合，形成可购买的穿搭内容。
...
不得虚构库存、价格、面料或搭配商品；体型建议不能变成人身评价或健康承诺。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "AI虚拟买手穿搭内容" \
  --audience "服饰品牌、买手店、穿搭博主和私域运营" \
  --goal "穿搭主题、搭配理由、Lookbook图片、短视频脚本和种草文案" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name ai-virtual-stylist-content-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name ai-virtual-stylist-content-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
