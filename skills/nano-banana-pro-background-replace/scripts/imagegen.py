...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_pro\", \"name\": \"nano-banana-pro-background-replace\", \"rule\": \"image\", \"title\": \"Nano Banana Pro Background Replacement\"}")
