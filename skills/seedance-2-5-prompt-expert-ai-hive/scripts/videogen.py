...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Seedance 2.5 提示词专家制作一条主体清晰、节奏明确的商业视频", "keywords": "Seedance 2.5,视频提示词,参考生视频,视频编辑,视频延长", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "seedance-2-5-prompt-expert-ai-hive", "rule": "optional", "search": "覆盖生成、参考、编辑和延长的完整能力选择", "title": "Seedance 2.5 提示词专家"}')
