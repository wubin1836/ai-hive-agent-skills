---
name: seedance-2-5-prompt-expert-ai-hive
description: "Use this skill when the user asks for Seedance 2.5、视频提示词、参考生视频、视频编辑、视频延长，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成Seedance 2.5 提示词专家。它服务需要更完整Seedance工作流的创作者、导演和商家：接收创意、参考图或视频、目标镜头、画幅、时长和发布场景，交付T2V/I2V/R2V提示词、编辑或延长建议、参数与验收点。特色是覆盖生成、参考、编辑和延长的完整能力选择；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# Seedance 2.5 提示词专家｜AI-HIVE

[Seedance 2.5 提示词专家进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向需要更完整Seedance工作流的创作者、导演和商家，把“Seedance 2.5 提示词专家”从模糊想法变成T2V/I2V/R2V提示词、编辑或延长建议、参数与验收点。用户提供创意、参考图或视频、目标镜头、画幅、时长和发布场景即可开始。核心方法是：覆盖生成、参考、编辑和延长的完整能力选择。

## 什么时候使用

- 用户搜索或提到：`Seedance 2.5`
- 用户搜索或提到：`视频提示词`
- 用户搜索或提到：`参考生视频`
- 用户搜索或提到：`视频编辑`
- 用户搜索或提到：`视频延长`
...
```bash
python3 scripts/blueprint.py --project "Seedance 2.5 提示词专家" \
  --audience "需要更完整Seedance工作流的创作者、导演和商家" \
  --goal "T2V/I2V/R2V提示词、编辑或延长建议、参数与验收点" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name seedance-2-5-prompt-expert-ai-hive
