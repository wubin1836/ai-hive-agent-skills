#!/usr/bin/env python3
"""Create a deterministic production brief for MiniMax H3 视频工具箱｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='MiniMax H3 视频工具箱｜AI-HIVE')
    ...
    data = {
        "skill": 'MiniMax H3 视频工具箱｜AI-HIVE',
        "category": 'video',
        ...
        "format": args.format,
        "searchAliases": ['MiniMax H3', '海螺H3', 'Hailuo H3', '文生视频', '图生视频'],
