...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为MiniMax H3 视频工具箱制作一条主体清晰、节奏明确的商业视频", "keywords": "MiniMax H3,海螺H3,Hailuo H3,文生视频,图生视频", "models": {"t2v": "public_model_minimax_h3_t2v", "i2v": "public_model_minimax_h3_i2v", "r2v": "public_model_minimax_h3_r2v"}, "name": "minimax-h3-video-toolkit-ai-hive", "rule": "optional", "search": "用统一入口选择合适模式并保留成本与任务快照", "title": "MiniMax H3 视频工具箱"}')
