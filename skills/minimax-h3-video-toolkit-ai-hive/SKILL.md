---
name: minimax-h3-video-toolkit-ai-hive
description: "Use this skill when the user asks for MiniMax H3、海螺H3、Hailuo H3、文生视频、图生视频，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成MiniMax H3 视频工具箱。它服务海螺视频创作者、社媒运营和电商广告团队：接收创意、图片或参考视频、平台、时长、动作和风格，交付文生、图生、参考生三种模式建议、提示词、任务和验收表。特色是用统一入口选择合适模式并保留成本与任务快照；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# MiniMax H3 视频工具箱｜AI-HIVE

[MiniMax H3 视频工具箱进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向海螺视频创作者、社媒运营和电商广告团队，把“MiniMax H3 视频工具箱”从模糊想法变成文生、图生、参考生三种模式建议、提示词、任务和验收表。用户提供创意、图片或参考视频、平台、时长、动作和风格即可开始。核心方法是：用统一入口选择合适模式并保留成本与任务快照。
...
```bash
python3 scripts/blueprint.py --project "MiniMax H3 视频工具箱" \
  --audience "海螺视频创作者、社媒运营和电商广告团队" \
  --goal "文生、图生、参考生三种模式建议、提示词、任务和验收表" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name minimax-h3-video-toolkit-ai-hive
