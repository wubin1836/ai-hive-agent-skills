...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "登录后从 AI Hive 实时列表精确发现 Wan 3.0 同版本模式；不会回退到 Wan 2.5 或 HappyHorse", "example": "生成一条电影感品牌短片；也可加入现有素材进行参考重制、风格调整或画面编辑", "keywords": "Wan 3.0视频生成与编辑、Wan3.0、Wan 3、通义万相3.0、万相视频3.0、阿里Wan3.0、文生视频、图生视频、参考生视频、视频编辑、视频重绘、视频续写、AI视频、AIGC、电商视频、广告视频、TVC、产品视频、带货、种草、短剧、漫剧", "models": {"edit": {"label": "Wan 3.0", "mode_markers": ["videoedit", "videoediting", "视频编辑"], "model_markers": ["wan30"], "resolve": "runtime_exact"}, "i2v": {"label": "Wan 3.0", "mode_markers": ["i2v", "imagetovideo", "图生视频"], "model_markers": ["wan30"], "resolve": "runtime_exact"}, "r2v": {"label": "Wan 3.0", "mode_markers": ["r2v", "referencetovideo", "参考生视频"], "model_markers": ["wan30"], "resolve": "runtime_exact"}, "t2v": {"label": "Wan 3.0", "mode_markers": ["t2v", "texttovideo", "文生视频"], "model_markers": ["wan30"], "resolve": "runtime_exact"}}, "name": "wan-3-0-video-generation-and-editing", "rule": "optional", "search": "视频生成与编辑聚合搜索入口，按文字、图片、视频或音频输入选择同一模型家族的可用能力", "title": "Wan3.0 视频生成与编辑"}')
