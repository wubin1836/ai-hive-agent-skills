...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "社交媒体营销视频，主体快速出现，节奏紧凑，卖点视觉化，结尾留出标题和行动号召空间", "keywords": "社媒视频、营销视频、Social Media Video、Reels、Shorts、朋友圈广告、多平台视频", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "social-media-marketing-video-generation-editing", "product_promise": "一次创意生成适合抖音、小红书、视频号、Reels、TikTok 和 Shorts 的渠道版本", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "社媒营销视频生成与编辑", "trend_inspired": true}')
