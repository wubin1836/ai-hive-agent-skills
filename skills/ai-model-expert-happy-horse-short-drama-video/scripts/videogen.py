...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一条高完成度短剧视频，主体明确，节奏清晰，结尾有记忆点", "keywords": "Happy Horse、HappyHorse、Happyhorse、快乐马、通义万相视频、短剧视频、AI短剧、微短剧、剧情短片、故事视频、连续剧片段、AI视频、视频生成", "models": {"i2v": "public_model_happyhorse_i2v", "r2v": "public_model_happyhorse_r2v", "t2v": "public_model_happyhorse_t2v"}, "name": "happy-horse-short-drama-video", "rule": "optional", "search": "使用 Happy Horse 制作短剧视频", "title": "Happy Horse 短剧视频"}')
