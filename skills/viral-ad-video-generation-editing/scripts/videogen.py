...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "爆款广告视频，强视觉开场，单一核心主张，多层产品细节与使用证据，结尾形成品牌记忆点", "keywords": "爆款广告、广告片、信息流爆款、TVC、品牌广告、产品广告、高转化视频", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "viral-ad-video-generation-editing", "product_promise": "围绕一个传播主张生成广告成片，覆盖品牌曝光、效果投放、TVC 和社交媒体版本", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "爆款广告视频生成与编辑", "trend_inspired": true}')
