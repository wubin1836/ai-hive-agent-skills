...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合eBay的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "eBay卖家、eBay Shop、跨境电商、eBay主图、Listing、商品视频、跨境广告、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "ebay-ecommerce-image-generation-editing", "rule": "optional", "search": "eBay 商家、运营、商品与广告图片搜索入口", "title": "eBay 电商图片生成与编辑"}')
