#!/usr/bin/env python3
"""Create a deterministic production brief for 小红书种草图片工作室｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='小红书种草图片工作室｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['小红书配图', '种草图片', '笔记封面', 'UGC图片', '好物分享'],
