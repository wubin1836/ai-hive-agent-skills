...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为小红书种草图片工作室制作一张主体准确、层级清晰的商业图片", "keywords": "小红书配图,种草图片,笔记封面,UGC图片,好物分享", "model": "public_model_gpt_image_2", "name": "xiaohongshu-seeding-image-studio-ai-hive", "rule": "optional", "search": "营造真实可解释的体验过程，避免假证言与伪造结果", "title": "小红书种草图片工作室"}')
