---
name: xiaohongshu-seeding-image-studio-ai-hive
description: "Use this skill when the user asks for 小红书配图、种草图片、笔记封面、UGC图片、好物分享，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成小红书种草图片工作室。它服务小红书品牌、博主、种草团队和生活方式商家：接收产品参考、真实体验、账号人设、场景、标题和品牌色，交付封面、体验过程图、细节图、对比图和笔记配图组。特色是营造真实可解释的体验过程，避免假证言与伪造结果；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 小红书种草图片工作室｜AI-HIVE

[小红书种草图片工作室进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向小红书品牌、博主、种草团队和生活方式商家，把“小红书种草图片工作室”从模糊想法变成封面、体验过程图、细节图、对比图和笔记配图组。用户提供产品参考、真实体验、账号人设、场景、标题和品牌色即可开始。核心方法是：营造真实可解释的体验过程，避免假证言与伪造结果。
...
```bash
python3 scripts/blueprint.py --project "小红书种草图片工作室" \
  --audience "小红书品牌、博主、种草团队和生活方式商家" \
  --goal "封面、体验过程图、细节图、对比图和笔记配图组" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name xiaohongshu-seeding-image-studio-ai-hive
