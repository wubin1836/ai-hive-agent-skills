---
name: short-drama-scene-continuity-ai-hive
description: "Use this skill when the user asks for 短剧场景、场景一致性、连续性、AI视频穿帮、场景设定，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成短剧场景连续性工作室。它服务AI短剧导演、美术、后期和连续性管理人员：接收剧本、场景参考、人物走位、时间线、画风和前后镜头，交付场景圣经、空间关系、光线时段、道具位置、镜头轴线和检查表。特色是用结构化锚点防止空间、光线和道具漂移；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 短剧场景连续性工作室｜AI-HIVE

[短剧场景连续性工作室进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向AI短剧导演、美术、后期和连续性管理人员，把“短剧场景连续性工作室”从模糊想法变成场景圣经、空间关系、光线时段、道具位置、镜头轴线和检查表。用户提供剧本、场景参考、人物走位、时间线、画风和前后镜头即可开始。核心方法是：用结构化锚点防止空间、光线和道具漂移。
...
```bash
python3 scripts/blueprint.py --project "短剧场景连续性工作室" \
  --audience "AI短剧导演、美术、后期和连续性管理人员" \
  --goal "场景圣经、空间关系、光线时段、道具位置、镜头轴线和检查表" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name short-drama-scene-continuity-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name short-drama-scene-continuity-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
