#!/usr/bin/env python3
"""Create a deterministic production brief for 短剧场景连续性工作室｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='短剧场景连续性工作室｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['短剧场景', '场景一致性', '连续性', 'AI视频穿帮', '场景设定'],
