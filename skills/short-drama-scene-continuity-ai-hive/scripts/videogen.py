...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为短剧场景连续性工作室制作一条主体清晰、节奏明确的商业视频", "keywords": "短剧场景,场景一致性,连续性,AI视频穿帮,场景设定", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "short-drama-scene-continuity-ai-hive", "rule": "optional", "search": "用结构化锚点防止空间、光线和道具漂移", "title": "短剧场景连续性工作室"}')
