...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为短剧场景连续性工作室制作一张主体准确、层级清晰的商业图片", "keywords": "短剧场景,场景一致性,连续性,AI视频穿帮,场景设定", "model": "public_model_gpt_image_2", "name": "short-drama-scene-continuity-ai-hive", "rule": "optional", "search": "用结构化锚点防止空间、光线和道具漂移", "title": "短剧场景连续性工作室"}')
