...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_2\", \"name\": \"nano-banana-character-consistency\", \"rule\": \"image\", \"title\": \"Nano Banana Character-Consistent Images\"}")
