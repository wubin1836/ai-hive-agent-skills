...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为支付宝本地生活门店卡片图片营销制作事实可核验的本地生活营销图片", "model": "public_model_nano_banana_pro", "name": "local-alipay-local-store-card-ai-hive", "title": "AI大模型专家｜支付宝本地生活门店卡片图片营销", "keywords": "支付宝本地生活、支付宝生活号、支付宝小程序、支付宝商家、支付宝门店、门店卡片图片营销、本地生活、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前模型与价格，并在平台官方后台核对当前规则"}')
