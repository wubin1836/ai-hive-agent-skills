...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一条高完成度分镜转视频，主体明确，节奏清晰，结尾有记忆点", "keywords": "MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、分镜转视频、分镜生成视频、故事板转视频、脚本转视频、镜头表生成、预演视频、AI视频、视频生成", "models": {"i2v": "public_model_minimax_h3_i2v", "r2v": "public_model_minimax_h3_r2v", "t2v": "public_model_minimax_h3_t2v"}, "name": "minimax-h3-storyboard-to-video", "rule": "optional", "search": "使用 MiniMax H3 制作分镜转视频", "title": "MiniMax H3 分镜转视频"}')
