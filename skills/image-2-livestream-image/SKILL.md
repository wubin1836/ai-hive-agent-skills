...
|---|---|---|
| Image2 Livestream Commerce Image | `public_model_gpt_image_2` | Prompt with optional reference images |
...
python3 "$SKILL_PATH/scripts/imagegen.py" init --skill-name image-2-livestream-image
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "Create a polished image2 livestream commerce image visual with an accurate subject, clear composition, and commercial finish"
```
...
```bash
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "Create a polished image2 livestream commerce image result; preserve factual product details and leave useful copy space"
```
