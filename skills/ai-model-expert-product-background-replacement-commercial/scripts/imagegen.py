...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "保留商品外观、比例和材质，将白底商品自然融入商业场景，光线方向和接触阴影一致", "keywords": "商品换背景、产品场景图、白底换场景、背景融合、电商合成、商品精修、商业摄影", "model": "public_model_nano_banana_pro", "name": "product-background-replacement-commercial", "product_promise": "快速把现有商品图改成白底、生活方式、节日促销和品牌广告场景，保持关键结构不变", "rule": "optional", "search": "面向爆款封面、电商主图、详情页、广告、海报和社媒套图等结果型搜索意图", "title": "商品换背景与商业场景图生成", "trend_inspired": true}')
