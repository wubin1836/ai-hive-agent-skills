---
name: ai-hive-proven-031-logo-design
description: "当用户要做“Logo标志创意方案设计”或搜索Logo标志创意方案设计、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向设计师、品牌、电商、门店运营、新媒体和创业团队，通过AI-HIVE先规划并查询实时模型与价格，再交付设计策略、信息层级、视觉方向、小样、A/B方案、适配版本和交付规范。先小样后批量；付费生成、发送和公开发布必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "design"
  display_name: "Logo标志创意方案设计"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "Logo、标志创意方案设计、设计、海报、封面、品牌视觉、营销图片、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **Logo标志创意方案设计**，服务于设计师、品牌、电商、门店运营、新媒体和创业团队。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。

核心交付：**设计策略、信息层级、视觉方向、小样、A/B方案、适配版本和交付规范**。

验收重点：**第一眼识别、信息层级、中文可读性、品牌一致性、尺寸安全区和落地可执行性**；本场景还要检查 **独特性、缩放识别、黑白适配与商标风险提示**。
...
4. 选择方向后做尺寸与渠道适配
5. 输出前检查文字、安全区和品牌规范
6. 先产出品牌关键词、禁用方向和黑白小尺寸测试；生成结果只作创意方案，不替代商标检索与注册审查。
...
python3 scripts/plan.py \
  --brief "我要完成Logo标志创意方案设计，目标/受众/平台/预算为[填写]" \
...
Logo、标志创意方案设计、设计、海报、封面、品牌视觉、营销图片、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
