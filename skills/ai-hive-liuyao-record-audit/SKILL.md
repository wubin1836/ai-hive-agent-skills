---
name: ai-hive-liuyao-record-audit
description: "六爻助手｜摇卦记录与本卦变卦核对：读取六次按时间顺序记录的结果或用户已确认的六爻图、用户核验的阴阳、动静对应表及爻序约定，表格导入或 OCR 抽取六次记录，要求用户确认时间顺序、上下方向与缺失项，交付可回查的文件及待核实清单。适用于六爻、六尧、六爻盘怎么看、六爻本卦变卦；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。"
metadata:
  display_name: "六爻助手｜摇卦记录与本卦变卦核对"
  version: "1.0.0"
...
六爻助手｜摇卦记录与本卦变卦核对：读取六次按时间顺序记录的结果或用户已确认的六爻图、用户核验的阴阳、动静对应表及爻序约定，表格导入或 OCR 抽取六次记录，要求用户确认时间顺序、上下方向与缺失项，交付可回查的文件及待核实清单。适用于六爻、六尧、六爻盘怎么看、六爻本卦变卦；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。

## 适用场景与输入

- 六次按时间顺序记录的结果或用户已确认的六爻图
- 用户核验的阴阳、动静对应表及爻序约定
- 可选的原排盘截图
...
1. 表格导入或 OCR 抽取六次记录，要求用户确认时间顺序、上下方向与缺失项
2. 仅用用户确认的映射表做确定性编码检查，对照本卦、变卦和动爻位置；规则不完整就输出待核对清单
3. 绘制逐爻对照 SVG，导出每条原始记录到盘面位置的审计表
...
- `liuyao-records.csv`
- `liuyao-comparison.svg`
- `liuyao-checklist.pdf`
...
六爻、六尧、六爻盘怎么看、六爻本卦变卦、动爻核对、六爻记录表
