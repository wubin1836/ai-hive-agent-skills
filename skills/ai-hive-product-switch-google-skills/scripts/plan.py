...
SKILL = 'ai-hive-product-switch-google-skills'
TITLE = 'Google Skills平替迁移：AI-HIVE多模型工作流'
PRODUCT = 'Google Skills'
CATEGORY = '学习翻译与研究'
MODE = '论文与研究迁移'
TRIAL = '用同一篇公开或授权论文比较摘要、证据和限制提取'
DELIVERABLES = '问题、方法、证据、限制、引用位置'
