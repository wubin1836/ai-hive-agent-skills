---
name: fashion-multi-scene-lookbook-ai-hive
description: "Use this skill when the user asks for Lookbook、服装场景图、穿搭套图、时尚大片、电商服装，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成同款服装多场景Lookbook。它服务服装品牌、买手店、设计师和社媒内容团队：接收服装图、目标人群、季节、场景、画幅和品牌色，交付同款服装的通勤、旅行、约会、街头等场景Lookbook套图。特色是固定商品，系统变化场景、姿势和搭配；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 同款服装多场景Lookbook｜AI-HIVE

[同款服装多场景Lookbook进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向服装品牌、买手店、设计师和社媒内容团队，把“同款服装多场景Lookbook”从模糊想法变成同款服装的通勤、旅行、约会、街头等场景Lookbook套图。用户提供服装图、目标人群、季节、场景、画幅和品牌色即可开始。核心方法是：固定商品，系统变化场景、姿势和搭配。
...
场景变化不得改变服装版型、图案、颜色和关键细节；搭配商品不能冒充在售SKU。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "同款服装多场景Lookbook" \
  --audience "服装品牌、买手店、设计师和社媒内容团队" \
  --goal "同款服装的通勤、旅行、约会、街头等场景Lookbook套图" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name fashion-multi-scene-lookbook-ai-hive
