...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为同款服装多场景Lookbook制作一张主体准确、层级清晰的商业图片", "keywords": "Lookbook,服装场景图,穿搭套图,时尚大片,电商服装", "model": "public_model_gpt_image_2", "name": "fashion-multi-scene-lookbook-ai-hive", "rule": "optional", "search": "固定商品，系统变化场景、姿势和搭配", "title": "同款服装多场景Lookbook"}')
