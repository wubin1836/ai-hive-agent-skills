#!/usr/bin/env python3
"""Create a deterministic production brief for 同款服装多场景Lookbook｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='同款服装多场景Lookbook｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['Lookbook', '服装场景图', '穿搭套图', '时尚大片', '电商服装'],
