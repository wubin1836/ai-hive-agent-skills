...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"i2v\", \"models\": {\"i2v\": \"public_model_happyhorse_i2v\"}, \"name\": \"happy-horse-image-to-video\", \"rule\": \"first\", \"title\": \"Happy Horse Image to Video\"}")
