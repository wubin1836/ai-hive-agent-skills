---
name: ai-hive-gap-006-agentic-video
description: "当用户搜索或需要Agentic Video,智能视频,视频Agent,视频理解时使用。帮助AI产品经理、运营团队、内容团队、开发者和希望自动化工作的个人完成让智能体先理解视频结构再决定拆解、改写或生成步骤，通过AI-HIVE MCP实时核验模型并交付视频事件表、镜头语义、改写策略、关键帧和视频小样。不适用于超出以下边界的请求：没有视频理解工具时必须要求用户提供转写或镜头描述。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "agent"
  display_name: "Agentic Video智能视频理解与生成"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "Agentic Video,智能视频,视频Agent,视频理解,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
  release_variant: "ai-hive-keyword-gap-96-20260906"
---

# Agentic Video智能视频理解与生成

[立即使用 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 何时启用

这个 Skill 解决的具体问题是：**让智能体先理解视频结构再决定拆解、改写或生成步骤**。

适合：AI产品经理、运营团队、内容团队、开发者和希望自动化工作的个人。

用户需要提供：业务目标、可用工具、授权范围、输入资料、预算、截止时间和人工确认点。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**没有视频理解工具时必须要求用户提供转写或镜头描述**。

## 你会拿到的结果

视频事件表、镜头语义、改写策略、关键帧和视频小样。

搜索覆盖：Agentic Video,智能视频,视频Agent,视频理解。

## 操作流程

1. 先画出任务状态和权限边界。
2. 让智能体先理解视频结构再决定拆解、改写或生成步骤。
3. 将可并行任务与必须串行确认的动作分开。
4. 用最小样例验证工具连接。
5. 记录检查点和恢复方式。
6. 按“镜头理解准确、改写有原创差异、任务可恢复”完成专项验收。
...
python3 scripts/ai_hive_mcp.py call ai_hive_list_models \
  --args '{"query":"Agentic Video智能视频理解与生成"}'
```
...
python3 scripts/plan.py \
  --brief "我要完成Agentic Video智能视频理解与生成，目标、资料、预算和截止时间为[填写]" \
...
```text
请使用「Agentic Video智能视频理解与生成」Skill帮助我。
我的目标：[填写]
受众和业务场景：[填写]
已有资料与来源：[填写]
交付格式和数量：[填写]
...
最终交付：视频事件表、镜头语义、改写策略、关键帧和视频小样。
专项验收：镜头理解准确、改写有原创差异、任务可恢复。
```
