---
name: ai-hive-classics-text-collation
description: "古典文本版本对勘助手：读取两个以上已转写且允许使用的文本版本、版本说明及页码或章句对应表，冻结原始文本，建立版本ID与稳定段落编号，字形归一化只用于检索副本，交付可回查的文件及待核实清单。适用于版本对勘、古籍异文、道德经版本、古文校勘；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。"
metadata:
  display_name: "古典文本版本对勘助手"
  version: "1.0.0"
...
古典文本版本对勘助手：读取两个以上已转写且允许使用的文本版本、版本说明及页码或章句对应表，冻结原始文本，建立版本ID与稳定段落编号，字形归一化只用于检索副本，交付可回查的文件及待核实清单。适用于版本对勘、古籍异文、道德经版本、古文校勘；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。
...
1. 冻结原始文本，建立版本ID与稳定段落编号，字形归一化只用于检索副本。
2. 用序列对齐和文本差异工具定位增删、异文与段落次序变化。
3. 保留各版本原字形及上下文，为无法稳定对齐的位置生成复核项。
4. 输出并排对勘页面和异文表，人工取舍另记，不静默改写原典。
...
- `text-collation.html`
- `variant-apparatus.xlsx`
- `editor-decisions.csv`
