...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"r2v\", \"models\": {\"r2v\": \"public_model_happyhorse_r2v\"}, \"name\": \"happy-horse-image-reference-to-video\", \"rule\": \"image\", \"title\": \"Happy Horse Image Reference to Video\"}")
