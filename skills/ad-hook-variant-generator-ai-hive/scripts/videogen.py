...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为广告钩子批量变体制作一条主体清晰、节奏明确的商业视频", "keywords": "广告钩子,黄金3秒,开场变体,短视频广告,素材测试", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ad-hook-variant-generator-ai-hive", "rule": "optional", "search": "核心卖点不变，只替换首屏进入方式", "title": "广告钩子批量变体"}')
