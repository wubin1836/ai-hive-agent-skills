#!/usr/bin/env python3
"""Create a deterministic production brief for 广告钩子批量变体｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='广告钩子批量变体｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['广告钩子', '黄金3秒', '开场变体', '短视频广告', '素材测试'],
