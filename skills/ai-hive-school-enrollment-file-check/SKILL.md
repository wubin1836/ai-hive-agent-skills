---
name: ai-hive-school-enrollment-file-check
description: "孩子入学材料核对助手，用于幼升小材料、小升初材料、随迁子女入学。读取你授权的原始资料，完成当年当地官方招生清单，并交付报名节点与缺件待办。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "孩子入学材料核对助手"
  version: "1.0.0"
...
孩子入学材料核对助手，用于幼升小材料、小升初材料、随迁子女入学。读取你授权的原始资料，完成当年当地官方招生清单，并交付报名节点与缺件待办。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 确认学段、区县、年份和用户选定入学类型，儿童信息去标识化
2. 只使用对应年份教育局或学校正式通知，区分预报名与最终要求
3. 核对日期、关系和地址一致性，不推断录取概率、承诺学位或包装材料
...
- `school-enrollment-file-check-checklist.xlsx`
- `school-enrollment-file-check-evidence.docx`
- `school-enrollment-file-check-sources.json`
...
> 仅示例，以下文件名和情境均为假设，不表示已存在真实数据：假设我已提供 示例_区县学段及报名年份.json、示例_当年正式招生通知.pdf、示例_脱敏报名材料目录.csv。请使用「孩子入学材料核对助手」，按我选定的入学类型逐项核对日期、亲属关系和地址一致性，把缺件做成可筛选清单。将结果写入我指定的本地目录，交付 school-enrollment-file-check-checklist.xlsx、school-enrollment-file-check-evidence.docx、school-enrollment-file-check-sources.json。本例先离线处理；输入、工具或适用规则不足时先交缺口说明，不编造结果。需要联网更新来源先征得我同意，不登录账户、不代提交或付款。

## 搜索与任务识别

幼升小材料、小升初材料、随迁子女入学、入学报名材料、入学资料审核
