#!/usr/bin/env python3
"""Create a deterministic production brief for Token Hub多模型Token管理."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='Token Hub多模型Token管理')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['Token Hub', 'TokenHub', 'Token管理', 'API Key管理', '密钥中心'],
