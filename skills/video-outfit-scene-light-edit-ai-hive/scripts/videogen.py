...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为视频换服装换场景换光线制作一条主体清晰、节奏明确的商业视频", "keywords": "AI视频换装,视频换背景,视频改光线,生成式编辑,视频重绘", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "video-outfit-scene-light-edit-ai-hive", "rule": "optional", "search": "每次只修改一类主要变量，避免人物与动作同时漂移", "title": "视频换服装换场景换光线"}')
