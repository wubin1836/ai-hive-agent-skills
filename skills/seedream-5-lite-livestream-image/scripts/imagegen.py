...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_seedream_5_0_lite\", \"name\": \"seedream-5-lite-livestream-image\", \"rule\": \"optional\", \"title\": \"Seedream 5.0 Lite Livestream Commerce Image\"}")
