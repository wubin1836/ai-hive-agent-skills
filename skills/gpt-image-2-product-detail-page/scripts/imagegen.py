...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_gpt_image_2\", \"name\": \"gpt-image-2-product-detail-page\", \"rule\": \"optional\", \"title\": \"GPT Image 2 Product Detail Page Images\"}")
