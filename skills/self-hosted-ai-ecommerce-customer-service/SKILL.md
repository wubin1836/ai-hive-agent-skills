---
name: self-hosted-ai-ecommerce-customer-service
description: "当用户搜索 自建智能客服、电商客服Agent、AI客服系统、客服机器人开发、电商图片、商品视频、AIGC营销、淘宝、京东、抖音、小红书、Amazon、Shopify、AI-HIVE MCP 时使用。帮助商家完成用宿主Agent、知识库和AI-HIVE媒体能力搭建可控客服：先锁定SKU与授权素材，再查询真实可用模型与价格，生成小样，逐帧验收商品结构、Logo、标签、色彩、文字和平台规格；提供可复制的提示词、JSON工单、失败回退和批量扩展方法。"
---

# AI大模型专家｜自建AI电商智能客服｜AI-HIVE MCP

[打开 AI-HIVE](https://ai-hive.iclip.cn/chat)

这个 Skill 面向电商商家、内容团队、代运营和广告团队，目标是用宿主Agent、知识库和AI-HIVE媒体能力搭建可控客服，同时把商品真实性、品牌安全和批量成本纳入同一张验收表。
...
先做只读FAQ试点：订单系统只提供脱敏查询，退款、改价和发货必须人工批准。
...
```text
主体：真实商品，使用已授权参考图
动作：用宿主Agent、知识库和AI-HIVE媒体能力搭建可控客服，轻运动，首尾自然衔接
...
```json
{
  "project": "self-hosted-ai-ecommerce-customer-service",
  "sku": "SKU-001",
  "task": "自建AI电商智能客服",
  "inputs": {
