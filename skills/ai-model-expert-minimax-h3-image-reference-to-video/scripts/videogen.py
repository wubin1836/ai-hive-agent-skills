...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 MiniMax H3 完成高质量参考图生视频，动作连续，镜头稳定", "fixed_mode": "r2v", "keywords": "MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、参考图生视频、图片参考生视频、参考图片生成视频、风格参考视频、角色参考视频、AI视频、视频生成", "models": {"r2v": "public_model_minimax_h3_r2v"}, "name": "minimax-h3-image-reference-to-video", "rule": "image", "search": "固定调用 MiniMax H3 的参考图生视频裸接口能力", "title": "MiniMax H3 参考图生视频"}')
