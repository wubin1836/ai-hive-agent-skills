...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_2\", \"name\": \"nano-banana-product-detail-page\", \"rule\": \"optional\", \"title\": \"Nano Banana Product Detail Page Images\"}")
