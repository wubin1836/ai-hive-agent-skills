...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为饿了么外卖菜单图片制作事实可核验的本地生活营销图片", "model": "public_model_nano_banana_pro", "name": "local-eleme-menu-image-ai-hive", "title": "AI大模型专家｜饿了么外卖菜单图片", "keywords": "饿了么、饿了么商家、饿了么外卖、饿了么店铺、外卖平台、外卖菜单图片、本地生活、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前模型与价格，并在平台官方后台核对当前规则"}')
