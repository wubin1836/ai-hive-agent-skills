...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为小说转短剧工作台制作一条主体清晰、节奏明确的商业视频", "keywords": "小说转短剧,网文改编,短剧剧本,AI编剧,剧情拆分", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "novel-to-short-drama-ai-hive", "rule": "optional", "search": "先完成可拍性和单集钩子改编，再进入视觉生成", "title": "小说转短剧工作台"}')
