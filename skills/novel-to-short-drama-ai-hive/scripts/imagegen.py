...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为小说转短剧工作台制作一张主体准确、层级清晰的商业图片", "keywords": "小说转短剧,网文改编,短剧剧本,AI编剧,剧情拆分", "model": "public_model_nano_banana_pro", "name": "novel-to-short-drama-ai-hive", "rule": "optional", "search": "先完成可拍性和单集钩子改编，再进入视觉生成", "title": "小说转短剧工作台"}')
