#!/usr/bin/env python3
"""Create a deterministic production brief for 小说转短剧工作台｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='小说转短剧工作台｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['小说转短剧', '网文改编', '短剧剧本', 'AI编剧', '剧情拆分'],
