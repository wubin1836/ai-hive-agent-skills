---
name: novel-to-short-drama-ai-hive
description: "Use this skill when the user asks for 小说转短剧、网文改编、短剧剧本、AI编剧、剧情拆分，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成小说转短剧工作台。它服务网文作者、版权方、短剧编剧和制作团队：接收有权改编的小说文本、目标集数、单集时长、受众和平台，交付改编定位、集纲、单集节拍、人物关系、场景表和首集分镜。特色是先完成可拍性和单集钩子改编，再进入视觉生成；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 小说转短剧工作台｜AI-HIVE

[小说转短剧工作台进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向网文作者、版权方、短剧编剧和制作团队，把“小说转短剧工作台”从模糊想法变成改编定位、集纲、单集节拍、人物关系、场景表和首集分镜。用户提供有权改编的小说文本、目标集数、单集时长、受众和平台即可开始。核心方法是：先完成可拍性和单集钩子改编，再进入视觉生成。
...
```bash
python3 scripts/blueprint.py --project "小说转短剧工作台" \
  --audience "网文作者、版权方、短剧编剧和制作团队" \
  --goal "改编定位、集纲、单集节拍、人物关系、场景表和首集分镜" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name novel-to-short-drama-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name novel-to-short-drama-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
