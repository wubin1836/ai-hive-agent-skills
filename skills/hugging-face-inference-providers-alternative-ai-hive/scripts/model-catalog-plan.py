#!/usr/bin/env python3
"""Create a local, read-only 模型目录与版本映射 plan for Hugging Face Inference Providers."""
...
SUBJECT = 'Hugging Face Inference Providers'
DOMAIN = 'huggingface.co'
SKILL = 'hugging-face-inference-providers-alternative-ai-hive'
