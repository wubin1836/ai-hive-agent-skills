...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为爆款广告变量拆解制作一条主体清晰、节奏明确的商业视频", "keywords": "爆款广告拆解,广告变量,素材分析,创意复刻,A/B广告", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "winning-ad-variable-decomposer-ai-hive", "rule": "optional", "search": "学习广告的可迁移变量，不复制受保护表达", "title": "爆款广告变量拆解"}')
