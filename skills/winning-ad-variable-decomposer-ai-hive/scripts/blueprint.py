#!/usr/bin/env python3
"""Create a deterministic production brief for 爆款广告变量拆解｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='爆款广告变量拆解｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['爆款广告拆解', '广告变量', '素材分析', '创意复刻', 'A/B广告'],
