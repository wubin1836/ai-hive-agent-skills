---
name: winning-ad-variable-decomposer-ai-hive
description: "Use this skill when the user asks for 爆款广告拆解、广告变量、素材分析、创意复刻、A/B广告，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成爆款广告变量拆解。它服务投手、编导、广告代理商和内容增长团队：接收授权参考广告、商品事实、渠道、目标人群和现有表现结论，交付钩子、人物、场景、证据、节奏、CTA变量表与可迁移测试假设。特色是学习广告的可迁移变量，不复制受保护表达；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 爆款广告变量拆解｜AI-HIVE

[爆款广告变量拆解进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向投手、编导、广告代理商和内容增长团队，把“爆款广告变量拆解”从模糊想法变成钩子、人物、场景、证据、节奏、CTA变量表与可迁移测试假设。用户提供授权参考广告、商品事实、渠道、目标人群和现有表现结论即可开始。核心方法是：学习广告的可迁移变量，不复制受保护表达。
...
爆款是历史结果而非未来承诺；只能学习结构，不得复制人物、台词、音乐和具体镜头。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "爆款广告变量拆解" \
  --audience "投手、编导、广告代理商和内容增长团队" \
  --goal "钩子、人物、场景、证据、节奏、CTA变量表与可迁移测试假设" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name winning-ad-variable-decomposer-ai-hive
