...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"r2v\", \"models\": {\"r2v\": \"public_model_happyhorse_r2v\"}, \"name\": \"happy-horse-video-reference-to-video\", \"rule\": \"video\", \"title\": \"Happy Horse Video Reference to Video\"}")
