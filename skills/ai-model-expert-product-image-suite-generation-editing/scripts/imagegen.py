...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "同一商品的完整视觉套图，包含白底主图、生活场景、材质特写、尺寸说明和营销构图", "keywords": "商品套图、产品套图、批量商品图、主图套图、SKU套图、商品精修、换背景、多图生成", "model": "public_model_nano_banana_pro", "name": "product-image-suite-generation-editing", "product_promise": "保持商品结构、颜色和品牌元素一致，一次生成适合上新、详情页和广告投放的图片套组", "rule": "optional", "search": "面向爆款封面、电商主图、详情页、广告、海报和社媒套图等结果型搜索意图", "title": "商品套图生成与编辑", "trend_inspired": true}')
