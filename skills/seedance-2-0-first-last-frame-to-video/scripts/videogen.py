...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"i2v\", \"models\": {\"i2v\": \"public_model_seedance_i2v\"}, \"name\": \"seedance-2-0-first-last-frame-to-video\", \"rule\": \"first_last\", \"title\": \"Seedance 2.0 First and Last Frame Video\"}")
