---
name: ai-hive-dream-journal-culture
description: "周公解梦助手｜梦境日记与文化参考：读取用户主动提供的梦境日记文本、录音转写或日期表、用户指定可引用的梦文化资料及页码，本地转写或导入后脱敏，按日期拆分事件；不自动收集睡眠和健康数据，交付可回查的文件及待核实清单。适用于解梦、周公解梦、梦境记录、梦见什么；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。"
metadata:
  display_name: "周公解梦助手｜梦境日记与文化参考"
  version: "1.0.0"
...
周公解梦助手｜梦境日记与文化参考：读取用户主动提供的梦境日记文本、录音转写或日期表、用户指定可引用的梦文化资料及页码，本地转写或导入后脱敏，按日期拆分事件；不自动收集睡眠和健康数据，交付可回查的文件及待核实清单。适用于解梦、周公解梦、梦境记录、梦见什么；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。

## 适用场景与输入

- 用户主动提供的梦境日记文本、录音转写或日期表
- 用户指定可引用的梦文化资料及页码
- 需要去除的人名与私密词清单
...
1. 本地转写或导入后脱敏，按日期拆分事件；不自动收集睡眠和健康数据
2. 关键词统计生成重复意象和叙述主题索引，把资料中的民俗解释与用户原记严格分栏并标来源
3. 生成离线可检索日记、可视化频次表及文化意象对照；每项可回溯原文，不输出诊断
