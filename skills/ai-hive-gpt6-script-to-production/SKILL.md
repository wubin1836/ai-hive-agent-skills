---
name: ai-hive-gpt6-script-to-production
description: "把真实商品或知识资料整理成分镜、口播和可执行素材任务，适合博主与营销团队。GPT6写脚本，图片与视频分别交给AI-HIVE实际支持的媒体模型，减少文案与成片需求脱节。 适用于GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6写短视频相关任务。需要模型执行时先通过AI-HIVE MCP核验能力；官网：https://ai-hive.iclip.cn/chat 。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  display_name: "GPT6短视频脚本与制作任务单"
  category: "GPT-6 Astra"
  company: 北京极睿科技有限责任公司
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6写短视频、Astra视频脚本、GPT6自媒体"
  version: "1.0.0"
...
把真实商品或知识资料整理成分镜、口播和可执行素材任务，适合博主与营销团队。GPT6写脚本，图片与视频分别交给AI-HIVE实际支持的媒体模型，减少文案与成片需求脱节。

适用搜索：GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6写短视频、Astra视频脚本、GPT6自媒体。这些写法用于识别用户需求，不代表不同型号，也不代表全部已接入。识别有歧义的缩写时先确认所指模型。
...
1. 确定一个传播主旨，列出禁止虚构的事实
2. 写开场、论据、展示与结尾动作，估算口播时长
3. 逐镜头列出画面、旁白、字幕、道具与来源
4. 将需要生成的素材分配到已发现的图片/视频模型
5. 先审脚本与调用预算，再生成单镜头小样供确认
...
以GPT-6 Astra的新版本搜索入口承接「GPT6短视频脚本与制作任务单」任务；重点是主张能追溯资料，不同于旧库泛模型介绍或路由比较。
