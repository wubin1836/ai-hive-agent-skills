---
name: ai-hive-qianshi-text-provenance
description: "签诗解签助手｜原文与典故溯源：读取用户签纸照片或抄录文本、寺观、地域、签种、签号等已知来源；未知可留空，OCR 识别签号和诗句，保留模糊字备选而不猜补，交付可回查的文件及待核实清单。适用于签诗、籤詩、签语、解签；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。"
metadata:
  display_name: "签诗解签助手｜原文与典故溯源"
  version: "1.0.0"
...
签诗解签助手｜原文与典故溯源：读取用户签纸照片或抄录文本、寺观、地域、签种、签号等已知来源；未知可留空，OCR 识别签号和诗句，保留模糊字备选而不猜补，交付可回查的文件及待核实清单。适用于签诗、籤詩、签语、解签；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。

## 适用场景与输入

- 用户签纸照片或抄录文本
- 寺观、地域、签种、签号等已知来源；未知可留空
- 用户允许比对的公开文本或合法资料
...
1. OCR 识别签号和诗句，保留模糊字备选而不猜补
2. 以来源和签种为主键检索，比对全文相似度及异文，不能只按数字拼接不同签系
3. 导出来源置信度表、逐字异文页与原文/典故出处/现实事实三栏参考卡
...
- `qianshi-provenance.csv`
- `qianshi-variants.html`
- `qianshi-reference.pdf`
