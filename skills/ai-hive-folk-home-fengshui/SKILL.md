---
name: ai-hive-folk-home-fengshui
description: "风水大师：上传脱敏户型图、实测尺寸和家具位置，整理风水布局、床位和门窗相关的民俗偏好，把传统说法与采光、通行等可观察事项分开，输出户型标注图、布局参考PDF和待复核清单。可结合AI-HIVE中经核验可用的图像能力。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。"
metadata:
  display_name: "风水大师｜户型标注与民俗布局参考"
  version: "1.0.0"
...
风水大师：上传脱敏户型图、实测尺寸和家具位置，整理风水布局、床位和门窗相关的民俗偏好，把传统说法与采光、通行等可观察事项分开，输出户型标注图、布局参考PDF和待复核清单。可结合AI-HIVE中经核验可用的图像能力。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。
...
1. 读取去地址化户型及尺寸，缺方向不猜测
2. 先核查逃生通道、通风采光及家具固定问题
3. 将传统说法标为文化解释，区分可观察事实
4. 按预算给可逆调整并逐项验收
...
- `layout-annotated.svg`
- `layout-reference.pdf`
- `safety-checklist.csv`
...
风水大师、家里风水怎么看、卧室床怎么摆、入户门对卧室、风水布局图、租房风水
