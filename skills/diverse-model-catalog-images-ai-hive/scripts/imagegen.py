...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为多肤色多体型模特套图制作一张主体准确、层级清晰的商业图片", "keywords": "多肤色模特,多体型模特,服装套图,跨境电商,AI模特", "model": "public_model_gpt_image_2", "name": "diverse-model-catalog-images-ai-hive", "rule": "optional", "search": "用同一商品锚点生成多样化展示，扩大内容覆盖", "title": "多肤色多体型模特套图"}')
