---
name: diverse-model-catalog-images-ai-hive
description: "Use this skill when the user asks for 多肤色模特、多体型模特、服装套图、跨境电商、AI模特，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成多肤色多体型模特套图。它服务国际服装品牌、跨境卖家和多元化营销团队：接收服装图、人物条件、场景、姿势、品牌规范和平台，交付同一服装在不同肤色、体型和年龄条件下的模特套图。特色是用同一商品锚点生成多样化展示，扩大内容覆盖；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 多肤色多体型模特套图｜AI-HIVE

[多肤色多体型模特套图进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向国际服装品牌、跨境卖家和多元化营销团队，把“多肤色多体型模特套图”从模糊想法变成同一服装在不同肤色、体型和年龄条件下的模特套图。用户提供服装图、人物条件、场景、姿势、品牌规范和平台即可开始。核心方法是：用同一商品锚点生成多样化展示，扩大内容覆盖。
...
避免刻板印象、歧视性描述和不真实身体效果；人物为合成时应按平台要求披露。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "多肤色多体型模特套图" \
  --audience "国际服装品牌、跨境卖家和多元化营销团队" \
  --goal "同一服装在不同肤色、体型和年龄条件下的模特套图" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name diverse-model-catalog-images-ai-hive
