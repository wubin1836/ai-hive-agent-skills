...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI虚拟网红孵化器制作一张主体准确、层级清晰的商业图片", "keywords": "AI虚拟网红,虚拟IP,数字人账号,AI博主,虚拟偶像", "model": "public_model_nano_banana_pro", "name": "ai-virtual-influencer-incubator-ai-hive", "rule": "optional", "search": "先建立可持续角色资产，再批量生产栏目内容", "title": "AI虚拟网红孵化器"}')
