...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI虚拟网红孵化器制作一条主体清晰、节奏明确的商业视频", "keywords": "AI虚拟网红,虚拟IP,数字人账号,AI博主,虚拟偶像", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ai-virtual-influencer-incubator-ai-hive", "rule": "optional", "search": "先建立可持续角色资产，再批量生产栏目内容", "title": "AI虚拟网红孵化器"}')
