...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为TikTok Shop 爆款带货视频拆解制作一条主体清晰、节奏明确的商业视频", "keywords": "TikTok Shop,爆款带货,TikTok视频,UGC广告,跨境电商", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "tiktok-shop-viral-video-decomposer-ai-hive", "rule": "optional", "search": "按海外用户语境改写，不做逐句直译", "title": "TikTok Shop 爆款带货视频拆解"}')
