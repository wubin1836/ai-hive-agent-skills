---
name: tiktok-shop-viral-video-decomposer-ai-hive
description: "Use this skill when the user asks for TikTok Shop、爆款带货、TikTok视频、UGC广告、跨境电商，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成TikTok Shop 爆款带货视频拆解。它服务跨境卖家、TikTok Shop 团队和海外内容运营：接收授权参考视频、商品卖点、目标国家、合规限制和语言，交付英文钩子、演示节奏、UGC脚本、字幕方案和多地区改版建议。特色是按海外用户语境改写，不做逐句直译；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# TikTok Shop 爆款带货视频拆解｜AI-HIVE

[TikTok Shop 爆款带货视频拆解进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向跨境卖家、TikTok Shop 团队和海外内容运营，把“TikTok Shop 爆款带货视频拆解”从模糊想法变成英文钩子、演示节奏、UGC脚本、字幕方案和多地区改版建议。用户提供授权参考视频、商品卖点、目标国家、合规限制和语言即可开始。核心方法是：按海外用户语境改写，不做逐句直译。
...
```bash
python3 scripts/blueprint.py --project "TikTok Shop 爆款带货视频拆解" \
  --audience "跨境卖家、TikTok Shop 团队和海外内容运营" \
  --goal "英文钩子、演示节奏、UGC脚本、字幕方案和多地区改版建议" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name tiktok-shop-viral-video-decomposer-ai-hive
