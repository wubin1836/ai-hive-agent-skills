---
name: ai-hive-proven-105-private-domain-campaign
description: "当用户要做“私域活动策划与物料生成”或搜索私域活动策划与物料生成、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向品牌市场、电商运营、新媒体、私域团队、门店和个人IP，通过AI-HIVE先规划并查询实时模型与价格，再交付分析结论、策略、内容结构、文案、可选图片/视频素材、执行日历和复盘指标。先小样后批量；付费生成、发送和公开发布必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "marketing"
  display_name: "私域活动策划与物料生成"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "私域活动策划与物料生成、营销、内容运营、爆款、种草、增长、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **私域活动策划与物料生成**，服务于品牌市场、电商运营、新媒体、私域团队、门店和个人IP。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。
...
python3 scripts/plan.py \
  --brief "我要完成私域活动策划与物料生成，目标/受众/平台/预算为[填写]" \
...
私域活动策划与物料生成、营销、内容运营、爆款、种草、增长、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
