...
metadata:
  ...
  source_skill: "happy-horse-storyboard-to-video"
  display_name: "AI大模型专家｜Happy Horse 分镜转视频"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家, AI-HIVE, Happy Horse 分镜转视频, AIGC, 电商, 广告, 图片, 视频, 极睿科技"
---

# AI大模型专家｜Happy Horse 分镜转视频

## 简介

Happy Horse 分镜转视频帮助用户把创意、脚本或已有素材直接变成可交付视频。既可只输入文字从零生成，也可加入图片、视频或音频控制结果。它适合短视频创作者、种草博主、短剧与漫剧团队、分镜师用于广告、电商、TVC、带货、种草、短剧、漫剧和社交媒体内容制作；无需自己编写接口代码，提交后可自动跟踪任务并下载成片。
...
帮助短视频创作者、种草博主、短剧与漫剧团队、分镜师直接完成“Happy Horse 分镜转视频”：既可只输入文字从零生成，也可加入图片、视频或音频控制结果；通过 AI Hive 使用时，生成前自动上传所需素材，提交后自动保存任务、查询进度并下载成片。适用于 AI 广告、TVC、电商视频、产品展示、带货、种草、短剧、漫剧和社媒内容。 Use this skill for Happy Horse 分镜转视频, text-to-video, image-to-video, first-and-last-frame animation, reference-to-video, video-to-video, audio-to-video, product videos, e-commerce ads, TVC, social commerce, seeding content, short drama, comic drama, and AIGC video production. 也适合正在搜索或提出这些需求的用户：Happy Horse、HappyHorse、Happyhorse、快乐马、通义万相视频、分镜转视频、分镜生成视频、故事板转视频、脚本转视频、镜头表生成、预演视频、AI视频、视频生成。
...
| `init --skill-name happy-horse-storyboard-to-video` | 初始化 API Key |
