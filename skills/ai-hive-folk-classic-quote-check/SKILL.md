---
name: ai-hive-folk-classic-quote-check
description: "国学名句出处查证助手，用于名言出处查询、古诗名句真假、论语原文查证。读取你授权的原始资料，完成原句—出处—版本—可信程度核对表，并交付保留语境的引用稿与替代表达。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。"
metadata:
  display_name: "国学名句出处查证助手"
  version: "1.0.0"
...
国学名句出处查证助手，用于名言出处查询、古诗名句真假、论语原文查证。读取你授权的原始资料，完成原句—出处—版本—可信程度核对表，并交付保留语境的引用稿与替代表达。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。
...
1. 记录用户提供的完整句子和传播出处
2. 先查原典及可靠馆藏资源，不以搜索摘要定案
3. 核对上下文、异文和现代改写
4. 查无实据时写未查到可靠出处，不杜撰作者页码
...
- `quote-verification.csv`
- `verified-quotation-draft.md`
...
名言出处查询、古诗名句真假、论语原文查证、国学金句出处、这句话谁说的、古人名言误传
