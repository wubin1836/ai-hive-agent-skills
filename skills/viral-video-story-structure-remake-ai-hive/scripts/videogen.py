...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为爆款视频故事结构原创复刻制作一条主体清晰、节奏明确的商业视频", "keywords": "故事结构复刻,爆款剧情,短视频脚本,反转剧情,原创改编", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "viral-video-story-structure-remake-ai-hive", "rule": "optional", "search": "学习结构和节奏，不复制人物、台词、镜头或受保护表达", "title": "爆款视频故事结构原创复刻"}')
