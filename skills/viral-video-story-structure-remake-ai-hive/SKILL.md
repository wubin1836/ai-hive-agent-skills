---
name: viral-video-story-structure-remake-ai-hive
description: "Use this skill when the user asks for 故事结构复刻、爆款剧情、短视频脚本、反转剧情、原创改编，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成爆款视频故事结构原创复刻。它服务品牌内容团队、短剧编剧和广告创意人员：接收授权参考、品牌事实、角色设定、场景资源和目标时长，交付故事节拍、冲突升级、反转位置、品牌植入点和原创故事板。特色是学习结构和节奏，不复制人物、台词、镜头或受保护表达；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 爆款视频故事结构原创复刻｜AI-HIVE

[爆款视频故事结构原创复刻进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向品牌内容团队、短剧编剧和广告创意人员，把“爆款视频故事结构原创复刻”从模糊想法变成故事节拍、冲突升级、反转位置、品牌植入点和原创故事板。用户提供授权参考、品牌事实、角色设定、场景资源和目标时长即可开始。核心方法是：学习结构和节奏，不复制人物、台词、镜头或受保护表达。
...
```bash
python3 scripts/blueprint.py --project "爆款视频故事结构原创复刻" \
  --audience "品牌内容团队、短剧编剧和广告创意人员" \
  --goal "故事节拍、冲突升级、反转位置、品牌植入点和原创故事板" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name viral-video-story-structure-remake-ai-hive
