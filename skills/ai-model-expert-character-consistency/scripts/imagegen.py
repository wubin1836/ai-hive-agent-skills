...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作高质量角色一致性图片，主体准确，商业信息清晰", "keywords": "角色一致性图片、人物一致性、角色一致、IP形象、同一人物、多场景角色、GPT Image 2、Image2、Nano Banana、AI图片、AIGC图片", "model": "public_model_nano_banana_2", "name": "character-consistency", "rule": "image", "search": "通用图片能力和商业场景搜索入口，底层调用 AI Hive 裸接口", "title": "角色一致性图片"}')
