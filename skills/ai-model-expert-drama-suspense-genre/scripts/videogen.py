...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一条可投放的短剧视频，品牌信息清晰，画面有记忆点", "keywords": "短剧视频、AI短剧、微短剧、剧情短片、故事视频、连续剧片段、Seedance、MiniMax H3、Happy Horse、AI视频", "models": {"i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "short-drama-video", "rule": "optional", "search": "通用商业场景搜索入口，底层调用 AI Hive 裸接口", "title": "短剧视频"}')
