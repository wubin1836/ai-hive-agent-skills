...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为播客访谈转短视频制作一条主体清晰、节奏明确的商业视频", "keywords": "播客切片,访谈转短视频,知识视频,内容拆条,Shorts", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "podcast-interview-to-shorts-ai-hive", "rule": "optional", "search": "每条短视频保留完整论点和必要上下文", "title": "播客访谈转短视频"}')
