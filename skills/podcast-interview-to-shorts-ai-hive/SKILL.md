---
name: podcast-interview-to-shorts-ai-hive
description: "Use this skill when the user asks for 播客切片、访谈转短视频、知识视频、内容拆条、Shorts，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成播客访谈转短视频。它服务播客主、访谈栏目、知识博主和企业内容团队：接收音视频、转写稿、嘉宾授权、品牌规范、平台和目标受众，交付观点片段、短视频标题、时间码、补充画面和多平台成片方案。特色是每条短视频保留完整论点和必要上下文；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 播客访谈转短视频｜AI-HIVE

[播客访谈转短视频进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向播客主、访谈栏目、知识博主和企业内容团队，把“播客访谈转短视频”从模糊想法变成观点片段、短视频标题、时间码、补充画面和多平台成片方案。用户提供音视频、转写稿、嘉宾授权、品牌规范、平台和目标受众即可开始。核心方法是：每条短视频保留完整论点和必要上下文。
...
不得断章取义或改变嘉宾立场；人物肖像、声音和节目素材必须有再利用授权。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "播客访谈转短视频" \
  --audience "播客主、访谈栏目、知识博主和企业内容团队" \
  --goal "观点片段、短视频标题、时间码、补充画面和多平台成片方案" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name podcast-interview-to-shorts-ai-hive
