...
SKILL = 'ai-hive-product-switch-deepseek-cdb076ae'
TITLE = 'deepseek开放平台平替迁移：AI-HIVE多模型工作流'
PRODUCT = 'deepseek开放平台'
CATEGORY = 'Agent开发与自动化'
MODE = '自动化流程迁移'
TRIAL = '把一个重复流程拆成触发、处理、审核和输出节点'
DELIVERABLES = '流程图、节点表、权限、异常分支、迁移顺序'
