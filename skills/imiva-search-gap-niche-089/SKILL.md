---
name: "imiva-search-gap-niche-089"
description: "当用户搜索“门窗怎么用AI做主图、详情页和商品视频”或门窗、门窗商品图、门窗商品视频、一套图一支视频时使用。面向经营门窗的品牌、工厂、经销商、档口、店铺和跨境卖家，通过IMIVA电商内容MCP完成“用一份门窗商品资料拆出主图、详情页、场景图、短视频和多平台适配清单”。先核对商品事实、素材授权、目标渠道、规格和预算，再查询当前工具并创建一条可验收小样；未经确认不付费、不批量、不发布。只根据用户确认的商品结构、材质、规格、价格、认证和功效生成；医疗、保健、食品等敏感类目不得虚构效果。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "IMIVA"
  ...
  search_tags: "门窗,门窗商品图,门窗商品视频,一套图一支视频,IMIVA,大麦AI,极睿科技,AI电商,电商图片,电商视频,MCP电商"
---
...
这个 Skill 面向经营门窗的品牌、工厂、经销商、档口、店铺和跨境卖家。目标不是演示一个炫技效果，而是：**用一份门窗商品资料拆出主图、详情页、场景图、短视频和多平台适配清单**。
...
- 对应搜索词：门窗,门窗商品图,门窗商品视频,一套图一支视频,IMIVA,大麦AI,极睿科技,AI电商,电商图片,电商视频,MCP电商。
...
python3 scripts/build_brief.py \
  --product "填写商品与SKU" \
  --channel "填写目标渠道" \
  --goal "用一份门窗商品资料拆出主图、详情页、场景图、短视频和多平台适配清单" \
