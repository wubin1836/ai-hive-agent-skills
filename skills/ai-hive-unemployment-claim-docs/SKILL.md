---
name: ai-hive-unemployment-claim-docs
description: "失业金申领材料助手，用于失业金怎么领、失业保险金、离职能领失业金吗。读取你授权的原始资料，完成申请条件事实对照，并交付官方入口和待确认清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "失业金申领材料助手"
  version: "1.0.0"
...
失业金申领材料助手，用于失业金怎么领、失业保险金、离职能领失业金吗。读取你授权的原始资料，完成申请条件事实对照，并交付官方入口和待确认清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 记录城市、缴费与离职文件事实，不替用户编写离职原因
2. 分别核对失业登记和待遇申领的当前官方要求
3. 把已有资料、缺件和需经办核定的资格分开，不保证能领或具体数额
...
- `unemployment-claim-docs-checklist.xlsx`
- `unemployment-claim-docs-evidence.docx`
- `unemployment-claim-docs-sources.json`
...
> 仅示例，以下文件名和情境均为假设，不表示已存在真实数据：假设我已提供 示例_离职文件片段.pdf、示例_缴费记录.csv、示例_当地失业登记及申领指南.pdf。请使用「失业金申领材料助手」，把失业登记和待遇申领分别建清单，忠实记录离职文件事实，列出待经办核实的问题。将结果写入我指定的本地目录，交付 unemployment-claim-docs-checklist.xlsx、unemployment-claim-docs-evidence.docx、unemployment-claim-docs-sources.json。本例先离线处理；输入、工具或适用规则不足时先交缺口说明，不编造结果。需要联网更新来源先征得我同意，不登录账户、不代提交或付款。

## 搜索与任务识别

失业金怎么领、失业保险金、离职能领失业金吗、失业登记、失业金申请
