...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为无脸带货视频生成器制作一条主体清晰、节奏明确的商业视频", "keywords": "无脸视频,Faceless Video,不露脸带货,商品演示,AI短视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "faceless-commerce-video-ai-hive", "rule": "optional", "search": "让商品、手部动作和字幕承担叙事，不依赖人物正脸", "title": "无脸带货视频生成器"}')
