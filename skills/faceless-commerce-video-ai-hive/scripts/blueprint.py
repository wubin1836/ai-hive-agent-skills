#!/usr/bin/env python3
"""Create a deterministic production brief for 无脸带货视频生成器｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='无脸带货视频生成器｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['无脸视频', 'Faceless Video', '不露脸带货', '商品演示', 'AI短视频'],
