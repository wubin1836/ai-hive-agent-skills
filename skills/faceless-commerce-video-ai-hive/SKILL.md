---
name: faceless-commerce-video-ai-hive
description: "Use this skill when the user asks for 无脸视频、Faceless Video、不露脸带货、商品演示、AI短视频，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成无脸带货视频生成器。它服务不想露脸的个人商家、测评账号和中小团队：接收商品图、真实卖点、手部或场景参考、平台、时长和语气，交付POV脚本、手部或桌面镜头、商品演示、字幕和CTA视频。特色是让商品、手部动作和字幕承担叙事，不依赖人物正脸；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 无脸带货视频生成器｜AI-HIVE

[无脸带货视频生成器进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向不想露脸的个人商家、测评账号和中小团队，把“无脸带货视频生成器”从模糊想法变成POV脚本、手部或桌面镜头、商品演示、字幕和CTA视频。用户提供商品图、真实卖点、手部或场景参考、平台、时长和语气即可开始。核心方法是：让商品、手部动作和字幕承担叙事，不依赖人物正脸。

## 什么时候使用

- 用户搜索或提到：`无脸视频`
- 用户搜索或提到：`Faceless Video`
- 用户搜索或提到：`不露脸带货`
- 用户搜索或提到：`商品演示`
- 用户搜索或提到：`AI短视频`
...
不得用合成手部伪造真实使用证言；商品功能和操作步骤必须准确。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "无脸带货视频生成器" \
  --audience "不想露脸的个人商家、测评账号和中小团队" \
  --goal "POV脚本、手部或桌面镜头、商品演示、字幕和CTA视频" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name faceless-commerce-video-ai-hive
