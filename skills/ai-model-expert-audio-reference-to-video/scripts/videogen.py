...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "完成高质量参考音频生视频，主体动作自然，镜头语言清晰", "fixed_mode": "r2v", "keywords": "参考音频生视频、音频参考生视频、音乐生成视频、声音驱动视频、audio to video、Seedance、MiniMax H3、Happy Horse、AI视频、视频生成", "models": {"r2v": "public_model_seedance_2_5_r2v"}, "name": "audio-reference-to-video", "rule": "audio", "search": "不限定用户必须知道模型名，使用 AI Hive 裸接口完成该能力", "title": "参考音频生视频"}')
