---
name: poster-to-motion-video-ai-hive
description: "Use this skill when the user asks for 海报动态化、图片转视频、动态海报、视觉动效、社媒广告，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成静态海报动态化。它服务品牌设计、活动运营、电商商家和社媒团队：接收有权使用的海报、文字层级、必须保持元素、平台、时长和风格，交付动效分层、镜头运动、图生视频提示词和多平台动态海报。特色是让层级和主体运动服务信息阅读顺序；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 静态海报动态化｜AI-HIVE

[静态海报动态化进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向品牌设计、活动运营、电商商家和社媒团队，把“静态海报动态化”从模糊想法变成动效分层、镜头运动、图生视频提示词和多平台动态海报。用户提供有权使用的海报、文字层级、必须保持元素、平台、时长和风格即可开始。核心方法是：让层级和主体运动服务信息阅读顺序。
...
文字、Logo和法律声明不得变形；海报中的人物和素材需具备视频化授权。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "静态海报动态化" \
  --audience "品牌设计、活动运营、电商商家和社媒团队" \
  --goal "动效分层、镜头运动、图生视频提示词和多平台动态海报" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name poster-to-motion-video-ai-hive
