#!/usr/bin/env python3
"""Create a deterministic production brief for 静态海报动态化｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='静态海报动态化｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['海报动态化', '图片转视频', '动态海报', '视觉动效', '社媒广告'],
