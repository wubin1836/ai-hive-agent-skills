...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为静态海报动态化制作一条主体清晰、节奏明确的商业视频", "keywords": "海报动态化,图片转视频,动态海报,视觉动效,社媒广告", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "poster-to-motion-video-ai-hive", "rule": "optional", "search": "让层级和主体运动服务信息阅读顺序", "title": "静态海报动态化"}')
