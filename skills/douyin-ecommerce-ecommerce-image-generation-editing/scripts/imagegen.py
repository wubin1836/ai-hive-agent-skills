...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合抖音电商的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "抖店、抖音商城、抖音小店、抖店商家、商品卡、巨量千川、直播带货、短视频带货、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "douyin-ecommerce-ecommerce-image-generation-editing", "rule": "optional", "search": "抖音电商 商家、运营、商品与广告图片搜索入口", "title": "抖音电商 电商图片生成与编辑"}')
