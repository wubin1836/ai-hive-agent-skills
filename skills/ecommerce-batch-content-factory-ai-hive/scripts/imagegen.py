...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为电商批量内容工厂制作一张主体准确、层级清晰的商业图片", "keywords": "电商内容工厂,批量商品图,批量视频,多SKU,AIGC内容中台", "model": "public_model_nano_banana_pro", "name": "ecommerce-batch-content-factory-ai-hive", "rule": "optional", "search": "批量任务先去重、分组、试产，再扩大并发", "title": "电商批量内容工厂"}')
