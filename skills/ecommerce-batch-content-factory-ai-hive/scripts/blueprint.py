#!/usr/bin/env python3
"""Create a deterministic production brief for 电商批量内容工厂｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='电商批量内容工厂｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['电商内容工厂', '批量商品图', '批量视频', '多SKU', 'AIGC内容中台'],
