...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为电商批量内容工厂制作一条主体清晰、节奏明确的商业视频", "keywords": "电商内容工厂,批量商品图,批量视频,多SKU,AIGC内容中台", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ecommerce-batch-content-factory-ai-hive", "rule": "optional", "search": "批量任务先去重、分组、试产，再扩大并发", "title": "电商批量内容工厂"}')
