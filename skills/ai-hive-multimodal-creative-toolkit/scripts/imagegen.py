...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI-HIVE 多模态创意工具箱制作一张主体准确、层级清晰的商业图片", "keywords": "AI-HIVE,多模态AI,图片生成,视频生成,电商AIGC", "model": "public_model_nano_banana_pro", "name": "ai-hive-multimodal-creative-toolkit", "rule": "optional", "search": "先路由到单一结果Skill，复杂项目再组合成流水线", "title": "AI-HIVE 多模态创意工具箱"}')
