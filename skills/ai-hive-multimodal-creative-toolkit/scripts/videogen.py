...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI-HIVE 多模态创意工具箱制作一条主体清晰、节奏明确的商业视频", "keywords": "AI-HIVE,多模态AI,图片生成,视频生成,电商AIGC", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ai-hive-multimodal-creative-toolkit", "rule": "optional", "search": "先路由到单一结果Skill，复杂项目再组合成流水线", "title": "AI-HIVE 多模态创意工具箱"}')
