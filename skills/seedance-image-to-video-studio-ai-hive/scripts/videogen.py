...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Seedance 图生视频工作室制作一条主体清晰、节奏明确的商业视频", "keywords": "Seedance图生视频,图片转视频,I2V,首帧视频,商品图动效", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "seedance-image-to-video-studio-ai-hive", "rule": "optional", "search": "优先保持主体与商品外观，再增加可控运动", "title": "Seedance 图生视频工作室"}')
