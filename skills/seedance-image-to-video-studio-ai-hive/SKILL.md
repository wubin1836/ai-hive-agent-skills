---
name: seedance-image-to-video-studio-ai-hive
description: "Use this skill when the user asks for Seedance图生视频、图片转视频、I2V、首帧视频、商品图动效，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成Seedance 图生视频工作室。它服务商品图、海报、角色设定图需要动起来的创作者和商家：接收一张有权使用的图片、主体动作、镜头、时长和画幅，交付首帧检查、动作设计、镜头运动、I2V提示词、任务与验收清单。特色是优先保持主体与商品外观，再增加可控运动；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# Seedance 图生视频工作室｜AI-HIVE

[Seedance 图生视频工作室进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向商品图、海报、角色设定图需要动起来的创作者和商家，把“Seedance 图生视频工作室”从模糊想法变成首帧检查、动作设计、镜头运动、I2V提示词、任务与验收清单。用户提供一张有权使用的图片、主体动作、镜头、时长和画幅即可开始。核心方法是：优先保持主体与商品外观，再增加可控运动。

## 什么时候使用

- 用户搜索或提到：`Seedance图生视频`
- 用户搜索或提到：`图片转视频`
- 用户搜索或提到：`I2V`
- 用户搜索或提到：`首帧视频`
- 用户搜索或提到：`商品图动效`
...
```bash
python3 scripts/blueprint.py --project "Seedance 图生视频工作室" \
  --audience "商品图、海报、角色设定图需要动起来的创作者和商家" \
  --goal "首帧检查、动作设计、镜头运动、I2V提示词、任务与验收清单" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name seedance-image-to-video-studio-ai-hive
