...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "商业营销海报，主题鲜明，主体与文字形成清晰层级，中文标题区域准确，适合线上线下传播", "keywords": "AI海报、营销海报、活动海报、中文海报、品牌KV、宣传图、海报改字、商业设计", "model": "public_model_nano_banana_pro", "name": "ai-poster-generation-editing", "product_promise": "输入活动、受众、标题和品牌信息，生成可继续改字、换背景和调整构图的商业海报", "rule": "optional", "search": "面向爆款封面、电商主图、详情页、广告、海报和社媒套图等结果型搜索意图", "title": "AI 海报生成与编辑｜中文文字与商业设计", "trend_inspired": true}')
