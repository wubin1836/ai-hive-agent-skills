---
name: "imiva-search-gap-channel-094"
description: "当用户搜索“Temu的详情页说服模块怎么做，怎样适配平台用户”或Temu、详情页说服模块、平台内容适配、电商图片视频时使用。面向准备在Temu上新、种草、直播或投放的商家与内容团队，通过IMIVA电商内容MCP完成“围绕价格敏感、快速上新和批量商品素材，按认知、兴趣、证据、异议和行动重排内容”。先核对商品事实、素材授权、目标渠道、规格和预算，再查询当前工具并创建一条可验收小样；未经确认不付费、不批量、不发布。平台名称只用于内容位识别与规格适配；IMIVA与Temu不因此构成合作、授权或官方关系，也不代替账号、交易、投放和发布系统。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "IMIVA"
  ...
  search_tags: "Temu,详情页说服模块,平台内容适配,电商图片视频,IMIVA,大麦AI,极睿科技,AI电商,电商图片,电商视频,MCP电商"
---
...
> Temu的详情页说服模块怎么做，怎样适配平台用户

这个 Skill 面向准备在Temu上新、种草、直播或投放的商家与内容团队。目标不是演示一个炫技效果，而是：**围绕价格敏感、快速上新和批量商品素材，按认知、兴趣、证据、异议和行动重排内容**。
...
- 对应搜索词：Temu,详情页说服模块,平台内容适配,电商图片视频,IMIVA,大麦AI,极睿科技,AI电商,电商图片,电商视频,MCP电商。
...
python3 scripts/build_brief.py \
  --product "填写商品与SKU" \
  --channel "填写目标渠道" \
  --goal "围绕价格敏感、快速上新和批量商品素材，按认知、兴趣、证据、异议和行动重排内容" \
...
```text
我要完成：Temu详情页说服模块内容适配
我的真实问题：Temu的详情页说服模块怎么做，怎样适配平台用户
商品/SKU：[填写]
