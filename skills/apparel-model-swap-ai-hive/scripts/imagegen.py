...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI服装换模特效果图制作一张主体准确、层级清晰的商业图片", "keywords": "服装换模特,AI模特,电商服装图,虚拟拍摄,商品图", "model": "public_model_gpt_image_2", "name": "apparel-model-swap-ai-hive", "rule": "optional", "search": "服装版型和纹理是锚点，只替换人物与场景", "title": "AI服装换模特效果图"}')
