...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"r2v\", \"models\": {\"r2v\": \"public_model_seedance_2_5_r2v\"}, \"name\": \"video-reference-to-video\", \"rule\": \"video\", \"title\": \"Video Reference to Video\"}")
