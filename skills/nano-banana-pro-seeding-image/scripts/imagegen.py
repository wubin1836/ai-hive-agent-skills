...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_pro\", \"name\": \"nano-banana-pro-seeding-image\", \"rule\": \"optional\", \"title\": \"Nano Banana Pro Social Seeding Image\"}")
