---
name: viral-video-multi-platform-reversion-ai-hive
description: "Use this skill when the user asks for 多平台改版、一稿多发、抖音小红书视频号、TikTok、内容分发，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成爆款视频多平台改版。它服务全域运营团队、MCN和品牌市场部门：接收母版视频、平台清单、地区语言、账号定位和转化目标，交付抖音、小红书、视频号、TikTok四套钩子、时长、字幕和CTA版本。特色是同一核心卖点按平台机制重做，而不是简单裁切；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 爆款视频多平台改版｜AI-HIVE

[爆款视频多平台改版进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向全域运营团队、MCN和品牌市场部门，把“爆款视频多平台改版”从模糊想法变成抖音、小红书、视频号、TikTok四套钩子、时长、字幕和CTA版本。用户提供母版视频、平台清单、地区语言、账号定位和转化目标即可开始。核心方法是：同一核心卖点按平台机制重做，而不是简单裁切。
...
```bash
python3 scripts/blueprint.py --project "爆款视频多平台改版" \
  --audience "全域运营团队、MCN和品牌市场部门" \
  --goal "抖音、小红书、视频号、TikTok四套钩子、时长、字幕和CTA版本" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name viral-video-multi-platform-reversion-ai-hive
