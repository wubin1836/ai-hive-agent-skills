#!/usr/bin/env python3
"""Create a deterministic production brief for 爆款视频多平台改版｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='爆款视频多平台改版｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['多平台改版', '一稿多发', '抖音小红书视频号', 'TikTok', '内容分发'],
