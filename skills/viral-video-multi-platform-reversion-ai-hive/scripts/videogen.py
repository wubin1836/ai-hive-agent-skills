...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为爆款视频多平台改版制作一条主体清晰、节奏明确的商业视频", "keywords": "多平台改版,一稿多发,抖音小红书视频号,TikTok,内容分发", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "viral-video-multi-platform-reversion-ai-hive", "rule": "optional", "search": "同一核心卖点按平台机制重做，而不是简单裁切", "title": "爆款视频多平台改版"}')
