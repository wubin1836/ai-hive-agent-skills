...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为红果短剧生成工作室制作一条主体清晰、节奏明确的商业视频", "keywords": "红果短剧,番茄短剧,竖屏短剧,微短剧,AI短剧", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "hongguo-short-drama-studio-ai-hive", "rule": "optional", "search": "借鉴竖屏短剧的强节拍方法，但不承诺平台审核或流量", "title": "红果短剧生成工作室"}')
