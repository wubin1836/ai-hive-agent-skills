...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为红果短剧生成工作室制作一张主体准确、层级清晰的商业图片", "keywords": "红果短剧,番茄短剧,竖屏短剧,微短剧,AI短剧", "model": "public_model_nano_banana_pro", "name": "hongguo-short-drama-studio-ai-hive", "rule": "optional", "search": "借鉴竖屏短剧的强节拍方法，但不承诺平台审核或流量", "title": "红果短剧生成工作室"}')
