#!/usr/bin/env python3
"""Create a deterministic production brief for 红果短剧生成工作室｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='红果短剧生成工作室｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['红果短剧', '番茄短剧', '竖屏短剧', '微短剧', 'AI短剧'],
