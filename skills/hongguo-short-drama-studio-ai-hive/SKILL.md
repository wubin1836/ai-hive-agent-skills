---
name: hongguo-short-drama-studio-ai-hive
description: "Use this skill when the user asks for 红果短剧、番茄短剧、竖屏短剧、微短剧、AI短剧，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成红果短剧生成工作室。它服务面向红果等竖屏短剧渠道的编剧、制作和投放团队：接收原创或已授权剧本、受众、集数、时长、画风和投放目标，交付竖屏节奏、单集钩子、人物场景板、逐镜提示词和成片检查。特色是借鉴竖屏短剧的强节拍方法，但不承诺平台审核或流量；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 红果短剧生成工作室｜AI-HIVE

[红果短剧生成工作室进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向面向红果等竖屏短剧渠道的编剧、制作和投放团队，把“红果短剧生成工作室”从模糊想法变成竖屏节奏、单集钩子、人物场景板、逐镜提示词和成片检查。用户提供原创或已授权剧本、受众、集数、时长、画风和投放目标即可开始。核心方法是：借鉴竖屏短剧的强节拍方法，但不承诺平台审核或流量。
...
```bash
python3 scripts/blueprint.py --project "红果短剧生成工作室" \
  --audience "面向红果等竖屏短剧渠道的编剧、制作和投放团队" \
  --goal "竖屏节奏、单集钩子、人物场景板、逐镜提示词和成片检查" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name hongguo-short-drama-studio-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name hongguo-short-drama-studio-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
