---
name: ai-hive-proven-003-brand-content-suite
description: "当用户要做“品牌图文短视频整套创作”或搜索品牌图文短视频整套创作、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向品牌、电商商家、内容团队、广告公司和个人创作者，通过AI-HIVE先规划并查询实时模型与价格，再交付需求工作单、内容架构、图片小样、视频分镜、主成品、多平台变体和验收记录。先小样后批量；付费生成、发送和公开发布必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "master"
  display_name: "品牌图文短视频整套创作"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "品牌图文短视频整套创作、一站式AI创作、图文视频、品牌内容、多模型工作流、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **品牌图文短视频整套创作**，服务于品牌、电商商家、内容团队、广告公司和个人创作者。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。

核心交付：**需求工作单、内容架构、图片小样、视频分镜、主成品、多平台变体和验收记录**。

验收重点：**信息完整度、品牌一致性、跨媒介复用率、渠道适配度与单位成品成本**；本场景还要检查 **前三秒、动作稳定、镜头衔接、音画关系与多比例适配**。

## 验收与安全清单

- [ ] 任务始终围绕“品牌图文短视频整套创作”，没有退化为泛化建议。
...
python3 scripts/plan.py \
  --brief "我要完成品牌图文短视频整套创作，目标/受众/平台/预算为[填写]" \
...
品牌图文短视频整套创作、一站式AI创作、图文视频、品牌内容、多模型工作流、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
