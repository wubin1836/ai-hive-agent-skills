---
name: meme-short-video-generator-ai-hive
description: "Use this skill when the user asks for Meme视频、梗图短视频、热点改编、社媒内容、品牌年轻化，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成Meme梗图短视频生成器。它服务社媒运营、年轻化品牌、游戏和互联网产品团队：接收目标梗或参考、品牌事实、受众、平台、语气和版权限制，交付梗的结构解释、品牌改写、图片或视频模板、字幕和发布版本。特色是学习梗的互动机制，重写成品牌自己的原创表达；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# Meme梗图短视频生成器｜AI-HIVE

[Meme梗图短视频生成器进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向社媒运营、年轻化品牌、游戏和互联网产品团队，把“Meme梗图短视频生成器”从模糊想法变成梗的结构解释、品牌改写、图片或视频模板、字幕和发布版本。用户提供目标梗或参考、品牌事实、受众、平台、语气和版权限制即可开始。核心方法是：学习梗的互动机制，重写成品牌自己的原创表达。
...
不得直接复制受版权保护模板、冒充热点当事人或使用歧视、骚扰和灾难性内容。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "Meme梗图短视频生成器" \
  --audience "社媒运营、年轻化品牌、游戏和互联网产品团队" \
  --goal "梗的结构解释、品牌改写、图片或视频模板、字幕和发布版本" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name meme-short-video-generator-ai-hive
