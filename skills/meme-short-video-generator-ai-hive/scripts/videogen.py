...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Meme梗图短视频生成器制作一条主体清晰、节奏明确的商业视频", "keywords": "Meme视频,梗图短视频,热点改编,社媒内容,品牌年轻化", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "meme-short-video-generator-ai-hive", "rule": "optional", "search": "学习梗的互动机制，重写成品牌自己的原创表达", "title": "Meme梗图短视频生成器"}')
