---
name: ai-hive-provident-housing-loan-docs
description: "公积金买房贷款材料助手，用于公积金贷款、公积金买房、异地公积金贷款。读取你授权的原始资料，完成贷款材料与来源对照，并交付办理顺序和咨询清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "公积金买房贷款材料助手"
  version: "1.0.0"
...
公积金买房贷款材料助手，用于公积金贷款、公积金买房、异地公积金贷款。读取你授权的原始资料，完成贷款材料与来源对照，并交付办理顺序和咨询清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 确认购房地、缴存地、购房用途及申请阶段，不判断授信结果
2. 核查受理地现行官方说明，区分公积金与商业银行材料
3. 整理原件复印件、有效期和前置事项，额度利率必须另取当前正式依据
...
- `provident-housing-loan-docs-checklist.xlsx`
- `provident-housing-loan-docs-evidence.docx`
- `provident-housing-loan-docs-sources.json`
...
> 仅示例，以下文件名和情境均为假设，不表示已存在真实数据：假设我已提供 示例_购房与缴存地区.json、示例_申请阶段.md、示例_公积金中心清单.pdf、示例_银行材料清单.pdf。请使用「公积金买房贷款材料助手」，把申请材料按原件复印件、有效期和前置手续整理，区分公积金中心与商业银行要求。将结果写入我指定的本地目录，交付 provident-housing-loan-docs-checklist.xlsx、provident-housing-loan-docs-evidence.docx、provident-housing-loan-docs-sources.json。本例先离线处理；输入、工具或适用规则不足时先交缺口说明，不编造结果。需要联网更新来源先征得我同意，不登录账户、不代提交或付款。

## 搜索与任务识别

公积金贷款、公积金买房、异地公积金贷款、公积金贷款资料、组合贷材料
