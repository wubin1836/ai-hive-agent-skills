---
name: ai-hive-guoxue-xuankong-grid-diff
description: "玄空飞星盘与九宫资料核对助手：读取用户已核验的飞星盘截图及版本、原工具明确记录的时间、朝向与其他输入，分别提取九宫坐标及各层标签，标出来自原盘的信息与缺项，不重新猜排盘，交付可回查的文件及待核实清单。适用于玄空飞星、九宫飞星、玄空风水、三元九运；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。"
metadata:
  display_name: "玄空飞星盘与九宫资料核对助手"
  version: "1.0.0"
...
玄空飞星盘与九宫资料核对助手：读取用户已核验的飞星盘截图及版本、原工具明确记录的时间、朝向与其他输入，分别提取九宫坐标及各层标签，标出来自原盘的信息与缺项，不重新猜排盘，交付可回查的文件及待核实清单。适用于玄空飞星、九宫飞星、玄空风水、三元九运；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。
...
1. 分别提取九宫坐标及各层标签，标出来自原盘的信息与缺项，不重新猜排盘
2. 逐格比较输入与字段差异，保留版本/口径解释，不擅自选某一盘为事实
3. 生成图层对照PDF和差异CSV，逐格回读，传统符号不直接转为房屋安全或吉凶结论
...
- `flying-star-fields.json`
- `nine-palace-differences.csv`
- `flying-star-comparison.pdf`
...
玄空飞星、九宫飞星、玄空风水、三元九运、九运离火、飞星盘对照
