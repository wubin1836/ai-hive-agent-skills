...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合拼多多的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "拼多多商家、拼多多运营、PDD、多多、拼多多主图、多多搜索、多多场景、商品视频、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "pinduoduo-ecommerce-image-generation-editing", "rule": "optional", "search": "拼多多 商家、运营、商品与广告图片搜索入口", "title": "拼多多 电商图片生成与编辑"}')
