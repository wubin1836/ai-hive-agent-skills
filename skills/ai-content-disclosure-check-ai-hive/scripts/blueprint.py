#!/usr/bin/env python3
"""Create a deterministic production brief for AI生成内容披露检查｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI生成内容披露检查｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['AI内容标识', 'AI广告披露', '生成内容标签', '合成媒体', '广告透明度'],
