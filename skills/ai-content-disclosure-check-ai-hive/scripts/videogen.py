...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI生成内容披露检查制作一条主体清晰、节奏明确的商业视频", "keywords": "AI内容标识,AI广告披露,生成内容标签,合成媒体,广告透明度", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ai-content-disclosure-check-ai-hive", "rule": "optional", "search": "根据生成方式与平台规则判断需要记录和披露什么", "title": "AI生成内容披露检查"}')
