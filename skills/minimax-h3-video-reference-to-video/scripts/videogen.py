...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"r2v\", \"models\": {\"r2v\": \"public_model_minimax_h3_r2v\"}, \"name\": \"minimax-h3-video-reference-to-video\", \"rule\": \"video\", \"title\": \"MiniMax H3 Video Reference to Video\"}")
