...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Seedance 2.0 完成高质量参考视频生视频，动作连续，镜头稳定", "fixed_mode": "r2v", "keywords": "Seedance2.0、Seedance 2、Seedance2、Seed Dance 2.0、字节 Seedance、参考视频生视频、视频参考生视频、参考视频生成视频、动作参考、运镜参考、AI视频、视频生成", "models": {"r2v": "public_model_seedance_r2v"}, "name": "seedance-2-0-video-reference-to-video", "rule": "video", "search": "固定调用 Seedance 2.0 的参考视频生视频裸接口能力", "title": "Seedance 2.0 参考视频生视频"}')
