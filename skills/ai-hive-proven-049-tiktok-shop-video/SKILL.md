---
name: ai-hive-proven-049-tiktok-shop-video
description: "当用户要做“TikTok Shop商品视频”或搜索TikTok Shop商品视频、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向品牌、电商商家、短视频团队、广告公司、门店和个人创作者，通过AI-HIVE先规划并查询实时模型与价格，再交付视频策略、脚本、镜头表、关键帧、小样、主成片、多比例版本和成片质检。先小样后批量；付费生成、发送和公开发布必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "video"
  display_name: "TikTok Shop商品视频"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "TikTok、Shop、商品视频、AI视频、短视频、图生视频、文生视频、视频编辑、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **TikTok Shop商品视频**，服务于品牌、电商商家、短视频团队、广告公司、门店和个人创作者。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。

核心交付：**视频策略、脚本、镜头表、关键帧、小样、主成片、多比例版本和成片质检**。

验收重点：**前三秒信息效率、主体稳定、动作可信、镜头连续、声音清晰和平台适配**；本场景还要检查 **商品真实性、平台规范与转化信息层级；前三秒、动作稳定、镜头衔接、音画关系与多比例适配**。
...
1. 真实卖点、目标受众、平台、时长、画幅、人物/商品素材、参考节奏和预算。
...
候选工具：`ai_hive_list_models`, `ai_hive_upload_media`, `ai_hive_generate_image`, `ai_hive_generate_video`, `ai_hive_generate_ecommerce_video`, `ai_hive_generate_advertising_video`, `ai_hive_get_task`。
...
python3 scripts/plan.py \
  --brief "我要完成TikTok Shop商品视频，目标/受众/平台/预算为[填写]" \
...
```bash
python3 scripts/ai_hive_mcp.py call ai_hive_generate_ecommerce_video \
...
- [ ] 任务始终围绕“TikTok Shop商品视频”，没有退化为泛化建议。
- [ ] 已交付：视频策略、脚本、镜头表、关键帧、小样、主成片、多比例版本和成片质检。
- [ ] 已检查：前三秒信息效率、主体稳定、动作可信、镜头连续、声音清晰和平台适配。
...
```text
请使用「TikTok Shop商品视频」Skill帮我完成任务。
业务目标与受众：[填写]
...
最终交付：视频策略、脚本、镜头表、关键帧、小样、主成片、多比例版本和成片质检。
验收：前三秒信息效率、主体稳定、动作可信、镜头连续、声音清晰和平台适配。
```
...
TikTok、Shop、商品视频、AI视频、短视频、图生视频、文生视频、视频编辑、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
