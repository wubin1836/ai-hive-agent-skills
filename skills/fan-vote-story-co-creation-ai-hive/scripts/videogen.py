...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为粉丝投票共创剧情制作一条主体清晰、节奏明确的商业视频", "keywords": "粉丝投票剧情,共创短剧,互动IP,剧情投票,社群内容", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "fan-vote-story-co-creation-ai-hive", "rule": "optional", "search": "给粉丝真实可执行的选择，并预先评估每条路径成本", "title": "粉丝投票共创剧情"}')
