...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为粉丝投票共创剧情制作一张主体准确、层级清晰的商业图片", "keywords": "粉丝投票剧情,共创短剧,互动IP,剧情投票,社群内容", "model": "public_model_gpt_image_2", "name": "fan-vote-story-co-creation-ai-hive", "rule": "optional", "search": "给粉丝真实可执行的选择，并预先评估每条路径成本", "title": "粉丝投票共创剧情"}')
