...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为高德地图连锁门店地图营销制作主体稳定、事实可核验的本地生活视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "local-amap-multi-store-ai-hive", "title": "AI大模型专家｜高德地图连锁门店地图营销", "keywords": "高德地图、高德商家、高德地图门店、高德POI、高德地图营销、连锁门店地图营销、本地生活、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前模型与价格，并在平台官方后台核对当前规则"}')
