...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name happy-horse-social-commerce-video
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode i2v \
  --prompt "Happy Horse Social Commerce Video: polished motion, clear subject, coherent action, stable camera, commercial finish"
```
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "Create a polished happy horse social commerce video result with coherent motion, stable identity, and a clear ending"
```
