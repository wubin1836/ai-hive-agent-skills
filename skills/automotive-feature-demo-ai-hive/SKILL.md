---
name: automotive-feature-demo-ai-hive
description: "Use this skill when the user asks for 汽车视频、功能演示、汽车广告、新车介绍、AI汽车，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成汽车功能演示视频。它服务汽车品牌、经销商、车媒体和功能培训团队：接收真实车型多角度图、官方功能资料、场景、平台、时长和禁用表述，交付功能脚本、车辆锚点、使用场景、视频片段和安全提示。特色是以官方功能资料为依据，用场景解释一个功能；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 汽车功能演示视频｜AI-HIVE

[汽车功能演示视频进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向汽车品牌、经销商、车媒体和功能培训团队，把“汽车功能演示视频”从模糊想法变成功能脚本、车辆锚点、使用场景、视频片段和安全提示。用户提供真实车型多角度图、官方功能资料、场景、平台、时长和禁用表述即可开始。核心方法是：以官方功能资料为依据，用场景解释一个功能。
...
不得生成未配置功能、危险驾驶、虚假道路表现或未经许可的品牌比较。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "汽车功能演示视频" \
  --audience "汽车品牌、经销商、车媒体和功能培训团队" \
  --goal "功能脚本、车辆锚点、使用场景、视频片段和安全提示" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name automotive-feature-demo-ai-hive
