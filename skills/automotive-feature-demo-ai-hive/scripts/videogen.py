...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为汽车功能演示视频制作一条主体清晰、节奏明确的商业视频", "keywords": "汽车视频,功能演示,汽车广告,新车介绍,AI汽车", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "automotive-feature-demo-ai-hive", "rule": "optional", "search": "以官方功能资料为依据，用场景解释一个功能", "title": "汽车功能演示视频"}')
