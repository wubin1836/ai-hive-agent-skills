...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为商品植入微短剧制作一条主体清晰、节奏明确的商业视频", "keywords": "商品短剧,品牌微短剧,剧情带货,广告植入,AI短剧", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "product-placement-micro-drama-ai-hive", "rule": "optional", "search": "让商品解决剧情中的真实问题，而不是生硬念卖点", "title": "商品植入微短剧"}')
