...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为商品植入微短剧制作一张主体准确、层级清晰的商业图片", "keywords": "商品短剧,品牌微短剧,剧情带货,广告植入,AI短剧", "model": "public_model_nano_banana_pro", "name": "product-placement-micro-drama-ai-hive", "rule": "optional", "search": "让商品解决剧情中的真实问题，而不是生硬念卖点", "title": "商品植入微短剧"}')
