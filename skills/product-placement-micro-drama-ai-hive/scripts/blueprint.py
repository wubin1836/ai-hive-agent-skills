#!/usr/bin/env python3
"""Create a deterministic production brief for 商品植入微短剧｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='商品植入微短剧｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['商品短剧', '品牌微短剧', '剧情带货', '广告植入', 'AI短剧'],
