---
name: product-placement-micro-drama-ai-hive
description: "Use this skill when the user asks for 商品短剧、品牌微短剧、剧情带货、广告植入、AI短剧，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成商品植入微短剧。它服务品牌市场、电商商家、短剧制作和内容代理商：接收商品事实、受众、品牌边界、故事类型、平台、时长和预算，交付剧情命题、植入节点、人物场景板、分镜、商品镜头和成片。特色是让商品解决剧情中的真实问题，而不是生硬念卖点；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 商品植入微短剧｜AI-HIVE

[商品植入微短剧进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向品牌市场、电商商家、短剧制作和内容代理商，把“商品植入微短剧”从模糊想法变成剧情命题、植入节点、人物场景板、分镜、商品镜头和成片。用户提供商品事实、受众、品牌边界、故事类型、平台、时长和预算即可开始。核心方法是：让商品解决剧情中的真实问题，而不是生硬念卖点。
...
广告属性和商业合作应按平台要求披露；不得用剧情虚构产品功效。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "商品植入微短剧" \
  --audience "品牌市场、电商商家、短剧制作和内容代理商" \
  --goal "剧情命题、植入节点、人物场景板、分镜、商品镜头和成片" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name product-placement-micro-drama-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name product-placement-micro-drama-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
