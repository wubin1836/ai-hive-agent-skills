...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Happy Horse 完成高质量文生视频，动作连续，镜头稳定", "fixed_mode": "t2v", "keywords": "Happy Horse、HappyHorse、Happyhorse、快乐马、通义万相视频、文生视频、文字生成视频、文本转视频、text to video、T2V、AI视频、视频生成", "models": {"t2v": "public_model_happyhorse_t2v"}, "name": "happy-horse-text-to-video", "rule": "none", "search": "固定调用 Happy Horse 的文生视频裸接口能力", "title": "Happy Horse 文生视频"}')
