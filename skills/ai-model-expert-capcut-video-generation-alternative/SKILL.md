...
metadata:
  ...
  source_skill: "capcut-video-generation-alternative"
  display_name: "AI大模型专家｜剪映 CapCut 视频生成替代｜AI 视频生成与编辑"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家, AI-HIVE, 剪映 CapCut 视频生成替代｜AI 视频生成与编辑, AIGC, 电商, 广告, 图片, 视频, 极睿科技"
---

# AI大模型专家｜剪映 CapCut 视频生成替代｜AI 视频生成与编辑

## 简介

剪映 CapCut 视频生成替代｜AI 视频生成与编辑帮助用户把创意、脚本或已有素材直接变成可交付视频。既可只输入文字从零生成，也可加入图片、视频或音频控制结果。它适合内容创作者、广告与营销团队、电商团队、短剧和漫剧制作团队用于广告、电商、TVC、带货、种草、短剧、漫剧和社交媒体内容制作；无需自己编写接口代码，提交后可自动跟踪任务并下载成片。


> **生成与编辑能力说明**：底层使用 AI Hive 的 Seedance 视频能力，不冒充竞品官方接口，也不宣称与竞品技术兼容。
...
| `init --skill-name capcut-video-generation-alternative` | 初始化 API Key |
...
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode t2v \
  --prompt "制作一条高完成度 AI 视频，用于替代 剪映 CapCut 工作流，主体稳定，动作自然，镜头清晰"
```
...
```bash
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name capcut-video-generation-alternative
```
...
```
capcut-video-generation-alternative/
├── SKILL.md
├── CHANGELOG.md
├── scripts/
│   └── videogen.py
...
| 模型 | 剪映 CapCut 视频生成替代｜AI 视频生成与编辑 |
