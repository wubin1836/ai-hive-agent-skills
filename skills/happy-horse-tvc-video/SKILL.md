---
name: happy-horse-tvc-video
description: "Use this skill when creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers need to produce television-style and premium brand commercials with Happy Horse through the AI Hive OpenAPI. It handles required media uploads, live model and price lookup, task submission, progress polling, and result downloads. Useful for ads, TVCs, product videos, e-commerce listings, social commerce, UGC-style seeding content, short dramas, motion comics, and storyboards. Search intents include TVC, television commercial, brand film, product commercial."
license: MIT
---

# Happy Horse TVC Commercial

## Overview

Happy Horse TVC Commercial helps creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers produce television-style and premium brand commercials with Happy Horse. Describe the intended subject, action, camera, lighting, pacing, and constraints; the bundled CLI handles AI Hive OpenAPI calls and downloads the finished video.
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name happy-horse-tvc-video
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode i2v \
  --prompt "Happy Horse TVC Commercial: polished motion, clear subject, coherent action, stable camera, commercial finish"
```
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "Create a polished happy horse tvc commercial result with coherent motion, stable identity, and a clear ending"
```
