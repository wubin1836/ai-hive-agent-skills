---
name: electronics-feature-explainer-ai-hive
description: "Use this skill when the user asks for 3C产品视频、数码功能演示、结构动画、科技广告、产品讲解，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成3C产品结构与功能演示。它服务3C品牌、数码电商、科技媒体和产品培训团队：接收真实产品图、官方参数、结构资料、功能步骤、平台和时长，交付功能解释脚本、结构示意关键帧、使用场景视频和参数卡。特色是把复杂功能拆成可视化步骤，使用真实参数作锚点；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 3C产品结构与功能演示｜AI-HIVE

[3C产品结构与功能演示进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向3C品牌、数码电商、科技媒体和产品培训团队，把“3C产品结构与功能演示”从模糊想法变成功能解释脚本、结构示意关键帧、使用场景视频和参数卡。用户提供真实产品图、官方参数、结构资料、功能步骤、平台和时长即可开始。核心方法是：把复杂功能拆成可视化步骤，使用真实参数作锚点。
...
生成画面不能冒充工程剖面或安全测试；内部结构、性能和参数必须来自官方资料。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "3C产品结构与功能演示" \
  --audience "3C品牌、数码电商、科技媒体和产品培训团队" \
  --goal "功能解释脚本、结构示意关键帧、使用场景视频和参数卡" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name electronics-feature-explainer-ai-hive
