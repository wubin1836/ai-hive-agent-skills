...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为3C产品结构与功能演示制作一条主体清晰、节奏明确的商业视频", "keywords": "3C产品视频,数码功能演示,结构动画,科技广告,产品讲解", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "electronics-feature-explainer-ai-hive", "rule": "optional", "search": "把复杂功能拆成可视化步骤，使用真实参数作锚点", "title": "3C产品结构与功能演示"}')
