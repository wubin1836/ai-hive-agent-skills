...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为电商选品决策助手制作一条主体清晰、节奏明确的商业视频", "keywords": "电商选品,商品决策,选品评分,带货选品,SKU分析", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ecommerce-product-selector-ai-hive", "rule": "optional", "search": "只基于给定事实做决策，不冒充实时市场数据", "title": "电商选品决策助手"}')
