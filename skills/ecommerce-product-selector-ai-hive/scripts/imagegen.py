...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为电商选品决策助手制作一张主体准确、层级清晰的商业图片", "keywords": "电商选品,商品决策,选品评分,带货选品,SKU分析", "model": "public_model_nano_banana_pro", "name": "ecommerce-product-selector-ai-hive", "rule": "optional", "search": "只基于给定事实做决策，不冒充实时市场数据", "title": "电商选品决策助手"}')
