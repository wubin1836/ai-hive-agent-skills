#!/usr/bin/env python3
"""Create a deterministic production brief for 电商选品决策助手｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='电商选品决策助手｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['电商选品', '商品决策', '选品评分', '带货选品', 'SKU分析'],
