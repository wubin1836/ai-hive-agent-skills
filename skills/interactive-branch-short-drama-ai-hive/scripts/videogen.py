...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为互动分支短剧生成器制作一条主体清晰、节奏明确的商业视频", "keywords": "互动短剧,分支剧情,选择式视频,AI短剧,互动叙事", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "interactive-branch-short-drama-ai-hive", "rule": "optional", "search": "先验证分支逻辑和资产复用，再按节点生成视频", "title": "互动分支短剧生成器"}')
