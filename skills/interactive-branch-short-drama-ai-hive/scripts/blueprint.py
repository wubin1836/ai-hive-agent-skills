#!/usr/bin/env python3
"""Create a deterministic production brief for 互动分支短剧生成器｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='互动分支短剧生成器｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['互动短剧', '分支剧情', '选择式视频', 'AI短剧', '互动叙事'],
