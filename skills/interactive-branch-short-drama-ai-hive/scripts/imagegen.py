...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为互动分支短剧生成器制作一张主体准确、层级清晰的商业图片", "keywords": "互动短剧,分支剧情,选择式视频,AI短剧,互动叙事", "model": "public_model_nano_banana_pro", "name": "interactive-branch-short-drama-ai-hive", "rule": "optional", "search": "先验证分支逻辑和资产复用，再按节点生成视频", "title": "互动分支短剧生成器"}')
