...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_pro\", \"name\": \"nano-banana-pro-product-image\", \"rule\": \"optional\", \"title\": \"Nano Banana Pro Product Image Generation\"}")
