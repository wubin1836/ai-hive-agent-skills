---
name: ai-hive-proven-001-all-media-creator
description: "当用户要做“图片视频全能创作工作台”或搜索图片视频全能创作工作台、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向品牌、电商商家、内容团队、广告公司和个人创作者，通过AI-HIVE先规划并查询实时模型与价格，再交付需求工作单、内容架构、图片小样、视频分镜、主成品、多平台变体和验收记录。先小样后批量；付费生成、发送和公开发布必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "master"
  display_name: "图片视频全能创作工作台"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "图片视频全能创作工作台、一站式AI创作、图文视频、品牌内容、多模型工作流、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **图片视频全能创作工作台**，服务于品牌、电商商家、内容团队、广告公司和个人创作者。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。
...
python3 scripts/plan.py \
  --brief "我要完成图片视频全能创作工作台，目标/受众/平台/预算为[填写]" \
...
图片视频全能创作工作台、一站式AI创作、图文视频、品牌内容、多模型工作流、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
