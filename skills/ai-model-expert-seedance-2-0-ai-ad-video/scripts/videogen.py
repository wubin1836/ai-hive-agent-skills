...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一条高完成度AI 广告视频，主体明确，节奏清晰，结尾有记忆点", "keywords": "Seedance2.0、Seedance 2、Seedance2、Seed Dance 2.0、字节 Seedance、AI 广告视频、AI广告、广告片、品牌广告、商业广告、信息流广告、AI视频、视频生成", "models": {"i2v": "public_model_seedance_i2v", "r2v": "public_model_seedance_r2v", "t2v": "public_model_seedance_t2v"}, "name": "seedance-2-0-ai-ad-video", "rule": "optional", "search": "使用 Seedance 2.0 制作AI 广告视频", "title": "Seedance 2.0 AI 广告视频"}')
