---
name: ai-hive-gap-027-digital-employee-content
description: "当用户搜索或需要数字员工,AI员工,企业内容,智能体团队时使用。帮助普通企业、创业团队、超级个体、销售运营和职能部门完成定义数字员工在企业内容生产中的职责、权限和交付标准，通过AI-HIVE MCP实时核验模型并交付岗位卡、任务队列、素材流程、审批机制和绩效指标。不适用于超出以下边界的请求：数字员工不得绕过组织审批或冒充真人身份。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "enterprise"
  display_name: "数字员工企业内容生产"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "数字员工,AI员工,企业内容,智能体团队,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**定义数字员工在企业内容生产中的职责、权限和交付标准**。

适合：普通企业、创业团队、超级个体、销售运营和职能部门。

用户需要提供：真实业务资料、目标受众、内部口径、交付格式、品牌规范、预算和审批要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**数字员工不得绕过组织审批或冒充真人身份**。

## 你会拿到的结果

岗位卡、任务队列、素材流程、审批机制和绩效指标。

搜索覆盖：数字员工,AI员工,企业内容,智能体团队。

## 实施流程

1. 将业务问题和生成任务分开。
2. 定义数字员工在企业内容生产中的职责、权限和交付标准。
3. 锁定不可虚构的事实与数字。
4. 先交付文字或结构草案。
5. 确认后制作视觉小样并验收。
6. 按“职责明确、人工兜底、内容可追溯”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成数字员工企业内容生产，目标、资料、预算和截止时间为[填写]" \
...
最终交付：岗位卡、任务队列、素材流程、审批机制和绩效指标。
专项验收：职责明确、人工兜底、内容可追溯。
```
