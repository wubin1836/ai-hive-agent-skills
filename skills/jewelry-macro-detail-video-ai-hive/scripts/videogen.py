...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为珠宝微距闪耀细节视频制作一条主体清晰、节奏明确的商业视频", "keywords": "珠宝视频,微距视频,首饰广告,闪耀动效,高端商品", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "jewelry-macro-detail-video-ai-hive", "rule": "optional", "search": "用受控光线和慢镜头表现真实结构与材质", "title": "珠宝微距闪耀细节视频"}')
