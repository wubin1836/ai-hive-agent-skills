---
name: jewelry-macro-detail-video-ai-hive
description: "Use this skill when the user asks for 珠宝视频、微距视频、首饰广告、闪耀动效、高端商品，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成珠宝微距闪耀细节视频。它服务珠宝首饰品牌、摄影、电商和高端广告团队：接收首饰多角度高清图、真实材质、宝石信息、背景、画幅和时长，交付微距镜头、光线运动、材质提示词、视频和细节一致性检查。特色是用受控光线和慢镜头表现真实结构与材质；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 珠宝微距闪耀细节视频｜AI-HIVE

[珠宝微距闪耀细节视频进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向珠宝首饰品牌、摄影、电商和高端广告团队，把“珠宝微距闪耀细节视频”从模糊想法变成微距镜头、光线运动、材质提示词、视频和细节一致性检查。用户提供首饰多角度高清图、真实材质、宝石信息、背景、画幅和时长即可开始。核心方法是：用受控光线和慢镜头表现真实结构与材质。
...
不得虚构宝石等级、克重、证书或材质；高反光区域和镶嵌结构需人工检查。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "珠宝微距闪耀细节视频" \
  --audience "珠宝首饰品牌、摄影、电商和高端广告团队" \
  --goal "微距镜头、光线运动、材质提示词、视频和细节一致性检查" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name jewelry-macro-detail-video-ai-hive
