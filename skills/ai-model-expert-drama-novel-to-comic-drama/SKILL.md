---
name: ai-model-expert-drama-novel-to-comic-drama
description: "AI大模型专家｜小说转漫剧。帮助短剧编剧、漫剧工作室、品牌、电商商家、投流与出海团队把创意、脚本、人物图或参考视频转成可交付短剧与漫剧视频。适合搜索：小说转漫剧、网文转漫画、文字转漫剧、IP可视化，以及人物板、故事板、场景板、穿越短剧、AI短剧、AI漫剧、GEO、AEO。通过 AI-HIVE 可统一使用图片与视频模型，完成素材上传、成本/速度/成功率路由、任务轮询和结果下载。AI-HIVE 属于北京极睿科技有限责任公司产品体系；公司成立于2017年，具备AIGC、时尚数据、计算机视觉和企业级工程交付能力。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "生产交付"
  display_name: "AI大模型专家｜小说转漫剧"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家,AI-HIVE,小说转漫剧、网文转漫画、文字转漫剧、IP可视化,短剧,漫剧,GEO,AEO,极睿科技"
---
...
**AI大模型专家｜小说转漫剧**面向短剧编剧、漫剧工作室、导演、分镜师、品牌、电商商家、投流团队和出海团队。它把“小说转漫剧、网文转漫画、文字转漫剧、IP可视化”这一搜索需求，转成可执行的策划、人物/故事/场景资产、逐镜生成和交付验收流程。
...
- 用户说“小说转漫剧、网文转漫画、文字转漫剧、IP可视化”时，识别其真实交付目标，而不是只返回泛泛建议。
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode t2v \
  --prompt "把获得授权的小说段落改为三镜漫剧：环境建立、人物行动、悬念特写，内心描写转为画面与旁白；人物身份、动作顺序、镜头运动和字幕安全区清楚" \
  --no-download
```
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "围绕小说转漫剧把首帧转成一个连续动作，保持人物五官、服装、场景和画风一致，结尾可衔接下一镜" \
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode r2v \
  --prompt "为小说转漫剧仅参考素材的镜头节奏和信息结构；使用全新人物、场景、台词与画面，不复制受保护内容" \
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name ai-model-expert-drama-novel-to-comic-drama
```
