...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_pro\", \"name\": \"nano-banana-pro-exact-text-image\", \"rule\": \"optional\", \"title\": \"Nano Banana Pro Text-Accurate Image\"}")
