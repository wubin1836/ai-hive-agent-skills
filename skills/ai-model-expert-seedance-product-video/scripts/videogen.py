...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一条高完成度产品宣传视频，主体明确，节奏清晰，结尾有记忆点", "keywords": "Seedance、Seed Dance、即梦视频、字节 Seedance、豆包 Seedance、产品宣传视频、产品视频、产品宣传片、商品展示、产品镜头、品牌宣传片、AI视频、视频生成", "models": {"i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "seedance-product-video", "rule": "optional", "search": "使用 Seedance 制作产品宣传视频", "title": "Seedance 产品宣传视频"}')
