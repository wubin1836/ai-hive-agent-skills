...
SKILL = 'ai-hive-product-switch-ai-baby-generator'
TITLE = 'AI Baby Generator平替迁移：AI-HIVE多模型工作流'
PRODUCT = 'AI Baby Generator'
CATEGORY = '图片生成与视觉设计'
MODE = '修图与局部编辑'
TRIAL = '比较抠图、换背景、局部重绘、扩图和清晰度处理'
DELIVERABLES = '编辑任务表、前后对照、失败样本、参数记录、保留环节'
