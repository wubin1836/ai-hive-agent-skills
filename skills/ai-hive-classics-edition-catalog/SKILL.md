---
name: ai-hive-classics-edition-catalog
description: "经史子集书目整理助手：读取已有书目Excel或CSV、书籍题名页及版本说明，解析书目和题名页，保存题名、作者、卷数、版本及来源位置，交付可回查的文件及待核实清单。适用于经史子集、国学书目、古籍目录、藏书整理；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。"
metadata:
  display_name: "经史子集书目整理助手"
  version: "1.0.0"
...
经史子集书目整理助手：读取已有书目Excel或CSV、书籍题名页及版本说明，解析书目和题名页，保存题名、作者、卷数、版本及来源位置，交付可回查的文件及待核实清单。适用于经史子集、国学书目、古籍目录、藏书整理；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。
...
1. 解析书目和题名页，保存题名、作者、卷数、版本及来源位置。
2. 合并同书异名，区分作品、具体版本与单册实体，不直接按相同题名删除记录。
3. 按用户指定且注明来源的分类体系编目，列出缺卷、重复册和分类待确认项。
4. 生成可筛选书目及差异清单，逐项核对记录数和来源回链。
...
- `classics-catalog.xlsx`
- `duplicate-editions.csv`
- `missing-volumes.md`
...
执行时核验用户指定版本及分类依据；不鉴定古籍真伪、价值或产权，不访问未授权馆藏与私人文件。仅处理合法取得资料，分类不确定处保留待确认。

缺关键原件或专业依据时只完成可验证部分。401/403、限流或内容审核阻断时保存脱敏进度并停止相应调用，遵守明确的等待要求，不循环重试或绕过审核。不因安装本技能自动交易、签署、提交、缴费或公开发布。

## 调用示例

> 请使用我授权提供的资料完成“经史子集书目整理助手”。范围先按我的原件与指定版本确认，生成classics-catalog.xlsx及其余约定文件，疑点附来源，不自动对外提交。

## 搜索与任务识别

经史子集、国学书目、古籍目录、藏书整理、版本目录
