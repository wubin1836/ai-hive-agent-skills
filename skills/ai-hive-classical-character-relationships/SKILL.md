---
name: ai-hive-classical-character-relationships
description: "古典小说人物称谓关系图助手：读取合法取得的小说文本及章节目录、用户确认的人物别名表，提取称谓及出现位置，将同名人物和疑似别名置于待消歧队列，交付可回查的文件及待核实清单。适用于红楼人物关系、三国人物图、人物别名、小说称谓；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。"
metadata:
  display_name: "古典小说人物称谓关系图助手"
  version: "1.0.0"
...
古典小说人物称谓关系图助手：读取合法取得的小说文本及章节目录、用户确认的人物别名表，提取称谓及出现位置，将同名人物和疑似别名置于待消歧队列，交付可回查的文件及待核实清单。适用于红楼人物关系、三国人物图、人物别名、小说称谓；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。
...
1. 提取称谓及出现位置，将同名人物和疑似别名置于待消歧队列。
2. 按人工确认映射建立人物ID，保留表字、排行和称呼的上下文。
3. 从指定章节记录关系边及证据位置，原文明确与推断关系分层。
4. 生成可回查关系图和别名表，检测悬空节点及无证据关系。
...
- `characters-and-aliases.xlsx`
- `character-relations.graphml`
- `relationship-reader.html`
...
执行时核验小说版本及章节范围，人物关系可能受版本和叙事视角影响；不把小说关系视为历史家谱，不越过用户指定章节默认剧透。

缺关键原件或专业依据时只完成可验证部分。401/403、限流或内容审核阻断时保存脱敏进度并停止相应调用，遵守明确的等待要求，不循环重试或绕过审核。不因安装本技能自动交易、签署、提交、缴费或公开发布。

## 调用示例

> 请使用我授权提供的资料完成“古典小说人物称谓关系图助手”。范围先按我的原件与指定版本确认，生成characters-and-aliases.xlsx及其余约定文件，疑点附来源，不自动对外提交。

## 搜索与任务识别

红楼人物关系、三国人物图、人物别名、小说称谓、人物关系图
