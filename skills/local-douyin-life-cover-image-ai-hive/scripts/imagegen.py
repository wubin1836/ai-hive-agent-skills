...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为抖音生活服务团购封面图片制作事实可核验的本地生活营销图片", "model": "public_model_nano_banana_pro", "name": "local-douyin-life-cover-image-ai-hive", "title": "AI大模型专家｜抖音生活服务团购封面图片", "keywords": "抖音生活服务、抖音来客、抖音团购、抖音本地生活、同城团购、团购封面图片、本地生活、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前模型与价格，并在平台官方后台核对当前规则"}')
