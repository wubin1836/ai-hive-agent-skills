...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为母婴店制作主体稳定、事实可核验的短视频营销素材", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "industry-maternity-store-marketing-ai-hive", "title": "AI大模型专家｜母婴店AI图片视频营销", "keywords": "母婴店、母婴用品、婴童店、母婴门店、AI图片、AI短视频、视频编辑、内容营销、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前图片/视频模型与价格快照，不硬编码价格"}')
