...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"r2v\", \"models\": {\"r2v\": \"public_model_seedance_r2v\"}, \"name\": \"seedance-2-0-reference-to-video\", \"rule\": \"reference\", \"title\": \"Seedance 2.0 Reference to Video\"}")
