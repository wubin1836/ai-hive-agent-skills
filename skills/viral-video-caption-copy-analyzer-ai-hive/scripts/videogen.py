...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为爆款视频字幕与文案拆解制作一条主体清晰、节奏明确的商业视频", "keywords": "视频字幕,口播文案,字幕排版,CTA,爆款文案", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "viral-video-caption-copy-analyzer-ai-hive", "rule": "optional", "search": "把字幕当作第二条叙事线，兼顾静音观看和信息密度", "title": "爆款视频字幕与文案拆解"}')
