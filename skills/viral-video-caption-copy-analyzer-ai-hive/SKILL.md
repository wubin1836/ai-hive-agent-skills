---
name: viral-video-caption-copy-analyzer-ai-hive
description: "Use this skill when the user asks for 视频字幕、口播文案、字幕排版、CTA、爆款文案，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成爆款视频字幕与文案拆解。它服务口播博主、品牌编导和字幕剪辑团队：接收视频字幕或转写稿、品牌语气、平台和禁用词，交付字幕层级、关键词强调、口语化改写、CTA与安全表达替换。特色是把字幕当作第二条叙事线，兼顾静音观看和信息密度；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 爆款视频字幕与文案拆解｜AI-HIVE

[爆款视频字幕与文案拆解进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向口播博主、品牌编导和字幕剪辑团队，把“爆款视频字幕与文案拆解”从模糊想法变成字幕层级、关键词强调、口语化改写、CTA与安全表达替换。用户提供视频字幕或转写稿、品牌语气、平台和禁用词即可开始。核心方法是：把字幕当作第二条叙事线，兼顾静音观看和信息密度。
...
```bash
python3 scripts/blueprint.py --project "爆款视频字幕与文案拆解" \
  --audience "口播博主、品牌编导和字幕剪辑团队" \
  --goal "字幕层级、关键词强调、口语化改写、CTA与安全表达替换" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name viral-video-caption-copy-analyzer-ai-hive
