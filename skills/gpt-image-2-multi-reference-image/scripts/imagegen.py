...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_gpt_image_2\", \"name\": \"gpt-image-2-multi-reference-image\", \"rule\": \"multi\", \"title\": \"GPT Image 2 Multi-Reference Image Generation\"}")
