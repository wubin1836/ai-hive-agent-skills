---
name: ai-hive-used-car-transfer-docs
description: "二手车过户材料助手，用于二手车过户、异地车辆过户、汽车过户材料。读取你授权的原始资料，完成当前受理地材料清单，并交付待买卖双方确认项。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "二手车过户材料助手"
  version: "1.0.0"
...
二手车过户材料助手，用于二手车过户、异地车辆过户、汽车过户材料。读取你授权的原始资料，完成当前受理地材料清单，并交付待买卖双方确认项。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 确认车辆注册地、拟迁入地与办理事项，证件只留脱敏引用
2. 查公安交管当期官方指南，抵押查验等状态无证据不能判断
3. 整理真实材料和官方预约前检查，不保证能过户或代签交易文件
...
- `used-car-transfer-docs-checklist.xlsx`
- `used-car-transfer-docs-evidence.docx`
- `used-car-transfer-docs-sources.json`
...
二手车过户、异地车辆过户、汽车过户材料、车辆转籍、买二手车手续
