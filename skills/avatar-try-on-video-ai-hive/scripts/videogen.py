...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为数字人试穿展示视频制作一条主体清晰、节奏明确的商业视频", "keywords": "数字人试穿,AI模特试衣,服装视频,虚拟试穿视频,电商模特", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "avatar-try-on-video-ai-hive", "rule": "optional", "search": "把试穿效果图作为首帧锚点，再生成短时、可控的展示动作", "title": "数字人试穿展示视频"}')
