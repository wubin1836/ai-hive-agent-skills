...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name seedance-short-drama-video
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode i2v \
  --prompt "Seedance Short Drama Video: polished motion, clear subject, coherent action, stable camera, commercial finish"
```
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "Create a polished seedance short drama video result with coherent motion, stable identity, and a clear ending"
```
