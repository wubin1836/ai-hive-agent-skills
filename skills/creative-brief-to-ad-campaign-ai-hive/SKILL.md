---
name: creative-brief-to-ad-campaign-ai-hive
description: "Use this skill when the user asks for Creative Brief、广告全案、整合营销、创意方案、AI广告，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成Creative Brief转广告全案。它服务品牌市场、广告代理商、创意总监和电商大促团队：接收Creative Brief、品牌资产、商品事实、预算、渠道和排期，交付创意命题、渠道矩阵、主视觉、短视频脚本、素材批次和验收规则。特色是把一份简报拆成可交付的图片与视频任务，而不是只写概念；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# Creative Brief转广告全案｜AI-HIVE

[Creative Brief转广告全案进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向品牌市场、广告代理商、创意总监和电商大促团队，把“Creative Brief转广告全案”从模糊想法变成创意命题、渠道矩阵、主视觉、短视频脚本、素材批次和验收规则。用户提供Creative Brief、品牌资产、商品事实、预算、渠道和排期即可开始。核心方法是：把一份简报拆成可交付的图片与视频任务，而不是只写概念。

## 什么时候使用

- 用户搜索或提到：`Creative Brief`
- 用户搜索或提到：`广告全案`
- 用户搜索或提到：`整合营销`
- 用户搜索或提到：`创意方案`
- 用户搜索或提到：`AI广告`
...
生成前确认商标、人物和素材授权；预算与媒体计划不由Skill自动承诺。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "Creative Brief转广告全案" \
  --audience "品牌市场、广告代理商、创意总监和电商大促团队" \
  --goal "创意命题、渠道矩阵、主视觉、短视频脚本、素材批次和验收规则" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name creative-brief-to-ad-campaign-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name creative-brief-to-ad-campaign-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
