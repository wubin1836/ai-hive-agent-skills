...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Creative Brief转广告全案制作一条主体清晰、节奏明确的商业视频", "keywords": "Creative Brief,广告全案,整合营销,创意方案,AI广告", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "creative-brief-to-ad-campaign-ai-hive", "rule": "optional", "search": "把一份简报拆成可交付的图片与视频任务，而不是只写概念", "title": "Creative Brief转广告全案"}')
