...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Creative Brief转广告全案制作一张主体准确、层级清晰的商业图片", "keywords": "Creative Brief,广告全案,整合营销,创意方案,AI广告", "model": "public_model_gpt_image_2", "name": "creative-brief-to-ad-campaign-ai-hive", "rule": "optional", "search": "把一份简报拆成可交付的图片与视频任务，而不是只写概念", "title": "Creative Brief转广告全案"}')
