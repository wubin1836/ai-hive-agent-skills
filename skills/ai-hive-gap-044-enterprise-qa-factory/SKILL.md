---
name: ai-hive-gap-044-enterprise-qa-factory
description: "当用户搜索或需要企业知识问答,FAQ生成,知识库客服,RAG问答时使用。帮助企业知识管理、研究、培训、销售、客服和个人知识创作者完成从已验证知识生成客服、培训和销售问答内容，通过AI-HIVE MCP实时核验模型并交付问题分类、标准答案、引用、禁答规则和更新流程。不适用于超出以下边界的请求：不得用模型常识覆盖企业规则。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "knowledge"
  display_name: "企业知识问答内容工厂"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "企业知识问答,FAQ生成,知识库客服,RAG问答,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**从已验证知识生成客服、培训和销售问答内容**。

适合：企业知识管理、研究、培训、销售、客服和个人知识创作者。

用户需要提供：有权使用的文档、知识库导出、来源链接、目标受众、内容格式和更新日期。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不得用模型常识覆盖企业规则**。

## 你会拿到的结果

问题分类、标准答案、引用、禁答规则和更新流程。

搜索覆盖：企业知识问答,FAQ生成,知识库客服,RAG问答。

## 运行路线

1. 建立资料索引与可信度层级。
2. 从已验证知识生成客服、培训和销售问答内容。
3. 把事实、观点和生成建议分层。
4. 每个结论保留来源位置。
5. 确认知识结构后再生成多模态内容。
6. 按“答案一致、来源明确、未知可拒答”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成企业知识问答内容工厂，目标、资料、预算和截止时间为[填写]" \
...
最终交付：问题分类、标准答案、引用、禁答规则和更新流程。
专项验收：答案一致、来源明确、未知可拒答。
```
