...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合Amazon 亚马逊的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "Amazon Seller、Seller Central、亚马逊卖家、Amazon Ads、Amazon主图、Listing Images、A+ Content、PDP、Product Video、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "amazon-ecommerce-image-generation-editing", "rule": "optional", "search": "Amazon 亚马逊 商家、运营、商品与广告图片搜索入口", "title": "Amazon 亚马逊 电商图片生成与编辑"}')
