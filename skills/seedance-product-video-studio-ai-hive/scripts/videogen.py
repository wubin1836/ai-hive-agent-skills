...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Seedance 商品视频工作室制作一条主体清晰、节奏明确的商业视频", "keywords": "Seedance商品视频,电商视频,产品广告,带货视频,商品图转视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "seedance-product-video-studio-ai-hive", "rule": "optional", "search": "以商品准确性和购买证据为第一验收标准", "title": "Seedance 商品视频工作室"}')
