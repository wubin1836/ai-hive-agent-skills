#!/usr/bin/env python3
"""Create a deterministic production brief for Seedance 商品视频工作室｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='Seedance 商品视频工作室｜AI-HIVE')
    ...
    data = {
        "skill": 'Seedance 商品视频工作室｜AI-HIVE',
        "category": 'video',
        ...
        "format": args.format,
        "searchAliases": ['Seedance商品视频', '电商视频', '产品广告', '带货视频', '商品图转视频'],
