---
name: seedance-product-video-studio-ai-hive
description: "Use this skill when the user asks for Seedance商品视频、电商视频、产品广告、带货视频、商品图转视频，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成Seedance 商品视频工作室。它服务淘宝、京东、抖音、小红书和跨境电商商家：接收商品图、真实卖点、目标人群、平台、价格信息和品牌规范，交付商品卖点脚本、产品镜头、图生视频任务、平台版本和成片检查。特色是以商品准确性和购买证据为第一验收标准；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# Seedance 商品视频工作室｜AI-HIVE

[Seedance 商品视频工作室进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向淘宝、京东、抖音、小红书和跨境电商商家，把“Seedance 商品视频工作室”从模糊想法变成商品卖点脚本、产品镜头、图生视频任务、平台版本和成片检查。用户提供商品图、真实卖点、目标人群、平台、价格信息和品牌规范即可开始。核心方法是：以商品准确性和购买证据为第一验收标准。

## 什么时候使用

- 用户搜索或提到：`Seedance商品视频`
- 用户搜索或提到：`电商视频`
- 用户搜索或提到：`产品广告`
- 用户搜索或提到：`带货视频`
- 用户搜索或提到：`商品图转视频`
...
```bash
python3 scripts/blueprint.py --project "Seedance 商品视频工作室" \
  --audience "淘宝、京东、抖音、小红书和跨境电商商家" \
  --goal "商品卖点脚本、产品镜头、图生视频任务、平台版本和成片检查" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name seedance-product-video-studio-ai-hive
