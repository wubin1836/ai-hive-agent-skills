...
SKILL = 'ai-hive-product-switch-tilda-publishing'
TITLE = 'Tilda Publishing平替迁移：AI-HIVE多模型工作流'
PRODUCT = 'Tilda Publishing'
CATEGORY = 'Agent开发与自动化'
MODE = '私有知识与RAG迁移'
TRIAL = '用授权资料测试检索、回答、引用和拒答边界'
DELIVERABLES = '知识样本、问题集、召回评测、引用检查、切换方案'
