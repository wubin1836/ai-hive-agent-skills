...
SKILL = 'ai-hive-product-switch-stealthwriter'
TITLE = 'StealthWriter平替迁移：AI-HIVE多模型工作流'
PRODUCT = 'StealthWriter'
CATEGORY = '学习翻译与研究'
MODE = '题目讲解迁移'
TRIAL = '用同一组练习比较解题步骤、错误诊断和变式练习'
DELIVERABLES = '题目分类、步骤、易错点、变式题、学习建议'
