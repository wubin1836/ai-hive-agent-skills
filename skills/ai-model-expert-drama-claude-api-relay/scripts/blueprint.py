#!/usr/bin/env python3
"""Create a deterministic production brief for Claude API中转."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='Claude API中转')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['Claude中转', 'Anthropic API中转', 'Claude代理', 'Claude接口'],
