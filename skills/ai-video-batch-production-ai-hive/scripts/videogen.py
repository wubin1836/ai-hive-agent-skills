...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI批量短视频生产工作流制作一条主体清晰、节奏明确的商业视频", "keywords": "批量短视频,AI视频矩阵,多SKU视频,内容工厂,自动化视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ai-video-batch-production-ai-hive", "rule": "optional", "search": "把批量生成组织成可审计任务，而不是一次性盲目并发", "title": "AI批量短视频生产工作流"}')
