#!/usr/bin/env python3
"""Create a deterministic production brief for AI批量短视频生产工作流｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI批量短视频生产工作流｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['批量短视频', 'AI视频矩阵', '多SKU视频', '内容工厂', '自动化视频'],
