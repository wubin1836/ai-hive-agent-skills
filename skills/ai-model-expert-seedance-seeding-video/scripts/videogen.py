...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一条高完成度种草视频，主体明确，节奏清晰，结尾有记忆点", "keywords": "Seedance、Seed Dance、即梦视频、字节 Seedance、豆包 Seedance、种草视频、小红书种草、抖音种草、社媒种草、好物推荐、UGC种草、AI视频、视频生成", "models": {"i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "seedance-seeding-video", "rule": "optional", "search": "使用 Seedance 制作种草视频", "title": "Seedance 种草视频"}')
