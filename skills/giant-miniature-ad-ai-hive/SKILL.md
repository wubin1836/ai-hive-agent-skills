---
name: giant-miniature-ad-ai-hive
description: "Use this skill when the user asks for 巨物广告、微缩世界、奇观视频、AI创意广告、超现实商品，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成巨物与微缩奇观广告。它服务品牌创意、节日营销、食品美妆和社媒广告团队：接收商品图、品牌元素、城市或微缩场景、画幅、时长和风格，交付巨物或微缩概念、比例关系、分镜、视频提示词和品牌植入方案。特色是用夸张比例制造记忆点，同时保持商品识别；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 巨物与微缩奇观广告｜AI-HIVE

[巨物与微缩奇观广告进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向品牌创意、节日营销、食品美妆和社媒广告团队，把“巨物与微缩奇观广告”从模糊想法变成巨物或微缩概念、比例关系、分镜、视频提示词和品牌植入方案。用户提供商品图、品牌元素、城市或微缩场景、画幅、时长和风格即可开始。核心方法是：用夸张比例制造记忆点，同时保持商品识别。
...
奇观必须明显属于创意表达，不能误导商品真实尺寸、功能或公共事件。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "巨物与微缩奇观广告" \
  --audience "品牌创意、节日营销、食品美妆和社媒广告团队" \
  --goal "巨物或微缩概念、比例关系、分镜、视频提示词和品牌植入方案" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name giant-miniature-ad-ai-hive
