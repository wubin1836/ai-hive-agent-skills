...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为巨物与微缩奇观广告制作一条主体清晰、节奏明确的商业视频", "keywords": "巨物广告,微缩世界,奇观视频,AI创意广告,超现实商品", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "giant-miniature-ad-ai-hive", "rule": "optional", "search": "用夸张比例制造记忆点，同时保持商品识别", "title": "巨物与微缩奇观广告"}')
