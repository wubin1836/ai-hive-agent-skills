#!/usr/bin/env python3
"""Create a deterministic production brief for 巨物与微缩奇观广告｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='巨物与微缩奇观广告｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['巨物广告', '微缩世界', '奇观视频', 'AI创意广告', '超现实商品'],
