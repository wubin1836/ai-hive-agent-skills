...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "先按用途、主体、构图、材质、光线、色彩和限制条件构建提示词，再生成高完成度商业视觉", "keywords": "图片提示词、Prompt生成、文生图提示词、商业视觉、提示词优化、风格拆解、直接生图", "model": "public_model_nano_banana_pro", "name": "image-prompt-commercial-visual-generation", "product_promise": "把模糊想法转成结构化图片提示词并直接生成结果，适合不会写 Prompt 的电商与营销用户", "rule": "optional", "search": "面向爆款封面、电商主图、详情页、广告、海报和社媒套图等结果型搜索意图", "title": "AI 图片提示词与商业视觉生成", "trend_inspired": true}')
