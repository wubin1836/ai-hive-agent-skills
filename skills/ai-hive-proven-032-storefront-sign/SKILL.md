---
name: ai-hive-proven-032-storefront-sign
description: "当用户要做“门店招牌门头效果图设计”或搜索门店招牌门头效果图设计、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向设计师、品牌、电商、门店运营、新媒体和创业团队，通过AI-HIVE先规划并查询实时模型与价格，再交付设计策略、信息层级、视觉方向、小样、A/B方案、适配版本和交付规范。先小样后批量；付费生成、发送和公开发布必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "design"
  display_name: "门店招牌门头效果图设计"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "门店招牌门头效果图设计、设计、海报、封面、品牌视觉、营销图片、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **门店招牌门头效果图设计**，服务于设计师、品牌、电商、门店运营、新媒体和创业团队。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。
...
python3 scripts/plan.py \
  --brief "我要完成门店招牌门头效果图设计，目标/受众/平台/预算为[填写]" \
...
门店招牌门头效果图设计、设计、海报、封面、品牌视觉、营销图片、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
