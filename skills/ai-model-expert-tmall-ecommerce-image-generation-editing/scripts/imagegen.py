...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合天猫的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "天猫商城、天猫国际、天猫商家、天猫运营、天猫主图、详情页、大促视觉、商品视频、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "tmall-ecommerce-image-generation-editing", "rule": "optional", "search": "天猫 商家、运营、商品与广告图片搜索入口", "title": "天猫 电商图片生成与编辑"}')
