...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一条高完成度动态漫画，主体明确，节奏清晰，结尾有记忆点", "keywords": "MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、动态漫画、动态漫、漫画转视频、漫画动起来、动画分镜、二次元动画、AI视频、视频生成", "models": {"i2v": "public_model_minimax_h3_i2v", "r2v": "public_model_minimax_h3_r2v", "t2v": "public_model_minimax_h3_t2v"}, "name": "minimax-h3-dynamic-comic-video", "rule": "optional", "search": "使用 MiniMax H3 制作动态漫画", "title": "MiniMax H3 动态漫画"}')
