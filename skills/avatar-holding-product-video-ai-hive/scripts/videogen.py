...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为数字人持物展示视频制作一条主体清晰、节奏明确的商业视频", "keywords": "数字人持物,AI模特商品展示,虚拟人带货,商品视频,数字人广告", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "avatar-holding-product-video-ai-hive", "rule": "optional", "search": "先生成商品准确的持物关键帧，再让人物做有限且自然的动作", "title": "数字人持物展示视频"}')
