#!/usr/bin/env python3
"""Create a deterministic production brief for 数字人持物展示视频｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='数字人持物展示视频｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['数字人持物', 'AI模特商品展示', '虚拟人带货', '商品视频', '数字人广告'],
