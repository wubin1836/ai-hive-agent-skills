---
name: avatar-holding-product-video-ai-hive
description: "Use this skill when the user asks for 数字人持物、AI模特商品展示、虚拟人带货、商品视频、数字人广告，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成数字人持物展示视频。它服务缺少真人拍摄条件的电商商家、品牌和广告团队：接收有权使用的人物参考、商品图、持物方式、平台、时长和台词，交付人物与商品锚点、持物关键帧、动作脚本、图生或参考生视频和准确性检查。特色是先生成商品准确的持物关键帧，再让人物做有限且自然的动作；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 数字人持物展示视频｜AI-HIVE

[数字人持物展示视频进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向缺少真人拍摄条件的电商商家、品牌和广告团队，把“数字人持物展示视频”从模糊想法变成人物与商品锚点、持物关键帧、动作脚本、图生或参考生视频和准确性检查。用户提供有权使用的人物参考、商品图、持物方式、平台、时长和台词即可开始。核心方法是：先生成商品准确的持物关键帧，再让人物做有限且自然的动作。
...
不得未经授权复制真人肖像；合成人物不得冒充真实代言人，商品比例和握持关系要人工复核。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "数字人持物展示视频" \
  --audience "缺少真人拍摄条件的电商商家、品牌和广告团队" \
  --goal "人物与商品锚点、持物关键帧、动作脚本、图生或参考生视频和准确性检查" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name avatar-holding-product-video-ai-hive
