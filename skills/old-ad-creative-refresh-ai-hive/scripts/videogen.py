...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为旧广告智能改版制作一条主体清晰、节奏明确的商业视频", "keywords": "旧广告改版,广告翻新,素材再利用,AI视频编辑,广告焕新", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "old-ad-creative-refresh-ai-hive", "rule": "optional", "search": "保留品牌资产与有效证据，重做钩子、节奏、字幕和CTA", "title": "旧广告智能改版"}')
