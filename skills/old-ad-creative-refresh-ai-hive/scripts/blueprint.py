#!/usr/bin/env python3
"""Create a deterministic production brief for 旧广告智能改版｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='旧广告智能改版｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['旧广告改版', '广告翻新', '素材再利用', 'AI视频编辑', '广告焕新'],
