---
name: old-ad-creative-refresh-ai-hive
description: "Use this skill when the user asks for 旧广告改版、广告翻新、素材再利用、AI视频编辑、广告焕新，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成旧广告智能改版。它服务拥有旧TVC、信息流和商品视频资产的品牌与商家：接收有权使用的旧广告、当前商品事实、新平台、时长和品牌规范，交付旧片拆解、可保留资产、平台新版本、AI补镜和精剪命令。特色是保留品牌资产与有效证据，重做钩子、节奏、字幕和CTA；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 旧广告智能改版｜AI-HIVE

[旧广告智能改版进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向拥有旧TVC、信息流和商品视频资产的品牌与商家，把“旧广告智能改版”从模糊想法变成旧片拆解、可保留资产、平台新版本、AI补镜和精剪命令。用户提供有权使用的旧广告、当前商品事实、新平台、时长和品牌规范即可开始。核心方法是：保留品牌资产与有效证据，重做钩子、节奏、字幕和CTA。
...
不得去除版权水印或把过期价格、活动和产品信息继续用于新广告。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "旧广告智能改版" \
  --audience "拥有旧TVC、信息流和商品视频资产的品牌与商家" \
  --goal "旧片拆解、可保留资产、平台新版本、AI补镜和精剪命令" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name old-ad-creative-refresh-ai-hive
