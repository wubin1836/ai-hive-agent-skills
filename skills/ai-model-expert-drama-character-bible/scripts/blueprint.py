#!/usr/bin/env python3
"""Create a deterministic production brief for 短剧人物设定与人物小传."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='短剧人物设定与人物小传')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['人物设定', '人物小传', '角色档案', 'character bible', '人物关系'],
