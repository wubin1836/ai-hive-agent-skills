---
name: ai-hive-gap-025-ai-recruitment-brand
description: "当用户搜索或需要AI招聘,招聘智能体,雇主品牌,招聘视频时使用。帮助普通企业、创业团队、超级个体、销售运营和职能部门完成为招聘岗位生成真实、有吸引力的雇主品牌图文视频，通过AI-HIVE MCP实时核验模型并交付岗位事实卡、候选人画像、招聘文案、海报和口播脚本。不适用于超出以下边界的请求：不得虚构薪资福利或进行歧视性筛选。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "enterprise"
  display_name: "AI招聘雇主品牌内容生成"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "AI招聘,招聘智能体,雇主品牌,招聘视频,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**为招聘岗位生成真实、有吸引力的雇主品牌图文视频**。

适合：普通企业、创业团队、超级个体、销售运营和职能部门。

用户需要提供：真实业务资料、目标受众、内部口径、交付格式、品牌规范、预算和审批要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不得虚构薪资福利或进行歧视性筛选**。

## 你会拿到的结果

岗位事实卡、候选人画像、招聘文案、海报和口播脚本。

搜索覆盖：AI招聘,招聘智能体,雇主品牌,招聘视频。

## 交付路径

1. 将业务问题和生成任务分开。
2. 为招聘岗位生成真实、有吸引力的雇主品牌图文视频。
3. 锁定不可虚构的事实与数字。
4. 先交付文字或结构草案。
5. 确认后制作视觉小样并验收。
6. 按“岗位信息准确、表达包容、渠道适配”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成AI招聘雇主品牌内容生成，目标、资料、预算和截止时间为[填写]" \
...
最终交付：岗位事实卡、候选人画像、招聘文案、海报和口播脚本。
专项验收：岗位信息准确、表达包容、渠道适配。
```
