...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "SDK 已确认文生、图生和参考生视频；编辑需求通过参考素材约束后重新生成，不宣称原生 edit 端点", "example": "生成一条电影感品牌短片；也可加入现有素材进行参考重制、风格调整或画面编辑", "keywords": "Seedance 2.0视频生成与编辑、Seedance2视频、Seed Dance 2.0、字节Seedance2.0、文生视频、图生视频、参考生视频、视频编辑、视频重绘、视频续写、AI视频、AIGC、电商视频、广告视频、TVC、产品视频、带货、种草、短剧、漫剧", "models": {"i2v": "public_model_seedance_i2v", "r2v": "public_model_seedance_r2v", "t2v": "public_model_seedance_t2v"}, "name": "seedance-2-0-video-generation-and-editing", "rule": "optional", "search": "视频生成与编辑聚合搜索入口，按文字、图片、视频或音频输入选择同一模型家族的可用能力", "title": "Seedance2.0 视频生成与编辑"}')
