---
name: food-dish-motion-ad-ai-hive
description: "Use this skill when the user asks for 餐饮视频、菜品动效、外卖广告、美食短视频、本地生活，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成餐饮菜品动效广告。它服务餐饮品牌、外卖商家、食品电商和本地生活运营：接收真实菜品图、配料与份量、门店信息、平台、时长和活动事实，交付菜品微距动作、热气或酱汁动效、短视频脚本和门店版本。特色是保持真实菜品与份量，增强可感知的温度和材质；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 餐饮菜品动效广告｜AI-HIVE

[餐饮菜品动效广告进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向餐饮品牌、外卖商家、食品电商和本地生活运营，把“餐饮菜品动效广告”从模糊想法变成菜品微距动作、热气或酱汁动效、短视频脚本和门店版本。用户提供真实菜品图、配料与份量、门店信息、平台、时长和活动事实即可开始。核心方法是：保持真实菜品与份量，增强可感知的温度和材质。
...
不得生成不存在的食材、夸大份量或不安全烹饪过程；价格和门店信息必须核实。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "餐饮菜品动效广告" \
  --audience "餐饮品牌、外卖商家、食品电商和本地生活运营" \
  --goal "菜品微距动作、热气或酱汁动效、短视频脚本和门店版本" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name food-dish-motion-ad-ai-hive
