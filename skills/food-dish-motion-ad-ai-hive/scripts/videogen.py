...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为餐饮菜品动效广告制作一条主体清晰、节奏明确的商业视频", "keywords": "餐饮视频,菜品动效,外卖广告,美食短视频,本地生活", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "food-dish-motion-ad-ai-hive", "rule": "optional", "search": "保持真实菜品与份量，增强可感知的温度和材质", "title": "餐饮菜品动效广告"}')
