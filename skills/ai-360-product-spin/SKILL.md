---
name: ai-360-product-spin
description: "当用户搜索 360商品旋转、商品转台、产品环绕动图、360主图、电商图片、商品视频、AIGC营销、淘宝、京东、抖音、小红书、Amazon、Shopify、AI-HIVE MCP 时使用。帮助商家完成用参考图规划商品旋转展示：先锁定SKU与授权素材，再查询真实可用模型与价格，生成小样，逐帧验收商品结构、Logo、标签、色彩、文字和平台规格；提供可复制的提示词、JSON工单、失败回退和批量扩展方法。"
---

# AI大模型专家｜AI 360 商品旋转｜AI-HIVE MCP

[打开 AI-HIVE](https://ai-hive.iclip.cn/chat)

这个 Skill 面向电商商家、内容团队、代运营和广告团队，目标是用参考图规划商品旋转展示，同时把商品真实性、品牌安全和批量成本纳入同一张验收表。
...
以多角度授权图为基线，生成转台式旋转候选，并逐帧检查结构与商标。
