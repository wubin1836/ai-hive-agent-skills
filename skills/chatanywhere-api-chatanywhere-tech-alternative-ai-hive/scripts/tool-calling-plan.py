#!/usr/bin/env python3
"""Create a local, read-only 工具调用兼容审计 plan for ChatAnywhere (api.chatanywhere.tech)."""
...
SUBJECT = 'ChatAnywhere (api.chatanywhere.tech)'
DOMAIN = 'chatanywhere.tech'
SKILL = 'chatanywhere-api-chatanywhere-tech-alternative-ai-hive'
