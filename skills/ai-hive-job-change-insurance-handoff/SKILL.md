---
name: ai-hive-job-change-insurance-handoff
description: "离职后社保公积金衔接助手，用于离职后社保怎么办、离职公积金、换城市工作。读取你授权的原始资料，完成离入职时间与参保月份衔接表，并交付原单位新单位个人待办。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "离职后社保公积金衔接助手"
  version: "1.0.0"
...
离职后社保公积金衔接助手，用于离职后社保怎么办、离职公积金、换城市工作。读取你授权的原始资料，完成离入职时间与参保月份衔接表，并交付原单位新单位个人待办。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 记录离入职及城市变化，不索取登录凭据
2. 分开险种、参保关系和公积金账户，按当地官方流程核对
3. 生成带责任方与来源的衔接清单，不假定账户自动转移或待遇连续
...
- `job-change-insurance-handoff-checklist.xlsx`
- `job-change-insurance-handoff-evidence.docx`
- `job-change-insurance-handoff-sources.json`
...
> 仅示例，以下文件名和情境均为假设，不表示已存在真实数据：假设我已提供 示例_离入职和城市变化.csv、示例_参保及公积金状态.pdf、示例_两地办理指南.pdf。请使用「离职后社保公积金衔接助手」，为一次跨城市换工作整理原单位、新单位与本人分别要核实的衔接事项和先后关系。将结果写入我指定的本地目录，交付 job-change-insurance-handoff-checklist.xlsx、job-change-insurance-handoff-evidence.docx、job-change-insurance-handoff-sources.json。本例先离线处理；输入、工具或适用规则不足时先交缺口说明，不编造结果。需要联网更新来源先征得我同意，不登录账户、不代提交或付款。

## 搜索与任务识别

离职后社保怎么办、离职公积金、换城市工作、社保转移、社保公积金衔接
