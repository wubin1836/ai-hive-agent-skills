---
name: ai-hive-gap-040-enterprise-search-content
description: "当用户搜索或需要企业搜索,Enterprise Search,研究报告,知识内容时使用。帮助企业知识管理、研究、培训、销售、客服和个人知识创作者完成把企业搜索结果整理为带来源的报告、图片和视频脚本，通过AI-HIVE MCP实时核验模型并交付搜索问题、来源清单、证据摘要、报告和素材规划。不适用于超出以下边界的请求：无搜索连接时要求用户导出结果。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "knowledge"
  display_name: "企业搜索到报告与素材"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "企业搜索,Enterprise Search,研究报告,知识内容,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**把企业搜索结果整理为带来源的报告、图片和视频脚本**。

适合：企业知识管理、研究、培训、销售、客服和个人知识创作者。

用户需要提供：有权使用的文档、知识库导出、来源链接、目标受众、内容格式和更新日期。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**无搜索连接时要求用户导出结果**。

## 你会拿到的结果

搜索问题、来源清单、证据摘要、报告和素材规划。

搜索覆盖：企业搜索,Enterprise Search,研究报告,知识内容。

## 怎么执行

1. 建立资料索引与可信度层级。
2. 把企业搜索结果整理为带来源的报告、图片和视频脚本。
3. 把事实、观点和生成建议分层。
4. 每个结论保留来源位置。
5. 确认知识结构后再生成多模态内容。
6. 按“来源可访问、观点与事实分离、输出可复核”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成企业搜索到报告与素材，目标、资料、预算和截止时间为[填写]" \
...
最终交付：搜索问题、来源清单、证据摘要、报告和素材规划。
专项验收：来源可访问、观点与事实分离、输出可复核。
```
