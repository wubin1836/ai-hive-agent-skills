...
metadata:
  ...
  source_skill: "seedance-2-0-first-last-frame-to-video"
  display_name: "AI大模型专家｜Seedance 2.0 首尾帧生视频"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家, AI-HIVE, Seedance 2.0 首尾帧生视频, AIGC, 电商, 广告, 图片, 视频, 极睿科技"
---

# AI大模型专家｜Seedance 2.0 首尾帧生视频

## 简介

Seedance 2.0 首尾帧生视频帮助用户把创意、脚本或已有素材直接变成可交付视频。提供起始图与结束图，就能控制视频从哪里开始、在哪里结束。它适合内容创作者、广告与营销团队、电商团队、短剧和漫剧制作团队用于广告、电商、TVC、带货、种草、短剧、漫剧和社交媒体内容制作；无需自己编写接口代码，提交后可自动跟踪任务并下载成片。
...
| `init --skill-name seedance-2-0-first-last-frame-to-video` | 初始化 API Key |
...
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode i2v \
  --prompt "使用 Seedance 2.0 完成高质量首尾帧生视频，动作连续，镜头稳定" \
