...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作高质量商品详情页，主体准确，商业信息清晰", "keywords": "商品详情页、电商详情页、详情页视觉、卖点图、产品长图、商品介绍图、GPT Image 2、Image2、Nano Banana、AI图片、AIGC图片", "model": "public_model_nano_banana_2", "name": "product-detail-page", "rule": "optional", "search": "通用图片能力和商业场景搜索入口，底层调用 AI Hive 裸接口", "title": "商品详情页"}')
