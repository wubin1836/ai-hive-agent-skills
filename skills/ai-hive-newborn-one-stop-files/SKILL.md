---
name: ai-hive-newborn-one-stop-files
description: "新生儿出生手续助手，用于孩子出生后办什么、新生儿上户口、新生儿医保。读取你授权的原始资料，完成出生后事项依赖清单，并交付已办未办进度表。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "新生儿出生手续助手"
  version: "1.0.0"
...
新生儿出生手续助手，用于孩子出生后办什么、新生儿上户口、新生儿医保。读取你授权的原始资料，完成出生后事项依赖清单，并交付已办未办进度表。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 确认办理地区和家长已获得的正式材料，不生成或修改出生证明
2. 核对当地出生一件事官方清单，区分户籍、医保等实际分支
3. 按依赖关系和责任人整理待办，敏感原件留在用户本地，不代签声明
...
- `newborn-one-stop-files-checklist.xlsx`
- `newborn-one-stop-files-evidence.docx`
- `newborn-one-stop-files-sources.json`
...
孩子出生后办什么、新生儿上户口、新生儿医保、出生证明材料、出生一件事
