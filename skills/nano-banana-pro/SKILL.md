...
|---|---|---|
| Nano Banana Pro Image Generation and Editing | `public_model_nano_banana_pro` | Prompt with optional reference images |
...
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "Create a polished nano banana pro image generation and editing visual with an accurate subject, clear composition, and commercial finish"
```
...
```bash
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "Create a polished nano banana pro image generation and editing result; preserve factual product details and leave useful copy space"
```
