...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "服装虚拟试穿商品图，保持服装版型、颜色、纹理和关键结构，人物姿态自然，背景适合电商展示", "keywords": "AI试衣、虚拟试穿、AI换装、服装上身、模特换装、服饰商品图、穿搭图、商品换色", "model": "public_model_nano_banana_pro", "name": "virtual-try-on-product-image-generation", "product_promise": "使用有授权的人物与服装素材生成试穿效果，适合服饰上新、搭配展示和跨境商品图", "rule": "optional", "search": "面向爆款封面、电商主图、详情页、广告、海报和社媒套图等结果型搜索意图", "title": "AI 试衣商品图生成与编辑", "trend_inspired": true}')
