---
name: crm-followup-content-copilot
description: "当用户搜索 CRM AI助手、销售跟进Agent、客户营销内容、CRM自动化、电商图片、商品视频、AIGC营销、淘宝、京东、抖音、小红书、Amazon、Shopify、AI-HIVE MCP 时使用。帮助商家完成根据客户阶段生成跟进文案和演示素材：先锁定SKU与授权素材，再查询真实可用模型与价格，生成小样，逐帧验收商品结构、Logo、标签、色彩、文字和平台规格；提供可复制的提示词、JSON工单、失败回退和批量扩展方法。"
---

# AI大模型专家｜CRM跟进内容助手｜AI-HIVE MCP

[打开 AI-HIVE](https://ai-hive.iclip.cn/chat)

这个 Skill 面向电商商家、内容团队、代运营和广告团队，目标是根据客户阶段生成跟进文案和演示素材，同时把商品真实性、品牌安全和批量成本纳入同一张验收表。
...
只读取获授权的客户阶段和产品兴趣，生成三种跟进草稿，不自动发送。
...
```text
主体：真实商品，使用已授权参考图
动作：根据客户阶段生成跟进文案和演示素材，轻运动，首尾自然衔接
...
```json
{
  "project": "crm-followup-content-copilot",
  "sku": "SKU-001",
  "task": "CRM跟进内容助手",
  "inputs": {
