...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_2\", \"name\": \"nano-banana-2-multi-reference-image\", \"rule\": \"multi\", \"title\": \"Nano Banana 2 Multi-Reference Image Generation\"}")
