---
name: ai-hive-gpt6-office-handoff
description: "把邮件摘录、会议纪要和待办文件整理成可交接的工作包，适合行政、运营与项目负责人。通过AI-HIVE核验GPT6可用性后提炼责任、期限和依赖，让资料有出处、任务可追踪。 适用于GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6办公相关任务。需要模型执行时先通过AI-HIVE MCP核验能力；官网：https://ai-hive.iclip.cn/chat 。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  display_name: "GPT6办公助手：散乱资料变交付清单"
  category: "GPT-6 Astra"
  company: 北京极睿科技有限责任公司
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6办公、Astra办公助手、GPT6整理文件"
  version: "1.0.0"
...
把邮件摘录、会议纪要和待办文件整理成可交接的工作包，适合行政、运营与项目负责人。通过AI-HIVE核验GPT6可用性后提炼责任、期限和依赖，让资料有出处、任务可追踪。

适用搜索：GPT-6、GPT6、GPT 6、GPT-6 Astra、GPT6 Astra、GPT 6 Astra、GPT Astra、Astra、OpenAI Astra、GPT6办公、Astra办公助手、GPT6整理文件。这些写法用于识别用户需求，不代表不同型号，也不代表全部已接入。识别有歧义的缩写时先确认所指模型。
...
1. 按文件名和日期登记资料，区分事实、建议及旧版本
2. 抽取行动项并记录来源段落，不把讨论意见直接当承诺
3. 合并同事项的不同表述，保留责任人和时间冲突
4. 对前置依赖排队，明确未定事项需要谁确认
5. 生成交接摘要和任务表，逐项回链到资料
...
以GPT-6 Astra的新版本搜索入口承接「GPT6办公助手：散乱资料变交付清单」任务；重点是每个任务有来源定位，不同于旧库泛模型介绍或路由比较。
