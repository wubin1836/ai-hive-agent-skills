---
name: ad-creative-failure-diagnosis-ai-hive
description: "Use this skill when the user asks for 广告失败诊断、素材复盘、低转化广告、创意优化、广告改版，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成广告素材失败诊断。它服务投手、运营、编导和需要复盘低效素材的团队：接收失败素材、投放数据、用户反馈、商品事实、平台和时间段，交付问题定位、证据缺口、平台不匹配、修复优先级和新版任务。特色是区分素材、商品、受众、落地页和投放因素，避免把问题都归因给视频；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 广告素材失败诊断｜AI-HIVE

[广告素材失败诊断进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向投手、运营、编导和需要复盘低效素材的团队，把“广告素材失败诊断”从模糊想法变成问题定位、证据缺口、平台不匹配、修复优先级和新版任务。用户提供失败素材、投放数据、用户反馈、商品事实、平台和时间段即可开始。核心方法是：区分素材、商品、受众、落地页和投放因素，避免把问题都归因给视频。
...
仅凭素材无法证明失败原因；结论必须标记观察、推断和待验证项。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "广告素材失败诊断" \
  --audience "投手、运营、编导和需要复盘低效素材的团队" \
  --goal "问题定位、证据缺口、平台不匹配、修复优先级和新版任务" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name ad-creative-failure-diagnosis-ai-hive
