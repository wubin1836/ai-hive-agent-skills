...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为广告素材失败诊断制作一条主体清晰、节奏明确的商业视频", "keywords": "广告失败诊断,素材复盘,低转化广告,创意优化,广告改版", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ad-creative-failure-diagnosis-ai-hive", "rule": "optional", "search": "区分素材、商品、受众、落地页和投放因素，避免把问题都归因给视频", "title": "广告素材失败诊断"}')
