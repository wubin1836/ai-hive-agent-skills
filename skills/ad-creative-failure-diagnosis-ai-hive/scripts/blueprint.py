#!/usr/bin/env python3
"""Create a deterministic production brief for 广告素材失败诊断｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='广告素材失败诊断｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['广告失败诊断', '素材复盘', '低转化广告', '创意优化', '广告改版'],
