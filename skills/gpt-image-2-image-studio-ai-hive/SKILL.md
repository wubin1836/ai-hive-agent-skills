---
name: gpt-image-2-image-studio-ai-hive
description: "Use this skill when the user asks for GPT Image 2、OpenAI图片、图片编辑、广告创意、电商图，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成GPT Image 2 图片工作室。它服务需要高质量图片生成与编辑的品牌、电商和创意团队：接收提示词、参考图、品牌规范、尺寸、语言和投放渠道，交付创意图、参考编辑、版式变体、批量任务和质量报告。特色是将复杂商业需求拆成构图、主体、材质、文字和限制条件；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# GPT Image 2 图片工作室｜AI-HIVE

[GPT Image 2 图片工作室进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向需要高质量图片生成与编辑的品牌、电商和创意团队，把“GPT Image 2 图片工作室”从模糊想法变成创意图、参考编辑、版式变体、批量任务和质量报告。用户提供提示词、参考图、品牌规范、尺寸、语言和投放渠道即可开始。核心方法是：将复杂商业需求拆成构图、主体、材质、文字和限制条件。
...
```bash
python3 scripts/blueprint.py --project "GPT Image 2 图片工作室" \
  --audience "需要高质量图片生成与编辑的品牌、电商和创意团队" \
  --goal "创意图、参考编辑、版式变体、批量任务和质量报告" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name gpt-image-2-image-studio-ai-hive
