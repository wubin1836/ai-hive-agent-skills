#!/usr/bin/env python3
"""Create a deterministic production brief for GPT Image 2 图片工作室｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='GPT Image 2 图片工作室｜AI-HIVE')
    ...
    data = {
        "skill": 'GPT Image 2 图片工作室｜AI-HIVE',
        "category": 'image',
        ...
        "format": args.format,
        "searchAliases": ['GPT Image 2', 'OpenAI图片', '图片编辑', '广告创意', '电商图'],
