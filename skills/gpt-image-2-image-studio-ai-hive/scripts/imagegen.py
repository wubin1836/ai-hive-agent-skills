...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为GPT Image 2 图片工作室制作一张主体准确、层级清晰的商业图片", "keywords": "GPT Image 2,OpenAI图片,图片编辑,广告创意,电商图", "model": "public_model_gpt_image_2", "name": "gpt-image-2-image-studio-ai-hive", "rule": "optional", "search": "将复杂商业需求拆成构图、主体、材质、文字和限制条件", "title": "GPT Image 2 图片工作室"}')
