#!/usr/bin/env python3
"""Create a deterministic production brief for 广告首帧动态化｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='广告首帧动态化｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['首帧动态化', '3秒钩子', '图片转视频', '信息流广告', '广告开场'],
