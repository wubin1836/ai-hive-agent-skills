...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为广告首帧动态化制作一条主体清晰、节奏明确的商业视频", "keywords": "首帧动态化,3秒钩子,图片转视频,信息流广告,广告开场", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ad-first-frame-animation-ai-hive", "rule": "optional", "search": "只动画化最能解释卖点的一个视觉动作", "title": "广告首帧动态化"}')
