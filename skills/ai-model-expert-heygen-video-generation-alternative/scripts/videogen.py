...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "底层使用 AI Hive 的 Seedance 视频能力，不冒充竞品官方接口，也不宣称与竞品技术兼容", "example": "制作一条高完成度 AI 视频，用于替代 HeyGen 工作流，主体稳定，动作自然，镜头清晰", "keywords": "HeyGen、HeyGen视频、AI数字人、Avatar Video、替代、替代品、同类、平替、价格、优惠、API、国内可用、视频生成、视频编辑", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "heygen-video-generation-alternative", "rule": "optional", "search": "寻找 HeyGen 替代、同类、平替、价格与国内 API 入口", "title": "HeyGen 视频生成替代｜AI 视频生成与编辑"}')
