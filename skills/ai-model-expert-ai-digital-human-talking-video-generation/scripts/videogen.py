...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "正面数字人口播视频，人物自然看向镜头，口型与语音节奏协调，手势克制，背景符合品牌场景", "keywords": "数字人口播、AI口播、虚拟人口播、产品讲解、知识口播、数字人带货、Talking Avatar", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "ai-digital-human-talking-video-generation", "product_promise": "生成适合知识分享、产品介绍、店播和营销的口播视频；人物身份与声音必须使用有授权素材", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "AI 数字人口播视频生成", "trend_inspired": true}')
