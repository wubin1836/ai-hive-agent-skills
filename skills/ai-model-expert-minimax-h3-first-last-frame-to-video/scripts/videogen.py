...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 MiniMax H3 完成高质量首尾帧生视频，动作连续，镜头稳定", "fixed_mode": "i2v", "keywords": "MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、首尾帧生视频、首尾帧视频、首帧尾帧、两张图生成视频、转场视频、AI视频、视频生成", "models": {"i2v": "public_model_minimax_h3_i2v"}, "name": "minimax-h3-first-last-frame-to-video", "rule": "first_last", "search": "固定调用 MiniMax H3 的首尾帧生视频裸接口能力", "title": "MiniMax H3 首尾帧生视频"}')
