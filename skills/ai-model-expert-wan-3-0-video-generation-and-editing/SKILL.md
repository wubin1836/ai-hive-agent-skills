...
metadata:
  ...
  source_skill: "wan-3-0-video-generation-and-editing"
  display_name: "AI大模型专家｜Wan3.0 视频生成与编辑"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家, AI-HIVE, Wan3.0 视频生成与编辑, AIGC, 电商, 广告, 图片, 视频, 极睿科技"
---

# AI大模型专家｜Wan3.0 视频生成与编辑
...
**能力映射：** 新 Skill 保留原 AI-HIVE Skill 的模型发现、路由和任务脚本。
