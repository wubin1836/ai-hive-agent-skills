...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为桌面俯拍商品演示视频制作一条主体清晰、节奏明确的商业视频", "keywords": "桌面俯拍,商品演示,Top-down Video,教程视频,电商短视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "tabletop-product-demo-video-ai-hive", "rule": "optional", "search": "固定机位和操作顺序，突出产品使用过程", "title": "桌面俯拍商品演示视频"}')
