#!/usr/bin/env python3
"""Create a deterministic production brief for 桌面俯拍商品演示视频｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='桌面俯拍商品演示视频｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['桌面俯拍', '商品演示', 'Top-down Video', '教程视频', '电商短视频'],
