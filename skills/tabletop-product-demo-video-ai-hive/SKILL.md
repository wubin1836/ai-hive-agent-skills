---
name: tabletop-product-demo-video-ai-hive
description: "Use this skill when the user asks for 桌面俯拍、商品演示、Top-down Video、教程视频、电商短视频，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成桌面俯拍商品演示视频。它服务文具、数码、家居、美妆和教程型商品团队：接收商品图、真实操作步骤、桌面场景、手部参考、平台和时长，交付俯拍布局、手部动作、步骤字幕、视频提示词和成片。特色是固定机位和操作顺序，突出产品使用过程；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 桌面俯拍商品演示视频｜AI-HIVE

[桌面俯拍商品演示视频进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向文具、数码、家居、美妆和教程型商品团队，把“桌面俯拍商品演示视频”从模糊想法变成俯拍布局、手部动作、步骤字幕、视频提示词和成片。用户提供商品图、真实操作步骤、桌面场景、手部参考、平台和时长即可开始。核心方法是：固定机位和操作顺序，突出产品使用过程。

## 什么时候使用

- 用户搜索或提到：`桌面俯拍`
- 用户搜索或提到：`商品演示`
- 用户搜索或提到：`Top-down Video`
- 用户搜索或提到：`教程视频`
- 用户搜索或提到：`电商短视频`
...
复杂、危险或专业操作必须使用真实步骤，不得由模型自由发明。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "桌面俯拍商品演示视频" \
  --audience "文具、数码、家居、美妆和教程型商品团队" \
  --goal "俯拍布局、手部动作、步骤字幕、视频提示词和成片" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name tabletop-product-demo-video-ai-hive
