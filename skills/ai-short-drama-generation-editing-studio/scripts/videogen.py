...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "短剧分镜成片，固定角色外观、服装和场景，以单镜头单动作为原则推进冲突和情绪", "keywords": "AI短剧、微短剧、短剧成片、剧情视频、角色一致性、分镜生成、短剧编辑", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "ai-short-drama-generation-editing-studio", "product_promise": "从剧情梗概、角色设定和分镜生成短剧片段，支持参考素材控制角色并继续编辑、延长", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "AI 短剧生成与编辑工作台", "trend_inspired": true}')
