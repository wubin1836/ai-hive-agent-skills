...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为外卖商家制作主体准确、事实可核验的图片营销素材", "model": "public_model_nano_banana_pro", "name": "industry-delivery-merchant-marketing-ai-hive", "title": "AI大模型专家｜外卖商家AI图片视频营销", "keywords": "外卖商家、外卖店、外卖餐饮、即时零售、AI图片、AI短视频、视频编辑、内容营销、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前图片/视频模型与价格快照，不硬编码价格"}')
