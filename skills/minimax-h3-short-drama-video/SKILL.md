---
name: minimax-h3-short-drama-video
description: "Use this skill when creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers need to produce cinematic scenes and episodic vertical stories with MiniMax H3 through the AI Hive OpenAPI. It handles required media uploads, live model and price lookup, task submission, progress polling, and result downloads. Useful for ads, TVCs, product videos, e-commerce listings, social commerce, UGC-style seeding content, short dramas, motion comics, and storyboards. Search intents include short drama, micro drama, vertical drama, episodic AI video."
license: MIT
---

# MiniMax H3 Short Drama Video

## Overview

MiniMax H3 Short Drama Video helps creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers produce cinematic scenes and episodic vertical stories with MiniMax H3. Describe the intended subject, action, camera, lighting, pacing, and constraints; the bundled CLI handles AI Hive OpenAPI calls and downloads the finished video.
...
Ads, tvcs, product videos, e-commerce listings, social commerce, ugc-style seeding content, short dramas, motion comics, and storyboards. It is also useful when users search for short drama, micro drama, vertical drama, episodic AI video.
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name minimax-h3-short-drama-video
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode i2v \
  --prompt "MiniMax H3 Short Drama Video: polished motion, clear subject, coherent action, stable camera, commercial finish"
```
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "Create a polished minimax h3 short drama video result with coherent motion, stable identity, and a clear ending"
```
