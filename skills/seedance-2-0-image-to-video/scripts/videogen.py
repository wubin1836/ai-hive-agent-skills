...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"i2v\", \"models\": {\"i2v\": \"public_model_seedance_i2v\"}, \"name\": \"seedance-2-0-image-to-video\", \"rule\": \"first\", \"title\": \"Seedance 2.0 Image to Video\"}")
