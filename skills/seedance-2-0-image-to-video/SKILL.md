...
description: "Use this skill when creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers need to animate a still image from a controlled first frame with Seedance 2.0 through the AI Hive OpenAPI. It handles required media uploads, live model and price lookup, task submission, progress polling, and result downloads. Useful for ads, TVCs, product videos, e-commerce listings, social commerce, UGC-style seeding content, short dramas, motion comics, and storyboards. Search intents include image-to-video, I2V, photo animation, still image animation."
license: MIT
---
...
Seedance 2.0 Image to Video helps creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers animate a still image from a controlled first frame with Seedance 2.0. Describe the intended subject, action, camera, lighting, pacing, and constraints; the bundled CLI handles AI Hive OpenAPI calls and downloads the finished video.
...
Ads, tvcs, product videos, e-commerce listings, social commerce, ugc-style seeding content, short dramas, motion comics, and storyboards. It is also useful when users search for image-to-video, I2V, photo animation, still image animation.
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name seedance-2-0-image-to-video
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode i2v \
  --prompt "Seedance 2.0 Image to Video: polished motion, clear subject, coherent action, stable camera, commercial finish" \
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "Create a polished seedance 2.0 image to video result with coherent motion, stable identity, and a clear ending" \
+  --first-frame /path/to/start.png
```
