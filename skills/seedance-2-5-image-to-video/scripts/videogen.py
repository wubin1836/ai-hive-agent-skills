...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"i2v\", \"models\": {\"i2v\": \"public_model_seedance_2_5_i2v\"}, \"name\": \"seedance-2-5-image-to-video\", \"rule\": \"first\", \"title\": \"Seedance 2.5 Image to Video\"}")
