---
name: ai-hive-gap-074-enterprise-ai-governance
description: "当用户搜索或需要AI治理,企业AI,模型治理,AI政策时使用。帮助企业安全、法务合规、AI治理、内容审核和平台工程团队完成建立模型、数据、人员、供应商和内容使用的治理框架，通过AI-HIVE MCP实时核验模型并交付治理原则、角色责任、模型清单、风险分级和审计周期。不适用于超出以下边界的请求：治理方案不能替代组织正式制度和法律审查。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "security"
  display_name: "企业AI治理方案"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "AI治理,企业AI,模型治理,AI政策,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**建立模型、数据、人员、供应商和内容使用的治理框架**。

适合：企业安全、法务合规、AI治理、内容审核和平台工程团队。

用户需要提供：待审计文本或流程、数据分类、工具权限、风险级别、适用制度和人工负责人。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**治理方案不能替代组织正式制度和法律审查**。

## 你会拿到的结果

治理原则、角色责任、模型清单、风险分级和审计周期。

搜索覆盖：AI治理,企业AI,模型治理,AI政策。

## 工作方法

1. 识别资产、数据和工具权限。
2. 建立模型、数据、人员、供应商和内容使用的治理框架。
3. 建立风险情景与测试样例。
4. 提出最小权限和确认门。
5. 保留审计证据与人工复核。
6. 按“责任明确、规则可执行、例外可审批”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成企业AI治理方案，目标、资料、预算和截止时间为[填写]" \
...
最终交付：治理原则、角色责任、模型清单、风险分级和审计周期。
专项验收：责任明确、规则可执行、例外可审批。
```
