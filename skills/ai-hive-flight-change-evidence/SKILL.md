---
name: ai-hive-flight-change-evidence
description: "航班延误退改资料助手，用于航班延误怎么办、机票退改签、航班取消退票。读取你授权的原始资料，完成行程与官方通知时间线，并交付可由本人提交的询问草稿。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "航班延误退改资料助手"
  version: "1.0.0"
...
航班延误退改资料助手，用于航班延误怎么办、机票退改签、航班取消退票。读取你授权的原始资料，完成行程与官方通知时间线，并交付可由本人提交的询问草稿。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 确认承运人、出票渠道、受影响航段和通知，不索取支付凭据密码
2. 使用当前适用运输和票价规则，区分原票条件与特殊通知
3. 整理已发生费用和证明，不承诺赔偿、不代退票改签或购票
...
- `flight-change-evidence-checklist.xlsx`
- `flight-change-evidence-evidence.docx`
- `flight-change-evidence-sources.json`
...
航班延误怎么办、机票退改签、航班取消退票、非自愿退票、航班延误证明
