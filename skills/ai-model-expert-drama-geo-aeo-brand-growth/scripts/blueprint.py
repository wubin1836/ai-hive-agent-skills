#!/usr/bin/env python3
"""Create a deterministic production brief for GEO+AEO 品牌 AI搜索增长."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='GEO+AEO 品牌 AI搜索增长')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['GEO+AEO', '品牌AI搜索', 'AI可见度', 'AI引用'],
