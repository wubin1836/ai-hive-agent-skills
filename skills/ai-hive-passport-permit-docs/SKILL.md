---
name: ai-hive-passport-permit-docs
description: "护照港澳通行证办证助手，用于办护照、港澳通行证、护照到期换发。读取你授权的原始资料，完成证件事项分流表，并交付有效期和待确认清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "护照港澳通行证办证助手"
  version: "1.0.0"
...
护照港澳通行证办证助手，用于办护照、港澳通行证、护照到期换发。读取你授权的原始资料，完成证件事项分流表，并交付有效期和待确认清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 确认本人需求、证件类型及办理地，不读取证件账号或完整号码
2. 依据国家移民管理局和受理地当前指南区分护照、通行证、签注与目的地签证
3. 整理材料及预约前检查，不保证网办资格、办结时间或代预约缴费
...
- `passport-permit-docs-checklist.xlsx`
- `passport-permit-docs-evidence.docx`
- `passport-permit-docs-sources.json`
