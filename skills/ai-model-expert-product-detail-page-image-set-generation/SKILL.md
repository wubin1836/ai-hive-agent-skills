...
metadata:
  ...
  source_skill: "product-detail-page-image-set-generation"
  display_name: "AI大模型专家｜商品详情页套图一键生成"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家, AI-HIVE, 商品详情页套图一键生成, AIGC, 电商, 广告, 图片, 视频, 极睿科技"
---
