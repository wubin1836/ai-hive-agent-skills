#!/usr/bin/env python3
"""Create a deterministic production brief for 红果免费漫剧 AI生成与编辑."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='红果免费漫剧 AI生成与编辑')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['红果免费漫剧', '红果漫剧', 'AI漫剧', '动态漫画'],
