...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Amazon Listing 图片工作室制作一张主体准确、层级清晰的商业图片", "keywords": "Amazon Listing,亚马逊图片,A+页面,跨境电商,产品信息图", "model": "public_model_gpt_image_2", "name": "amazon-listing-image-studio-ai-hive", "rule": "optional", "search": "按站点语言和购买决策路径组织图片，不虚构认证与效果", "title": "Amazon Listing 图片工作室"}')
