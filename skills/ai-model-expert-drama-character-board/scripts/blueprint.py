#!/usr/bin/env python3
"""Create a deterministic production brief for 短剧人物版人物板."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='短剧人物版人物板')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['人物版', '人物板', '角色板', 'character board', '人物设定图'],
