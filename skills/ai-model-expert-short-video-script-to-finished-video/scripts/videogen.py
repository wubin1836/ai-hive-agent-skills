...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "将脚本按时间切成连续镜头，准确表现每段主体动作、镜头运动、光线和节奏，形成完整短视频", "keywords": "脚本转视频、文案转视频、分镜成片、短视频脚本、口播脚本、视频制作、一键成片", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "short-video-script-to-finished-video", "product_promise": "输入脚本或分镜表，整理成可执行的镜头提示并生成连续成片，减少从文案到制作的断层", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "短视频脚本一键生成成片", "trend_inspired": true}')
