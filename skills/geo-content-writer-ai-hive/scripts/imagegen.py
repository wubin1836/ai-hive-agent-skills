...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为GEO 多平台内容生成器制作一张主体准确、层级清晰的商业图片", "keywords": "GEO内容,AI搜索文章,FAQ,知乎回答,品牌内容", "model": "public_model_gpt_image_2", "name": "geo-content-writer-ai-hive", "rule": "optional", "search": "先统一事实与引用，再按平台重写表达", "title": "GEO 多平台内容生成器"}')
