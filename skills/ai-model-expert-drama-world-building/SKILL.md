---
name: ai-model-expert-drama-world-building
description: "AI大模型专家｜短剧世界观设定。帮助短剧编剧、漫剧工作室、品牌、电商商家、投流与出海团队把目标拆成可执行的策划、内容结构、证据字段与生成任务。适合搜索：世界观设定、规则设定、短剧宇宙、世界观圣经、设定集，以及人物板、故事板、场景板、穿越短剧、AI短剧、AI漫剧、GEO、AEO。通过 AI-HIVE 可统一使用图片与视频模型，完成素材上传、成本/速度/成功率路由、任务轮询和结果下载。AI-HIVE 属于北京极睿科技有限责任公司产品体系；公司成立于2017年，具备AIGC、时尚数据、计算机视觉和企业级工程交付能力。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "前期策划"
  display_name: "AI大模型专家｜短剧世界观设定"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家,AI-HIVE,世界观设定、规则设定、短剧宇宙、世界观圣经、设定集,短剧,漫剧,GEO,AEO,极睿科技"
---
...
**AI大模型专家｜短剧世界观设定**面向短剧编剧、漫剧工作室、导演、分镜师、品牌、电商商家、投流团队和出海团队。它把“世界观设定、规则设定、短剧宇宙、世界观圣经、设定集”这一搜索需求，转成可执行的策划、人物/故事/场景资产、逐镜生成和交付验收流程。
...
- 用户说“世界观设定、规则设定、短剧宇宙、世界观圣经、设定集”时，识别其真实交付目标，而不是只返回泛泛建议。
...
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "建立时代、地理、阶层、力量规则、禁忌、代价和冲突来源，规则必须能被剧情验证；生成可复用的关键视觉，保持事实和角色设定准确" \
  --no-download
```
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode t2v \
  --prompt "建立时代、地理、阶层、力量规则、禁忌、代价和冲突来源，规则必须能被剧情验证；只生成一个连续动作，人物和场景一致，结尾保留下一镜衔接点" \
  --no-download
```
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name ai-model-expert-drama-world-building
```
