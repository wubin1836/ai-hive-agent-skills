---
name: ai-hive-proven-013-product-render
description: "当用户要做“产品描述生成商业效果图”或搜索产品描述生成商业效果图、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向淘宝、天猫、京东、抖音、小红书、亚马逊、TikTok Shop、Shopify和独立站商家，通过AI-HIVE先规划并查询实时模型与价格，再交付商品事实卡、版式计划、主图/场景图/卖点图小样、系列成图、尺寸清单和发布前检查。先小样后批量；付费生成、发送和公开发布必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  display_name: "产品描述生成商业效果图"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "产品描述生成商业效果图、电商图片、商品主图、详情页、Listing、商业摄影、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **产品描述生成商业效果图**，服务于淘宝、天猫、京东、抖音、小红书、亚马逊、TikTok Shop、Shopify和独立站商家。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。
...
python3 scripts/plan.py \
  --brief "我要完成产品描述生成商业效果图，目标/受众/平台/预算为[填写]" \
...
产品描述生成商业效果图、电商图片、商品主图、详情页、Listing、商业摄影、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
