...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为大众点评30天口碑运营制作事实可核验的本地生活营销图片", "model": "public_model_nano_banana_pro", "name": "local-dianping-operation-ai-hive", "title": "AI大模型专家｜大众点评30天口碑运营", "keywords": "大众点评、点评、大众点评商家、点评商家版、点评推广、30天口碑运营、本地生活、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前模型与价格，并在平台官方后台核对当前规则"}')
