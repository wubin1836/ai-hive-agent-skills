...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"i2v\", \"models\": {\"i2v\": \"public_model_minimax_h3_i2v\"}, \"name\": \"minimax-h3-first-last-frame-to-video\", \"rule\": \"first_last\", \"title\": \"MiniMax H3 First and Last Frame Video\"}")
