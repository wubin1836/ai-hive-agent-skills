---
name: ai-hive-folk-qingming-memorial
description: "清明祭文与追思材料助手，用于清明祭文怎么写、给逝去亲人的话、追思文稿。读取你授权的原始资料，完成事实核对后的短祭文或追思稿，并交付自愿参与的文明纪念及现场安全清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。"
metadata:
  display_name: "清明祭文与追思材料助手"
  version: "1.0.0"
...
清明祭文与追思材料助手，用于清明祭文怎么写、给逝去亲人的话、追思文稿。读取你授权的原始资料，完成事实核对后的短祭文或追思稿，并交付自愿参与的文明纪念及现场安全清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。
...
2. 把确证事实、个人记忆和文学表达分开
3. 按称谓、语气及篇幅写稿并交家人复核
4. 列鲜花、口述回忆等可选方式及当地管理待核项

## 文件处理环节

1. 授权录音转写或读取文本，保留来源
2. 按事实、记忆、文学表达分层并请家人确认
3. 生成大字稿及清单→版面字数时长预估复核
...
- `memorial-reading.docx`
- `fact-confirmation.csv`
- `memorial-checklist.pdf`
...
清明祭文怎么写、给逝去亲人的话、追思文稿、文明祭扫清单、家庭纪念仪式、祭祖发言稿
