#!/usr/bin/env python3
"""Create a deterministic production brief for Gemini API中转."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='Gemini API中转')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['Gemini中转', 'Google AI API中转', 'Gemini代理', 'Gemini接口'],
