...
SKILL_CONFIG = json.loads("{\"model\": \"public_model_nano_banana_pro\", \"name\": \"nano-banana-pro-livestream-image\", \"rule\": \"optional\", \"title\": \"Nano Banana Pro Livestream Commerce Image\"}")
