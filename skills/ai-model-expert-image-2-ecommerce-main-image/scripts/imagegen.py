...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Image2 制作高完成度电商主图，主体准确，构图清晰", "keywords": "Image2、Image 2、GPT Image 2、GPTImage2、OpenAI 图片、ChatGPT 图片、电商主图、商品主图、电商首图、白底图、SKU主图、平台主图、AI图片、AIGC图片", "model": "public_model_gpt_image_2", "name": "image-2-ecommerce-main-image", "rule": "optional", "search": "固定调用 Image2 的电商主图裸接口能力", "title": "Image2 电商主图"}')
