...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"i2v\", \"models\": {\"i2v\": \"public_model_minimax_h3_i2v\"}, \"name\": \"minimax-h3-image-to-video\", \"rule\": \"first\", \"title\": \"MiniMax H3 Image to Video\"}")
