...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 MiniMax H3 完成高质量文生视频，动作连续，镜头稳定", "fixed_mode": "t2v", "keywords": "MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、文生视频、文字生成视频、文本转视频、text to video、T2V、AI视频、视频生成", "models": {"t2v": "public_model_minimax_h3_t2v"}, "name": "minimax-h3-text-to-video", "rule": "none", "search": "固定调用 MiniMax H3 的文生视频裸接口能力", "title": "MiniMax H3 文生视频"}')
