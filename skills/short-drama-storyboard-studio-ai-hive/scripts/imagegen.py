...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为短剧分镜故事板工作室制作一张主体准确、层级清晰的商业图片", "keywords": "短剧分镜,故事板,镜头脚本,AI分镜,漫剧分镜", "model": "public_model_nano_banana_pro", "name": "short-drama-storyboard-studio-ai-hive", "rule": "optional", "search": "每个镜头标注叙事功能和连续性锚点", "title": "短剧分镜故事板工作室"}')
