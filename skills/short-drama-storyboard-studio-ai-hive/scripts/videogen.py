...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为短剧分镜故事板工作室制作一条主体清晰、节奏明确的商业视频", "keywords": "短剧分镜,故事板,镜头脚本,AI分镜,漫剧分镜", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "short-drama-storyboard-studio-ai-hive", "rule": "optional", "search": "每个镜头标注叙事功能和连续性锚点", "title": "短剧分镜故事板工作室"}')
