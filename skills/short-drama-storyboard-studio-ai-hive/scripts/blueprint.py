#!/usr/bin/env python3
"""Create a deterministic production brief for 短剧分镜故事板工作室｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='短剧分镜故事板工作室｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['短剧分镜', '故事板', '镜头脚本', 'AI分镜', '漫剧分镜'],
