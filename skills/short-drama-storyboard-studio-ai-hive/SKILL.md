---
name: short-drama-storyboard-studio-ai-hive
description: "Use this skill when the user asks for 短剧分镜、故事板、镜头脚本、AI分镜、漫剧分镜，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成短剧分镜故事板工作室。它服务导演、编剧、漫剧团队和AI视频创作者：接收剧本段落、人物板、场景板、风格、画幅和单集时长，交付镜号、景别、机位、动作、台词、时长、转场和逐镜提示词。特色是每个镜头标注叙事功能和连续性锚点；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 短剧分镜故事板工作室｜AI-HIVE

[短剧分镜故事板工作室进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向导演、编剧、漫剧团队和AI视频创作者，把“短剧分镜故事板工作室”从模糊想法变成镜号、景别、机位、动作、台词、时长、转场和逐镜提示词。用户提供剧本段落、人物板、场景板、风格、画幅和单集时长即可开始。核心方法是：每个镜头标注叙事功能和连续性锚点。
...
```bash
python3 scripts/blueprint.py --project "短剧分镜故事板工作室" \
  --audience "导演、编剧、漫剧团队和AI视频创作者" \
  --goal "镜号、景别、机位、动作、台词、时长、转场和逐镜提示词" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name short-drama-storyboard-studio-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name short-drama-storyboard-studio-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
