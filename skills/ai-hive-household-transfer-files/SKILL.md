---
name: ai-hive-household-transfer-files
description: "户口迁移与落户材料助手，用于迁户口、落户材料、户口迁移。读取你授权的原始资料，完成迁入迁出办理路线，并交付家庭成员材料缺口。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "户口迁移与落户材料助手"
  version: "1.0.0"
...
户口迁移与落户材料助手，用于迁户口、落户材料、户口迁移。读取你授权的原始资料，完成迁入迁出办理路线，并交付家庭成员材料缺口。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 确认迁入迁出地和用户选定办理事由，不推荐虚假条件或包装经历
2. 对照两地官方指南标前置手续、可联办事项和待确认差异
3. 按户籍关系与授权范围整理材料，不推定具有落户资格
...
- `household-transfer-files-checklist.xlsx`
- `household-transfer-files-evidence.docx`
- `household-transfer-files-sources.json`
