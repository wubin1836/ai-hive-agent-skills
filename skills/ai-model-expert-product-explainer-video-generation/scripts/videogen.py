...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "商品讲解视频，依次呈现外观、结构、使用步骤和已确认卖点，镜头清晰，信息易懂", "keywords": "商品讲解、产品演示、产品介绍、功能讲解、开箱视频、测评视频、电商成片", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "product-explainer-video-generation", "product_promise": "把商品资料整理成观看顺序明确的讲解视频，适合详情页、店播、客服介绍和新品发布", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "商品讲解视频一键生成", "trend_inspired": true}')
