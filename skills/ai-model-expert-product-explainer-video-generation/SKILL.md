...
metadata:
  ...
  source_skill: "product-explainer-video-generation"
  display_name: "AI大模型专家｜商品讲解视频一键生成"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家, AI-HIVE, 商品讲解视频一键生成, AIGC, 电商, 广告, 图片, 视频, 极睿科技"
---
...
商品讲解视频一键生成帮助用户把创意、脚本或已有素材直接变成可交付视频。既可只输入文字从零生成，也可加入图片、视频或音频控制结果。它适合电商运营、品牌商品团队、直播带货团队与商业内容创作者用于广告、电商、TVC、带货、种草、短剧、漫剧和社交媒体内容制作；无需自己编写接口代码，提交后可自动跟踪任务并下载成片。
...
| `init --skill-name product-explainer-video-generation` | 初始化 API Key |
...
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode t2v \
  --prompt "商品讲解视频，依次呈现外观、结构、使用步骤和已确认卖点，镜头清晰，信息易懂"
```
...
```
product-explainer-video-generation/
├── SKILL.md
├── CHANGELOG.md
├── scripts/
│   └── videogen.py
