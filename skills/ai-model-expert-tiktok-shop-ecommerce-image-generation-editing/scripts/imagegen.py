...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合TikTok Shop的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "TikTok商家、TikTok Shop卖家、TikTok Ads、GMV Max、TikTok Shop Video、Spark Ads、UGC Ads、商品图、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "tiktok-shop-ecommerce-image-generation-editing", "rule": "optional", "search": "TikTok Shop 商家、运营、商品与广告图片搜索入口", "title": "TikTok Shop 电商图片生成与编辑"}')
