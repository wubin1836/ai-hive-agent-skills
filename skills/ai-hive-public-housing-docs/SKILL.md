---
name: ai-hive-public-housing-docs
description: "公租房申请材料助手，用于申请公租房、公租房怎么申请、保障房申请。读取你授权的原始资料，完成当地申请类别与条件来源表，并交付待经办确认问题单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "公租房申请材料助手"
  version: "1.0.0"
...
公租房申请材料助手，用于申请公租房、公租房怎么申请、保障房申请。读取你授权的原始资料，完成当地申请类别与条件来源表，并交付待经办确认问题单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
1. 确认地区、申请类别和用户自述事实，不索取无关家庭隐私
2. 查当地当前住房保障官方指南，不照搬别处收入或面积条件
3. 将真实材料与要求逐一对照，不判断审批结果或帮助隐瞒财产
...
- `public-housing-docs-checklist.xlsx`
- `public-housing-docs-evidence.docx`
- `public-housing-docs-sources.json`
...
申请公租房、公租房怎么申请、保障房申请、公租房材料、住房保障
