...
metadata:
  ...
  source_skill: "wechat-official-account-viral-cover-generation"
  display_name: "AI大模型专家｜公众号爆款封面生成与编辑"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家, AI-HIVE, 公众号爆款封面生成与编辑, AIGC, 电商, 广告, 图片, 视频, 极睿科技"
---

# AI大模型专家｜公众号爆款封面生成与编辑
