...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"extend\", \"models\": {\"extend\": \"public_model_seedance_2_5_video_extend\"}, \"name\": \"seedance-2-5-video-extend\", \"rule\": \"extend\", \"title\": \"Seedance 2.5 Video Extension\"}")
