---
name: ai-hive-renovation-quote-check
description: "装修报价查漏与增项核对助手，用于装修报价怎么看、装修增项、装修清单避坑。读取你授权的原始资料，完成工程量单价材料规格对照，并交付向施工方提问清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。"
metadata:
  display_name: "装修报价查漏与增项核对助手"
  version: "1.0.0"
...
装修报价查漏与增项核对助手，用于装修报价怎么看、装修增项、装修清单避坑。读取你授权的原始资料，完成工程量单价材料规格对照，并交付向施工方提问清单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供材料准备与核对参考；具体要求以办理地当前官方规则为准，不保证资格或审批结果。
...
- XLSX/PDF 报价表读取、版本差异匹配
- Decimal 计量单位转换、金额及优惠复算
...
1. 读取用户报价与房屋基础尺寸，统一单位并保留原件
2. 分拆人工材料辅料、数量单价、包含范围与不明增项，实际复算金额
3. 只指出有依据的差异，不凭低价判断欺诈；承重、防水等专业工程另请专业人员核查

## 文件处理环节

1. 读取脱敏报价/账单PDF或CSV，提取项目、计费单位、数量、单价、优惠及出处
2. 用Decimal/电子表格实际复算行金额与汇总，核对单位、重复收费、范围和版本差异
3. 生成带原记录链接的费用对照XLSX与询问事项DOCX
4. 再次校验总计、未解释差额和原文件映射；不自动联系对方或修改合同
...
- `renovation-quote-check-checklist.xlsx`
- `renovation-quote-check-evidence.docx`
- `renovation-quote-check-sources.json`
...
装修报价怎么看、装修增项、装修清单避坑、装修预算审核、半包全包报价
