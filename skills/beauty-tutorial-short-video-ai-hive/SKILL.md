---
name: beauty-tutorial-short-video-ai-hive
description: "Use this skill when the user asks for 美妆教程、化妆步骤、彩妆视频、美妆种草、AI短视频，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成美妆步骤教程短视频。它服务美妆品牌、达人、培训和电商内容团队：接收产品与色号、官方用法、授权人物参考、步骤、平台和时长，交付真实步骤脚本、局部关键帧、短视频提示词、字幕和产品卡。特色是每条视频只讲一个妆容目标和可验证步骤；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 美妆步骤教程短视频｜AI-HIVE

[美妆步骤教程短视频进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向美妆品牌、达人、培训和电商内容团队，把“美妆步骤教程短视频”从模糊想法变成真实步骤脚本、局部关键帧、短视频提示词、字幕和产品卡。用户提供产品与色号、官方用法、授权人物参考、步骤、平台和时长即可开始。核心方法是：每条视频只讲一个妆容目标和可验证步骤。
...
不得生成医疗或治疗功效；色差、肤质和效果必须说明为AI视觉，敏感提示按产品要求保留。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "美妆步骤教程短视频" \
  --audience "美妆品牌、达人、培训和电商内容团队" \
  --goal "真实步骤脚本、局部关键帧、短视频提示词、字幕和产品卡" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name beauty-tutorial-short-video-ai-hive
