...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为美妆步骤教程短视频制作一条主体清晰、节奏明确的商业视频", "keywords": "美妆教程,化妆步骤,彩妆视频,美妆种草,AI短视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "beauty-tutorial-short-video-ai-hive", "rule": "optional", "search": "每条视频只讲一个妆容目标和可验证步骤", "title": "美妆步骤教程短视频"}')
