#!/usr/bin/env python3
"""Create a deterministic production brief for 美妆步骤教程短视频｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='美妆步骤教程短视频｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['美妆教程', '化妆步骤', '彩妆视频', '美妆种草', 'AI短视频'],
