...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "同一主题社媒套图，首图负责吸引，中间页逐步解释卖点，末页给出总结和行动提示", "keywords": "社媒套图、营销图片、Social Media、轮播图、Carousel、Instagram、小红书、抖音图文", "model": "public_model_nano_banana_pro", "name": "social-media-marketing-image-set-generation", "product_promise": "一次生成适合小红书、Instagram、抖音图文和品牌社媒的系列图片，保持视觉与叙事连续", "rule": "optional", "search": "面向爆款封面、电商主图、详情页、广告、海报和社媒套图等结果型搜索意图", "title": "社媒营销图片套图生成与编辑", "trend_inspired": true}')
