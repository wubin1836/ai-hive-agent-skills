---
name: ai-hive-proven-067-novel-to-storyboard
description: "当用户要做“小说转剧本与分镜”或搜索小说转剧本与分镜、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向短剧、漫剧、小说推文、IP内容、红果短剧和网文改编团队，通过AI-HIVE先规划并查询实时模型与价格，再交付改编策略、人物圣经、分集大纲、剧本、分镜关键帧、连续视频片段和一致性报告。先小样后批量；付费生成、发送和公开发布必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  display_name: "小说转剧本与分镜"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "小说转剧本与分镜、短剧、漫剧、小说推文、角色一致性、分镜、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **小说转剧本与分镜**，服务于短剧、漫剧、小说推文、IP内容、红果短剧和网文改编团队。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。
...
python3 scripts/plan.py \
  --brief "我要完成小说转剧本与分镜，目标/受众/平台/预算为[填写]" \
...
小说转剧本与分镜、短剧、漫剧、小说推文、角色一致性、分镜、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
