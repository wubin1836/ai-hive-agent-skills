...
SKILL = 'ai-hive-product-switch-future-baby-generator'
TITLE = 'Future Baby Generator平替迁移：AI-HIVE多模型工作流'
PRODUCT = 'Future Baby Generator'
CATEGORY = '图片生成与视觉设计'
MODE = '角色与风格一致性'
TRIAL = '用有权使用的参考图比较多张输出的一致性'
DELIVERABLES = '参考图清单、角色规则、连续小样、漂移检查、工作流'
