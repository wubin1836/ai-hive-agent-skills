---
name: ai-hive-gap-032-autonomous-marketing-agent
description: "当用户搜索或需要自主营销智能体,营销Agent,内容增长,自动营销时使用。帮助普通企业、创业团队、超级个体、销售运营和职能部门完成规划从洞察、创意、生成到复盘的营销智能体循环，通过AI-HIVE MCP实时核验模型并交付增长假设、内容计划、图片视频小样、指标和复盘规则。不适用于超出以下边界的请求：不得承诺流量、销量或自动投放。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "enterprise"
  display_name: "自主营销智能体内容增长"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "自主营销智能体,营销Agent,内容增长,自动营销,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**规划从洞察、创意、生成到复盘的营销智能体循环**。

适合：普通企业、创业团队、超级个体、销售运营和职能部门。

用户需要提供：真实业务资料、目标受众、内部口径、交付格式、品牌规范、预算和审批要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不得承诺流量、销量或自动投放**。

## 你会拿到的结果

增长假设、内容计划、图片视频小样、指标和复盘规则。

搜索覆盖：自主营销智能体,营销Agent,内容增长,自动营销。

## 怎么执行

1. 将业务问题和生成任务分开。
2. 规划从洞察、创意、生成到复盘的营销智能体循环。
3. 锁定不可虚构的事实与数字。
4. 先交付文字或结构草案。
5. 确认后制作视觉小样并验收。
6. 按“假设可验证、素材一致、循环有停止条件”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成自主营销智能体内容增长，目标、资料、预算和截止时间为[填写]" \
...
最终交付：增长假设、内容计划、图片视频小样、指标和复盘规则。
专项验收：假设可验证、素材一致、循环有停止条件。
```
