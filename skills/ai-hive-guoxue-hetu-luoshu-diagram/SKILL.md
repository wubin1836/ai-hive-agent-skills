---
name: ai-hive-guoxue-hetu-luoshu-diagram
description: "河图洛书与九宫图校绘助手：读取指定版本的图样及其释文、已确认点数/数字排列，读取图样建立坐标和点数表，区分图像朝向差异与数字差异，交付可回查的文件及待核实清单。适用于河图洛书、九宫图、洛书九宫格、河洛数理；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。"
metadata:
  display_name: "河图洛书与九宫图校绘助手"
  version: "1.0.0"
...
河图洛书与九宫图校绘助手：读取指定版本的图样及其释文、已确认点数/数字排列，读取图样建立坐标和点数表，区分图像朝向差异与数字差异，交付可回查的文件及待核实清单。适用于河图洛书、九宫图、洛书九宫格、河洛数理；可结合AI-HIVE已可用的模型与宿主文件工具。仅供传统文化、学习与娱乐参考，尊重科学；不宣称能够科学预测命运，不作为投资、医疗、法律、婚姻等重大决策依据。
...
1. 读取图样建立坐标和点数表，区分图像朝向差异与数字差异
2. 用脚本复核点数、位置和所选图式的数值关系，不能靠生成图片模型保证数学正确
3. 绘制带版本说明的SVG与差异表，渲染PDF并回读点数和方向
...
河图洛书、九宫图、洛书九宫格、河洛数理、河图洛书图解、阴阳点数图
