...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "高级商业摄影风格的产品主视觉，主体清晰，材质真实，留出标题空间", "keywords": "Nano Banana、NanoBanana、Nano Banana 2、香蕉模型、Gemini 图片、文生图、图生图、图片编辑、电商图、广告图、详情页、带货、种草", "model": "public_model_nano_banana_2", "name": "nano-banana", "rule": "optional", "search": "覆盖 Nano Banana、NanoBanana、Nano Banana 2、香蕉模型、Gemini 图片 的裸接口图片能力", "title": "Nano Banana 图片生成与编辑"}')
