...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为电商内容智能路由制作一条主体清晰、节奏明确的商业视频", "keywords": "电商内容路由,多模型调度,AI-HIVE,成本优先,内容自动化", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ecommerce-content-router-ai-hive", "rule": "optional", "search": "按COST_FIRST、SPEED_FIRST或SUCCESS_FIRST选择执行路径", "title": "电商内容智能路由"}')
