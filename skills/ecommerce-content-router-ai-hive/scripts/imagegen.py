...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为电商内容智能路由制作一张主体准确、层级清晰的商业图片", "keywords": "电商内容路由,多模型调度,AI-HIVE,成本优先,内容自动化", "model": "public_model_nano_banana_pro", "name": "ecommerce-content-router-ai-hive", "rule": "optional", "search": "按COST_FIRST、SPEED_FIRST或SUCCESS_FIRST选择执行路径", "title": "电商内容智能路由"}')
