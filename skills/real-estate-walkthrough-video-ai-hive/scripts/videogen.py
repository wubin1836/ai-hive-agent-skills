...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为房产样板间漫游视频制作一条主体清晰、节奏明确的商业视频", "keywords": "房产视频,样板间漫游,空间视频,民宿展示,家装广告", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "real-estate-walkthrough-video-ai-hive", "rule": "optional", "search": "用真实空间参考串联平滑镜头，不随意改变布局", "title": "房产样板间漫游视频"}')
