#!/usr/bin/env python3
"""Create a deterministic production brief for 房产样板间漫游视频｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='房产样板间漫游视频｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['房产视频', '样板间漫游', '空间视频', '民宿展示', '家装广告'],
