---
name: viral-video-hook-analyzer-ai-hive
description: "Use this skill when the user asks for 黄金3秒、视频钩子、开场文案、完播率、爆款视频，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成爆款视频黄金3秒钩子分析。它服务编导、投手、剪辑师和增长团队：接收参考视频或首屏截图、产品事实、受众痛点和发布平台，交付钩子类型判断、信息差、画面冲突、字幕首屏与10个原创开场。特色是只聚焦首屏停留问题，给出可直接A/B测试的钩子矩阵；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 爆款视频黄金3秒钩子分析｜AI-HIVE

[爆款视频黄金3秒钩子分析进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向编导、投手、剪辑师和增长团队，把“爆款视频黄金3秒钩子分析”从模糊想法变成钩子类型判断、信息差、画面冲突、字幕首屏与10个原创开场。用户提供参考视频或首屏截图、产品事实、受众痛点和发布平台即可开始。核心方法是：只聚焦首屏停留问题，给出可直接A/B测试的钩子矩阵。
...
```bash
python3 scripts/blueprint.py --project "爆款视频黄金3秒钩子分析" \
  --audience "编导、投手、剪辑师和增长团队" \
  --goal "钩子类型判断、信息差、画面冲突、字幕首屏与10个原创开场" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name viral-video-hook-analyzer-ai-hive
