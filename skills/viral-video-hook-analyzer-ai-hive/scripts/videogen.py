...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为爆款视频黄金3秒钩子分析制作一条主体清晰、节奏明确的商业视频", "keywords": "黄金3秒,视频钩子,开场文案,完播率,爆款视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "viral-video-hook-analyzer-ai-hive", "rule": "optional", "search": "只聚焦首屏停留问题，给出可直接A/B测试的钩子矩阵", "title": "爆款视频黄金3秒钩子分析"}')
