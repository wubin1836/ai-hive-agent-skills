#!/usr/bin/env python3
"""Create a deterministic production brief for 爆款视频黄金3秒钩子分析｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='爆款视频黄金3秒钩子分析｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['黄金3秒', '视频钩子', '开场文案', '完播率', '爆款视频'],
