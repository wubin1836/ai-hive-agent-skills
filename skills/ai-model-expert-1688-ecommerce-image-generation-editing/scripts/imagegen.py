...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合1688的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "阿里巴巴批发网、1688商家、源头工厂、工厂店、批发商品图、工厂产品视频、批量SKU、招商素材、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "1688-ecommerce-image-generation-editing", "rule": "optional", "search": "1688 商家、运营、商品与广告图片搜索入口", "title": "1688 电商图片生成与编辑"}')
