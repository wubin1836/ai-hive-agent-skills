---
name: ai-hive-gap-026-ai-bi-insight
description: "当用户搜索或需要AI BI,商业智能,经营洞察,数据报告时使用。帮助普通企业、创业团队、超级个体、销售运营和职能部门完成把业务数据、问题和行动建议组织成图文洞察报告，通过AI-HIVE MCP实时核验模型并交付分析问题树、指标解释、图表、洞察卡和行动清单。不适用于超出以下边界的请求：没有原始数据时只能提供分析框架。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "enterprise"
  display_name: "AI BI经营洞察图文报告"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "AI BI,商业智能,经营洞察,数据报告,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**把业务数据、问题和行动建议组织成图文洞察报告**。

适合：普通企业、创业团队、超级个体、销售运营和职能部门。

用户需要提供：真实业务资料、目标受众、内部口径、交付格式、品牌规范、预算和审批要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**没有原始数据时只能提供分析框架**。

## 你会拿到的结果

分析问题树、指标解释、图表、洞察卡和行动清单。

搜索覆盖：AI BI,商业智能,经营洞察,数据报告。

## 工作方法

1. 将业务问题和生成任务分开。
2. 把业务数据、问题和行动建议组织成图文洞察报告。
3. 锁定不可虚构的事实与数字。
4. 先交付文字或结构草案。
5. 确认后制作视觉小样并验收。
6. 按“数据可追溯、相关不当因果、行动具体”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成AI BI经营洞察图文报告，目标、资料、预算和截止时间为[填写]" \
...
最终交付：分析问题树、指标解释、图表、洞察卡和行动清单。
专项验收：数据可追溯、相关不当因果、行动具体。
```
