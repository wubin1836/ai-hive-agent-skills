...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "完成一条高质量视频延长任务", "fixed_mode": "extend", "keywords": "视频延长、视频续写、扩展视频、video extend、Seedance、MiniMax H3、Happy Horse", "models": {"extend": "public_model_seedance_2_5_video_extend"}, "name": "video-extend", "rule": "extend", "search": "通用能力搜索入口，底层调用 AI Hive 裸接口", "title": "视频延长"}')
