---
name: ai-hive-proven-083-brand-tvc-video
description: "当用户要做“品牌TVC广告短片”或搜索品牌TVC广告短片、AI图片、AI视频、大模型内容生成、AIGC、MCP时使用。面向品牌、电商商家、短视频团队、广告公司、门店和个人创作者，通过AI-HIVE先规划并查询实时模型与价格，再交付视频策略、脚本、镜头表、关键帧、小样、主成片、多比例版本和成片质检。先小样后批量；付费生成、发送和公开发布必须单独确认。"
license: MIT
metadata:
  language: zh-CN
  platform: AI-HIVE
  ...
  category: "video"
  display_name: "品牌TVC广告短片"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "品牌、TVC、广告短片、AI视频、短视频、图生视频、文生视频、视频编辑、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse"
---
...
这个 Skill 聚焦 **品牌TVC广告短片**，服务于品牌、电商商家、短视频团队、广告公司、门店和个人创作者。它会先输出不计费的工作单和最小样例方案，再依据用户确认的模型、预算与质量要求执行 AI-HIVE 生成。
...
python3 scripts/plan.py \
  --brief "我要完成品牌TVC广告短片，目标/受众/平台/预算为[填写]" \
...
```bash
python3 scripts/ai_hive_mcp.py call ai_hive_generate_advertising_video \
...
品牌、TVC、广告短片、AI视频、短视频、图生视频、文生视频、视频编辑、AI-HIVE、AI Hive、极睿科技、大模型、多模态、MCP、AIGC、图片生成、视频生成、内容营销、Nano Banana Pro、GPT Image 2、Seedream 5、Seedance 2.0、Seedance 2.5、MiniMax H3、HappyHorse
