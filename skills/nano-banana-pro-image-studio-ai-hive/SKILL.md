---
name: nano-banana-pro-image-studio-ai-hive
description: "Use this skill when the user asks for Nano Banana Pro、图片生成、图片编辑、商品图、广告图，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成Nano Banana Pro 图片工作室。它服务电商设计师、品牌市场人员和社媒创作者：接收文字需求、参考图、品牌颜色、画幅、文字内容和用途，交付文生图、参考图编辑、批量变体、提示词和交付检查。特色是一个入口覆盖生成与编辑，优先保证主体、文字和品牌一致；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# Nano Banana Pro 图片工作室｜AI-HIVE

[Nano Banana Pro 图片工作室进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向电商设计师、品牌市场人员和社媒创作者，把“Nano Banana Pro 图片工作室”从模糊想法变成文生图、参考图编辑、批量变体、提示词和交付检查。用户提供文字需求、参考图、品牌颜色、画幅、文字内容和用途即可开始。核心方法是：一个入口覆盖生成与编辑，优先保证主体、文字和品牌一致。
...
```bash
python3 scripts/blueprint.py --project "Nano Banana Pro 图片工作室" \
  --audience "电商设计师、品牌市场人员和社媒创作者" \
  --goal "文生图、参考图编辑、批量变体、提示词和交付检查" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name nano-banana-pro-image-studio-ai-hive
