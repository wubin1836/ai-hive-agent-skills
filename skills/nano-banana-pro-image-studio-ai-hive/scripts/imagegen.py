...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Nano Banana Pro 图片工作室制作一张主体准确、层级清晰的商业图片", "keywords": "Nano Banana Pro,图片生成,图片编辑,商品图,广告图", "model": "public_model_nano_banana_pro", "name": "nano-banana-pro-image-studio-ai-hive", "rule": "optional", "search": "一个入口覆盖生成与编辑，优先保证主体、文字和品牌一致", "title": "Nano Banana Pro 图片工作室"}')
