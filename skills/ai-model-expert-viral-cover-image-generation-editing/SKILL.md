...
metadata:
  ...
  source_skill: "viral-cover-image-generation-editing"
  display_name: "AI大模型专家｜爆款封面图片生成与编辑"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家, AI-HIVE, 爆款封面图片生成与编辑, AIGC, 电商, 广告, 图片, 视频, 极睿科技"
---
