...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为Seedance 2.0 提示词专家制作一条主体清晰、节奏明确的商业视频", "keywords": "Seedance 2.0,即梦视频,视频提示词,文生视频,图生视频", "models": {"t2v": "public_model_seedance_t2v", "i2v": "public_model_seedance_i2v", "r2v": "public_model_seedance_r2v"}, "name": "seedance-2-prompt-expert-ai-hive", "rule": "optional", "search": "把自然语言创意转成可执行的镜头指令", "title": "Seedance 2.0 提示词专家"}')
