#!/usr/bin/env python3
"""Create a deterministic production brief for Seedance 2.0 提示词专家｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='Seedance 2.0 提示词专家｜AI-HIVE')
    ...
    data = {
        "skill": 'Seedance 2.0 提示词专家｜AI-HIVE',
        "category": 'video',
        ...
        "format": args.format,
        "searchAliases": ['Seedance 2.0', '即梦视频', '视频提示词', '文生视频', '图生视频'],
