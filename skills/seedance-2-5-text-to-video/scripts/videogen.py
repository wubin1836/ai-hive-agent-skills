...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"t2v\", \"models\": {\"t2v\": \"public_model_seedance_2_5_t2v\"}, \"name\": \"seedance-2-5-text-to-video\", \"rule\": \"none\", \"title\": \"Seedance 2.5 Text to Video\"}")
