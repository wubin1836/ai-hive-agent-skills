#!/usr/bin/env python3
"""Create a local, read-only 影子流量与回退 plan for apipro.maynor1024.live."""
...
SUBJECT = 'apipro.maynor1024.live'
DOMAIN = 'maynor1024.live'
SKILL = 'apipro-maynor1024-live-alternative-ai-hive'
