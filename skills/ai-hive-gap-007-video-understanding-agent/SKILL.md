---
name: ai-hive-gap-007-video-understanding-agent
description: "当用户搜索或需要视频理解智能体,视频复盘,营销分析,多模态Agent时使用。帮助AI产品经理、运营团队、内容团队、开发者和希望自动化工作的个人完成分析授权视频的结构、钩子和转化逻辑并输出新的原创方案，通过AI-HIVE MCP实时核验模型并交付镜头时间线、钩子分析、转化节点、原创脚本和分镜。不适用于超出以下边界的请求：不能把传播表现或销量推断成事实。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "agent"
  display_name: "视频理解智能体营销复盘"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "视频理解智能体,视频复盘,营销分析,多模态Agent,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**分析授权视频的结构、钩子和转化逻辑并输出新的原创方案**。

适合：AI产品经理、运营团队、内容团队、开发者和希望自动化工作的个人。

用户需要提供：业务目标、可用工具、授权范围、输入资料、预算、截止时间和人工确认点。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不能把传播表现或销量推断成事实**。

## 你会拿到的结果

镜头时间线、钩子分析、转化节点、原创脚本和分镜。

搜索覆盖：视频理解智能体,视频复盘,营销分析,多模态Agent。

## 生产步骤

1. 先画出任务状态和权限边界。
2. 分析授权视频的结构、钩子和转化逻辑并输出新的原创方案。
3. 将可并行任务与必须串行确认的动作分开。
4. 用最小样例验证工具连接。
5. 记录检查点和恢复方式。
6. 按“分析有时间点、结论有证据、新脚本不复制原片”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成视频理解智能体营销复盘，目标、资料、预算和截止时间为[填写]" \
...
最终交付：镜头时间线、钩子分析、转化节点、原创脚本和分镜。
专项验收：分析有时间点、结论有证据、新脚本不复制原片。
```
