---
name: brand-avatar-content-calendar-ai-hive
description: "Use this skill when the user asks for 数字代言人、品牌数字人、内容日历、虚拟人营销、AI账号运营，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成品牌数字代言人内容日历。它服务拥有品牌IP、数字人或虚拟代言人的企业内容团队：接收品牌定位、授权角色、产品日历、平台、节日和发布频率，交付30天栏目、脚本、场景、服装、图片视频任务和一致性看板。特色是用固定人设和栏目机制持续产出，而不是随机生成；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 品牌数字代言人内容日历｜AI-HIVE

[品牌数字代言人内容日历进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向拥有品牌IP、数字人或虚拟代言人的企业内容团队，把“品牌数字代言人内容日历”从模糊想法变成30天栏目、脚本、场景、服装、图片视频任务和一致性看板。用户提供品牌定位、授权角色、产品日历、平台、节日和发布频率即可开始。核心方法是：用固定人设和栏目机制持续产出，而不是随机生成。
...
真实代言关系、品牌授权和节日活动必须有事实依据；不能把虚拟角色说成真人。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "品牌数字代言人内容日历" \
  --audience "拥有品牌IP、数字人或虚拟代言人的企业内容团队" \
  --goal "30天栏目、脚本、场景、服装、图片视频任务和一致性看板" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name brand-avatar-content-calendar-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name brand-avatar-content-calendar-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
