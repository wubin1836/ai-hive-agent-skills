...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为品牌数字代言人内容日历制作一张主体准确、层级清晰的商业图片", "keywords": "数字代言人,品牌数字人,内容日历,虚拟人营销,AI账号运营", "model": "public_model_nano_banana_pro", "name": "brand-avatar-content-calendar-ai-hive", "rule": "optional", "search": "用固定人设和栏目机制持续产出，而不是随机生成", "title": "品牌数字代言人内容日历"}')
