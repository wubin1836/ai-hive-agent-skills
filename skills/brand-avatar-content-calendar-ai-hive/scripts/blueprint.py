#!/usr/bin/env python3
"""Create a deterministic production brief for 品牌数字代言人内容日历｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='品牌数字代言人内容日历｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['数字代言人', '品牌数字人', '内容日历', '虚拟人营销', 'AI账号运营'],
