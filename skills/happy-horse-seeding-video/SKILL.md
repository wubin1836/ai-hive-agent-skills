---
name: happy-horse-seeding-video
description: "Use this skill when creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers need to produce authentic product discovery and recommendation content with Happy Horse through the AI Hive OpenAPI. It handles required media uploads, live model and price lookup, task submission, progress polling, and result downloads. Useful for ads, TVCs, product videos, e-commerce listings, social commerce, UGC-style seeding content, short dramas, motion comics, and storyboards. Search intents include social seeding, product recommendation, UGC ad, creator content."
license: MIT
---

# Happy Horse Social Seeding Video

## Overview

Happy Horse Social Seeding Video helps creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers produce authentic product discovery and recommendation content with Happy Horse. Describe the intended subject, action, camera, lighting, pacing, and constraints; the bundled CLI handles AI Hive OpenAPI calls and downloads the finished video.
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name happy-horse-seeding-video
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode i2v \
  --prompt "Happy Horse Social Seeding Video: polished motion, clear subject, coherent action, stable camera, commercial finish"
```
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode i2v \
  --prompt "Create a polished happy horse social seeding video result with coherent motion, stable identity, and a clear ending"
```
