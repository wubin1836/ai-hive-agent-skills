...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Seedance 2.0 完成高质量图生视频，动作连续，镜头稳定", "fixed_mode": "i2v", "keywords": "Seedance2.0、Seedance 2、Seedance2、Seed Dance 2.0、字节 Seedance、图生视频、图片生成视频、图片转视频、image to video、I2V、首帧生视频、AI视频、视频生成", "models": {"i2v": "public_model_seedance_i2v"}, "name": "seedance-2-0-image-to-video", "rule": "first", "search": "固定调用 Seedance 2.0 的图生视频裸接口能力", "title": "Seedance 2.0 图生视频"}')
