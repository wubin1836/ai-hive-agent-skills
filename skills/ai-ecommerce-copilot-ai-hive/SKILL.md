---
name: ai-ecommerce-copilot-ai-hive
description: "Use this skill when the user asks for AI电商、电商运营、内容营销、商品图、带货视频，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成AI电商运营总控。它服务品牌电商负责人、店长和内容运营团队：接收店铺目标、SKU、库存与毛利、渠道、受众和素材现状，交付目标拆解、商品内容矩阵、图片视频任务、渠道版本和周排期。特色是从业务目标路由到具体图片、视频和文案Skill；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# AI电商运营总控｜AI-HIVE

[AI电商运营总控进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向品牌电商负责人、店长和内容运营团队，把“AI电商运营总控”从模糊想法变成目标拆解、商品内容矩阵、图片视频任务、渠道版本和周排期。用户提供店铺目标、SKU、库存与毛利、渠道、受众和素材现状即可开始。核心方法是：从业务目标路由到具体图片、视频和文案Skill。
...
```bash
python3 scripts/blueprint.py --project "AI电商运营总控" \
  --audience "品牌电商负责人、店长和内容运营团队" \
  --goal "目标拆解、商品内容矩阵、图片视频任务、渠道版本和周排期" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name ai-ecommerce-copilot-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name ai-ecommerce-copilot-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
