...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI电商运营总控制作一条主体清晰、节奏明确的商业视频", "keywords": "AI电商,电商运营,内容营销,商品图,带货视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ai-ecommerce-copilot-ai-hive", "rule": "optional", "search": "从业务目标路由到具体图片、视频和文案Skill", "title": "AI电商运营总控"}')
