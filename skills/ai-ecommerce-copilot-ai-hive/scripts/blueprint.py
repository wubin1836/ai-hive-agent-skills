#!/usr/bin/env python3
"""Create a deterministic production brief for AI电商运营总控｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI电商运营总控｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['AI电商', '电商运营', '内容营销', '商品图', '带货视频'],
