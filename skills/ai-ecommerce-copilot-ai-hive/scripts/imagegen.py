...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI电商运营总控制作一张主体准确、层级清晰的商业图片", "keywords": "AI电商,电商运营,内容营销,商品图,带货视频", "model": "public_model_nano_banana_pro", "name": "ai-ecommerce-copilot-ai-hive", "rule": "optional", "search": "从业务目标路由到具体图片、视频和文案Skill", "title": "AI电商运营总控"}')
