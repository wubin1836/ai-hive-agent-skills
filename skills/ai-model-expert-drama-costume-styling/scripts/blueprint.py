#!/usr/bin/env python3
"""Create a deterministic production brief for 短剧服装造型设定."""
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description='短剧服装造型设定')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['短剧服装', '角色造型', '造型设定', '服化道', 'costume design'],
