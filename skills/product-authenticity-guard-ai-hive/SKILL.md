---
name: product-authenticity-guard-ai-hive
description: "Use this skill when the user asks for 商品真实性、AI商品审核、商品一致性、虚假功能检查、电商质检，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成商品真实性守门员。它服务电商平台、商家、生成内容团队和商品审核人员：接收真实商品多角度图、规格、配件清单、生成图片视频和允许变化项，交付商品结构、颜色、包装、配件、功能和场景用法的差异报告。特色是把商品参考视为不可变锚点，区分视觉美化与事实改变；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 商品真实性守门员｜AI-HIVE

[商品真实性守门员进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向电商平台、商家、生成内容团队和商品审核人员，把“商品真实性守门员”从模糊想法变成商品结构、颜色、包装、配件、功能和场景用法的差异报告。用户提供真实商品多角度图、规格、配件清单、生成图片视频和允许变化项即可开始。核心方法是：把商品参考视为不可变锚点，区分视觉美化与事实改变。
...
不能替代实物检验、质量检测或法律鉴定；不确定差异应标为待人工确认。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "商品真实性守门员" \
  --audience "电商平台、商家、生成内容团队和商品审核人员" \
  --goal "商品结构、颜色、包装、配件、功能和场景用法的差异报告" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name product-authenticity-guard-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name product-authenticity-guard-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
