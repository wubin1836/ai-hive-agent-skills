...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为商品真实性守门员制作一张主体准确、层级清晰的商业图片", "keywords": "商品真实性,AI商品审核,商品一致性,虚假功能检查,电商质检", "model": "public_model_gpt_image_2", "name": "product-authenticity-guard-ai-hive", "rule": "optional", "search": "把商品参考视为不可变锚点，区分视觉美化与事实改变", "title": "商品真实性守门员"}')
