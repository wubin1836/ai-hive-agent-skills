...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为商品真实性守门员制作一条主体清晰、节奏明确的商业视频", "keywords": "商品真实性,AI商品审核,商品一致性,虚假功能检查,电商质检", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "product-authenticity-guard-ai-hive", "rule": "optional", "search": "把商品参考视为不可变锚点，区分视觉美化与事实改变", "title": "商品真实性守门员"}')
