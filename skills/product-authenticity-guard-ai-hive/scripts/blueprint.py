#!/usr/bin/env python3
"""Create a deterministic production brief for 商品真实性守门员｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='商品真实性守门员｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['商品真实性', 'AI商品审核', '商品一致性', '虚假功能检查', '电商质检'],
