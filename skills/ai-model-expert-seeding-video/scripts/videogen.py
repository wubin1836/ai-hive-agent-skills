...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一条可投放的种草视频，品牌信息清晰，画面有记忆点", "keywords": "种草视频、小红书种草、抖音种草、社媒种草、好物推荐、UGC种草、Seedance、MiniMax H3、Happy Horse、AI视频", "models": {"i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "seeding-video", "rule": "optional", "search": "通用商业场景搜索入口，底层调用 AI Hive 裸接口", "title": "种草视频"}')
