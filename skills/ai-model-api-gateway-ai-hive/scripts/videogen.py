...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI大模型API企业网关制作一条主体清晰、节奏明确的商业视频", "keywords": "AI API网关,大模型中转站,模型聚合,OpenAPI,MCP", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ai-model-api-gateway-ai-hive", "rule": "optional", "search": "统一图片视频模型接入，并保留价格快照与任务状态", "title": "AI大模型API企业网关"}')
