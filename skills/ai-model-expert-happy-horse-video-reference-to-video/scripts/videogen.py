...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Happy Horse 完成高质量参考视频生视频，动作连续，镜头稳定", "fixed_mode": "r2v", "keywords": "Happy Horse、HappyHorse、Happyhorse、快乐马、通义万相视频、参考视频生视频、视频参考生视频、参考视频生成视频、动作参考、运镜参考、AI视频、视频生成", "models": {"r2v": "public_model_happyhorse_r2v"}, "name": "happy-horse-video-reference-to-video", "rule": "video", "search": "固定调用 Happy Horse 的参考视频生视频裸接口能力", "title": "Happy Horse 参考视频生视频"}')
