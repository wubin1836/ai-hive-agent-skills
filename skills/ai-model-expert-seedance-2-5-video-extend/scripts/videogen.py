...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "延续原视频动作和镜头方向，自然扩展场景并保持人物一致", "fixed_mode": "extend", "keywords": "Seedance2.5、Seedance 2.5、字节 Seedance、豆包 Seedance、即梦视频、视频延长、视频续写、向前延长、向后延长、扩展视频、video extend", "models": {"extend": "public_model_seedance_2_5_video_extend"}, "name": "seedance-2-5-video-extend", "rule": "extend", "search": "固定调用 Seedance 2.5 视频延长裸接口", "title": "Seedance 2.5 视频延长"}')
