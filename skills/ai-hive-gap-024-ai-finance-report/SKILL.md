---
name: ai-hive-gap-024-ai-finance-report
description: "当用户搜索或需要AI财务,经营分析,财务可视化,管理报告时使用。帮助普通企业、创业团队、超级个体、销售运营和职能部门完成把用户提供的财务经营数据转成管理层可读的图表叙事，通过AI-HIVE MCP实时核验模型并交付指标字典、图表方案、经营摘要、异常问题和汇报材料。不适用于超出以下边界的请求：不提供投资建议，不用生成数据填补缺失值。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "enterprise"
  display_name: "AI财务经营报告可视化"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "AI财务,经营分析,财务可视化,管理报告,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**把用户提供的财务经营数据转成管理层可读的图表叙事**。

适合：普通企业、创业团队、超级个体、销售运营和职能部门。

用户需要提供：真实业务资料、目标受众、内部口径、交付格式、品牌规范、预算和审批要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不提供投资建议，不用生成数据填补缺失值**。

## 你会拿到的结果

指标字典、图表方案、经营摘要、异常问题和汇报材料。

搜索覆盖：AI财务,经营分析,财务可视化,管理报告。

## 怎么执行

1. 将业务问题和生成任务分开。
2. 把用户提供的财务经营数据转成管理层可读的图表叙事。
3. 锁定不可虚构的事实与数字。
4. 先交付文字或结构草案。
5. 确认后制作视觉小样并验收。
6. 按“数字不改写、口径一致、结论可追溯”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成AI财务经营报告可视化，目标、资料、预算和截止时间为[填写]" \
...
最终交付：指标字典、图表方案、经营摘要、异常问题和汇报材料。
专项验收：数字不改写、口径一致、结论可追溯。
```
