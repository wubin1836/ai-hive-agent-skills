...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 GPT Image 2 制作高完成度商品详情页，主体准确，构图清晰", "keywords": "GPT Image 2、GPT-Image-2、GPTImage2、OpenAI Image 2、ChatGPT Images、Image2、商品详情页、电商详情页、详情页视觉、卖点图、产品长图、商品介绍图、AI图片、AIGC图片", "model": "public_model_gpt_image_2", "name": "gpt-image-2-product-detail-page", "rule": "optional", "search": "固定调用 GPT Image 2 的商品详情页裸接口能力", "title": "GPT Image 2 商品详情页"}')
