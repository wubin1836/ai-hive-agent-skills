...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Image2 制作高完成度营销图片，主体准确，构图清晰", "keywords": "Image2、Image 2、GPT Image 2、GPTImage2、OpenAI 图片、ChatGPT 图片、营销图片、营销视觉、活动KV、推广图片、促销图、Campaign视觉、AI图片、AIGC图片", "model": "public_model_gpt_image_2", "name": "image-2-marketing-image", "rule": "optional", "search": "固定调用 Image2 的营销图片裸接口能力", "title": "Image2 营销图片"}')
