#!/usr/bin/env python3
"""Create a deterministic production brief for 评论区痛点转广告｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='评论区痛点转广告｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['评论区洞察', '评论转广告', '用户痛点', '短视频选题', '电商增长'],
