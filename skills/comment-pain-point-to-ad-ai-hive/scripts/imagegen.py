...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为评论区痛点转广告制作一张主体准确、层级清晰的商业图片", "keywords": "评论区洞察,评论转广告,用户痛点,短视频选题,电商增长", "model": "public_model_nano_banana_pro", "name": "comment-pain-point-to-ad-ai-hive", "rule": "optional", "search": "把真实问题变成内容选题，不把抱怨直接当作营销话术", "title": "评论区痛点转广告"}')
