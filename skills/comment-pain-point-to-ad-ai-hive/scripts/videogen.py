...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为评论区痛点转广告制作一条主体清晰、节奏明确的商业视频", "keywords": "评论区洞察,评论转广告,用户痛点,短视频选题,电商增长", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "comment-pain-point-to-ad-ai-hive", "rule": "optional", "search": "把真实问题变成内容选题，不把抱怨直接当作营销话术", "title": "评论区痛点转广告"}')
