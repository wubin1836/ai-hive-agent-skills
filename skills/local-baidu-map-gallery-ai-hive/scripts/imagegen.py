...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为百度地图门店图册营销制作事实可核验的本地生活营销图片", "model": "public_model_nano_banana_pro", "name": "local-baidu-map-gallery-ai-hive", "title": "AI大模型专家｜百度地图门店图册营销", "keywords": "百度地图、百度地图商家、百度地图门店、百度POI、百度地图营销、门店图册营销、本地生活、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前模型与价格，并在平台官方后台核对当前规则"}')
