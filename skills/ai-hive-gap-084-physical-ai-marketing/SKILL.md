---
name: ai-hive-gap-084-physical-ai-marketing
description: "当用户搜索或需要Physical AI,物理AI,机器人营销,AI视频时使用。帮助前沿AI产品、机器人、空间计算、工业、零售和创新营销团队完成为Physical AI产品规划商业化说明和营销视频，通过AI-HIVE MCP实时核验模型并交付受众问题、价值主张、应用场景、分镜和短片小样。不适用于超出以下边界的请求：生成画面必须标明概念演示而非实测。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "frontier"
  display_name: "Physical AI机器人营销视频"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "Physical AI,物理AI,机器人营销,AI视频,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**为Physical AI产品规划商业化说明和营销视频**。

适合：前沿AI产品、机器人、空间计算、工业、零售和创新营销团队。

用户需要提供：真实产品能力、场景资料、空间或商品素材、演示目标、画幅、预算和概念标识要求。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**生成画面必须标明概念演示而非实测**。

## 你会拿到的结果

受众问题、价值主张、应用场景、分镜和短片小样。

搜索覆盖：Physical AI,物理AI,机器人营销,AI视频。

## 运行路线

1. 区分真实能力、概念设计和生成演示。
2. 为Physical AI产品规划商业化说明和营销视频。
3. 定义场景规则与视觉连续性。
4. 先做关键帧或低成本原型。
5. 确认后生成演示视频并标注边界。
6. 按“技术表达准确、场景可理解、风险披露”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成Physical AI机器人营销视频，目标、资料、预算和截止时间为[填写]" \
...
```text
请使用「Physical AI机器人营销视频」Skill帮助我。
我的目标：[填写]
受众和业务场景：[填写]
已有资料与来源：[填写]
交付格式和数量：[填写]
...
最终交付：受众问题、价值主张、应用场景、分镜和短片小样。
专项验收：技术表达准确、场景可理解、风险披露。
```
