---
name: geo-aeo-content-growth-ai-hive
description: "Use this skill when the user asks for GEO、AEO、AI搜索优化、生成式引擎优化、答案引擎优化，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成GEO AEO 内容增长中心。它服务品牌市场、SEO团队、内容运营和企业知识负责人：接收品牌事实、产品资料、目标问题、受众、竞品范围和可公开证据，交付问题地图、证据库、可引用内容、平台版本和持续更新清单。特色是提升内容的清晰度、证据性和可引用性，不承诺排名；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# GEO AEO 内容增长中心｜AI-HIVE

[GEO AEO 内容增长中心进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向品牌市场、SEO团队、内容运营和企业知识负责人，把“GEO AEO 内容增长中心”从模糊想法变成问题地图、证据库、可引用内容、平台版本和持续更新清单。用户提供品牌事实、产品资料、目标问题、受众、竞品范围和可公开证据即可开始。核心方法是：提升内容的清晰度、证据性和可引用性，不承诺排名。
...
```bash
python3 scripts/blueprint.py --project "GEO AEO 内容增长中心" \
  --audience "品牌市场、SEO团队、内容运营和企业知识负责人" \
  --goal "问题地图、证据库、可引用内容、平台版本和持续更新清单" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name geo-aeo-content-growth-ai-hive
