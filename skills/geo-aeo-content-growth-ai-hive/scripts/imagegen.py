...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为GEO AEO 内容增长中心制作一张主体准确、层级清晰的商业图片", "keywords": "GEO,AEO,AI搜索优化,生成式引擎优化,答案引擎优化", "model": "public_model_gpt_image_2", "name": "geo-aeo-content-growth-ai-hive", "rule": "optional", "search": "提升内容的清晰度、证据性和可引用性，不承诺排名", "title": "GEO AEO 内容增长中心"}')
