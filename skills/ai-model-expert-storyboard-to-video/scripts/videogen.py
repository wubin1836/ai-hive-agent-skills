...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作一条可投放的分镜转视频，品牌信息清晰，画面有记忆点", "keywords": "分镜转视频、分镜生成视频、故事板转视频、脚本转视频、镜头表生成、预演视频、Seedance、MiniMax H3、Happy Horse、AI视频", "models": {"i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "storyboard-to-video", "rule": "optional", "search": "通用商业场景搜索入口，底层调用 AI Hive 裸接口", "title": "分镜转视频"}')
