...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为口播视频去废话精剪制作一条主体清晰、节奏明确的商业视频", "keywords": "口播精剪,去废话,自动剪辑,视频删停顿,知识短视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "talking-video-silence-cut-ai-hive", "rule": "optional", "search": "删除重复、停顿和偏题，但保留论证逻辑和说话人语气", "title": "口播视频去废话精剪"}')
