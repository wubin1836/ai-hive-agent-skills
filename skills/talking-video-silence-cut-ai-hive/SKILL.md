---
name: talking-video-silence-cut-ai-hive
description: "Use this skill when the user asks for 口播精剪、去废话、自动剪辑、视频删停顿、知识短视频，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成口播视频去废话精剪。它服务知识博主、企业讲师、销售和短视频口播团队：接收原始口播视频、转写稿（如有）、目标时长、平台和必须保留内容，交付保留段落、删除建议、时间码、节奏重排、字幕与竖版成片。特色是删除重复、停顿和偏题，但保留论证逻辑和说话人语气；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 口播视频去废话精剪｜AI-HIVE

[口播视频去废话精剪进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向知识博主、企业讲师、销售和短视频口播团队，把“口播视频去废话精剪”从模糊想法变成保留段落、删除建议、时间码、节奏重排、字幕与竖版成片。用户提供原始口播视频、转写稿（如有）、目标时长、平台和必须保留内容即可开始。核心方法是：删除重复、停顿和偏题，但保留论证逻辑和说话人语气。
...
不自动删除可能改变语义的否定、限制和风险提示；最终剪辑由用户确认。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "口播视频去废话精剪" \
  --audience "知识博主、企业讲师、销售和短视频口播团队" \
  --goal "保留段落、删除建议、时间码、节奏重排、字幕与竖版成片" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name talking-video-silence-cut-ai-hive
