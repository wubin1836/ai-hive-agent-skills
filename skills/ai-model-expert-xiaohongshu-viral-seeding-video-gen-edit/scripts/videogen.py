...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "小红书真实体验式种草视频，从使用痛点切入，展示开箱、细节和使用过程，以生活化结果收尾", "keywords": "小红书爆款、小红书种草、RED、XHS、好物分享、真实体验、UGC种草视频", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "xiaohongshu-viral-seeding-video-generation-editing", "product_promise": "按小红书真实体验、生活方式和收藏分享逻辑生成种草视频，避免硬广感并保留品牌准确性", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "小红书爆款种草视频生成与编辑", "trend_inspired": true}')
