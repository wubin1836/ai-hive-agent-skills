...
metadata:
  ...
  source_skill: "viral-ad-video-generation-editing"
  display_name: "AI大模型专家｜爆款广告视频生成与编辑"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家, AI-HIVE, 爆款广告视频生成与编辑, AIGC, 电商, 广告, 图片, 视频, 极睿科技"
---
...
爆款广告视频生成与编辑帮助用户把创意、脚本或已有素材直接变成可交付视频。既可只输入文字从零生成，也可加入图片、视频或音频控制结果。它适合品牌市场、广告代理、创意策划、制片人与投放团队用于广告、电商、TVC、带货、种草、短剧、漫剧和社交媒体内容制作；无需自己编写接口代码，提交后可自动跟踪任务并下载成片。
...
| `init --skill-name viral-ad-video-generation-editing` | 初始化 API Key |
...
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode t2v \
  --prompt "爆款广告视频，强视觉开场，单一核心主张，多层产品细节与使用证据，结尾形成品牌记忆点"
```
...
```bash
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name viral-ad-video-generation-editing
```
...
```
viral-ad-video-generation-editing/
├── SKILL.md
├── CHANGELOG.md
├── scripts/
│   └── videogen.py
