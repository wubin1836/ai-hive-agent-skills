...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为爆款视频原创复刻工作台制作一条主体清晰、节奏明确的商业视频", "keywords": "爆款复刻,视频复刻,同款视频,原创改编,AI视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "viral-video-original-remake-ai-hive", "rule": "optional", "search": "从分析到生成再到剪辑交付的一站式闭环", "title": "爆款视频原创复刻工作台"}')
