#!/usr/bin/env python3
"""Create a deterministic production brief for 爆款视频原创复刻工作台｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='爆款视频原创复刻工作台｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['爆款复刻', '视频复刻', '同款视频', '原创改编', 'AI视频'],
