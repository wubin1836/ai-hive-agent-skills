---
name: viral-video-original-remake-ai-hive
description: "Use this skill when the user asks for 爆款复刻、视频复刻、同款视频、原创改编、AI视频，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成爆款视频原创复刻工作台。它服务电商商家、创意团队和规模化内容生产者：接收授权参考视频、商品素材、品牌规范、受众和投放渠道，交付拆解报告、差异化创意、逐镜提示词、生成任务与成片验收表。特色是从分析到生成再到剪辑交付的一站式闭环；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 爆款视频原创复刻工作台｜AI-HIVE

[爆款视频原创复刻工作台进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向电商商家、创意团队和规模化内容生产者，把“爆款视频原创复刻工作台”从模糊想法变成拆解报告、差异化创意、逐镜提示词、生成任务与成片验收表。用户提供授权参考视频、商品素材、品牌规范、受众和投放渠道即可开始。核心方法是：从分析到生成再到剪辑交付的一站式闭环。
...
```bash
python3 scripts/blueprint.py --project "爆款视频原创复刻工作台" \
  --audience "电商商家、创意团队和规模化内容生产者" \
  --goal "拆解报告、差异化创意、逐镜提示词、生成任务与成片验收表" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name viral-video-original-remake-ai-hive
