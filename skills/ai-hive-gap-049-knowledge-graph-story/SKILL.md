---
name: ai-hive-gap-049-knowledge-graph-story
description: "当用户搜索或需要知识图谱,可视化叙事,关系图,数据故事时使用。帮助企业知识管理、研究、培训、销售、客服和个人知识创作者完成把实体关系和时间线转成可理解的视觉故事，通过AI-HIVE MCP实时核验模型并交付关系摘要、时间线、图表结构、解说稿和视觉方案。不适用于超出以下边界的请求：不从相关关系推断因果关系。"
license: MIT
metadata:
  language: "zh-CN"
  platform: "AI-HIVE"
  ...
  category: "knowledge"
  display_name: "知识图谱可视化叙事"
  homepage: "https://ai-hive.iclip.cn/chat"
  search_tags: "知识图谱,可视化叙事,关系图,数据故事,AI-HIVE,AI Hive,大模型,多模态,MCP,AIGC,模型路由,图片生成,视频生成"
...
这个 Skill 解决的具体问题是：**把实体关系和时间线转成可理解的视觉故事**。

适合：企业知识管理、研究、培训、销售、客服和个人知识创作者。

用户需要提供：有权使用的文档、知识库导出、来源链接、目标受众、内容格式和更新日期。

不满足条件时先返回缺失项，不启动付费生成。专项边界：**不从相关关系推断因果关系**。

## 你会拿到的结果

关系摘要、时间线、图表结构、解说稿和视觉方案。

搜索覆盖：知识图谱,可视化叙事,关系图,数据故事。

## 交付路径

1. 建立资料索引与可信度层级。
2. 把实体关系和时间线转成可理解的视觉故事。
3. 把事实、观点和生成建议分层。
4. 每个结论保留来源位置。
5. 确认知识结构后再生成多模态内容。
6. 按“关系准确、层次清楚、叙事不误导”完成专项验收。
...
python3 scripts/plan.py \
  --brief "我要完成知识图谱可视化叙事，目标、资料、预算和截止时间为[填写]" \
...
最终交付：关系摘要、时间线、图表结构、解说稿和视觉方案。
专项验收：关系准确、层次清楚、叙事不误导。
```
