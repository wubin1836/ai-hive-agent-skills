#!/usr/bin/env python3
"""Create a deterministic production brief for AI图片提示词大师｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI图片提示词大师｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['AI图片提示词', '生图提示词', 'Prompt', '文生图', '图生图'],
