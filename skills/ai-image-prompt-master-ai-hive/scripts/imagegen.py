...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI图片提示词大师制作一张主体准确、层级清晰的商业图片", "keywords": "AI图片提示词,生图提示词,Prompt,文生图,图生图", "model": "public_model_gpt_image_2", "name": "ai-image-prompt-master-ai-hive", "rule": "optional", "search": "把模糊需求翻译成可审查的视觉变量", "title": "AI图片提示词大师"}')
