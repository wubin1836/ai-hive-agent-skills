---
name: ai-hive-folk-genealogy-table
description: "家谱电子化与世系图生成器，用于家谱整理、族谱电子版、家谱世系图。读取你授权的原始资料，完成人物—世代—关系—页码来源表，并交付世系草图与缺页、异名、冲突核对单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。"
metadata:
  display_name: "家谱电子化与世系图生成器"
  version: "1.0.0"
...
家谱电子化与世系图生成器，用于家谱整理、族谱电子版、家谱世系图。读取你授权的原始资料，完成人物—世代—关系—页码来源表，并交付世系草图与缺页、异名、冲突核对单。可结合AI-HIVE中经核验可用的模型辅助整理，文件处理与校验由宿主工具完成。仅供传统文化与娱乐参考，尊重科学；相关解读不是科学预测，不作为投资、医疗、法律或婚姻等重大决策依据。
...
1. 逐页编号并保留原图，不改原件
2. 录入明确关系，疑字和口述信息单列
3. 按世代及来源核查重名、跨页和重复关系
4. 由家人复核后交付带证据链接的草稿

## 文件处理环节

1. 逐页OCR保留坐标与疑字
2. 关系表脚本检查重复人物、关系环和世代冲突
3. 生成谱系JSON及关系图→PDF回读抽检
...
- `family-tree.json`
- `genealogy-evidence.csv`
- `family-tree-review.pdf`
...
家谱整理、族谱电子版、家谱世系图、族谱照片转表格、家谱缺页、字辈整理
