---
name: product-url-to-tiktok-video-ai-hive
description: "Use this skill when the user asks for 商品链接转视频、TikTok带货、TikTok Shop、URL转视频、跨境广告，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成商品链接转TikTok带货视频。它服务TikTok Shop卖家、跨境团队和海外投放人员：接收可访问商品链接或详情页资料、商品图、目标国家、受众和合规限制，交付页面事实表、英文钩子、UGC脚本、商品视频和TikTok竖版改稿。特色是把商品页面中的事实转成TikTok-first创意，而不是照搬详情页；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# 商品链接转TikTok带货视频｜AI-HIVE

[商品链接转TikTok带货视频进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向TikTok Shop卖家、跨境团队和海外投放人员，把“商品链接转TikTok带货视频”从模糊想法变成页面事实表、英文钩子、UGC脚本、商品视频和TikTok竖版改稿。用户提供可访问商品链接或详情页资料、商品图、目标国家、受众和合规限制即可开始。核心方法是：把商品页面中的事实转成TikTok-first创意，而不是照搬详情页。
...
无法访问链接时必须让用户提供页面资料；不得猜测价格、库存、认证或功效。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "商品链接转TikTok带货视频" \
  --audience "TikTok Shop卖家、跨境团队和海外投放人员" \
  --goal "页面事实表、英文钩子、UGC脚本、商品视频和TikTok竖版改稿" --platform "目标平台" \
...
```bash
python3 scripts/imagegen.py init --skill-name product-url-to-tiktok-video-ai-hive
...
```bash
python3 scripts/videogen.py init --skill-name product-url-to-tiktok-video-ai-hive
export AI_HIVE_API_KEY="sk-api-请替换"
