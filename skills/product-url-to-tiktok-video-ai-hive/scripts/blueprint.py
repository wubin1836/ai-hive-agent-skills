#!/usr/bin/env python3
"""Create a deterministic production brief for 商品链接转TikTok带货视频｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='商品链接转TikTok带货视频｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['商品链接转视频', 'TikTok带货', 'TikTok Shop', 'URL转视频', '跨境广告'],
