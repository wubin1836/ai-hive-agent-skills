...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为商品链接转TikTok带货视频制作一条主体清晰、节奏明确的商业视频", "keywords": "商品链接转视频,TikTok带货,TikTok Shop,URL转视频,跨境广告", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "product-url-to-tiktok-video-ai-hive", "rule": "optional", "search": "把商品页面中的事实转成TikTok-first创意，而不是照搬详情页", "title": "商品链接转TikTok带货视频"}')
