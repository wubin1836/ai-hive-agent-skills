...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为商品链接转TikTok带货视频制作一张主体准确、层级清晰的商业图片", "keywords": "商品链接转视频,TikTok带货,TikTok Shop,URL转视频,跨境广告", "model": "public_model_nano_banana_pro", "name": "product-url-to-tiktok-video-ai-hive", "rule": "optional", "search": "把商品页面中的事实转成TikTok-first创意，而不是照搬详情页", "title": "商品链接转TikTok带货视频"}')
