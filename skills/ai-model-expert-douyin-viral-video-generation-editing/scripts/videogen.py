...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "抖音竖屏爆款视频，第一秒出现视觉钩子，快速切换产品细节和使用动作，结尾突出评论互动与购买理由", "keywords": "抖音爆款、抖音短视频、巨量千川、商品卡、抖音带货、抖音信息流、完播率", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "douyin-viral-video-generation-editing", "product_promise": "按抖音的强钩子、快节奏、完播和互动逻辑生成成片，适合自然流、商品卡与千川素材", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "抖音爆款短视频生成与编辑", "trend_inspired": true}')
