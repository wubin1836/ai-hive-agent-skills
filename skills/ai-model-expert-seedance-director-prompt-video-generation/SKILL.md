...
metadata:
  ...
  source_skill: "seedance-director-prompt-video-generation"
  display_name: "AI大模型专家｜Seedance 导演提示词与视频生成"
  homepage: https://ai-hive.iclip.cn/chat
  search_tags: "AI大模型专家, AI-HIVE, Seedance 导演提示词与视频生成, AIGC, 电商, 广告, 图片, 视频, 极睿科技"
---

# AI大模型专家｜Seedance 导演提示词与视频生成
