---
name: ai-asmr-product-video-ai-hive
description: "Use this skill when the user asks for AI ASMR、商品ASMR、视觉ASMR、解压视频、产品广告，或要为电商、广告、营销、短剧、漫剧、带货与种草内容完成AI ASMR商品视频。它服务食品、美妆、家居、3C和视觉内容创作者：接收商品图、材质、允许动作、场景、画幅、时长和声音要求，交付微距动作、材质反馈、镜头节拍、视频提示词和声音设计清单。特色是用微距、重复、材质和精确动作制造视觉满足感；需要生成素材时通过AI-HIVE OpenAPI完成配置查询、参考素材上传、价格快照、COST_FIRST/SPEED_FIRST/SUCCESS_FIRST路由、异步轮询和下载。不要把本Skill用于未授权复刻、虚假商品声明、伪造用户证言或规避平台规则。"
---
# AI ASMR商品视频｜AI-HIVE

[AI ASMR商品视频进入 AI-HIVE](https://ai-hive.iclip.cn/chat)

## 一句话解决什么

面向食品、美妆、家居、3C和视觉内容创作者，把“AI ASMR商品视频”从模糊想法变成微距动作、材质反馈、镜头节拍、视频提示词和声音设计清单。用户提供商品图、材质、允许动作、场景、画幅、时长和声音要求即可开始。核心方法是：用微距、重复、材质和精确动作制造视觉满足感。
...
不得表现不安全的食品、化学或电器操作；若模型不生成声音，只交付声音设计建议。 不能确认的事实必须标记为待核验，不能用模型输出替代真实产品、平台数据、专业检测或法律意见。
...
```bash
python3 scripts/blueprint.py --project "AI ASMR商品视频" \
  --audience "食品、美妆、家居、3C和视觉内容创作者" \
  --goal "微距动作、材质反馈、镜头节拍、视频提示词和声音设计清单" --platform "目标平台" \
...
```bash
python3 scripts/videogen.py init --skill-name ai-asmr-product-video-ai-hive
