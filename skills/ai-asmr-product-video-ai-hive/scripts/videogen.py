...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为AI ASMR商品视频制作一条主体清晰、节奏明确的商业视频", "keywords": "AI ASMR,商品ASMR,视觉ASMR,解压视频,产品广告", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "ai-asmr-product-video-ai-hive", "rule": "optional", "search": "用微距、重复、材质和精确动作制造视觉满足感", "title": "AI ASMR商品视频"}')
