#!/usr/bin/env python3
"""Create a deterministic production brief for AI ASMR商品视频｜AI-HIVE."""
import argparse
import json
from pathlib import Path

def main() -> None:
    parser = argparse.ArgumentParser(description='AI ASMR商品视频｜AI-HIVE')
    ...
    data = {
        ...
        "format": args.format,
        "searchAliases": ['AI ASMR', '商品ASMR', '视觉ASMR', '解压视频', '产品广告'],
