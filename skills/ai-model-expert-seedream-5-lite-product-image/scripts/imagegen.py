...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "使用 Seedream 5.0 Lite 制作高完成度产品图生成，主体准确，构图清晰", "keywords": "Seedream 5.0 Lite、Seedream 5 Lite、Seedream5、即梦图片 5、字节图片模型、产品图生成、产品图、商品图、商业摄影、商品场景图、产品渲染、AI图片、AIGC图片", "model": "public_model_seedream_5_0_lite", "name": "seedream-5-lite-product-image", "rule": "optional", "search": "固定调用 Seedream 5.0 Lite 的产品图生成裸接口能力", "title": "Seedream 5.0 Lite 产品图生成"}')
