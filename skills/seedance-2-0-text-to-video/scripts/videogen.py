...
SKILL_CONFIG = json.loads("{\"fixed_mode\": \"t2v\", \"models\": {\"t2v\": \"public_model_seedance_t2v\"}, \"name\": \"seedance-2-0-text-to-video\", \"rule\": \"none\", \"title\": \"Seedance 2.0 Text to Video\"}")
