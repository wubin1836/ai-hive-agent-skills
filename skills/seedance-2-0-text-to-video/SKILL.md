...
description: "Use this skill when creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers need to turn a written brief into an AI video with Seedance 2.0 through the AI Hive OpenAPI. It handles required media uploads, live model and price lookup, task submission, progress polling, and result downloads. Useful for ads, TVCs, product videos, e-commerce listings, social commerce, UGC-style seeding content, short dramas, motion comics, and storyboards. Search intents include text-to-video, T2V, prompt-to-video, AI video generation."
license: MIT
---
...
Seedance 2.0 Text to Video helps creators, video editors, advertisers, e-commerce teams, social-commerce teams, and short-form story producers turn a written brief into an AI video with Seedance 2.0. Describe the intended subject, action, camera, lighting, pacing, and constraints; the bundled CLI handles AI Hive OpenAPI calls and downloads the finished video.
...
Ads, tvcs, product videos, e-commerce listings, social commerce, ugc-style seeding content, short dramas, motion comics, and storyboards. It is also useful when users search for text-to-video, T2V, prompt-to-video, AI video generation.
...
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name seedance-2-0-text-to-video
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode t2v \
  --prompt "Seedance 2.0 Text to Video: polished motion, clear subject, coherent action, stable camera, commercial finish"
```
...
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode t2v \
  --prompt "Create a polished seedance 2.0 text to video result with coherent motion, stable identity, and a clear ending"
```
...
```bash
python3 "$SKILL_PATH/scripts/videogen.py" generate --mode t2v --prompt "Complex production brief" --no-download
