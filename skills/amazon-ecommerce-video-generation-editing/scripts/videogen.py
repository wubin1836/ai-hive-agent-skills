...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生、图生、参考生、原生视频编辑与视频延长，可按平台用途生产和改版", "example": "制作一条适合Amazon 亚马逊的商品展示视频，前两秒突出卖点，中段演示使用过程，结尾保留行动提示", "keywords": "Amazon 亚马逊、Amazon Seller、Seller Central、亚马逊卖家、Amazon Ads、Amazon主图、Listing Images、A+ Content、PDP、Product Video、电商视频、商品视频、带货、种草、直播、广告投放", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "amazon-ecommerce-video-generation-editing", "rule": "optional", "search": "Amazon 亚马逊 商家、运营、商品与广告视频搜索入口", "title": "Amazon 亚马逊 电商视频生成与编辑"}')
