...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "制作适合淘宝的商品主视觉，主体结构准确，材质真实，卖点清晰，预留标题与促销信息空间", "keywords": "淘宝网、淘宝店铺、淘宝卖家、淘宝运营、淘宝主图、淘宝详情页、直通车、万相台、商品视频、电商图片、主图、详情页、广告图", "model": "public_model_nano_banana_pro", "name": "taobao-ecommerce-image-generation-editing", "rule": "optional", "search": "淘宝 商家、运营、商品与广告图片搜索入口", "title": "淘宝 电商图片生成与编辑"}')
