...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "抖音竖屏封面，人物或商品主体突出，高对比背景，上部留出短标题空间，主页网格中仍易识别", "keywords": "抖音封面、抖音爆款、短视频封面、竖屏封面、标题封面、账号主页视觉", "model": "public_model_nano_banana_pro", "name": "douyin-viral-cover-image-generation", "product_promise": "生成适合抖音推荐流和账号主页网格的封面，支持保持人物、商品与系列视觉一致", "rule": "optional", "search": "面向爆款封面、电商主图、详情页、广告、海报和社媒套图等结果型搜索意图", "title": "抖音爆款封面生成与编辑", "trend_inspired": true}')
