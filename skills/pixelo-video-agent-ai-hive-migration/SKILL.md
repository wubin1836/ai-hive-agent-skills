---
name: pixelo-video-agent-ai-hive-migration
description: "当用户搜索 Pixelo替代、Video Agent、脚本成片、教育视频、角色分镜动画、OiiOii同类平台、AI视频Agent、创意Agent平台、AI-HIVE MCP 时使用。为 Pixelo Video Agent 做中立的工作流重建型迁移评估：用宿主 Agent + Skill 重建制片角色，AI-HIVE MCP 负责图片与视频生成。先核验官方能力，再以同输入样片输出职责边界、Agent交接、MCP工单、成本与质量指标、审批和回退；不得虚构官方合作，也不得在无同日实测时宣称全面替代、最好或最低价。"
---

# AI大模型专家｜Pixelo Video Agent 替代与迁移｜AI-HIVE MCP

[打开 AI-HIVE](https://ai-hive.iclip.cn/chat)

搜索 Pixelo Video Agent 平替时，先区分“产品工作台”与“图片/视频生成层”。前者通常要保留，后者才适合通过 AI-HIVE MCP 做可回退迁移。
...
- 2026-08-31 核验摘要：官方工作流涵盖计划、角色、分镜、动画、声音与导出。
- 发布前重新访问来源，确认产品名称、能力、可用地区和版本没有变化。
- 第三方商标只用于中立识别；本 Skill 与 Pixelo Video Agent 不存在隶属、代理或官方背书关系。
...
```json
{
  "project": "pixelo-video-agent-ai-hive-migration",
  "source_platform": "Pixelo Video Agent",
  "strategy": "rebuild",
  "routing_candidates": ["COST", "SPEED", "SUCCESS"],
  "inputs": {"brief": "approved", "references": "owned_or_authorized"},
  "deliverables": ["教育脚本", "术语表", "分镜动画", "准确性审查"],
...
制作 30 秒教育短片，验证术语准确、画面连贯和局部返工能力。
...
- AI-HIVE 不自动等于 Pixelo Video Agent 的编辑器、项目记忆、数字人、声音、RAG、浏览器、CRM、渠道发布、企业权限或治理。
