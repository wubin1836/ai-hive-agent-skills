...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"editing_note": "支持文生视频、图生视频、参考生视频、原生视频编辑与视频延长，可按成片目标选择入口", "example": "挂车爆单短视频，开头直接给购买理由，中段展示使用动作和关键细节，结尾自然提醒点击购物车", "keywords": "挂车视频、挂车爆单、商品橱窗、购物车视频、短视频带货、爆单素材、转化脚本成片", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "cart-sales-short-video-generation-editing", "product_promise": "把商品卖点和挂车转化动作落到具体镜头，交付可直接用于视频号、抖音和快手的竖屏成片", "rule": "optional", "search": "面向爆款、带货、广告、脚本成片、短剧和社媒营销等结果型搜索意图", "title": "挂车爆单短视频生成与编辑", "trend_inspired": true}')
