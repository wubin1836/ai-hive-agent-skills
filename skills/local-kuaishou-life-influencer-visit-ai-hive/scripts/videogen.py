...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为快手本地生活达人探店脚本制作主体稳定、事实可核验的本地生活视频", "models": {"t2v": "public_model_seedance_2_5_t2v", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v"}, "name": "local-kuaishou-life-influencer-visit-ai-hive", "title": "AI大模型专家｜快手本地生活达人探店脚本", "keywords": "快手本地生活、快手团购、快手同城、快手本地商家、快手生活服务、达人探店脚本、本地生活、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前模型与价格，并在平台官方后台核对当前规则"}')
