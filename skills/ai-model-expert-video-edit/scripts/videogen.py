...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "完成一条高质量视频编辑任务", "fixed_mode": "edit", "keywords": "视频编辑、AI剪辑、改视频、视频换背景、video edit、Seedance、MiniMax H3、Happy Horse", "models": {"edit": "public_model_seedance_2_5_video_edit"}, "name": "video-edit", "rule": "edit", "search": "通用能力搜索入口，底层调用 AI Hive 裸接口", "title": "视频编辑"}')
